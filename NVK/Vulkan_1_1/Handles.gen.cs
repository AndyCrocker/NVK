...
public readonly struct VkDebugReportCallbackEXT
{
	public readonly ulong Handle;
	public bool IsNull => Handle == 0;
...
[Obsolete("Use VkDescriptorUpdateTemplate")]
public readonly struct VkDescriptorUpdateTemplateKHR
{
	public readonly ulong Handle;
	public bool IsNull => Handle == 0;
...
public readonly struct VkObjectTableNVX
{
	public readonly ulong Handle;
	public bool IsNull => Handle == 0;
	public static VkObjectTableNVX Null => new(0);
	public VkObjectTableNVX(ulong handle)
	{
		Handle = handle;
	}
	public override bool Equals(object obj) => obj is VkObjectTableNVX handle && this == handle;
	public override int GetHashCode() => Handle.GetHashCode();
	...
	public static bool operator !=(VkObjectTableNVX left, ulong right) => left.Handle != right;
	public static bool operator ==(ulong left, VkObjectTableNVX right) => left == right.Handle;
	public static bool operator !=(ulong left, VkObjectTableNVX right) => left != right.Handle;
}
public readonly struct VkIndirectCommandsLayoutNVX
{
	public readonly ulong Handle;
	public bool IsNull => Handle == 0;
	public static VkIndirectCommandsLayoutNVX Null => new(0);
	public VkIndirectCommandsLayoutNVX(ulong handle)
	{
		Handle = handle;
	}
	public override bool Equals(object obj) => obj is VkIndirectCommandsLayoutNVX handle && this == handle;
	public override int GetHashCode() => Handle.GetHashCode();
	...
	public static bool operator !=(VkIndirectCommandsLayoutNVX left, ulong right) => left.Handle != right;
	public static bool operator ==(ulong left, VkIndirectCommandsLayoutNVX right) => left == right.Handle;
	public static bool operator !=(ulong left, VkIndirectCommandsLayoutNVX right) => left != right.Handle;
}
...
[Obsolete("Use VkSamplerYcbcrConversion")]
public readonly struct VkSamplerYcbcrConversionKHR
{
	public readonly ulong Handle;
	public bool IsNull => Handle == 0;
