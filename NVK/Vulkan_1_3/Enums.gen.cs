...
{
	AspectRatioInfoPresent = 1 << 0,
	OverscanInfoPresent = 1 << 1,
	OverscanAppropriate = 1 << 2,
	VideoSignalTypePresent = 1 << 3,
	VideoFullRange = 1 << 4,
	ColorDescriptionPresent = 1 << 5,
	ChromaLocInfoPresent = 1 << 6,
	TimingInfoPresent = 1 << 7,
	FixedFrameRate = 1 << 8,
	BitstreamRestriction = 1 << 9,
	NalHrdParametersPresent = 1 << 10,
	VclHrdParametersPresent = 1 << 11,
}
[Flags]
public enum StdVideoH264SpsFlags
{
	...
	ConstraintSet4 = 1 << 4,
	ConstraintSet5 = 1 << 5,
	Direct8x8Inference = 1 << 6,
	MbAdaptiveFrameField = 1 << 7,
	FrameMbsOnly = 1 << 8,
	DeltaPicOrderAlwaysZero = 1 << 9,
	SeparateColourPlane = 1 << 10,
	GapsInFrameNumValueAllowed = 1 << 11,
	QpprimeYZeroTransformBypass = 1 << 12,
	FrameCropping = 1 << 13,
	SeqScalingMatrixPresent = 1 << 14,
	VuiParametersPresent = 1 << 15,
}
[Flags]
public enum StdVideoH264PpsFlags
{
	Transform8x8Mode = 1 << 0,
	RedundantPicCntPresent = 1 << 1,
	ConstrainedIntraPred = 1 << 2,
	DeblockingFilterControlPresent = 1 << 3,
	WeightedPred = 1 << 4,
	BottomFieldPicOrderInFramePresent = 1 << 5,
	EntropyCodingMode = 1 << 6,
	PicScalingMatrixPresent = 1 << 7,
}
...
{
	NalHrdParametersPresent = 1 << 0,
	VclHrdParametersPresent = 1 << 1,
	SubPicHrdParamsPresent = 1 << 2,
	SubPicCpbParamsInPicTimingSei = 1 << 3,
	FixedPicRateGeneral0 = 1 << 4,
	FixedPicRateGeneral1 = 1 << 5,
	FixedPicRateGeneral2 = 1 << 6,
	FixedPicRateGeneral3 = 1 << 7,
	FixedPicRateGeneral4 = 1 << 8,
	FixedPicRateGeneral5 = 1 << 9,
	FixedPicRateGeneral6 = 1 << 10,
	FixedPicRateGeneral7 = 1 << 11,
	FixedPicRateWithinCvs0 = 1 << 12,
	FixedPicRateWithinCvs1 = 1 << 13,
	FixedPicRateWithinCvs2 = 1 << 14,
	FixedPicRateWithinCvs3 = 1 << 15,
	FixedPicRateWithinCvs4 = 1 << 16,
	FixedPicRateWithinCvs5 = 1 << 17,
	FixedPicRateWithinCvs6 = 1 << 18,
	FixedPicRateWithinCvs7 = 1 << 19,
	LowDelayHrd0 = 1 << 20,
	LowDelayHrd1 = 1 << 21,
	LowDelayHrd2 = 1 << 22,
	LowDelayHrd3 = 1 << 23,
...
{
	VpsTemporalIdNesting = 1 << 0,
	VpsSubLayerOrderingInfoPresent = 1 << 1,
	VpsTimingInfoPresent = 1 << 2,
	VpsPocProportionalToTiming = 1 << 3,
}
[Flags]
public enum StdVideoH265ProfileTierLevelFlags
{
	GeneralTier = 1 << 0,
	GeneralProgressiveSource = 1 << 1,
	GeneralInterlacedSource = 1 << 2,
	GeneralNonPackedConstraint = 1 << 3,
	GeneralFrameOnlyConstraint = 1 << 4,
}
[Flags]
public enum StdVideoH265SpsVuiFlags
{
	...
	VideoSignalTypePresent = 1 << 3,
	VideoFullRange = 1 << 4,
	ColourDescriptionPresent = 1 << 5,
	ChromaLocInfoPresent = 1 << 6,
	NeutralChromaIndication = 1 << 7,
	FieldSeq = 1 << 8,
	FrameFieldInfoPresent = 1 << 9,
	DefaultDisplayWindow = 1 << 10,
	VuiTimingInfoPresent = 1 << 11,
	VuiPocProportionalToTiming = 1 << 12,
	VuiHrdParametersPresent = 1 << 13,
	BitstreamRestriction = 1 << 14,
	TilesFixedStructure = 1 << 15,
	MotionVectorsOverPicBoundaries = 1 << 16,
	RestrictedRefPicLists = 1 << 17,
}
[Flags]
public enum StdVideoH265SpsFlags
{
	SpsTemporalIdNesting = 1 << 0,
	SeparateColourPlane = 1 << 1,
	ConformanceWindow = 1 << 2,
	SpsSubLayerOrderingInfoPresent = 1 << 3,
	ScalingListEnabled = 1 << 4,
	SpsScalingListDataPresent = 1 << 5,
	AmpEnabled = 1 << 6,
	SampleAdaptiveOffsetEnabled = 1 << 7,
	PcmEnabled = 1 << 8,
	PcmLoopFilterDisabled = 1 << 9,
	LongTermRefPicsPresent = 1 << 10,
	SpsTemporalMvpEnabled = 1 << 11,
	StrongIntraSmoothingEnabled = 1 << 12,
	VuiParametersPresent = 1 << 13,
	SpsExtensionPresent = 1 << 14,
	SpsRangeExtension = 1 << 15,
	TransformSkipRotationEnabled = 1 << 16,
	TransformSkipContextEnabled = 1 << 17,
	ImplicitRdpcmEnabled = 1 << 18,
	ExplicitRdpcmEnabled = 1 << 19,
	ExtendedPrecisionProcessing = 1 << 20,
	IntraSmoothingDisabled = 1 << 21,
	HighPrecisionOffsetsEnabled = 1 << 22,
	PersistentRiceAdaptationEnabled = 1 << 23,
	CabacBypassAlignmentEnabled = 1 << 24,
	SpsSccExtension = 1 << 25,
	SpsCurrPicRefEnabled = 1 << 26,
	PaletteModeEnabled = 1 << 27,
	SpsPalettePredictorInitializersPresent = 1 << 28,
	IntraBoundaryFilteringDisabled = 1 << 29,
}
[Flags]
public enum StdVideoH265ShortTermRefPicSetFlags
{
	InterRefPicSetPrediction = 1 << 0,
	DeltaRpsSign = 1 << 1,
}
[Flags]
public enum StdVideoH265PpsFlags
{
	DependentSliceSegmentsEnabled = 1 << 0,
	OutputFlagPresent = 1 << 1,
	SignDataHidingEnabled = 1 << 2,
	CabacInitPresent = 1 << 3,
	ConstrainedIntraPred = 1 << 4,
	TransformSkipEnabled = 1 << 5,
	CuQpDeltaEnabled = 1 << 6,
	PpsSliceChromaQpOffsetsPresent = 1 << 7,
	WeightedPred = 1 << 8,
	WeightedBipred = 1 << 9,
	TransquantBypassEnabled = 1 << 10,
	TilesEnabled = 1 << 11,
	EntropyCodingSyncEnabled = 1 << 12,
	UniformSpacing = 1 << 13,
	LoopFilterAcrossTilesEnabled = 1 << 14,
	PpsLoopFilterAcrossSlicesEnabled = 1 << 15,
	DeblockingFilterControlPresent = 1 << 16,
	DeblockingFilterOverrideEnabled = 1 << 17,
	PpsDeblockingFilterDisabled = 1 << 18,
	PpsScalingListDataPresent = 1 << 19,
	ListsModificationPresent = 1 << 20,
	SliceSegmentHeaderExtensionPresent = 1 << 21,
	PpsExtensionPresent = 1 << 22,
	CrossComponentPredictionEnabled = 1 << 23,
	ChromaQpOffsetListEnabled = 1 << 24,
	PpsCurrPicRefEnabled = 1 << 25,
	ResidualAdaptiveColourTransformEnabled = 1 << 26,
	PpsSliceActQpOffsetsPresent = 1 << 27,
	PpsPalettePredictorInitializersPresent = 1 << 28,
	MonochromePalette = 1 << 29,
	PpsRangeExtension = 1 << 30,
}
[Flags]
