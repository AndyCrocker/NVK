...
public static unsafe class VK
{
	...
	public static void GetPhysicalDeviceToolPropertiesEXT(VkPhysicalDevice physicalDevice, uint* toolCount, [In, Out] VkPhysicalDeviceToolPropertiesEXT[] toolProperties) => GetPhysicalDeviceToolPropertiesEXT_0(physicalDevice, toolCount, toolProperties);
	private delegate void GetPhysicalDeviceToolPropertiesEXTDelegate_0(VkPhysicalDevice physicalDevice, uint* toolCount, [In, Out] VkPhysicalDeviceToolPropertiesEXT[] toolProperties);
	private static GetPhysicalDeviceToolPropertiesEXTDelegate_0 GetPhysicalDeviceToolPropertiesEXT_0;
	[Obsolete("Use GetPhysicalDeviceToolProperties")]
	public static void GetPhysicalDeviceToolPropertiesEXT(VkPhysicalDevice physicalDevice, ref uint toolCount, [In, Out] VkPhysicalDeviceToolPropertiesEXT[] toolProperties) => GetPhysicalDeviceToolPropertiesEXT_1(physicalDevice, ref toolCount, toolProperties);
	private delegate void GetPhysicalDeviceToolPropertiesEXTDelegate_1(VkPhysicalDevice physicalDevice, ref uint toolCount, [In, Out] VkPhysicalDeviceToolPropertiesEXT[] toolProperties);
	...
	public static void CreatePrivateDataSlotEXT(VkDevice device, VkPrivateDataSlotCreateInfoEXT* createInfo, VkAllocationCallbacks* allocator, out VkPrivateDataSlotEXT privateDataSlot) => CreatePrivateDataSlotEXT_0(device, createInfo, allocator, out privateDataSlot);
	private delegate void CreatePrivateDataSlotEXTDelegate_0(VkDevice device, VkPrivateDataSlotCreateInfoEXT* createInfo, VkAllocationCallbacks* allocator, out VkPrivateDataSlotEXT privateDataSlot);
	private static CreatePrivateDataSlotEXTDelegate_0 CreatePrivateDataSlotEXT_0;
	[Obsolete("Use CreatePrivateDataSlot")]
	public static void CreatePrivateDataSlotEXT(VkDevice device, VkPrivateDataSlotCreateInfoEXT* createInfo, ref VkAllocationCallbacks allocator, out VkPrivateDataSlotEXT privateDataSlot) => CreatePrivateDataSlotEXT_1(device, createInfo, ref allocator, out privateDataSlot);
	private delegate void CreatePrivateDataSlotEXTDelegate_1(VkDevice device, VkPrivateDataSlotCreateInfoEXT* createInfo, ref VkAllocationCallbacks allocator, out VkPrivateDataSlotEXT privateDataSlot);
	private static CreatePrivateDataSlotEXTDelegate_1 CreatePrivateDataSlotEXT_1;
	[Obsolete("Use CreatePrivateDataSlot")]
	public static void CreatePrivateDataSlotEXT(VkDevice device, ref VkPrivateDataSlotCreateInfoEXT createInfo, VkAllocationCallbacks* allocator, out VkPrivateDataSlotEXT privateDataSlot) => CreatePrivateDataSlotEXT_2(device, ref createInfo, allocator, out privateDataSlot);
	private delegate void CreatePrivateDataSlotEXTDelegate_2(VkDevice device, ref VkPrivateDataSlotCreateInfoEXT createInfo, VkAllocationCallbacks* allocator, out VkPrivateDataSlotEXT privateDataSlot);
	private static CreatePrivateDataSlotEXTDelegate_2 CreatePrivateDataSlotEXT_2;
	[Obsolete("Use CreatePrivateDataSlot")]
	public static void CreatePrivateDataSlotEXT(VkDevice device, ref VkPrivateDataSlotCreateInfoEXT createInfo, ref VkAllocationCallbacks allocator, out VkPrivateDataSlotEXT privateDataSlot) => CreatePrivateDataSlotEXT_3(device, ref createInfo, ref allocator, out privateDataSlot);
	private delegate void CreatePrivateDataSlotEXTDelegate_3(VkDevice device, ref VkPrivateDataSlotCreateInfoEXT createInfo, ref VkAllocationCallbacks allocator, out VkPrivateDataSlotEXT privateDataSlot);
	...
	public static void SetPrivateDataEXT(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlotEXT privateDataSlot, ulong data) => SetPrivateDataEXT_0(device, objectType, objectHandle, privateDataSlot, data);
	private delegate void SetPrivateDataEXTDelegate_0(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlotEXT privateDataSlot, ulong data);
	...
	public static void QueueSubmit2KHR(VkQueue queue, uint submitCount, VkSubmitInfo2KHR[] submits, VkFence fence) => QueueSubmit2KHR_0(queue, submitCount, submits, fence);
	private delegate void QueueSubmit2KHRDelegate_0(VkQueue queue, uint submitCount, VkSubmitInfo2KHR[] submits, VkFence fence);
	...
	public static void GetDeviceBufferMemoryRequirementsKHR(VkDevice device, VkDeviceBufferMemoryRequirementsKHR* info, out VkMemoryRequirements2KHR memoryRequirements) => GetDeviceBufferMemoryRequirementsKHR_0(device, info, out memoryRequirements);
	private delegate void GetDeviceBufferMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceBufferMemoryRequirementsKHR* info, out VkMemoryRequirements2KHR memoryRequirements);
	private static GetDeviceBufferMemoryRequirementsKHRDelegate_0 GetDeviceBufferMemoryRequirementsKHR_0;
	[Obsolete("Use GetDeviceBufferMemoryRequirements")]
	public static void GetDeviceBufferMemoryRequirementsKHR(VkDevice device, ref VkDeviceBufferMemoryRequirementsKHR info, out VkMemoryRequirements2KHR memoryRequirements) => GetDeviceBufferMemoryRequirementsKHR_1(device, ref info, out memoryRequirements);
	private delegate void GetDeviceBufferMemoryRequirementsKHRDelegate_1(VkDevice device, ref VkDeviceBufferMemoryRequirementsKHR info, out VkMemoryRequirements2KHR memoryRequirements);
	...
	public static void GetDeviceImageMemoryRequirementsKHR(VkDevice device, VkDeviceImageMemoryRequirementsKHR* info, out VkMemoryRequirements2KHR memoryRequirements) => GetDeviceImageMemoryRequirementsKHR_0(device, info, out memoryRequirements);
	private delegate void GetDeviceImageMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceImageMemoryRequirementsKHR* info, out VkMemoryRequirements2KHR memoryRequirements);
	private static GetDeviceImageMemoryRequirementsKHRDelegate_0 GetDeviceImageMemoryRequirementsKHR_0;
	[Obsolete("Use GetDeviceImageMemoryRequirements")]
	public static void GetDeviceImageMemoryRequirementsKHR(VkDevice device, ref VkDeviceImageMemoryRequirementsKHR info, out VkMemoryRequirements2KHR memoryRequirements) => GetDeviceImageMemoryRequirementsKHR_1(device, ref info, out memoryRequirements);
	private delegate void GetDeviceImageMemoryRequirementsKHRDelegate_1(VkDevice device, ref VkDeviceImageMemoryRequirementsKHR info, out VkMemoryRequirements2KHR memoryRequirements);
	...
	public static void GetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, VkDeviceImageMemoryRequirementsKHR* info, uint* sparseMemoryRequirementCount, [In, Out] VkSparseImageMemoryRequirements2KHR[] sparseMemoryRequirements) => GetDeviceImageSparseMemoryRequirementsKHR_0(device, info, sparseMemoryRequirementCount, sparseMemoryRequirements);
	private delegate void GetDeviceImageSparseMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceImageMemoryRequirementsKHR* info, uint* sparseMemoryRequirementCount, [In, Out] VkSparseImageMemoryRequirements2KHR[] sparseMemoryRequirements);
	private static GetDeviceImageSparseMemoryRequirementsKHRDelegate_0 GetDeviceImageSparseMemoryRequirementsKHR_0;
	[Obsolete("Use GetDeviceImageSparseMemoryRequirements")]
	public static void GetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, VkDeviceImageMemoryRequirementsKHR* info, ref uint sparseMemoryRequirementCount, [In, Out] VkSparseImageMemoryRequirements2KHR[] sparseMemoryRequirements) => GetDeviceImageSparseMemoryRequirementsKHR_1(device, info, ref sparseMemoryRequirementCount, sparseMemoryRequirements);
	private delegate void GetDeviceImageSparseMemoryRequirementsKHRDelegate_1(VkDevice device, VkDeviceImageMemoryRequirementsKHR* info, ref uint sparseMemoryRequirementCount, [In, Out] VkSparseImageMemoryRequirements2KHR[] sparseMemoryRequirements);
	private static GetDeviceImageSparseMemoryRequirementsKHRDelegate_1 GetDeviceImageSparseMemoryRequirementsKHR_1;
	[Obsolete("Use GetDeviceImageSparseMemoryRequirements")]
	public static void GetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, ref VkDeviceImageMemoryRequirementsKHR info, uint* sparseMemoryRequirementCount, [In, Out] VkSparseImageMemoryRequirements2KHR[] sparseMemoryRequirements) => GetDeviceImageSparseMemoryRequirementsKHR_2(device, ref info, sparseMemoryRequirementCount, sparseMemoryRequirements);
	private delegate void GetDeviceImageSparseMemoryRequirementsKHRDelegate_2(VkDevice device, ref VkDeviceImageMemoryRequirementsKHR info, uint* sparseMemoryRequirementCount, [In, Out] VkSparseImageMemoryRequirements2KHR[] sparseMemoryRequirements);
	private static GetDeviceImageSparseMemoryRequirementsKHRDelegate_2 GetDeviceImageSparseMemoryRequirementsKHR_2;
	[Obsolete("Use GetDeviceImageSparseMemoryRequirements")]
	public static void GetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, ref VkDeviceImageMemoryRequirementsKHR info, ref uint sparseMemoryRequirementCount, [In, Out] VkSparseImageMemoryRequirements2KHR[] sparseMemoryRequirements) => GetDeviceImageSparseMemoryRequirementsKHR_3(device, ref info, ref sparseMemoryRequirementCount, sparseMemoryRequirements);
	private delegate void GetDeviceImageSparseMemoryRequirementsKHRDelegate_3(VkDevice device, ref VkDeviceImageMemoryRequirementsKHR info, ref uint sparseMemoryRequirementCount, [In, Out] VkSparseImageMemoryRequirements2KHR[] sparseMemoryRequirements);
	...
	public static void InitialiseInstanceMethods(VkInstance instance)
	{
		...
		var getPhysicalDeviceToolProperties = (nint)GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceToolProperties");
		if (getPhysicalDeviceToolProperties != nint.Zero)
		{
			GetPhysicalDeviceToolProperties_0 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceToolPropertiesDelegate_0>(getPhysicalDeviceToolProperties);
			GetPhysicalDeviceToolProperties_1 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceToolPropertiesDelegate_1>(getPhysicalDeviceToolProperties);
		}
		var createPrivateDataSlot = (nint)GetInstanceProcedureAddress(instance, "vkCreatePrivateDataSlot");
		if (createPrivateDataSlot != nint.Zero)
		{
			CreatePrivateDataSlot_0 = Marshal.GetDelegateForFunctionPointer<CreatePrivateDataSlotDelegate_0>(createPrivateDataSlot);
			CreatePrivateDataSlot_1 = Marshal.GetDelegateForFunctionPointer<CreatePrivateDataSlotDelegate_1>(createPrivateDataSlot);
			CreatePrivateDataSlot_2 = Marshal.GetDelegateForFunctionPointer<CreatePrivateDataSlotDelegate_2>(createPrivateDataSlot);
			CreatePrivateDataSlot_3 = Marshal.GetDelegateForFunctionPointer<CreatePrivateDataSlotDelegate_3>(createPrivateDataSlot);
		}
		var destroyPrivateDataSlot = (nint)GetInstanceProcedureAddress(instance, "vkDestroyPrivateDataSlot");
		if (destroyPrivateDataSlot != nint.Zero)
		{
			DestroyPrivateDataSlot_0 = Marshal.GetDelegateForFunctionPointer<DestroyPrivateDataSlotDelegate_0>(destroyPrivateDataSlot);
			DestroyPrivateDataSlot_1 = Marshal.GetDelegateForFunctionPointer<DestroyPrivateDataSlotDelegate_1>(destroyPrivateDataSlot);
		}
		var setPrivateData = (nint)GetInstanceProcedureAddress(instance, "vkSetPrivateData");
		if (setPrivateData != nint.Zero)
		{
			SetPrivateData_0 = Marshal.GetDelegateForFunctionPointer<SetPrivateDataDelegate_0>(setPrivateData);
		}
		var getPrivateData = (nint)GetInstanceProcedureAddress(instance, "vkGetPrivateData");
		if (getPrivateData != nint.Zero)
		{
			GetPrivateData_0 = Marshal.GetDelegateForFunctionPointer<GetPrivateDataDelegate_0>(getPrivateData);
		}
		var commandSetEvent2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetEvent2");
		if (commandSetEvent2 != nint.Zero)
		{
			CommandSetEvent2_0 = Marshal.GetDelegateForFunctionPointer<CommandSetEvent2Delegate_0>(commandSetEvent2);
			CommandSetEvent2_1 = Marshal.GetDelegateForFunctionPointer<CommandSetEvent2Delegate_1>(commandSetEvent2);
		}
		var commandResetEvent2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdResetEvent2");
		if (commandResetEvent2 != nint.Zero)
		{
			CommandResetEvent2_0 = Marshal.GetDelegateForFunctionPointer<CommandResetEvent2Delegate_0>(commandResetEvent2);
		}
		var commandWaitEvents2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdWaitEvents2");
		if (commandWaitEvents2 != nint.Zero)
		{
			CommandWaitEvents2_0 = Marshal.GetDelegateForFunctionPointer<CommandWaitEvents2Delegate_0>(commandWaitEvents2);
		}
		var commandPipelineBarrier2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdPipelineBarrier2");
		if (commandPipelineBarrier2 != nint.Zero)
		{
			CommandPipelineBarrier2_0 = Marshal.GetDelegateForFunctionPointer<CommandPipelineBarrier2Delegate_0>(commandPipelineBarrier2);
			CommandPipelineBarrier2_1 = Marshal.GetDelegateForFunctionPointer<CommandPipelineBarrier2Delegate_1>(commandPipelineBarrier2);
		}
		var commandWriteTimestamp2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdWriteTimestamp2");
		if (commandWriteTimestamp2 != nint.Zero)
		{
			CommandWriteTimestamp2_0 = Marshal.GetDelegateForFunctionPointer<CommandWriteTimestamp2Delegate_0>(commandWriteTimestamp2);
		}
		var queueSubmit2 = (nint)GetInstanceProcedureAddress(instance, "vkQueueSubmit2");
		if (queueSubmit2 != nint.Zero)
		{
			QueueSubmit2_0 = Marshal.GetDelegateForFunctionPointer<QueueSubmit2Delegate_0>(queueSubmit2);
		}
		var commandCopyBuffer2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyBuffer2");
		if (commandCopyBuffer2 != nint.Zero)
		{
			CommandCopyBuffer2_0 = Marshal.GetDelegateForFunctionPointer<CommandCopyBuffer2Delegate_0>(commandCopyBuffer2);
			CommandCopyBuffer2_1 = Marshal.GetDelegateForFunctionPointer<CommandCopyBuffer2Delegate_1>(commandCopyBuffer2);
		}
		var commandCopyImage2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyImage2");
		if (commandCopyImage2 != nint.Zero)
		{
			CommandCopyImage2_0 = Marshal.GetDelegateForFunctionPointer<CommandCopyImage2Delegate_0>(commandCopyImage2);
			CommandCopyImage2_1 = Marshal.GetDelegateForFunctionPointer<CommandCopyImage2Delegate_1>(commandCopyImage2);
		}
		var commandCopyBufferToImage2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyBufferToImage2");
		if (commandCopyBufferToImage2 != nint.Zero)
		{
			CommandCopyBufferToImage2_0 = Marshal.GetDelegateForFunctionPointer<CommandCopyBufferToImage2Delegate_0>(commandCopyBufferToImage2);
			CommandCopyBufferToImage2_1 = Marshal.GetDelegateForFunctionPointer<CommandCopyBufferToImage2Delegate_1>(commandCopyBufferToImage2);
		}
		var commandCopyImageToBuffer2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyImageToBuffer2");
		if (commandCopyImageToBuffer2 != nint.Zero)
		{
			CommandCopyImageToBuffer2_0 = Marshal.GetDelegateForFunctionPointer<CommandCopyImageToBuffer2Delegate_0>(commandCopyImageToBuffer2);
			CommandCopyImageToBuffer2_1 = Marshal.GetDelegateForFunctionPointer<CommandCopyImageToBuffer2Delegate_1>(commandCopyImageToBuffer2);
		}
		var commandBlitImage2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdBlitImage2");
		if (commandBlitImage2 != nint.Zero)
		{
			CommandBlitImage2_0 = Marshal.GetDelegateForFunctionPointer<CommandBlitImage2Delegate_0>(commandBlitImage2);
			CommandBlitImage2_1 = Marshal.GetDelegateForFunctionPointer<CommandBlitImage2Delegate_1>(commandBlitImage2);
		}
		var commandResolveImage2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdResolveImage2");
		if (commandResolveImage2 != nint.Zero)
		{
			CommandResolveImage2_0 = Marshal.GetDelegateForFunctionPointer<CommandResolveImage2Delegate_0>(commandResolveImage2);
			CommandResolveImage2_1 = Marshal.GetDelegateForFunctionPointer<CommandResolveImage2Delegate_1>(commandResolveImage2);
		}
		var commandBeginRendering = (nint)GetInstanceProcedureAddress(instance, "vkCmdBeginRendering");
		if (commandBeginRendering != nint.Zero)
		{
			CommandBeginRendering_0 = Marshal.GetDelegateForFunctionPointer<CommandBeginRenderingDelegate_0>(commandBeginRendering);
			CommandBeginRendering_1 = Marshal.GetDelegateForFunctionPointer<CommandBeginRenderingDelegate_1>(commandBeginRendering);
		}
		var commandEndRendering = (nint)GetInstanceProcedureAddress(instance, "vkCmdEndRendering");
		if (commandEndRendering != nint.Zero)
		{
			CommandEndRendering_0 = Marshal.GetDelegateForFunctionPointer<CommandEndRenderingDelegate_0>(commandEndRendering);
		}
		var commandSetCullMode = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetCullMode");
		if (commandSetCullMode != nint.Zero)
		{
			CommandSetCullMode_0 = Marshal.GetDelegateForFunctionPointer<CommandSetCullModeDelegate_0>(commandSetCullMode);
		}
		var commandSetFrontFace = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetFrontFace");
		if (commandSetFrontFace != nint.Zero)
		{
			CommandSetFrontFace_0 = Marshal.GetDelegateForFunctionPointer<CommandSetFrontFaceDelegate_0>(commandSetFrontFace);
		}
		var commandSetPrimitiveTopology = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetPrimitiveTopology");
		if (commandSetPrimitiveTopology != nint.Zero)
		{
			CommandSetPrimitiveTopology_0 = Marshal.GetDelegateForFunctionPointer<CommandSetPrimitiveTopologyDelegate_0>(commandSetPrimitiveTopology);
		}
		var commandSetViewportWithCount = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetViewportWithCount");
		if (commandSetViewportWithCount != nint.Zero)
		{
			CommandSetViewportWithCount_0 = Marshal.GetDelegateForFunctionPointer<CommandSetViewportWithCountDelegate_0>(commandSetViewportWithCount);
		}
		var commandSetScissorWithCount = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetScissorWithCount");
		if (commandSetScissorWithCount != nint.Zero)
		{
			CommandSetScissorWithCount_0 = Marshal.GetDelegateForFunctionPointer<CommandSetScissorWithCountDelegate_0>(commandSetScissorWithCount);
		}
		var commandBindVertexBuffers2 = (nint)GetInstanceProcedureAddress(instance, "vkCmdBindVertexBuffers2");
		if (commandBindVertexBuffers2 != nint.Zero)
		{
			CommandBindVertexBuffers2_0 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_0>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_1 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_1>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_2 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_2>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_3 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_3>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_4 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_4>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_5 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_5>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_6 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_6>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_7 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_7>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_8 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_8>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_9 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_9>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_10 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_10>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_11 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_11>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_12 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_12>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_13 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_13>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_14 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_14>(commandBindVertexBuffers2);
			CommandBindVertexBuffers2_15 = Marshal.GetDelegateForFunctionPointer<CommandBindVertexBuffers2Delegate_15>(commandBindVertexBuffers2);
		}
		var commandSetDepthTestEnable = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthTestEnable");
		if (commandSetDepthTestEnable != nint.Zero)
		{
			CommandSetDepthTestEnable_0 = Marshal.GetDelegateForFunctionPointer<CommandSetDepthTestEnableDelegate_0>(commandSetDepthTestEnable);
		}
		var commandSetDepthWriteEnable = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthWriteEnable");
		if (commandSetDepthWriteEnable != nint.Zero)
		{
			CommandSetDepthWriteEnable_0 = Marshal.GetDelegateForFunctionPointer<CommandSetDepthWriteEnableDelegate_0>(commandSetDepthWriteEnable);
		}
		var commandSetDepthCompareOp = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthCompareOp");
		if (commandSetDepthCompareOp != nint.Zero)
		{
			CommandSetDepthCompareOp_0 = Marshal.GetDelegateForFunctionPointer<CommandSetDepthCompareOpDelegate_0>(commandSetDepthCompareOp);
		}
		var commandSetDepthBoundsTestEnable = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthBoundsTestEnable");
		if (commandSetDepthBoundsTestEnable != nint.Zero)
		{
			CommandSetDepthBoundsTestEnable_0 = Marshal.GetDelegateForFunctionPointer<CommandSetDepthBoundsTestEnableDelegate_0>(commandSetDepthBoundsTestEnable);
		}
		var commandSetStencilTestEnable = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetStencilTestEnable");
		if (commandSetStencilTestEnable != nint.Zero)
		{
			CommandSetStencilTestEnable_0 = Marshal.GetDelegateForFunctionPointer<CommandSetStencilTestEnableDelegate_0>(commandSetStencilTestEnable);
		}
		var commandSetStencilOp = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetStencilOp");
		if (commandSetStencilOp != nint.Zero)
		{
			CommandSetStencilOp_0 = Marshal.GetDelegateForFunctionPointer<CommandSetStencilOpDelegate_0>(commandSetStencilOp);
		}
		var commandSetRasterizerDiscardEnable = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetRasterizerDiscardEnable");
		if (commandSetRasterizerDiscardEnable != nint.Zero)
		{
			CommandSetRasterizerDiscardEnable_0 = Marshal.GetDelegateForFunctionPointer<CommandSetRasterizerDiscardEnableDelegate_0>(commandSetRasterizerDiscardEnable);
		}
		var commandSetDepthBiasEnable = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthBiasEnable");
		if (commandSetDepthBiasEnable != nint.Zero)
		{
			CommandSetDepthBiasEnable_0 = Marshal.GetDelegateForFunctionPointer<CommandSetDepthBiasEnableDelegate_0>(commandSetDepthBiasEnable);
		}
		var commandSetPrimitiveRestartEnable = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetPrimitiveRestartEnable");
		if (commandSetPrimitiveRestartEnable != nint.Zero)
		{
			CommandSetPrimitiveRestartEnable_0 = Marshal.GetDelegateForFunctionPointer<CommandSetPrimitiveRestartEnableDelegate_0>(commandSetPrimitiveRestartEnable);
		}
		var getDeviceBufferMemoryRequirements = (nint)GetInstanceProcedureAddress(instance, "vkGetDeviceBufferMemoryRequirements");
		if (getDeviceBufferMemoryRequirements != nint.Zero)
		{
			GetDeviceBufferMemoryRequirements_0 = Marshal.GetDelegateForFunctionPointer<GetDeviceBufferMemoryRequirementsDelegate_0>(getDeviceBufferMemoryRequirements);
			GetDeviceBufferMemoryRequirements_1 = Marshal.GetDelegateForFunctionPointer<GetDeviceBufferMemoryRequirementsDelegate_1>(getDeviceBufferMemoryRequirements);
		}
		var getDeviceImageMemoryRequirements = (nint)GetInstanceProcedureAddress(instance, "vkGetDeviceImageMemoryRequirements");
		if (getDeviceImageMemoryRequirements != nint.Zero)
		{
			GetDeviceImageMemoryRequirements_0 = Marshal.GetDelegateForFunctionPointer<GetDeviceImageMemoryRequirementsDelegate_0>(getDeviceImageMemoryRequirements);
			GetDeviceImageMemoryRequirements_1 = Marshal.GetDelegateForFunctionPointer<GetDeviceImageMemoryRequirementsDelegate_1>(getDeviceImageMemoryRequirements);
		}
		var getDeviceImageSparseMemoryRequirements = (nint)GetInstanceProcedureAddress(instance, "vkGetDeviceImageSparseMemoryRequirements");
		if (getDeviceImageSparseMemoryRequirements != nint.Zero)
		{
			GetDeviceImageSparseMemoryRequirements_0 = Marshal.GetDelegateForFunctionPointer<GetDeviceImageSparseMemoryRequirementsDelegate_0>(getDeviceImageSparseMemoryRequirements);
			GetDeviceImageSparseMemoryRequirements_1 = Marshal.GetDelegateForFunctionPointer<GetDeviceImageSparseMemoryRequirementsDelegate_1>(getDeviceImageSparseMemoryRequirements);
			GetDeviceImageSparseMemoryRequirements_2 = Marshal.GetDelegateForFunctionPointer<GetDeviceImageSparseMemoryRequirementsDelegate_2>(getDeviceImageSparseMemoryRequirements);
			GetDeviceImageSparseMemoryRequirements_3 = Marshal.GetDelegateForFunctionPointer<GetDeviceImageSparseMemoryRequirementsDelegate_3>(getDeviceImageSparseMemoryRequirements);
		}
		...
		var getPhysicalDeviceVideoCapabilitiesKHR = (nint)GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceVideoCapabilitiesKHR");
		if (getPhysicalDeviceVideoCapabilitiesKHR != nint.Zero)
		{
			GetPhysicalDeviceVideoCapabilitiesKHR_0 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceVideoCapabilitiesKHRDelegate_0>(getPhysicalDeviceVideoCapabilitiesKHR);
			GetPhysicalDeviceVideoCapabilitiesKHR_1 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceVideoCapabilitiesKHRDelegate_1>(getPhysicalDeviceVideoCapabilitiesKHR);
		}
		var getPhysicalDeviceVideoFormatPropertiesKHR = (nint)GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceVideoFormatPropertiesKHR");
		if (getPhysicalDeviceVideoFormatPropertiesKHR != nint.Zero)
		{
			GetPhysicalDeviceVideoFormatPropertiesKHR_0 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceVideoFormatPropertiesKHRDelegate_0>(getPhysicalDeviceVideoFormatPropertiesKHR);
			GetPhysicalDeviceVideoFormatPropertiesKHR_1 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceVideoFormatPropertiesKHRDelegate_1>(getPhysicalDeviceVideoFormatPropertiesKHR);
			GetPhysicalDeviceVideoFormatPropertiesKHR_2 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceVideoFormatPropertiesKHRDelegate_2>(getPhysicalDeviceVideoFormatPropertiesKHR);
			GetPhysicalDeviceVideoFormatPropertiesKHR_3 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceVideoFormatPropertiesKHRDelegate_3>(getPhysicalDeviceVideoFormatPropertiesKHR);
		}
		var createVideoSessionKHR = (nint)GetInstanceProcedureAddress(instance, "vkCreateVideoSessionKHR");
		if (createVideoSessionKHR != nint.Zero)
		{
			CreateVideoSessionKHR_0 = Marshal.GetDelegateForFunctionPointer<CreateVideoSessionKHRDelegate_0>(createVideoSessionKHR);
			CreateVideoSessionKHR_1 = Marshal.GetDelegateForFunctionPointer<CreateVideoSessionKHRDelegate_1>(createVideoSessionKHR);
			CreateVideoSessionKHR_2 = Marshal.GetDelegateForFunctionPointer<CreateVideoSessionKHRDelegate_2>(createVideoSessionKHR);
			CreateVideoSessionKHR_3 = Marshal.GetDelegateForFunctionPointer<CreateVideoSessionKHRDelegate_3>(createVideoSessionKHR);
		}
		var destroyVideoSessionKHR = (nint)GetInstanceProcedureAddress(instance, "vkDestroyVideoSessionKHR");
		if (destroyVideoSessionKHR != nint.Zero)
		{
			DestroyVideoSessionKHR_0 = Marshal.GetDelegateForFunctionPointer<DestroyVideoSessionKHRDelegate_0>(destroyVideoSessionKHR);
			DestroyVideoSessionKHR_1 = Marshal.GetDelegateForFunctionPointer<DestroyVideoSessionKHRDelegate_1>(destroyVideoSessionKHR);
		}
		var getVideoSessionMemoryRequirementsKHR = (nint)GetInstanceProcedureAddress(instance, "vkGetVideoSessionMemoryRequirementsKHR");
		if (getVideoSessionMemoryRequirementsKHR != nint.Zero)
		{
			GetVideoSessionMemoryRequirementsKHR_0 = Marshal.GetDelegateForFunctionPointer<GetVideoSessionMemoryRequirementsKHRDelegate_0>(getVideoSessionMemoryRequirementsKHR);
			GetVideoSessionMemoryRequirementsKHR_1 = Marshal.GetDelegateForFunctionPointer<GetVideoSessionMemoryRequirementsKHRDelegate_1>(getVideoSessionMemoryRequirementsKHR);
		}
		var bindVideoSessionMemoryKHR = (nint)GetInstanceProcedureAddress(instance, "vkBindVideoSessionMemoryKHR");
		if (bindVideoSessionMemoryKHR != nint.Zero)
		{
			BindVideoSessionMemoryKHR_0 = Marshal.GetDelegateForFunctionPointer<BindVideoSessionMemoryKHRDelegate_0>(bindVideoSessionMemoryKHR);
		}
		var createVideoSessionParametersKHR = (nint)GetInstanceProcedureAddress(instance, "vkCreateVideoSessionParametersKHR");
		if (createVideoSessionParametersKHR != nint.Zero)
		{
			CreateVideoSessionParametersKHR_0 = Marshal.GetDelegateForFunctionPointer<CreateVideoSessionParametersKHRDelegate_0>(createVideoSessionParametersKHR);
			CreateVideoSessionParametersKHR_1 = Marshal.GetDelegateForFunctionPointer<CreateVideoSessionParametersKHRDelegate_1>(createVideoSessionParametersKHR);
			CreateVideoSessionParametersKHR_2 = Marshal.GetDelegateForFunctionPointer<CreateVideoSessionParametersKHRDelegate_2>(createVideoSessionParametersKHR);
			CreateVideoSessionParametersKHR_3 = Marshal.GetDelegateForFunctionPointer<CreateVideoSessionParametersKHRDelegate_3>(createVideoSessionParametersKHR);
		}
		var updateVideoSessionParametersKHR = (nint)GetInstanceProcedureAddress(instance, "vkUpdateVideoSessionParametersKHR");
		if (updateVideoSessionParametersKHR != nint.Zero)
		{
			UpdateVideoSessionParametersKHR_0 = Marshal.GetDelegateForFunctionPointer<UpdateVideoSessionParametersKHRDelegate_0>(updateVideoSessionParametersKHR);
			UpdateVideoSessionParametersKHR_1 = Marshal.GetDelegateForFunctionPointer<UpdateVideoSessionParametersKHRDelegate_1>(updateVideoSessionParametersKHR);
		}
		var destroyVideoSessionParametersKHR = (nint)GetInstanceProcedureAddress(instance, "vkDestroyVideoSessionParametersKHR");
		if (destroyVideoSessionParametersKHR != nint.Zero)
		{
			DestroyVideoSessionParametersKHR_0 = Marshal.GetDelegateForFunctionPointer<DestroyVideoSessionParametersKHRDelegate_0>(destroyVideoSessionParametersKHR);
			DestroyVideoSessionParametersKHR_1 = Marshal.GetDelegateForFunctionPointer<DestroyVideoSessionParametersKHRDelegate_1>(destroyVideoSessionParametersKHR);
		}
		var commandBeginVideoCodingKHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdBeginVideoCodingKHR");
		if (commandBeginVideoCodingKHR != nint.Zero)
		{
			CommandBeginVideoCodingKHR_0 = Marshal.GetDelegateForFunctionPointer<CommandBeginVideoCodingKHRDelegate_0>(commandBeginVideoCodingKHR);
			CommandBeginVideoCodingKHR_1 = Marshal.GetDelegateForFunctionPointer<CommandBeginVideoCodingKHRDelegate_1>(commandBeginVideoCodingKHR);
		}
		var commandEndVideoCodingKHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdEndVideoCodingKHR");
		if (commandEndVideoCodingKHR != nint.Zero)
		{
			CommandEndVideoCodingKHR_0 = Marshal.GetDelegateForFunctionPointer<CommandEndVideoCodingKHRDelegate_0>(commandEndVideoCodingKHR);
			CommandEndVideoCodingKHR_1 = Marshal.GetDelegateForFunctionPointer<CommandEndVideoCodingKHRDelegate_1>(commandEndVideoCodingKHR);
		}
		var commandControlVideoCodingKHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdControlVideoCodingKHR");
		if (commandControlVideoCodingKHR != nint.Zero)
		{
			CommandControlVideoCodingKHR_0 = Marshal.GetDelegateForFunctionPointer<CommandControlVideoCodingKHRDelegate_0>(commandControlVideoCodingKHR);
			CommandControlVideoCodingKHR_1 = Marshal.GetDelegateForFunctionPointer<CommandControlVideoCodingKHRDelegate_1>(commandControlVideoCodingKHR);
		}
		var commandDecodeVideoKHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdDecodeVideoKHR");
		if (commandDecodeVideoKHR != nint.Zero)
		{
			CommandDecodeVideoKHR_0 = Marshal.GetDelegateForFunctionPointer<CommandDecodeVideoKHRDelegate_0>(commandDecodeVideoKHR);
			CommandDecodeVideoKHR_1 = Marshal.GetDelegateForFunctionPointer<CommandDecodeVideoKHRDelegate_1>(commandDecodeVideoKHR);
		}
		...
		var commandBeginRenderingKHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdBeginRendering");
		...
		var commandEndRenderingKHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdEndRendering");
		...
		var getPhysicalDeviceToolPropertiesEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceToolProperties");
		...
		var commandSetCullModeEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetCullMode");
		...
		var commandSetFrontFaceEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetFrontFace");
		...
		var commandSetPrimitiveTopologyEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetPrimitiveTopology");
		...
		var commandSetViewportWithCountEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetViewportWithCount");
		...
		var commandSetScissorWithCountEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetScissorWithCount");
		...
		var commandBindVertexBuffers2EXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdBindVertexBuffers2");
		...
		var commandSetDepthTestEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthTestEnable");
		...
		var commandSetDepthWriteEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthWriteEnable");
		...
		var commandSetDepthCompareOpEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthCompareOp");
		...
		var commandSetDepthBoundsTestEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthBoundsTestEnable");
		...
		var commandSetStencilTestEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetStencilTestEnable");
		...
		var commandSetStencilOpEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetStencilOp");
		...
		{
			ReleaseSwapchainImagesEXT_0 = Marshal.GetDelegateForFunctionPointer<ReleaseSwapchainImagesEXTDelegate_0>(releaseSwapchainImagesEXT);
			ReleaseSwapchainImagesEXT_1 = Marshal.GetDelegateForFunctionPointer<ReleaseSwapchainImagesEXTDelegate_1>(releaseSwapchainImagesEXT);
		}
		...
		var createPrivateDataSlotEXT = (nint)GetInstanceProcedureAddress(instance, "vkCreatePrivateDataSlot");
		...
		var destroyPrivateDataSlotEXT = (nint)GetInstanceProcedureAddress(instance, "vkDestroyPrivateDataSlot");
		...
		var setPrivateDataEXT = (nint)GetInstanceProcedureAddress(instance, "vkSetPrivateData");
		...
		var getPrivateDataEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetPrivateData");
		...
		var commandSetEvent2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetEvent2");
		...
		var commandResetEvent2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdResetEvent2");
		...
		var commandWaitEvents2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdWaitEvents2");
		...
		var commandPipelineBarrier2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdPipelineBarrier2");
		...
		var commandWriteTimestamp2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdWriteTimestamp2");
		...
		var queueSubmit2KHR = (nint)GetInstanceProcedureAddress(instance, "vkQueueSubmit2");
		...
		var getDescriptorSetLayoutSizeEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetDescriptorSetLayoutSizeEXT");
		if (getDescriptorSetLayoutSizeEXT != nint.Zero)
		{
			GetDescriptorSetLayoutSizeEXT_0 = Marshal.GetDelegateForFunctionPointer<GetDescriptorSetLayoutSizeEXTDelegate_0>(getDescriptorSetLayoutSizeEXT);
		}
		var getDescriptorSetLayoutBindingOffsetEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetDescriptorSetLayoutBindingOffsetEXT");
		if (getDescriptorSetLayoutBindingOffsetEXT != nint.Zero)
		{
			GetDescriptorSetLayoutBindingOffsetEXT_0 = Marshal.GetDelegateForFunctionPointer<GetDescriptorSetLayoutBindingOffsetEXTDelegate_0>(getDescriptorSetLayoutBindingOffsetEXT);
		}
		var getDescriptorEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetDescriptorEXT");
		if (getDescriptorEXT != nint.Zero)
		{
			GetDescriptorEXT_0 = Marshal.GetDelegateForFunctionPointer<GetDescriptorEXTDelegate_0>(getDescriptorEXT);
			GetDescriptorEXT_1 = Marshal.GetDelegateForFunctionPointer<GetDescriptorEXTDelegate_1>(getDescriptorEXT);
		}
		var commandBindDescriptorBuffersEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdBindDescriptorBuffersEXT");
		if (commandBindDescriptorBuffersEXT != nint.Zero)
		{
			CommandBindDescriptorBuffersEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandBindDescriptorBuffersEXTDelegate_0>(commandBindDescriptorBuffersEXT);
		}
		var commandSetDescriptorBufferOffsetsEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDescriptorBufferOffsetsEXT");
		if (commandSetDescriptorBufferOffsetsEXT != nint.Zero)
		{
			CommandSetDescriptorBufferOffsetsEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetDescriptorBufferOffsetsEXTDelegate_0>(commandSetDescriptorBufferOffsetsEXT);
			CommandSetDescriptorBufferOffsetsEXT_1 = Marshal.GetDelegateForFunctionPointer<CommandSetDescriptorBufferOffsetsEXTDelegate_1>(commandSetDescriptorBufferOffsetsEXT);
			CommandSetDescriptorBufferOffsetsEXT_2 = Marshal.GetDelegateForFunctionPointer<CommandSetDescriptorBufferOffsetsEXTDelegate_2>(commandSetDescriptorBufferOffsetsEXT);
			CommandSetDescriptorBufferOffsetsEXT_3 = Marshal.GetDelegateForFunctionPointer<CommandSetDescriptorBufferOffsetsEXTDelegate_3>(commandSetDescriptorBufferOffsetsEXT);
		}
		var commandBindDescriptorBufferEmbeddedSamplersEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdBindDescriptorBufferEmbeddedSamplersEXT");
		if (commandBindDescriptorBufferEmbeddedSamplersEXT != nint.Zero)
		{
			CommandBindDescriptorBufferEmbeddedSamplersEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandBindDescriptorBufferEmbeddedSamplersEXTDelegate_0>(commandBindDescriptorBufferEmbeddedSamplersEXT);
		}
		var getBufferOpaqueCaptureDescriptorDataEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetBufferOpaqueCaptureDescriptorDataEXT");
		if (getBufferOpaqueCaptureDescriptorDataEXT != nint.Zero)
		{
			GetBufferOpaqueCaptureDescriptorDataEXT_0 = Marshal.GetDelegateForFunctionPointer<GetBufferOpaqueCaptureDescriptorDataEXTDelegate_0>(getBufferOpaqueCaptureDescriptorDataEXT);
			GetBufferOpaqueCaptureDescriptorDataEXT_1 = Marshal.GetDelegateForFunctionPointer<GetBufferOpaqueCaptureDescriptorDataEXTDelegate_1>(getBufferOpaqueCaptureDescriptorDataEXT);
		}
		var getImageOpaqueCaptureDescriptorDataEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetImageOpaqueCaptureDescriptorDataEXT");
		if (getImageOpaqueCaptureDescriptorDataEXT != nint.Zero)
		{
			GetImageOpaqueCaptureDescriptorDataEXT_0 = Marshal.GetDelegateForFunctionPointer<GetImageOpaqueCaptureDescriptorDataEXTDelegate_0>(getImageOpaqueCaptureDescriptorDataEXT);
			GetImageOpaqueCaptureDescriptorDataEXT_1 = Marshal.GetDelegateForFunctionPointer<GetImageOpaqueCaptureDescriptorDataEXTDelegate_1>(getImageOpaqueCaptureDescriptorDataEXT);
		}
		var getImageViewOpaqueCaptureDescriptorDataEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetImageViewOpaqueCaptureDescriptorDataEXT");
		if (getImageViewOpaqueCaptureDescriptorDataEXT != nint.Zero)
		{
			GetImageViewOpaqueCaptureDescriptorDataEXT_0 = Marshal.GetDelegateForFunctionPointer<GetImageViewOpaqueCaptureDescriptorDataEXTDelegate_0>(getImageViewOpaqueCaptureDescriptorDataEXT);
			GetImageViewOpaqueCaptureDescriptorDataEXT_1 = Marshal.GetDelegateForFunctionPointer<GetImageViewOpaqueCaptureDescriptorDataEXTDelegate_1>(getImageViewOpaqueCaptureDescriptorDataEXT);
		}
		var getSamplerOpaqueCaptureDescriptorDataEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetSamplerOpaqueCaptureDescriptorDataEXT");
		if (getSamplerOpaqueCaptureDescriptorDataEXT != nint.Zero)
		{
			GetSamplerOpaqueCaptureDescriptorDataEXT_0 = Marshal.GetDelegateForFunctionPointer<GetSamplerOpaqueCaptureDescriptorDataEXTDelegate_0>(getSamplerOpaqueCaptureDescriptorDataEXT);
			GetSamplerOpaqueCaptureDescriptorDataEXT_1 = Marshal.GetDelegateForFunctionPointer<GetSamplerOpaqueCaptureDescriptorDataEXTDelegate_1>(getSamplerOpaqueCaptureDescriptorDataEXT);
		}
		var getAccelerationStructureOpaqueCaptureDescriptorDataEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT");
		if (getAccelerationStructureOpaqueCaptureDescriptorDataEXT != nint.Zero)
		{
			GetAccelerationStructureOpaqueCaptureDescriptorDataEXT_0 = Marshal.GetDelegateForFunctionPointer<GetAccelerationStructureOpaqueCaptureDescriptorDataEXTDelegate_0>(getAccelerationStructureOpaqueCaptureDescriptorDataEXT);
			GetAccelerationStructureOpaqueCaptureDescriptorDataEXT_1 = Marshal.GetDelegateForFunctionPointer<GetAccelerationStructureOpaqueCaptureDescriptorDataEXTDelegate_1>(getAccelerationStructureOpaqueCaptureDescriptorDataEXT);
		}
		...
		var commandDrawMeshTasksEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdDrawMeshTasksEXT");
		if (commandDrawMeshTasksEXT != nint.Zero)
		{
			CommandDrawMeshTasksEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandDrawMeshTasksEXTDelegate_0>(commandDrawMeshTasksEXT);
		}
		var commandDrawMeshTasksIndirectEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdDrawMeshTasksIndirectEXT");
		if (commandDrawMeshTasksIndirectEXT != nint.Zero)
		{
			CommandDrawMeshTasksIndirectEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandDrawMeshTasksIndirectEXTDelegate_0>(commandDrawMeshTasksIndirectEXT);
		}
		var commandDrawMeshTasksIndirectCountEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdDrawMeshTasksIndirectCountEXT");
		if (commandDrawMeshTasksIndirectCountEXT != nint.Zero)
		{
			CommandDrawMeshTasksIndirectCountEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandDrawMeshTasksIndirectCountEXTDelegate_0>(commandDrawMeshTasksIndirectCountEXT);
		}
		var commandCopyBuffer2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyBuffer2");
		...
		var commandCopyImage2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyImage2");
		...
		var commandCopyBufferToImage2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyBufferToImage2");
		...
		var commandCopyImageToBuffer2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyImageToBuffer2");
		...
		var commandBlitImage2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdBlitImage2");
		...
		var commandResolveImage2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdResolveImage2");
		...
		{
			GetDeviceFaultInfoEXT_0 = Marshal.GetDelegateForFunctionPointer<GetDeviceFaultInfoEXTDelegate_0>(getDeviceFaultInfoEXT);
			GetDeviceFaultInfoEXT_1 = Marshal.GetDelegateForFunctionPointer<GetDeviceFaultInfoEXTDelegate_1>(getDeviceFaultInfoEXT);
		}
		...
		var getPipelinePropertiesEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetPipelinePropertiesEXT");
		if (getPipelinePropertiesEXT != nint.Zero)
		{
			GetPipelinePropertiesEXT_0 = Marshal.GetDelegateForFunctionPointer<GetPipelinePropertiesEXTDelegate_0>(getPipelinePropertiesEXT);
			GetPipelinePropertiesEXT_1 = Marshal.GetDelegateForFunctionPointer<GetPipelinePropertiesEXTDelegate_1>(getPipelinePropertiesEXT);
		}
		...
		var commandSetRasterizerDiscardEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetRasterizerDiscardEnable");
		...
		var commandSetDepthBiasEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthBiasEnable");
		...
		var commandSetPrimitiveRestartEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetPrimitiveRestartEnable");
		...
		var commandTraceRaysIndirect2KHR = (nint)GetInstanceProcedureAddress(instance, "vkCmdTraceRaysIndirect2KHR");
		if (commandTraceRaysIndirect2KHR != nint.Zero)
		{
			CommandTraceRaysIndirect2KHR_0 = Marshal.GetDelegateForFunctionPointer<CommandTraceRaysIndirect2KHRDelegate_0>(commandTraceRaysIndirect2KHR);
		}
		...
		var createMicromapEXT = (nint)GetInstanceProcedureAddress(instance, "vkCreateMicromapEXT");
		if (createMicromapEXT != nint.Zero)
		{
			CreateMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<CreateMicromapEXTDelegate_0>(createMicromapEXT);
			CreateMicromapEXT_1 = Marshal.GetDelegateForFunctionPointer<CreateMicromapEXTDelegate_1>(createMicromapEXT);
			CreateMicromapEXT_2 = Marshal.GetDelegateForFunctionPointer<CreateMicromapEXTDelegate_2>(createMicromapEXT);
			CreateMicromapEXT_3 = Marshal.GetDelegateForFunctionPointer<CreateMicromapEXTDelegate_3>(createMicromapEXT);
		}
		var destroyMicromapEXT = (nint)GetInstanceProcedureAddress(instance, "vkDestroyMicromapEXT");
		if (destroyMicromapEXT != nint.Zero)
		{
			DestroyMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<DestroyMicromapEXTDelegate_0>(destroyMicromapEXT);
			DestroyMicromapEXT_1 = Marshal.GetDelegateForFunctionPointer<DestroyMicromapEXTDelegate_1>(destroyMicromapEXT);
		}
		var commandBuildMicromapsEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdBuildMicromapsEXT");
		if (commandBuildMicromapsEXT != nint.Zero)
		{
			CommandBuildMicromapsEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandBuildMicromapsEXTDelegate_0>(commandBuildMicromapsEXT);
		}
		var buildMicromapsEXT = (nint)GetInstanceProcedureAddress(instance, "vkBuildMicromapsEXT");
		if (buildMicromapsEXT != nint.Zero)
		{
			BuildMicromapsEXT_0 = Marshal.GetDelegateForFunctionPointer<BuildMicromapsEXTDelegate_0>(buildMicromapsEXT);
		}
		var copyMicromapEXT = (nint)GetInstanceProcedureAddress(instance, "vkCopyMicromapEXT");
		if (copyMicromapEXT != nint.Zero)
		{
			CopyMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<CopyMicromapEXTDelegate_0>(copyMicromapEXT);
			CopyMicromapEXT_1 = Marshal.GetDelegateForFunctionPointer<CopyMicromapEXTDelegate_1>(copyMicromapEXT);
		}
		var copyMicromapToMemoryEXT = (nint)GetInstanceProcedureAddress(instance, "vkCopyMicromapToMemoryEXT");
		if (copyMicromapToMemoryEXT != nint.Zero)
		{
			CopyMicromapToMemoryEXT_0 = Marshal.GetDelegateForFunctionPointer<CopyMicromapToMemoryEXTDelegate_0>(copyMicromapToMemoryEXT);
			CopyMicromapToMemoryEXT_1 = Marshal.GetDelegateForFunctionPointer<CopyMicromapToMemoryEXTDelegate_1>(copyMicromapToMemoryEXT);
		}
		var copyMemoryToMicromapEXT = (nint)GetInstanceProcedureAddress(instance, "vkCopyMemoryToMicromapEXT");
		if (copyMemoryToMicromapEXT != nint.Zero)
		{
			CopyMemoryToMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<CopyMemoryToMicromapEXTDelegate_0>(copyMemoryToMicromapEXT);
			CopyMemoryToMicromapEXT_1 = Marshal.GetDelegateForFunctionPointer<CopyMemoryToMicromapEXTDelegate_1>(copyMemoryToMicromapEXT);
		}
		var writeMicromapsPropertiesEXT = (nint)GetInstanceProcedureAddress(instance, "vkWriteMicromapsPropertiesEXT");
		if (writeMicromapsPropertiesEXT != nint.Zero)
		{
			WriteMicromapsPropertiesEXT_0 = Marshal.GetDelegateForFunctionPointer<WriteMicromapsPropertiesEXTDelegate_0>(writeMicromapsPropertiesEXT);
		}
		var commandCopyMicromapEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyMicromapEXT");
		if (commandCopyMicromapEXT != nint.Zero)
		{
			CommandCopyMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandCopyMicromapEXTDelegate_0>(commandCopyMicromapEXT);
			CommandCopyMicromapEXT_1 = Marshal.GetDelegateForFunctionPointer<CommandCopyMicromapEXTDelegate_1>(commandCopyMicromapEXT);
		}
		var commandCopyMicromapToMemoryEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyMicromapToMemoryEXT");
		if (commandCopyMicromapToMemoryEXT != nint.Zero)
		{
			CommandCopyMicromapToMemoryEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandCopyMicromapToMemoryEXTDelegate_0>(commandCopyMicromapToMemoryEXT);
			CommandCopyMicromapToMemoryEXT_1 = Marshal.GetDelegateForFunctionPointer<CommandCopyMicromapToMemoryEXTDelegate_1>(commandCopyMicromapToMemoryEXT);
		}
		var commandCopyMemoryToMicromapEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyMemoryToMicromapEXT");
		if (commandCopyMemoryToMicromapEXT != nint.Zero)
		{
			CommandCopyMemoryToMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandCopyMemoryToMicromapEXTDelegate_0>(commandCopyMemoryToMicromapEXT);
			CommandCopyMemoryToMicromapEXT_1 = Marshal.GetDelegateForFunctionPointer<CommandCopyMemoryToMicromapEXTDelegate_1>(commandCopyMemoryToMicromapEXT);
		}
		var commandWriteMicromapsPropertiesEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdWriteMicromapsPropertiesEXT");
		if (commandWriteMicromapsPropertiesEXT != nint.Zero)
		{
			CommandWriteMicromapsPropertiesEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandWriteMicromapsPropertiesEXTDelegate_0>(commandWriteMicromapsPropertiesEXT);
		}
		var getDeviceMicromapCompatibilityEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetDeviceMicromapCompatibilityEXT");
		if (getDeviceMicromapCompatibilityEXT != nint.Zero)
		{
			GetDeviceMicromapCompatibilityEXT_0 = Marshal.GetDelegateForFunctionPointer<GetDeviceMicromapCompatibilityEXTDelegate_0>(getDeviceMicromapCompatibilityEXT);
			GetDeviceMicromapCompatibilityEXT_1 = Marshal.GetDelegateForFunctionPointer<GetDeviceMicromapCompatibilityEXTDelegate_1>(getDeviceMicromapCompatibilityEXT);
		}
		var getMicromapBuildSizesEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetMicromapBuildSizesEXT");
		if (getMicromapBuildSizesEXT != nint.Zero)
		{
			GetMicromapBuildSizesEXT_0 = Marshal.GetDelegateForFunctionPointer<GetMicromapBuildSizesEXTDelegate_0>(getMicromapBuildSizesEXT);
			GetMicromapBuildSizesEXT_1 = Marshal.GetDelegateForFunctionPointer<GetMicromapBuildSizesEXTDelegate_1>(getMicromapBuildSizesEXT);
		}
		var commandDrawClusterHUAWEI = (nint)GetInstanceProcedureAddress(instance, "vkCmdDrawClusterHUAWEI");
		if (commandDrawClusterHUAWEI != nint.Zero)
		{
			CommandDrawClusterHUAWEI_0 = Marshal.GetDelegateForFunctionPointer<CommandDrawClusterHUAWEIDelegate_0>(commandDrawClusterHUAWEI);
		}
		var commandDrawClusterIndirectHUAWEI = (nint)GetInstanceProcedureAddress(instance, "vkCmdDrawClusterIndirectHUAWEI");
		if (commandDrawClusterIndirectHUAWEI != nint.Zero)
		{
			CommandDrawClusterIndirectHUAWEI_0 = Marshal.GetDelegateForFunctionPointer<CommandDrawClusterIndirectHUAWEIDelegate_0>(commandDrawClusterIndirectHUAWEI);
		}
		...
		var getDeviceBufferMemoryRequirementsKHR = (nint)GetInstanceProcedureAddress(instance, "vkGetDeviceBufferMemoryRequirements");
		...
		var getDeviceImageMemoryRequirementsKHR = (nint)GetInstanceProcedureAddress(instance, "vkGetDeviceImageMemoryRequirements");
		...
		var getDeviceImageSparseMemoryRequirementsKHR = (nint)GetInstanceProcedureAddress(instance, "vkGetDeviceImageSparseMemoryRequirements");
		...
		var getDescriptorSetLayoutHostMappingInfoVALVE = (nint)GetInstanceProcedureAddress(instance, "vkGetDescriptorSetLayoutHostMappingInfoVALVE");
		if (getDescriptorSetLayoutHostMappingInfoVALVE != nint.Zero)
		{
			GetDescriptorSetLayoutHostMappingInfoVALVE_0 = Marshal.GetDelegateForFunctionPointer<GetDescriptorSetLayoutHostMappingInfoVALVEDelegate_0>(getDescriptorSetLayoutHostMappingInfoVALVE);
			GetDescriptorSetLayoutHostMappingInfoVALVE_1 = Marshal.GetDelegateForFunctionPointer<GetDescriptorSetLayoutHostMappingInfoVALVEDelegate_1>(getDescriptorSetLayoutHostMappingInfoVALVE);
		}
		var getDescriptorSetHostMappingVALVE = (nint)GetInstanceProcedureAddress(instance, "vkGetDescriptorSetHostMappingVALVE");
		if (getDescriptorSetHostMappingVALVE != nint.Zero)
		{
			GetDescriptorSetHostMappingVALVE_0 = Marshal.GetDelegateForFunctionPointer<GetDescriptorSetHostMappingVALVEDelegate_0>(getDescriptorSetHostMappingVALVE);
		}
		var commandCopyMemoryIndirectNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyMemoryIndirectNV");
		if (commandCopyMemoryIndirectNV != nint.Zero)
		{
			CommandCopyMemoryIndirectNV_0 = Marshal.GetDelegateForFunctionPointer<CommandCopyMemoryIndirectNVDelegate_0>(commandCopyMemoryIndirectNV);
		}
		var commandCopyMemoryToImageIndirectNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdCopyMemoryToImageIndirectNV");
		if (commandCopyMemoryToImageIndirectNV != nint.Zero)
		{
			CommandCopyMemoryToImageIndirectNV_0 = Marshal.GetDelegateForFunctionPointer<CommandCopyMemoryToImageIndirectNVDelegate_0>(commandCopyMemoryToImageIndirectNV);
			CommandCopyMemoryToImageIndirectNV_1 = Marshal.GetDelegateForFunctionPointer<CommandCopyMemoryToImageIndirectNVDelegate_1>(commandCopyMemoryToImageIndirectNV);
		}
		var commandDecompressMemoryNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdDecompressMemoryNV");
		if (commandDecompressMemoryNV != nint.Zero)
		{
			CommandDecompressMemoryNV_0 = Marshal.GetDelegateForFunctionPointer<CommandDecompressMemoryNVDelegate_0>(commandDecompressMemoryNV);
			CommandDecompressMemoryNV_1 = Marshal.GetDelegateForFunctionPointer<CommandDecompressMemoryNVDelegate_1>(commandDecompressMemoryNV);
		}
		var commandDecompressMemoryIndirectCountNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdDecompressMemoryIndirectCountNV");
		if (commandDecompressMemoryIndirectCountNV != nint.Zero)
		{
		...
		{
			CommandSetTessellationDomainOriginEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetTessellationDomainOriginEXTDelegate_0>(commandSetTessellationDomainOriginEXT);
		}
		var commandSetDepthClampEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthClampEnableEXT");
		if (commandSetDepthClampEnableEXT != nint.Zero)
		{
			CommandSetDepthClampEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetDepthClampEnableEXTDelegate_0>(commandSetDepthClampEnableEXT);
		}
		var commandSetPolygonModeEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetPolygonModeEXT");
		if (commandSetPolygonModeEXT != nint.Zero)
		{
			CommandSetPolygonModeEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetPolygonModeEXTDelegate_0>(commandSetPolygonModeEXT);
		}
		var commandSetRasterizationSamplesEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetRasterizationSamplesEXT");
		if (commandSetRasterizationSamplesEXT != nint.Zero)
		{
			CommandSetRasterizationSamplesEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetRasterizationSamplesEXTDelegate_0>(commandSetRasterizationSamplesEXT);
		}
		var commandSetSampleMaskEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetSampleMaskEXT");
		if (commandSetSampleMaskEXT != nint.Zero)
		{
			CommandSetSampleMaskEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetSampleMaskEXTDelegate_0>(commandSetSampleMaskEXT);
			CommandSetSampleMaskEXT_1 = Marshal.GetDelegateForFunctionPointer<CommandSetSampleMaskEXTDelegate_1>(commandSetSampleMaskEXT);
		}
		var commandSetAlphaToCoverageEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetAlphaToCoverageEnableEXT");
		if (commandSetAlphaToCoverageEnableEXT != nint.Zero)
		{
			CommandSetAlphaToCoverageEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetAlphaToCoverageEnableEXTDelegate_0>(commandSetAlphaToCoverageEnableEXT);
		}
		var commandSetAlphaToOneEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetAlphaToOneEnableEXT");
		if (commandSetAlphaToOneEnableEXT != nint.Zero)
		{
			CommandSetAlphaToOneEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetAlphaToOneEnableEXTDelegate_0>(commandSetAlphaToOneEnableEXT);
		}
		var commandSetLogicOpEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetLogicOpEnableEXT");
		if (commandSetLogicOpEnableEXT != nint.Zero)
		{
			CommandSetLogicOpEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetLogicOpEnableEXTDelegate_0>(commandSetLogicOpEnableEXT);
		}
		var commandSetColorBlendEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetColorBlendEnableEXT");
		if (commandSetColorBlendEnableEXT != nint.Zero)
		{
			CommandSetColorBlendEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetColorBlendEnableEXTDelegate_0>(commandSetColorBlendEnableEXT);
			CommandSetColorBlendEnableEXT_1 = Marshal.GetDelegateForFunctionPointer<CommandSetColorBlendEnableEXTDelegate_1>(commandSetColorBlendEnableEXT);
		}
		var commandSetColorBlendEquationEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetColorBlendEquationEXT");
		if (commandSetColorBlendEquationEXT != nint.Zero)
		{
			CommandSetColorBlendEquationEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetColorBlendEquationEXTDelegate_0>(commandSetColorBlendEquationEXT);
			CommandSetColorBlendEquationEXT_1 = Marshal.GetDelegateForFunctionPointer<CommandSetColorBlendEquationEXTDelegate_1>(commandSetColorBlendEquationEXT);
		}
		var commandSetColorWriteMaskEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetColorWriteMaskEXT");
		if (commandSetColorWriteMaskEXT != nint.Zero)
		{
			CommandSetColorWriteMaskEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetColorWriteMaskEXTDelegate_0>(commandSetColorWriteMaskEXT);
			CommandSetColorWriteMaskEXT_1 = Marshal.GetDelegateForFunctionPointer<CommandSetColorWriteMaskEXTDelegate_1>(commandSetColorWriteMaskEXT);
		}
		var commandSetRasterizationStreamEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetRasterizationStreamEXT");
		if (commandSetRasterizationStreamEXT != nint.Zero)
		{
			CommandSetRasterizationStreamEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetRasterizationStreamEXTDelegate_0>(commandSetRasterizationStreamEXT);
		}
		var commandSetConservativeRasterizationModeEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetConservativeRasterizationModeEXT");
		if (commandSetConservativeRasterizationModeEXT != nint.Zero)
		{
			CommandSetConservativeRasterizationModeEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetConservativeRasterizationModeEXTDelegate_0>(commandSetConservativeRasterizationModeEXT);
		}
		var commandSetExtraPrimitiveOverestimationSizeEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetExtraPrimitiveOverestimationSizeEXT");
		if (commandSetExtraPrimitiveOverestimationSizeEXT != nint.Zero)
		{
			CommandSetExtraPrimitiveOverestimationSizeEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetExtraPrimitiveOverestimationSizeEXTDelegate_0>(commandSetExtraPrimitiveOverestimationSizeEXT);
		}
		var commandSetDepthClipEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthClipEnableEXT");
		if (commandSetDepthClipEnableEXT != nint.Zero)
		{
			CommandSetDepthClipEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetDepthClipEnableEXTDelegate_0>(commandSetDepthClipEnableEXT);
		}
		var commandSetSampleLocationsEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetSampleLocationsEnableEXT");
		if (commandSetSampleLocationsEnableEXT != nint.Zero)
		{
			CommandSetSampleLocationsEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetSampleLocationsEnableEXTDelegate_0>(commandSetSampleLocationsEnableEXT);
		}
		var commandSetColorBlendAdvancedEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetColorBlendAdvancedEXT");
		if (commandSetColorBlendAdvancedEXT != nint.Zero)
		{
			CommandSetColorBlendAdvancedEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetColorBlendAdvancedEXTDelegate_0>(commandSetColorBlendAdvancedEXT);
			CommandSetColorBlendAdvancedEXT_1 = Marshal.GetDelegateForFunctionPointer<CommandSetColorBlendAdvancedEXTDelegate_1>(commandSetColorBlendAdvancedEXT);
		}
		var commandSetProvokingVertexModeEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetProvokingVertexModeEXT");
		if (commandSetProvokingVertexModeEXT != nint.Zero)
		{
			CommandSetProvokingVertexModeEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetProvokingVertexModeEXTDelegate_0>(commandSetProvokingVertexModeEXT);
		}
		var commandSetLineRasterizationModeEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetLineRasterizationModeEXT");
		if (commandSetLineRasterizationModeEXT != nint.Zero)
		{
			CommandSetLineRasterizationModeEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetLineRasterizationModeEXTDelegate_0>(commandSetLineRasterizationModeEXT);
		}
		var commandSetLineStippleEnableEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetLineStippleEnableEXT");
		if (commandSetLineStippleEnableEXT != nint.Zero)
		{
			CommandSetLineStippleEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetLineStippleEnableEXTDelegate_0>(commandSetLineStippleEnableEXT);
		}
		var commandSetDepthClipNegativeOneToOneEXT = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetDepthClipNegativeOneToOneEXT");
		if (commandSetDepthClipNegativeOneToOneEXT != nint.Zero)
		{
			CommandSetDepthClipNegativeOneToOneEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetDepthClipNegativeOneToOneEXTDelegate_0>(commandSetDepthClipNegativeOneToOneEXT);
		}
		var commandSetViewportWScalingEnableNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetViewportWScalingEnableNV");
		if (commandSetViewportWScalingEnableNV != nint.Zero)
		{
			CommandSetViewportWScalingEnableNV_0 = Marshal.GetDelegateForFunctionPointer<CommandSetViewportWScalingEnableNVDelegate_0>(commandSetViewportWScalingEnableNV);
		}
		var commandSetViewportSwizzleNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetViewportSwizzleNV");
		if (commandSetViewportSwizzleNV != nint.Zero)
		{
			CommandSetViewportSwizzleNV_0 = Marshal.GetDelegateForFunctionPointer<CommandSetViewportSwizzleNVDelegate_0>(commandSetViewportSwizzleNV);
			CommandSetViewportSwizzleNV_1 = Marshal.GetDelegateForFunctionPointer<CommandSetViewportSwizzleNVDelegate_1>(commandSetViewportSwizzleNV);
		}
		var commandSetCoverageToColorEnableNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetCoverageToColorEnableNV");
		if (commandSetCoverageToColorEnableNV != nint.Zero)
		{
			CommandSetCoverageToColorEnableNV_0 = Marshal.GetDelegateForFunctionPointer<CommandSetCoverageToColorEnableNVDelegate_0>(commandSetCoverageToColorEnableNV);
		}
		var commandSetCoverageToColorLocationNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetCoverageToColorLocationNV");
		if (commandSetCoverageToColorLocationNV != nint.Zero)
		{
			CommandSetCoverageToColorLocationNV_0 = Marshal.GetDelegateForFunctionPointer<CommandSetCoverageToColorLocationNVDelegate_0>(commandSetCoverageToColorLocationNV);
		}
		var commandSetCoverageModulationModeNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetCoverageModulationModeNV");
		if (commandSetCoverageModulationModeNV != nint.Zero)
		{
			CommandSetCoverageModulationModeNV_0 = Marshal.GetDelegateForFunctionPointer<CommandSetCoverageModulationModeNVDelegate_0>(commandSetCoverageModulationModeNV);
		}
		var commandSetCoverageModulationTableEnableNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetCoverageModulationTableEnableNV");
		if (commandSetCoverageModulationTableEnableNV != nint.Zero)
		{
			CommandSetCoverageModulationTableEnableNV_0 = Marshal.GetDelegateForFunctionPointer<CommandSetCoverageModulationTableEnableNVDelegate_0>(commandSetCoverageModulationTableEnableNV);
		}
		var commandSetCoverageModulationTableNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetCoverageModulationTableNV");
		if (commandSetCoverageModulationTableNV != nint.Zero)
		{
			CommandSetCoverageModulationTableNV_0 = Marshal.GetDelegateForFunctionPointer<CommandSetCoverageModulationTableNVDelegate_0>(commandSetCoverageModulationTableNV);
			CommandSetCoverageModulationTableNV_1 = Marshal.GetDelegateForFunctionPointer<CommandSetCoverageModulationTableNVDelegate_1>(commandSetCoverageModulationTableNV);
		}
		var commandSetShadingRateImageEnableNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetShadingRateImageEnableNV");
		if (commandSetShadingRateImageEnableNV != nint.Zero)
		{
			CommandSetShadingRateImageEnableNV_0 = Marshal.GetDelegateForFunctionPointer<CommandSetShadingRateImageEnableNVDelegate_0>(commandSetShadingRateImageEnableNV);
		}
		var commandSetRepresentativeFragmentTestEnableNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetRepresentativeFragmentTestEnableNV");
		if (commandSetRepresentativeFragmentTestEnableNV != nint.Zero)
		{
			CommandSetRepresentativeFragmentTestEnableNV_0 = Marshal.GetDelegateForFunctionPointer<CommandSetRepresentativeFragmentTestEnableNVDelegate_0>(commandSetRepresentativeFragmentTestEnableNV);
		}
		var commandSetCoverageReductionModeNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdSetCoverageReductionModeNV");
		if (commandSetCoverageReductionModeNV != nint.Zero)
		{
			CommandSetCoverageReductionModeNV_0 = Marshal.GetDelegateForFunctionPointer<CommandSetCoverageReductionModeNVDelegate_0>(commandSetCoverageReductionModeNV);
		}
		var getShaderModuleIdentifierEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetShaderModuleIdentifierEXT");
		if (getShaderModuleIdentifierEXT != nint.Zero)
		{
			GetShaderModuleIdentifierEXT_0 = Marshal.GetDelegateForFunctionPointer<GetShaderModuleIdentifierEXTDelegate_0>(getShaderModuleIdentifierEXT);
		}
		var getShaderModuleCreateInfoIdentifierEXT = (nint)GetInstanceProcedureAddress(instance, "vkGetShaderModuleCreateInfoIdentifierEXT");
		if (getShaderModuleCreateInfoIdentifierEXT != nint.Zero)
		{
			GetShaderModuleCreateInfoIdentifierEXT_0 = Marshal.GetDelegateForFunctionPointer<GetShaderModuleCreateInfoIdentifierEXTDelegate_0>(getShaderModuleCreateInfoIdentifierEXT);
			GetShaderModuleCreateInfoIdentifierEXT_1 = Marshal.GetDelegateForFunctionPointer<GetShaderModuleCreateInfoIdentifierEXTDelegate_1>(getShaderModuleCreateInfoIdentifierEXT);
		}
		var getPhysicalDeviceOpticalFlowImageFormatsNV = (nint)GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceOpticalFlowImageFormatsNV");
		if (getPhysicalDeviceOpticalFlowImageFormatsNV != nint.Zero)
		{
			GetPhysicalDeviceOpticalFlowImageFormatsNV_0 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceOpticalFlowImageFormatsNVDelegate_0>(getPhysicalDeviceOpticalFlowImageFormatsNV);
			GetPhysicalDeviceOpticalFlowImageFormatsNV_1 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceOpticalFlowImageFormatsNVDelegate_1>(getPhysicalDeviceOpticalFlowImageFormatsNV);
			GetPhysicalDeviceOpticalFlowImageFormatsNV_2 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceOpticalFlowImageFormatsNVDelegate_2>(getPhysicalDeviceOpticalFlowImageFormatsNV);
			GetPhysicalDeviceOpticalFlowImageFormatsNV_3 = Marshal.GetDelegateForFunctionPointer<GetPhysicalDeviceOpticalFlowImageFormatsNVDelegate_3>(getPhysicalDeviceOpticalFlowImageFormatsNV);
		}
		var createOpticalFlowSessionNV = (nint)GetInstanceProcedureAddress(instance, "vkCreateOpticalFlowSessionNV");
		if (createOpticalFlowSessionNV != nint.Zero)
		{
			CreateOpticalFlowSessionNV_0 = Marshal.GetDelegateForFunctionPointer<CreateOpticalFlowSessionNVDelegate_0>(createOpticalFlowSessionNV);
			CreateOpticalFlowSessionNV_1 = Marshal.GetDelegateForFunctionPointer<CreateOpticalFlowSessionNVDelegate_1>(createOpticalFlowSessionNV);
			CreateOpticalFlowSessionNV_2 = Marshal.GetDelegateForFunctionPointer<CreateOpticalFlowSessionNVDelegate_2>(createOpticalFlowSessionNV);
			CreateOpticalFlowSessionNV_3 = Marshal.GetDelegateForFunctionPointer<CreateOpticalFlowSessionNVDelegate_3>(createOpticalFlowSessionNV);
		}
		var destroyOpticalFlowSessionNV = (nint)GetInstanceProcedureAddress(instance, "vkDestroyOpticalFlowSessionNV");
		if (destroyOpticalFlowSessionNV != nint.Zero)
		{
			DestroyOpticalFlowSessionNV_0 = Marshal.GetDelegateForFunctionPointer<DestroyOpticalFlowSessionNVDelegate_0>(destroyOpticalFlowSessionNV);
			DestroyOpticalFlowSessionNV_1 = Marshal.GetDelegateForFunctionPointer<DestroyOpticalFlowSessionNVDelegate_1>(destroyOpticalFlowSessionNV);
		}
		var bindOpticalFlowSessionImageNV = (nint)GetInstanceProcedureAddress(instance, "vkBindOpticalFlowSessionImageNV");
		if (bindOpticalFlowSessionImageNV != nint.Zero)
		{
			BindOpticalFlowSessionImageNV_0 = Marshal.GetDelegateForFunctionPointer<BindOpticalFlowSessionImageNVDelegate_0>(bindOpticalFlowSessionImageNV);
		}
		var commandOpticalFlowExecuteNV = (nint)GetInstanceProcedureAddress(instance, "vkCmdOpticalFlowExecuteNV");
		if (commandOpticalFlowExecuteNV != nint.Zero)
		{
		...
		{
			GetFramebufferTilePropertiesQCOM_0 = Marshal.GetDelegateForFunctionPointer<GetFramebufferTilePropertiesQCOMDelegate_0>(getFramebufferTilePropertiesQCOM);
			GetFramebufferTilePropertiesQCOM_1 = Marshal.GetDelegateForFunctionPointer<GetFramebufferTilePropertiesQCOMDelegate_1>(getFramebufferTilePropertiesQCOM);
		}
		var getDynamicRenderingTilePropertiesQCOM = (nint)GetInstanceProcedureAddress(instance, "vkGetDynamicRenderingTilePropertiesQCOM");
		if (getDynamicRenderingTilePropertiesQCOM != nint.Zero)
		{
