...
public static unsafe class VK
{
	...
	[Obsolete("Use VK_MAX_GLOBAL_PRIORITY_SIZE_KHR")]
	...
	public static VkResult vkGetPhysicalDeviceToolProperties(VkPhysicalDevice physicalDevice, uint32_t* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties) => vkGetPhysicalDeviceToolProperties_0(physicalDevice, pToolCount, pToolProperties);
	private delegate VkResult vkGetPhysicalDeviceToolPropertiesDelegate_0(VkPhysicalDevice physicalDevice, uint32_t* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties);
	...
	public static VkResult vkSetPrivateData(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t data) => vkSetPrivateData_0(device, objectType, objectHandle, privateDataSlot, data);
	private delegate VkResult vkSetPrivateDataDelegate_0(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t data);
	private static IntPtr vkSetPrivateDataPointer;
	private static vkSetPrivateDataDelegate_0 vkSetPrivateData_0;
	public static void vkGetPrivateData(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t* pData) => vkGetPrivateData_0(device, objectType, objectHandle, privateDataSlot, pData);
	private delegate void vkGetPrivateDataDelegate_0(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t* pData);
	...
	public static void vkCmdWaitEvents2(VkCommandBuffer commandBuffer, uint32_t eventCount, VkEvent* pEvents, VkDependencyInfo* pDependencyInfos) => vkCmdWaitEvents2_0(commandBuffer, eventCount, pEvents, pDependencyInfos);
	private delegate void vkCmdWaitEvents2Delegate_0(VkCommandBuffer commandBuffer, uint32_t eventCount, VkEvent* pEvents, VkDependencyInfo* pDependencyInfos);
	...
	public static void vkCmdWriteTimestamp2(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint32_t query) => vkCmdWriteTimestamp2_0(commandBuffer, stage, queryPool, query);
	private delegate void vkCmdWriteTimestamp2Delegate_0(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint32_t query);
	private static IntPtr vkCmdWriteTimestamp2Pointer;
	private static vkCmdWriteTimestamp2Delegate_0 vkCmdWriteTimestamp2_0;
	public static VkResult vkQueueSubmit2(VkQueue queue, uint32_t submitCount, VkSubmitInfo2* pSubmits, VkFence fence) => vkQueueSubmit2_0(queue, submitCount, pSubmits, fence);
	private delegate VkResult vkQueueSubmit2Delegate_0(VkQueue queue, uint32_t submitCount, VkSubmitInfo2* pSubmits, VkFence fence);
	...
	public static void vkCmdSetViewportWithCount(VkCommandBuffer commandBuffer, uint32_t viewportCount, VkViewport* pViewports) => vkCmdSetViewportWithCount_0(commandBuffer, viewportCount, pViewports);
	private delegate void vkCmdSetViewportWithCountDelegate_0(VkCommandBuffer commandBuffer, uint32_t viewportCount, VkViewport* pViewports);
	...
	public static void vkCmdSetScissorWithCount(VkCommandBuffer commandBuffer, uint32_t scissorCount, VkRect2D* pScissors) => vkCmdSetScissorWithCount_0(commandBuffer, scissorCount, pScissors);
	private delegate void vkCmdSetScissorWithCountDelegate_0(VkCommandBuffer commandBuffer, uint32_t scissorCount, VkRect2D* pScissors);
	...
	public static void vkCmdBindVertexBuffers2(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, VkBuffer* pBuffers, VkDeviceSize* pOffsets, VkDeviceSize* pSizes, VkDeviceSize* pStrides) => vkCmdBindVertexBuffers2_0(commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, pSizes, pStrides);
	private delegate void vkCmdBindVertexBuffers2Delegate_0(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, VkBuffer* pBuffers, VkDeviceSize* pOffsets, VkDeviceSize* pSizes, VkDeviceSize* pStrides);
	...
	public static void vkGetDeviceImageSparseMemoryRequirements(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements) => vkGetDeviceImageSparseMemoryRequirements_0(device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
	private delegate void vkGetDeviceImageSparseMemoryRequirementsDelegate_0(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements);
	...
	public static VkResult vkGetPhysicalDeviceVideoFormatPropertiesKHR(VkPhysicalDevice physicalDevice, VkPhysicalDeviceVideoFormatInfoKHR* pVideoFormatInfo, uint32_t* pVideoFormatPropertyCount, VkVideoFormatPropertiesKHR* pVideoFormatProperties) => vkGetPhysicalDeviceVideoFormatPropertiesKHR_0(physicalDevice, pVideoFormatInfo, pVideoFormatPropertyCount, pVideoFormatProperties);
	private delegate VkResult vkGetPhysicalDeviceVideoFormatPropertiesKHRDelegate_0(VkPhysicalDevice physicalDevice, VkPhysicalDeviceVideoFormatInfoKHR* pVideoFormatInfo, uint32_t* pVideoFormatPropertyCount, VkVideoFormatPropertiesKHR* pVideoFormatProperties);
	...
	public static VkResult vkGetVideoSessionMemoryRequirementsKHR(VkDevice device, VkVideoSessionKHR videoSession, uint32_t* pMemoryRequirementsCount, VkVideoSessionMemoryRequirementsKHR* pMemoryRequirements) => vkGetVideoSessionMemoryRequirementsKHR_0(device, videoSession, pMemoryRequirementsCount, pMemoryRequirements);
	private delegate VkResult vkGetVideoSessionMemoryRequirementsKHRDelegate_0(VkDevice device, VkVideoSessionKHR videoSession, uint32_t* pMemoryRequirementsCount, VkVideoSessionMemoryRequirementsKHR* pMemoryRequirements);
	...
	public static VkResult vkBindVideoSessionMemoryKHR(VkDevice device, VkVideoSessionKHR videoSession, uint32_t bindSessionMemoryInfoCount, VkBindVideoSessionMemoryInfoKHR* pBindSessionMemoryInfos) => vkBindVideoSessionMemoryKHR_0(device, videoSession, bindSessionMemoryInfoCount, pBindSessionMemoryInfos);
	private delegate VkResult vkBindVideoSessionMemoryKHRDelegate_0(VkDevice device, VkVideoSessionKHR videoSession, uint32_t bindSessionMemoryInfoCount, VkBindVideoSessionMemoryInfoKHR* pBindSessionMemoryInfos);
	...
	public static void vkGetPhysicalDeviceToolPropertiesEXT(VkPhysicalDevice physicalDevice, uint32_t* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties) => vkGetPhysicalDeviceToolPropertiesEXT_0(physicalDevice, pToolCount, pToolProperties);
	private delegate void vkGetPhysicalDeviceToolPropertiesEXTDelegate_0(VkPhysicalDevice physicalDevice, uint32_t* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties);
	...
	public static void vkSetPrivateDataEXT(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t data) => vkSetPrivateDataEXT_0(device, objectType, objectHandle, privateDataSlot, data);
	private delegate void vkSetPrivateDataEXTDelegate_0(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t data);
	...
	public static void vkGetPrivateDataEXT(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t* pData) => vkGetPrivateDataEXT_0(device, objectType, objectHandle, privateDataSlot, pData);
	private delegate void vkGetPrivateDataEXTDelegate_0(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t* pData);
	...
	public static void vkCmdWaitEvents2KHR(VkCommandBuffer commandBuffer, uint32_t eventCount, VkEvent* pEvents, VkDependencyInfo* pDependencyInfos) => vkCmdWaitEvents2KHR_0(commandBuffer, eventCount, pEvents, pDependencyInfos);
	private delegate void vkCmdWaitEvents2KHRDelegate_0(VkCommandBuffer commandBuffer, uint32_t eventCount, VkEvent* pEvents, VkDependencyInfo* pDependencyInfos);
	...
	public static void vkCmdWriteTimestamp2KHR(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint32_t query) => vkCmdWriteTimestamp2KHR_0(commandBuffer, stage, queryPool, query);
	private delegate void vkCmdWriteTimestamp2KHRDelegate_0(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint32_t query);
	...
	public static void vkQueueSubmit2KHR(VkQueue queue, uint32_t submitCount, VkSubmitInfo2* pSubmits, VkFence fence) => vkQueueSubmit2KHR_0(queue, submitCount, pSubmits, fence);
	private delegate void vkQueueSubmit2KHRDelegate_0(VkQueue queue, uint32_t submitCount, VkSubmitInfo2* pSubmits, VkFence fence);
	private static IntPtr vkQueueSubmit2KHRPointer;
	private static vkQueueSubmit2KHRDelegate_0 vkQueueSubmit2KHR_0;
	public static void vkCmdWriteBufferMarker2AMD(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkBuffer dstBuffer, VkDeviceSize dstOffset, uint32_t marker) => vkCmdWriteBufferMarker2AMD_0(commandBuffer, stage, dstBuffer, dstOffset, marker);
	private delegate void vkCmdWriteBufferMarker2AMDDelegate_0(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkBuffer dstBuffer, VkDeviceSize dstOffset, uint32_t marker);
	...
	public static void vkGetDescriptorSetLayoutBindingOffsetEXT(VkDevice device, VkDescriptorSetLayout layout, uint32_t binding, VkDeviceSize* pOffset) => vkGetDescriptorSetLayoutBindingOffsetEXT_0(device, layout, binding, pOffset);
	private delegate void vkGetDescriptorSetLayoutBindingOffsetEXTDelegate_0(VkDevice device, VkDescriptorSetLayout layout, uint32_t binding, VkDeviceSize* pOffset);
	...
	public static void vkGetDescriptorEXT(VkDevice device, VkDescriptorGetInfoEXT* pDescriptorInfo, size_t dataSize, void* pDescriptor) => vkGetDescriptorEXT_0(device, pDescriptorInfo, dataSize, pDescriptor);
	private delegate void vkGetDescriptorEXTDelegate_0(VkDevice device, VkDescriptorGetInfoEXT* pDescriptorInfo, size_t dataSize, void* pDescriptor);
	private static IntPtr vkGetDescriptorEXTPointer;
	private static vkGetDescriptorEXTDelegate_0 vkGetDescriptorEXT_0;
	public static void vkCmdBindDescriptorBuffersEXT(VkCommandBuffer commandBuffer, uint32_t bufferCount, VkDescriptorBufferBindingInfoEXT* pBindingInfos) => vkCmdBindDescriptorBuffersEXT_0(commandBuffer, bufferCount, pBindingInfos);
	private delegate void vkCmdBindDescriptorBuffersEXTDelegate_0(VkCommandBuffer commandBuffer, uint32_t bufferCount, VkDescriptorBufferBindingInfoEXT* pBindingInfos);
	...
	public static void vkCmdSetDescriptorBufferOffsetsEXT(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint32_t firstSet, uint32_t setCount, uint32_t* pBufferIndices, VkDeviceSize* pOffsets) => vkCmdSetDescriptorBufferOffsetsEXT_0(commandBuffer, pipelineBindPoint, layout, firstSet, setCount, pBufferIndices, pOffsets);
	private delegate void vkCmdSetDescriptorBufferOffsetsEXTDelegate_0(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint32_t firstSet, uint32_t setCount, uint32_t* pBufferIndices, VkDeviceSize* pOffsets);
	...
	public static void vkCmdBindDescriptorBufferEmbeddedSamplersEXT(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint32_t set) => vkCmdBindDescriptorBufferEmbeddedSamplersEXT_0(commandBuffer, pipelineBindPoint, layout, set);
	private delegate void vkCmdBindDescriptorBufferEmbeddedSamplersEXTDelegate_0(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint32_t set);
	...
	public static void vkCmdDrawMeshTasksEXT(VkCommandBuffer commandBuffer, uint32_t groupCountX, uint32_t groupCountY, uint32_t groupCountZ) => vkCmdDrawMeshTasksEXT_0(commandBuffer, groupCountX, groupCountY, groupCountZ);
	private delegate void vkCmdDrawMeshTasksEXTDelegate_0(VkCommandBuffer commandBuffer, uint32_t groupCountX, uint32_t groupCountY, uint32_t groupCountZ);
	private static IntPtr vkCmdDrawMeshTasksEXTPointer;
	private static vkCmdDrawMeshTasksEXTDelegate_0 vkCmdDrawMeshTasksEXT_0;
	public static void vkCmdDrawMeshTasksIndirectEXT(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint32_t drawCount, uint32_t stride) => vkCmdDrawMeshTasksIndirectEXT_0(commandBuffer, buffer, offset, drawCount, stride);
	private delegate void vkCmdDrawMeshTasksIndirectEXTDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint32_t drawCount, uint32_t stride);
	...
	public static void vkCmdDrawMeshTasksIndirectCountEXT(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride) => vkCmdDrawMeshTasksIndirectCountEXT_0(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	private delegate void vkCmdDrawMeshTasksIndirectCountEXTDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride);
	...
	public static void vkCmdBuildMicromapsEXT(VkCommandBuffer commandBuffer, uint32_t infoCount, VkMicromapBuildInfoEXT* pInfos) => vkCmdBuildMicromapsEXT_0(commandBuffer, infoCount, pInfos);
	private delegate void vkCmdBuildMicromapsEXTDelegate_0(VkCommandBuffer commandBuffer, uint32_t infoCount, VkMicromapBuildInfoEXT* pInfos);
	...
	public static VkResult vkBuildMicromapsEXT(VkDevice device, VkDeferredOperationKHR deferredOperation, uint32_t infoCount, VkMicromapBuildInfoEXT* pInfos) => vkBuildMicromapsEXT_0(device, deferredOperation, infoCount, pInfos);
	private delegate VkResult vkBuildMicromapsEXTDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, uint32_t infoCount, VkMicromapBuildInfoEXT* pInfos);
	...
	public static VkResult vkWriteMicromapsPropertiesEXT(VkDevice device, uint32_t micromapCount, VkMicromapEXT* pMicromaps, VkQueryType queryType, size_t dataSize, void* pData, size_t stride) => vkWriteMicromapsPropertiesEXT_0(device, micromapCount, pMicromaps, queryType, dataSize, pData, stride);
	private delegate VkResult vkWriteMicromapsPropertiesEXTDelegate_0(VkDevice device, uint32_t micromapCount, VkMicromapEXT* pMicromaps, VkQueryType queryType, size_t dataSize, void* pData, size_t stride);
	...
	public static void vkCmdWriteMicromapsPropertiesEXT(VkCommandBuffer commandBuffer, uint32_t micromapCount, VkMicromapEXT* pMicromaps, VkQueryType queryType, VkQueryPool queryPool, uint32_t firstQuery) => vkCmdWriteMicromapsPropertiesEXT_0(commandBuffer, micromapCount, pMicromaps, queryType, queryPool, firstQuery);
	private delegate void vkCmdWriteMicromapsPropertiesEXTDelegate_0(VkCommandBuffer commandBuffer, uint32_t micromapCount, VkMicromapEXT* pMicromaps, VkQueryType queryType, VkQueryPool queryPool, uint32_t firstQuery);
	...
	public static void vkCmdDrawClusterHUAWEI(VkCommandBuffer commandBuffer, uint32_t groupCountX, uint32_t groupCountY, uint32_t groupCountZ) => vkCmdDrawClusterHUAWEI_0(commandBuffer, groupCountX, groupCountY, groupCountZ);
	private delegate void vkCmdDrawClusterHUAWEIDelegate_0(VkCommandBuffer commandBuffer, uint32_t groupCountX, uint32_t groupCountY, uint32_t groupCountZ);
	...
	public static void vkGetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements) => vkGetDeviceImageSparseMemoryRequirementsKHR_0(device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
	private delegate void vkGetDeviceImageSparseMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements);
	...
	public static void vkCmdCopyMemoryIndirectNV(VkCommandBuffer commandBuffer, VkDeviceAddress copyBufferAddress, uint32_t copyCount, uint32_t stride) => vkCmdCopyMemoryIndirectNV_0(commandBuffer, copyBufferAddress, copyCount, stride);
	private delegate void vkCmdCopyMemoryIndirectNVDelegate_0(VkCommandBuffer commandBuffer, VkDeviceAddress copyBufferAddress, uint32_t copyCount, uint32_t stride);
	...
	public static void vkCmdCopyMemoryToImageIndirectNV(VkCommandBuffer commandBuffer, VkDeviceAddress copyBufferAddress, uint32_t copyCount, uint32_t stride, VkImage dstImage, VkImageLayout dstImageLayout, VkImageSubresourceLayers* pImageSubresources) => vkCmdCopyMemoryToImageIndirectNV_0(commandBuffer, copyBufferAddress, copyCount, stride, dstImage, dstImageLayout, pImageSubresources);
	private delegate void vkCmdCopyMemoryToImageIndirectNVDelegate_0(VkCommandBuffer commandBuffer, VkDeviceAddress copyBufferAddress, uint32_t copyCount, uint32_t stride, VkImage dstImage, VkImageLayout dstImageLayout, VkImageSubresourceLayers* pImageSubresources);
	...
	public static void vkCmdDecompressMemoryNV(VkCommandBuffer commandBuffer, uint32_t decompressRegionCount, VkDecompressMemoryRegionNV* pDecompressMemoryRegions) => vkCmdDecompressMemoryNV_0(commandBuffer, decompressRegionCount, pDecompressMemoryRegions);
	private delegate void vkCmdDecompressMemoryNVDelegate_0(VkCommandBuffer commandBuffer, uint32_t decompressRegionCount, VkDecompressMemoryRegionNV* pDecompressMemoryRegions);
	...
	public static void vkCmdDecompressMemoryIndirectCountNV(VkCommandBuffer commandBuffer, VkDeviceAddress indirectCommandsAddress, VkDeviceAddress indirectCommandsCountAddress, uint32_t stride) => vkCmdDecompressMemoryIndirectCountNV_0(commandBuffer, indirectCommandsAddress, indirectCommandsCountAddress, stride);
	private delegate void vkCmdDecompressMemoryIndirectCountNVDelegate_0(VkCommandBuffer commandBuffer, VkDeviceAddress indirectCommandsAddress, VkDeviceAddress indirectCommandsCountAddress, uint32_t stride);
	...
	public static void vkCmdSetColorBlendEnableEXT(VkCommandBuffer commandBuffer, uint32_t firstAttachment, uint32_t attachmentCount, VkBool32* pColorBlendEnables) => vkCmdSetColorBlendEnableEXT_0(commandBuffer, firstAttachment, attachmentCount, pColorBlendEnables);
	private delegate void vkCmdSetColorBlendEnableEXTDelegate_0(VkCommandBuffer commandBuffer, uint32_t firstAttachment, uint32_t attachmentCount, VkBool32* pColorBlendEnables);
	...
	public static void vkCmdSetColorBlendEquationEXT(VkCommandBuffer commandBuffer, uint32_t firstAttachment, uint32_t attachmentCount, VkColorBlendEquationEXT* pColorBlendEquations) => vkCmdSetColorBlendEquationEXT_0(commandBuffer, firstAttachment, attachmentCount, pColorBlendEquations);
	private delegate void vkCmdSetColorBlendEquationEXTDelegate_0(VkCommandBuffer commandBuffer, uint32_t firstAttachment, uint32_t attachmentCount, VkColorBlendEquationEXT* pColorBlendEquations);
	...
	public static void vkCmdSetColorWriteMaskEXT(VkCommandBuffer commandBuffer, uint32_t firstAttachment, uint32_t attachmentCount, VkColorComponentFlags* pColorWriteMasks) => vkCmdSetColorWriteMaskEXT_0(commandBuffer, firstAttachment, attachmentCount, pColorWriteMasks);
	private delegate void vkCmdSetColorWriteMaskEXTDelegate_0(VkCommandBuffer commandBuffer, uint32_t firstAttachment, uint32_t attachmentCount, VkColorComponentFlags* pColorWriteMasks);
	...
	public static void vkCmdSetRasterizationStreamEXT(VkCommandBuffer commandBuffer, uint32_t rasterizationStream) => vkCmdSetRasterizationStreamEXT_0(commandBuffer, rasterizationStream);
	private delegate void vkCmdSetRasterizationStreamEXTDelegate_0(VkCommandBuffer commandBuffer, uint32_t rasterizationStream);
	...
	public static void vkCmdSetColorBlendAdvancedEXT(VkCommandBuffer commandBuffer, uint32_t firstAttachment, uint32_t attachmentCount, VkColorBlendAdvancedEXT* pColorBlendAdvanced) => vkCmdSetColorBlendAdvancedEXT_0(commandBuffer, firstAttachment, attachmentCount, pColorBlendAdvanced);
	private delegate void vkCmdSetColorBlendAdvancedEXTDelegate_0(VkCommandBuffer commandBuffer, uint32_t firstAttachment, uint32_t attachmentCount, VkColorBlendAdvancedEXT* pColorBlendAdvanced);
	...
	public static void vkCmdSetViewportSwizzleNV(VkCommandBuffer commandBuffer, uint32_t firstViewport, uint32_t viewportCount, VkViewportSwizzleNV* pViewportSwizzles) => vkCmdSetViewportSwizzleNV_0(commandBuffer, firstViewport, viewportCount, pViewportSwizzles);
	private delegate void vkCmdSetViewportSwizzleNVDelegate_0(VkCommandBuffer commandBuffer, uint32_t firstViewport, uint32_t viewportCount, VkViewportSwizzleNV* pViewportSwizzles);
	...
	public static void vkCmdSetCoverageToColorLocationNV(VkCommandBuffer commandBuffer, uint32_t coverageToColorLocation) => vkCmdSetCoverageToColorLocationNV_0(commandBuffer, coverageToColorLocation);
	private delegate void vkCmdSetCoverageToColorLocationNVDelegate_0(VkCommandBuffer commandBuffer, uint32_t coverageToColorLocation);
	...
	public static void vkCmdSetCoverageModulationTableNV(VkCommandBuffer commandBuffer, uint32_t coverageModulationTableCount, float* pCoverageModulationTable) => vkCmdSetCoverageModulationTableNV_0(commandBuffer, coverageModulationTableCount, pCoverageModulationTable);
	private delegate void vkCmdSetCoverageModulationTableNVDelegate_0(VkCommandBuffer commandBuffer, uint32_t coverageModulationTableCount, float* pCoverageModulationTable);
	...
	public static VkResult vkGetPhysicalDeviceOpticalFlowImageFormatsNV(VkPhysicalDevice physicalDevice, VkOpticalFlowImageFormatInfoNV* pOpticalFlowImageFormatInfo, uint32_t* pFormatCount, VkOpticalFlowImageFormatPropertiesNV* pImageFormatProperties) => vkGetPhysicalDeviceOpticalFlowImageFormatsNV_0(physicalDevice, pOpticalFlowImageFormatInfo, pFormatCount, pImageFormatProperties);
	private delegate VkResult vkGetPhysicalDeviceOpticalFlowImageFormatsNVDelegate_0(VkPhysicalDevice physicalDevice, VkOpticalFlowImageFormatInfoNV* pOpticalFlowImageFormatInfo, uint32_t* pFormatCount, VkOpticalFlowImageFormatPropertiesNV* pImageFormatProperties);
	...
	public static VkResult vkGetFramebufferTilePropertiesQCOM(VkDevice device, VkFramebuffer framebuffer, uint32_t* pPropertiesCount, VkTilePropertiesQCOM* pProperties) => vkGetFramebufferTilePropertiesQCOM_0(device, framebuffer, pPropertiesCount, pProperties);
	private delegate VkResult vkGetFramebufferTilePropertiesQCOMDelegate_0(VkDevice device, VkFramebuffer framebuffer, uint32_t* pPropertiesCount, VkTilePropertiesQCOM* pProperties);
