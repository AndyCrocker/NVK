...
public static unsafe class VK
{
	...
	public static VkResult vkEnumerateInstanceVersion(uint* pApiVersion) => vkEnumerateInstanceVersion_0(pApiVersion);
	private delegate VkResult vkEnumerateInstanceVersionDelegate_0(uint* pApiVersion);
	...
	public static VkResult vkBindBufferMemory2(VkDevice device, uint bindInfoCount, VkBindBufferMemoryInfo* pBindInfos) => vkBindBufferMemory2_0(device, bindInfoCount, pBindInfos);
	private delegate VkResult vkBindBufferMemory2Delegate_0(VkDevice device, uint bindInfoCount, VkBindBufferMemoryInfo* pBindInfos);
	private static IntPtr vkBindBufferMemory2Pointer;
	private static vkBindBufferMemory2Delegate_0 vkBindBufferMemory2_0;
	public static VkResult vkBindImageMemory2(VkDevice device, uint bindInfoCount, VkBindImageMemoryInfo* pBindInfos) => vkBindImageMemory2_0(device, bindInfoCount, pBindInfos);
	private delegate VkResult vkBindImageMemory2Delegate_0(VkDevice device, uint bindInfoCount, VkBindImageMemoryInfo* pBindInfos);
	private static IntPtr vkBindImageMemory2Pointer;
	private static vkBindImageMemory2Delegate_0 vkBindImageMemory2_0;
	public static void vkGetDeviceGroupPeerMemoryFeatures(VkDevice device, uint heapIndex, uint localDeviceIndex, uint remoteDeviceIndex, VkPeerMemoryFeatureFlags* pPeerMemoryFeatures) => vkGetDeviceGroupPeerMemoryFeatures_0(device, heapIndex, localDeviceIndex, remoteDeviceIndex, pPeerMemoryFeatures);
	private delegate void vkGetDeviceGroupPeerMemoryFeaturesDelegate_0(VkDevice device, uint heapIndex, uint localDeviceIndex, uint remoteDeviceIndex, VkPeerMemoryFeatureFlags* pPeerMemoryFeatures);
	...
	public static void vkCmdSetDeviceMask(VkCommandBuffer commandBuffer, uint deviceMask) => vkCmdSetDeviceMask_0(commandBuffer, deviceMask);
	private delegate void vkCmdSetDeviceMaskDelegate_0(VkCommandBuffer commandBuffer, uint deviceMask);
	private static IntPtr vkCmdSetDeviceMaskPointer;
	private static vkCmdSetDeviceMaskDelegate_0 vkCmdSetDeviceMask_0;
	public static void vkCmdDispatchBase(VkCommandBuffer commandBuffer, uint baseGroupX, uint baseGroupY, uint baseGroupZ, uint groupCountX, uint groupCountY, uint groupCountZ) => vkCmdDispatchBase_0(commandBuffer, baseGroupX, baseGroupY, baseGroupZ, groupCountX, groupCountY, groupCountZ);
	private delegate void vkCmdDispatchBaseDelegate_0(VkCommandBuffer commandBuffer, uint baseGroupX, uint baseGroupY, uint baseGroupZ, uint groupCountX, uint groupCountY, uint groupCountZ);
	private static IntPtr vkCmdDispatchBasePointer;
	private static vkCmdDispatchBaseDelegate_0 vkCmdDispatchBase_0;
	public static VkResult vkEnumeratePhysicalDeviceGroups(VkInstance instance, uint* pPhysicalDeviceGroupCount, VkPhysicalDeviceGroupProperties* pPhysicalDeviceGroupProperties) => vkEnumeratePhysicalDeviceGroups_0(instance, pPhysicalDeviceGroupCount, pPhysicalDeviceGroupProperties);
	private delegate VkResult vkEnumeratePhysicalDeviceGroupsDelegate_0(VkInstance instance, uint* pPhysicalDeviceGroupCount, VkPhysicalDeviceGroupProperties* pPhysicalDeviceGroupProperties);
	...
	public static void vkGetImageSparseMemoryRequirements2(VkDevice device, VkImageSparseMemoryRequirementsInfo2* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements) => vkGetImageSparseMemoryRequirements2_0(device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
	private delegate void vkGetImageSparseMemoryRequirements2Delegate_0(VkDevice device, VkImageSparseMemoryRequirementsInfo2* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements);
	...
	public static void vkGetPhysicalDeviceQueueFamilyProperties2(VkPhysicalDevice physicalDevice, uint* pQueueFamilyPropertyCount, VkQueueFamilyProperties2* pQueueFamilyProperties) => vkGetPhysicalDeviceQueueFamilyProperties2_0(physicalDevice, pQueueFamilyPropertyCount, pQueueFamilyProperties);
	private delegate void vkGetPhysicalDeviceQueueFamilyProperties2Delegate_0(VkPhysicalDevice physicalDevice, uint* pQueueFamilyPropertyCount, VkQueueFamilyProperties2* pQueueFamilyProperties);
	...
	public static void vkGetPhysicalDeviceSparseImageFormatProperties2(VkPhysicalDevice physicalDevice, VkPhysicalDeviceSparseImageFormatInfo2* pFormatInfo, uint* pPropertyCount, VkSparseImageFormatProperties2* pProperties) => vkGetPhysicalDeviceSparseImageFormatProperties2_0(physicalDevice, pFormatInfo, pPropertyCount, pProperties);
	private delegate void vkGetPhysicalDeviceSparseImageFormatProperties2Delegate_0(VkPhysicalDevice physicalDevice, VkPhysicalDeviceSparseImageFormatInfo2* pFormatInfo, uint* pPropertyCount, VkSparseImageFormatProperties2* pProperties);
	...
	public static void vkCmdDrawIndirectCount(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride) => vkCmdDrawIndirectCount_0(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	private delegate void vkCmdDrawIndirectCountDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride);
	...
	public static void vkCmdDrawIndexedIndirectCount(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride) => vkCmdDrawIndexedIndirectCount_0(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	private delegate void vkCmdDrawIndexedIndirectCountDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride);
	...
	public static void vkResetQueryPool(VkDevice device, VkQueryPool queryPool, uint firstQuery, uint queryCount) => vkResetQueryPool_0(device, queryPool, firstQuery, queryCount);
	private delegate void vkResetQueryPoolDelegate_0(VkDevice device, VkQueryPool queryPool, uint firstQuery, uint queryCount);
	private static IntPtr vkResetQueryPoolPointer;
	private static vkResetQueryPoolDelegate_0 vkResetQueryPool_0;
	public static VkResult vkGetSemaphoreCounterValue(VkDevice device, VkSemaphore semaphore, ulong* pValue) => vkGetSemaphoreCounterValue_0(device, semaphore, pValue);
	private delegate VkResult vkGetSemaphoreCounterValueDelegate_0(VkDevice device, VkSemaphore semaphore, ulong* pValue);
	...
	public static VkResult vkWaitSemaphores(VkDevice device, VkSemaphoreWaitInfo* pWaitInfo, ulong timeout) => vkWaitSemaphores_0(device, pWaitInfo, timeout);
	private delegate VkResult vkWaitSemaphoresDelegate_0(VkDevice device, VkSemaphoreWaitInfo* pWaitInfo, ulong timeout);
	...
	public static ulong vkGetBufferOpaqueCaptureAddress(VkDevice device, VkBufferDeviceAddressInfo* pInfo) => vkGetBufferOpaqueCaptureAddress_0(device, pInfo);
	private delegate ulong vkGetBufferOpaqueCaptureAddressDelegate_0(VkDevice device, VkBufferDeviceAddressInfo* pInfo);
	...
	public static ulong vkGetDeviceMemoryOpaqueCaptureAddress(VkDevice device, VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo) => vkGetDeviceMemoryOpaqueCaptureAddress_0(device, pInfo);
	private delegate ulong vkGetDeviceMemoryOpaqueCaptureAddressDelegate_0(VkDevice device, VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo);
	...
	public static VkResult vkGetPhysicalDeviceToolProperties(VkPhysicalDevice physicalDevice, uint* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties) => vkGetPhysicalDeviceToolProperties_0(physicalDevice, pToolCount, pToolProperties);
	private delegate VkResult vkGetPhysicalDeviceToolPropertiesDelegate_0(VkPhysicalDevice physicalDevice, uint* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties);
	private static IntPtr vkGetPhysicalDeviceToolPropertiesPointer;
	private static vkGetPhysicalDeviceToolPropertiesDelegate_0 vkGetPhysicalDeviceToolProperties_0;
	public static VkResult vkCreatePrivateDataSlot(VkDevice device, VkPrivateDataSlotCreateInfo* pCreateInfo, VkAllocationCallbacks* pAllocator, VkPrivateDataSlot* pPrivateDataSlot) => vkCreatePrivateDataSlot_0(device, pCreateInfo, pAllocator, pPrivateDataSlot);
	private delegate VkResult vkCreatePrivateDataSlotDelegate_0(VkDevice device, VkPrivateDataSlotCreateInfo* pCreateInfo, VkAllocationCallbacks* pAllocator, VkPrivateDataSlot* pPrivateDataSlot);
	private static IntPtr vkCreatePrivateDataSlotPointer;
	private static vkCreatePrivateDataSlotDelegate_0 vkCreatePrivateDataSlot_0;
	public static void vkDestroyPrivateDataSlot(VkDevice device, VkPrivateDataSlot privateDataSlot, VkAllocationCallbacks* pAllocator) => vkDestroyPrivateDataSlot_0(device, privateDataSlot, pAllocator);
	private delegate void vkDestroyPrivateDataSlotDelegate_0(VkDevice device, VkPrivateDataSlot privateDataSlot, VkAllocationCallbacks* pAllocator);
	private static IntPtr vkDestroyPrivateDataSlotPointer;
	private static vkDestroyPrivateDataSlotDelegate_0 vkDestroyPrivateDataSlot_0;
	public static VkResult vkSetPrivateData(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong data) => vkSetPrivateData_0(device, objectType, objectHandle, privateDataSlot, data);
	private delegate VkResult vkSetPrivateDataDelegate_0(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong data);
	private static IntPtr vkSetPrivateDataPointer;
	private static vkSetPrivateDataDelegate_0 vkSetPrivateData_0;
	public static void vkGetPrivateData(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong* pData) => vkGetPrivateData_0(device, objectType, objectHandle, privateDataSlot, pData);
	private delegate void vkGetPrivateDataDelegate_0(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong* pData);
	private static IntPtr vkGetPrivateDataPointer;
	private static vkGetPrivateDataDelegate_0 vkGetPrivateData_0;
	public static void vkCmdSetEvent2(VkCommandBuffer commandBuffer, VkEvent event, VkDependencyInfo* pDependencyInfo) => vkCmdSetEvent2_0(commandBuffer, event, pDependencyInfo);
	private delegate void vkCmdSetEvent2Delegate_0(VkCommandBuffer commandBuffer, VkEvent event, VkDependencyInfo* pDependencyInfo);
	private static IntPtr vkCmdSetEvent2Pointer;
	private static vkCmdSetEvent2Delegate_0 vkCmdSetEvent2_0;
	public static void vkCmdResetEvent2(VkCommandBuffer commandBuffer, VkEvent event, VkPipelineStageFlags2 stageMask) => vkCmdResetEvent2_0(commandBuffer, event, stageMask);
	private delegate void vkCmdResetEvent2Delegate_0(VkCommandBuffer commandBuffer, VkEvent event, VkPipelineStageFlags2 stageMask);
	private static IntPtr vkCmdResetEvent2Pointer;
	private static vkCmdResetEvent2Delegate_0 vkCmdResetEvent2_0;
	public static void vkCmdWaitEvents2(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, VkDependencyInfo* pDependencyInfos) => vkCmdWaitEvents2_0(commandBuffer, eventCount, pEvents, pDependencyInfos);
	private delegate void vkCmdWaitEvents2Delegate_0(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, VkDependencyInfo* pDependencyInfos);
	private static IntPtr vkCmdWaitEvents2Pointer;
	private static vkCmdWaitEvents2Delegate_0 vkCmdWaitEvents2_0;
	public static void vkCmdPipelineBarrier2(VkCommandBuffer commandBuffer, VkDependencyInfo* pDependencyInfo) => vkCmdPipelineBarrier2_0(commandBuffer, pDependencyInfo);
	private delegate void vkCmdPipelineBarrier2Delegate_0(VkCommandBuffer commandBuffer, VkDependencyInfo* pDependencyInfo);
	private static IntPtr vkCmdPipelineBarrier2Pointer;
	private static vkCmdPipelineBarrier2Delegate_0 vkCmdPipelineBarrier2_0;
	public static void vkCmdWriteTimestamp2(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint query) => vkCmdWriteTimestamp2_0(commandBuffer, stage, queryPool, query);
	private delegate void vkCmdWriteTimestamp2Delegate_0(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint query);
	private static IntPtr vkCmdWriteTimestamp2Pointer;
	private static vkCmdWriteTimestamp2Delegate_0 vkCmdWriteTimestamp2_0;
	public static VkResult vkQueueSubmit2(VkQueue queue, uint submitCount, VkSubmitInfo2* pSubmits, VkFence fence) => vkQueueSubmit2_0(queue, submitCount, pSubmits, fence);
	private delegate VkResult vkQueueSubmit2Delegate_0(VkQueue queue, uint submitCount, VkSubmitInfo2* pSubmits, VkFence fence);
	private static IntPtr vkQueueSubmit2Pointer;
	private static vkQueueSubmit2Delegate_0 vkQueueSubmit2_0;
	public static void vkCmdCopyBuffer2(VkCommandBuffer commandBuffer, VkCopyBufferInfo2* pCopyBufferInfo) => vkCmdCopyBuffer2_0(commandBuffer, pCopyBufferInfo);
	private delegate void vkCmdCopyBuffer2Delegate_0(VkCommandBuffer commandBuffer, VkCopyBufferInfo2* pCopyBufferInfo);
	private static IntPtr vkCmdCopyBuffer2Pointer;
	private static vkCmdCopyBuffer2Delegate_0 vkCmdCopyBuffer2_0;
	public static void vkCmdCopyImage2(VkCommandBuffer commandBuffer, VkCopyImageInfo2* pCopyImageInfo) => vkCmdCopyImage2_0(commandBuffer, pCopyImageInfo);
	private delegate void vkCmdCopyImage2Delegate_0(VkCommandBuffer commandBuffer, VkCopyImageInfo2* pCopyImageInfo);
	private static IntPtr vkCmdCopyImage2Pointer;
	private static vkCmdCopyImage2Delegate_0 vkCmdCopyImage2_0;
	public static void vkCmdCopyBufferToImage2(VkCommandBuffer commandBuffer, VkCopyBufferToImageInfo2* pCopyBufferToImageInfo) => vkCmdCopyBufferToImage2_0(commandBuffer, pCopyBufferToImageInfo);
	private delegate void vkCmdCopyBufferToImage2Delegate_0(VkCommandBuffer commandBuffer, VkCopyBufferToImageInfo2* pCopyBufferToImageInfo);
	private static IntPtr vkCmdCopyBufferToImage2Pointer;
	private static vkCmdCopyBufferToImage2Delegate_0 vkCmdCopyBufferToImage2_0;
	public static void vkCmdCopyImageToBuffer2(VkCommandBuffer commandBuffer, VkCopyImageToBufferInfo2* pCopyImageToBufferInfo) => vkCmdCopyImageToBuffer2_0(commandBuffer, pCopyImageToBufferInfo);
	private delegate void vkCmdCopyImageToBuffer2Delegate_0(VkCommandBuffer commandBuffer, VkCopyImageToBufferInfo2* pCopyImageToBufferInfo);
	private static IntPtr vkCmdCopyImageToBuffer2Pointer;
	private static vkCmdCopyImageToBuffer2Delegate_0 vkCmdCopyImageToBuffer2_0;
	public static void vkCmdBlitImage2(VkCommandBuffer commandBuffer, VkBlitImageInfo2* pBlitImageInfo) => vkCmdBlitImage2_0(commandBuffer, pBlitImageInfo);
	private delegate void vkCmdBlitImage2Delegate_0(VkCommandBuffer commandBuffer, VkBlitImageInfo2* pBlitImageInfo);
	private static IntPtr vkCmdBlitImage2Pointer;
	private static vkCmdBlitImage2Delegate_0 vkCmdBlitImage2_0;
	public static void vkCmdResolveImage2(VkCommandBuffer commandBuffer, VkResolveImageInfo2* pResolveImageInfo) => vkCmdResolveImage2_0(commandBuffer, pResolveImageInfo);
	private delegate void vkCmdResolveImage2Delegate_0(VkCommandBuffer commandBuffer, VkResolveImageInfo2* pResolveImageInfo);
	private static IntPtr vkCmdResolveImage2Pointer;
	private static vkCmdResolveImage2Delegate_0 vkCmdResolveImage2_0;
	public static void vkCmdBeginRendering(VkCommandBuffer commandBuffer, VkRenderingInfo* pRenderingInfo) => vkCmdBeginRendering_0(commandBuffer, pRenderingInfo);
	private delegate void vkCmdBeginRenderingDelegate_0(VkCommandBuffer commandBuffer, VkRenderingInfo* pRenderingInfo);
	private static IntPtr vkCmdBeginRenderingPointer;
	private static vkCmdBeginRenderingDelegate_0 vkCmdBeginRendering_0;
	public static void vkCmdEndRendering(VkCommandBuffer commandBuffer) => vkCmdEndRendering_0(commandBuffer);
	private delegate void vkCmdEndRenderingDelegate_0(VkCommandBuffer commandBuffer);
	private static IntPtr vkCmdEndRenderingPointer;
	private static vkCmdEndRenderingDelegate_0 vkCmdEndRendering_0;
	public static void vkCmdSetCullMode(VkCommandBuffer commandBuffer, VkCullModeFlags cullMode) => vkCmdSetCullMode_0(commandBuffer, cullMode);
	private delegate void vkCmdSetCullModeDelegate_0(VkCommandBuffer commandBuffer, VkCullModeFlags cullMode);
	private static IntPtr vkCmdSetCullModePointer;
	private static vkCmdSetCullModeDelegate_0 vkCmdSetCullMode_0;
	public static void vkCmdSetFrontFace(VkCommandBuffer commandBuffer, VkFrontFace frontFace) => vkCmdSetFrontFace_0(commandBuffer, frontFace);
	private delegate void vkCmdSetFrontFaceDelegate_0(VkCommandBuffer commandBuffer, VkFrontFace frontFace);
	private static IntPtr vkCmdSetFrontFacePointer;
	private static vkCmdSetFrontFaceDelegate_0 vkCmdSetFrontFace_0;
	public static void vkCmdSetPrimitiveTopology(VkCommandBuffer commandBuffer, VkPrimitiveTopology primitiveTopology) => vkCmdSetPrimitiveTopology_0(commandBuffer, primitiveTopology);
	private delegate void vkCmdSetPrimitiveTopologyDelegate_0(VkCommandBuffer commandBuffer, VkPrimitiveTopology primitiveTopology);
	private static IntPtr vkCmdSetPrimitiveTopologyPointer;
	private static vkCmdSetPrimitiveTopologyDelegate_0 vkCmdSetPrimitiveTopology_0;
	public static void vkCmdSetViewportWithCount(VkCommandBuffer commandBuffer, uint viewportCount, VkViewport* pViewports) => vkCmdSetViewportWithCount_0(commandBuffer, viewportCount, pViewports);
	private delegate void vkCmdSetViewportWithCountDelegate_0(VkCommandBuffer commandBuffer, uint viewportCount, VkViewport* pViewports);
	private static IntPtr vkCmdSetViewportWithCountPointer;
	private static vkCmdSetViewportWithCountDelegate_0 vkCmdSetViewportWithCount_0;
	public static void vkCmdSetScissorWithCount(VkCommandBuffer commandBuffer, uint scissorCount, VkRect2D* pScissors) => vkCmdSetScissorWithCount_0(commandBuffer, scissorCount, pScissors);
	private delegate void vkCmdSetScissorWithCountDelegate_0(VkCommandBuffer commandBuffer, uint scissorCount, VkRect2D* pScissors);
	private static IntPtr vkCmdSetScissorWithCountPointer;
	private static vkCmdSetScissorWithCountDelegate_0 vkCmdSetScissorWithCount_0;
	public static void vkCmdBindVertexBuffers2(VkCommandBuffer commandBuffer, uint firstBinding, uint bindingCount, VkBuffer* pBuffers, VkDeviceSize* pOffsets, VkDeviceSize* pSizes, VkDeviceSize* pStrides) => vkCmdBindVertexBuffers2_0(commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, pSizes, pStrides);
	private delegate void vkCmdBindVertexBuffers2Delegate_0(VkCommandBuffer commandBuffer, uint firstBinding, uint bindingCount, VkBuffer* pBuffers, VkDeviceSize* pOffsets, VkDeviceSize* pSizes, VkDeviceSize* pStrides);
	private static IntPtr vkCmdBindVertexBuffers2Pointer;
	private static vkCmdBindVertexBuffers2Delegate_0 vkCmdBindVertexBuffers2_0;
	public static void vkCmdSetDepthTestEnable(VkCommandBuffer commandBuffer, VkBool32 depthTestEnable) => vkCmdSetDepthTestEnable_0(commandBuffer, depthTestEnable);
	private delegate void vkCmdSetDepthTestEnableDelegate_0(VkCommandBuffer commandBuffer, VkBool32 depthTestEnable);
	private static IntPtr vkCmdSetDepthTestEnablePointer;
	private static vkCmdSetDepthTestEnableDelegate_0 vkCmdSetDepthTestEnable_0;
	public static void vkCmdSetDepthWriteEnable(VkCommandBuffer commandBuffer, VkBool32 depthWriteEnable) => vkCmdSetDepthWriteEnable_0(commandBuffer, depthWriteEnable);
	private delegate void vkCmdSetDepthWriteEnableDelegate_0(VkCommandBuffer commandBuffer, VkBool32 depthWriteEnable);
	private static IntPtr vkCmdSetDepthWriteEnablePointer;
	private static vkCmdSetDepthWriteEnableDelegate_0 vkCmdSetDepthWriteEnable_0;
	public static void vkCmdSetDepthCompareOp(VkCommandBuffer commandBuffer, VkCompareOp depthCompareOp) => vkCmdSetDepthCompareOp_0(commandBuffer, depthCompareOp);
	private delegate void vkCmdSetDepthCompareOpDelegate_0(VkCommandBuffer commandBuffer, VkCompareOp depthCompareOp);
	private static IntPtr vkCmdSetDepthCompareOpPointer;
	private static vkCmdSetDepthCompareOpDelegate_0 vkCmdSetDepthCompareOp_0;
	public static void vkCmdSetDepthBoundsTestEnable(VkCommandBuffer commandBuffer, VkBool32 depthBoundsTestEnable) => vkCmdSetDepthBoundsTestEnable_0(commandBuffer, depthBoundsTestEnable);
	private delegate void vkCmdSetDepthBoundsTestEnableDelegate_0(VkCommandBuffer commandBuffer, VkBool32 depthBoundsTestEnable);
	private static IntPtr vkCmdSetDepthBoundsTestEnablePointer;
	private static vkCmdSetDepthBoundsTestEnableDelegate_0 vkCmdSetDepthBoundsTestEnable_0;
	public static void vkCmdSetStencilTestEnable(VkCommandBuffer commandBuffer, VkBool32 stencilTestEnable) => vkCmdSetStencilTestEnable_0(commandBuffer, stencilTestEnable);
	private delegate void vkCmdSetStencilTestEnableDelegate_0(VkCommandBuffer commandBuffer, VkBool32 stencilTestEnable);
	private static IntPtr vkCmdSetStencilTestEnablePointer;
	private static vkCmdSetStencilTestEnableDelegate_0 vkCmdSetStencilTestEnable_0;
	public static void vkCmdSetStencilOp(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, VkStencilOp failOp, VkStencilOp passOp, VkStencilOp depthFailOp, VkCompareOp compareOp) => vkCmdSetStencilOp_0(commandBuffer, faceMask, failOp, passOp, depthFailOp, compareOp);
	private delegate void vkCmdSetStencilOpDelegate_0(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, VkStencilOp failOp, VkStencilOp passOp, VkStencilOp depthFailOp, VkCompareOp compareOp);
	private static IntPtr vkCmdSetStencilOpPointer;
	private static vkCmdSetStencilOpDelegate_0 vkCmdSetStencilOp_0;
	public static void vkCmdSetRasterizerDiscardEnable(VkCommandBuffer commandBuffer, VkBool32 rasterizerDiscardEnable) => vkCmdSetRasterizerDiscardEnable_0(commandBuffer, rasterizerDiscardEnable);
	private delegate void vkCmdSetRasterizerDiscardEnableDelegate_0(VkCommandBuffer commandBuffer, VkBool32 rasterizerDiscardEnable);
	private static IntPtr vkCmdSetRasterizerDiscardEnablePointer;
	private static vkCmdSetRasterizerDiscardEnableDelegate_0 vkCmdSetRasterizerDiscardEnable_0;
	public static void vkCmdSetDepthBiasEnable(VkCommandBuffer commandBuffer, VkBool32 depthBiasEnable) => vkCmdSetDepthBiasEnable_0(commandBuffer, depthBiasEnable);
	private delegate void vkCmdSetDepthBiasEnableDelegate_0(VkCommandBuffer commandBuffer, VkBool32 depthBiasEnable);
	private static IntPtr vkCmdSetDepthBiasEnablePointer;
	private static vkCmdSetDepthBiasEnableDelegate_0 vkCmdSetDepthBiasEnable_0;
	public static void vkCmdSetPrimitiveRestartEnable(VkCommandBuffer commandBuffer, VkBool32 primitiveRestartEnable) => vkCmdSetPrimitiveRestartEnable_0(commandBuffer, primitiveRestartEnable);
	private delegate void vkCmdSetPrimitiveRestartEnableDelegate_0(VkCommandBuffer commandBuffer, VkBool32 primitiveRestartEnable);
	private static IntPtr vkCmdSetPrimitiveRestartEnablePointer;
	private static vkCmdSetPrimitiveRestartEnableDelegate_0 vkCmdSetPrimitiveRestartEnable_0;
	public static void vkGetDeviceBufferMemoryRequirements(VkDevice device, VkDeviceBufferMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements) => vkGetDeviceBufferMemoryRequirements_0(device, pInfo, pMemoryRequirements);
	private delegate void vkGetDeviceBufferMemoryRequirementsDelegate_0(VkDevice device, VkDeviceBufferMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements);
	private static IntPtr vkGetDeviceBufferMemoryRequirementsPointer;
	private static vkGetDeviceBufferMemoryRequirementsDelegate_0 vkGetDeviceBufferMemoryRequirements_0;
	public static void vkGetDeviceImageMemoryRequirements(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements) => vkGetDeviceImageMemoryRequirements_0(device, pInfo, pMemoryRequirements);
	private delegate void vkGetDeviceImageMemoryRequirementsDelegate_0(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements);
	private static IntPtr vkGetDeviceImageMemoryRequirementsPointer;
	private static vkGetDeviceImageMemoryRequirementsDelegate_0 vkGetDeviceImageMemoryRequirements_0;
	public static void vkGetDeviceImageSparseMemoryRequirements(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements) => vkGetDeviceImageSparseMemoryRequirements_0(device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
	private delegate void vkGetDeviceImageSparseMemoryRequirementsDelegate_0(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements);
	private static IntPtr vkGetDeviceImageSparseMemoryRequirementsPointer;
	private static vkGetDeviceImageSparseMemoryRequirementsDelegate_0 vkGetDeviceImageSparseMemoryRequirements_0;
	...
	public static VkResult vkGetPhysicalDevicePresentRectanglesKHR(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint* pRectCount, VkRect2D* pRects) => vkGetPhysicalDevicePresentRectanglesKHR_0(physicalDevice, surface, pRectCount, pRects);
	private delegate VkResult vkGetPhysicalDevicePresentRectanglesKHRDelegate_0(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint* pRectCount, VkRect2D* pRects);
	...
	public static VkResult vkAcquireNextImage2KHR(VkDevice device, VkAcquireNextImageInfoKHR* pAcquireInfo, uint* pImageIndex) => vkAcquireNextImage2KHR_0(device, pAcquireInfo, pImageIndex);
	private delegate VkResult vkAcquireNextImage2KHRDelegate_0(VkDevice device, VkAcquireNextImageInfoKHR* pAcquireInfo, uint* pImageIndex);
	...
	public static VkResult vkGetPhysicalDeviceVideoCapabilitiesKHR(VkPhysicalDevice physicalDevice, VkVideoProfileInfoKHR* pVideoProfile, VkVideoCapabilitiesKHR* pCapabilities) => vkGetPhysicalDeviceVideoCapabilitiesKHR_0(physicalDevice, pVideoProfile, pCapabilities);
	private delegate VkResult vkGetPhysicalDeviceVideoCapabilitiesKHRDelegate_0(VkPhysicalDevice physicalDevice, VkVideoProfileInfoKHR* pVideoProfile, VkVideoCapabilitiesKHR* pCapabilities);
	private static IntPtr vkGetPhysicalDeviceVideoCapabilitiesKHRPointer;
	private static vkGetPhysicalDeviceVideoCapabilitiesKHRDelegate_0 vkGetPhysicalDeviceVideoCapabilitiesKHR_0;
	public static VkResult vkGetPhysicalDeviceVideoFormatPropertiesKHR(VkPhysicalDevice physicalDevice, VkPhysicalDeviceVideoFormatInfoKHR* pVideoFormatInfo, uint* pVideoFormatPropertyCount, VkVideoFormatPropertiesKHR* pVideoFormatProperties) => vkGetPhysicalDeviceVideoFormatPropertiesKHR_0(physicalDevice, pVideoFormatInfo, pVideoFormatPropertyCount, pVideoFormatProperties);
	private delegate VkResult vkGetPhysicalDeviceVideoFormatPropertiesKHRDelegate_0(VkPhysicalDevice physicalDevice, VkPhysicalDeviceVideoFormatInfoKHR* pVideoFormatInfo, uint* pVideoFormatPropertyCount, VkVideoFormatPropertiesKHR* pVideoFormatProperties);
	private static IntPtr vkGetPhysicalDeviceVideoFormatPropertiesKHRPointer;
	private static vkGetPhysicalDeviceVideoFormatPropertiesKHRDelegate_0 vkGetPhysicalDeviceVideoFormatPropertiesKHR_0;
	public static VkResult vkCreateVideoSessionKHR(VkDevice device, VkVideoSessionCreateInfoKHR* pCreateInfo, VkAllocationCallbacks* pAllocator, VkVideoSessionKHR* pVideoSession) => vkCreateVideoSessionKHR_0(device, pCreateInfo, pAllocator, pVideoSession);
	private delegate VkResult vkCreateVideoSessionKHRDelegate_0(VkDevice device, VkVideoSessionCreateInfoKHR* pCreateInfo, VkAllocationCallbacks* pAllocator, VkVideoSessionKHR* pVideoSession);
	private static IntPtr vkCreateVideoSessionKHRPointer;
	private static vkCreateVideoSessionKHRDelegate_0 vkCreateVideoSessionKHR_0;
	public static void vkDestroyVideoSessionKHR(VkDevice device, VkVideoSessionKHR videoSession, VkAllocationCallbacks* pAllocator) => vkDestroyVideoSessionKHR_0(device, videoSession, pAllocator);
	private delegate void vkDestroyVideoSessionKHRDelegate_0(VkDevice device, VkVideoSessionKHR videoSession, VkAllocationCallbacks* pAllocator);
	private static IntPtr vkDestroyVideoSessionKHRPointer;
	private static vkDestroyVideoSessionKHRDelegate_0 vkDestroyVideoSessionKHR_0;
	public static VkResult vkGetVideoSessionMemoryRequirementsKHR(VkDevice device, VkVideoSessionKHR videoSession, uint* pMemoryRequirementsCount, VkVideoSessionMemoryRequirementsKHR* pMemoryRequirements) => vkGetVideoSessionMemoryRequirementsKHR_0(device, videoSession, pMemoryRequirementsCount, pMemoryRequirements);
	private delegate VkResult vkGetVideoSessionMemoryRequirementsKHRDelegate_0(VkDevice device, VkVideoSessionKHR videoSession, uint* pMemoryRequirementsCount, VkVideoSessionMemoryRequirementsKHR* pMemoryRequirements);
	private static IntPtr vkGetVideoSessionMemoryRequirementsKHRPointer;
	private static vkGetVideoSessionMemoryRequirementsKHRDelegate_0 vkGetVideoSessionMemoryRequirementsKHR_0;
	public static VkResult vkBindVideoSessionMemoryKHR(VkDevice device, VkVideoSessionKHR videoSession, uint bindSessionMemoryInfoCount, VkBindVideoSessionMemoryInfoKHR* pBindSessionMemoryInfos) => vkBindVideoSessionMemoryKHR_0(device, videoSession, bindSessionMemoryInfoCount, pBindSessionMemoryInfos);
	private delegate VkResult vkBindVideoSessionMemoryKHRDelegate_0(VkDevice device, VkVideoSessionKHR videoSession, uint bindSessionMemoryInfoCount, VkBindVideoSessionMemoryInfoKHR* pBindSessionMemoryInfos);
	private static IntPtr vkBindVideoSessionMemoryKHRPointer;
	private static vkBindVideoSessionMemoryKHRDelegate_0 vkBindVideoSessionMemoryKHR_0;
	public static VkResult vkCreateVideoSessionParametersKHR(VkDevice device, VkVideoSessionParametersCreateInfoKHR* pCreateInfo, VkAllocationCallbacks* pAllocator, VkVideoSessionParametersKHR* pVideoSessionParameters) => vkCreateVideoSessionParametersKHR_0(device, pCreateInfo, pAllocator, pVideoSessionParameters);
	private delegate VkResult vkCreateVideoSessionParametersKHRDelegate_0(VkDevice device, VkVideoSessionParametersCreateInfoKHR* pCreateInfo, VkAllocationCallbacks* pAllocator, VkVideoSessionParametersKHR* pVideoSessionParameters);
	private static IntPtr vkCreateVideoSessionParametersKHRPointer;
	private static vkCreateVideoSessionParametersKHRDelegate_0 vkCreateVideoSessionParametersKHR_0;
	public static VkResult vkUpdateVideoSessionParametersKHR(VkDevice device, VkVideoSessionParametersKHR videoSessionParameters, VkVideoSessionParametersUpdateInfoKHR* pUpdateInfo) => vkUpdateVideoSessionParametersKHR_0(device, videoSessionParameters, pUpdateInfo);
	private delegate VkResult vkUpdateVideoSessionParametersKHRDelegate_0(VkDevice device, VkVideoSessionParametersKHR videoSessionParameters, VkVideoSessionParametersUpdateInfoKHR* pUpdateInfo);
	private static IntPtr vkUpdateVideoSessionParametersKHRPointer;
	private static vkUpdateVideoSessionParametersKHRDelegate_0 vkUpdateVideoSessionParametersKHR_0;
	public static void vkDestroyVideoSessionParametersKHR(VkDevice device, VkVideoSessionParametersKHR videoSessionParameters, VkAllocationCallbacks* pAllocator) => vkDestroyVideoSessionParametersKHR_0(device, videoSessionParameters, pAllocator);
	private delegate void vkDestroyVideoSessionParametersKHRDelegate_0(VkDevice device, VkVideoSessionParametersKHR videoSessionParameters, VkAllocationCallbacks* pAllocator);
	private static IntPtr vkDestroyVideoSessionParametersKHRPointer;
	private static vkDestroyVideoSessionParametersKHRDelegate_0 vkDestroyVideoSessionParametersKHR_0;
	public static void vkCmdBeginVideoCodingKHR(VkCommandBuffer commandBuffer, VkVideoBeginCodingInfoKHR* pBeginInfo) => vkCmdBeginVideoCodingKHR_0(commandBuffer, pBeginInfo);
	private delegate void vkCmdBeginVideoCodingKHRDelegate_0(VkCommandBuffer commandBuffer, VkVideoBeginCodingInfoKHR* pBeginInfo);
	private static IntPtr vkCmdBeginVideoCodingKHRPointer;
	private static vkCmdBeginVideoCodingKHRDelegate_0 vkCmdBeginVideoCodingKHR_0;
	public static void vkCmdEndVideoCodingKHR(VkCommandBuffer commandBuffer, VkVideoEndCodingInfoKHR* pEndCodingInfo) => vkCmdEndVideoCodingKHR_0(commandBuffer, pEndCodingInfo);
	private delegate void vkCmdEndVideoCodingKHRDelegate_0(VkCommandBuffer commandBuffer, VkVideoEndCodingInfoKHR* pEndCodingInfo);
	private static IntPtr vkCmdEndVideoCodingKHRPointer;
	private static vkCmdEndVideoCodingKHRDelegate_0 vkCmdEndVideoCodingKHR_0;
	public static void vkCmdControlVideoCodingKHR(VkCommandBuffer commandBuffer, VkVideoCodingControlInfoKHR* pCodingControlInfo) => vkCmdControlVideoCodingKHR_0(commandBuffer, pCodingControlInfo);
	private delegate void vkCmdControlVideoCodingKHRDelegate_0(VkCommandBuffer commandBuffer, VkVideoCodingControlInfoKHR* pCodingControlInfo);
	private static IntPtr vkCmdControlVideoCodingKHRPointer;
	private static vkCmdControlVideoCodingKHRDelegate_0 vkCmdControlVideoCodingKHR_0;
	public static void vkCmdDecodeVideoKHR(VkCommandBuffer commandBuffer, VkVideoDecodeInfoKHR* pDecodeInfo) => vkCmdDecodeVideoKHR_0(commandBuffer, pDecodeInfo);
	private delegate void vkCmdDecodeVideoKHRDelegate_0(VkCommandBuffer commandBuffer, VkVideoDecodeInfoKHR* pDecodeInfo);
	private static IntPtr vkCmdDecodeVideoKHRPointer;
	private static vkCmdDecodeVideoKHRDelegate_0 vkCmdDecodeVideoKHR_0;
	public static void vkCmdBindTransformFeedbackBuffersEXT(VkCommandBuffer commandBuffer, uint firstBinding, uint bindingCount, VkBuffer* pBuffers, VkDeviceSize* pOffsets, VkDeviceSize* pSizes) => vkCmdBindTransformFeedbackBuffersEXT_0(commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, pSizes);
	private delegate void vkCmdBindTransformFeedbackBuffersEXTDelegate_0(VkCommandBuffer commandBuffer, uint firstBinding, uint bindingCount, VkBuffer* pBuffers, VkDeviceSize* pOffsets, VkDeviceSize* pSizes);
	...
	public static void vkCmdBeginTransformFeedbackEXT(VkCommandBuffer commandBuffer, uint firstCounterBuffer, uint counterBufferCount, VkBuffer* pCounterBuffers, VkDeviceSize* pCounterBufferOffsets) => vkCmdBeginTransformFeedbackEXT_0(commandBuffer, firstCounterBuffer, counterBufferCount, pCounterBuffers, pCounterBufferOffsets);
	private delegate void vkCmdBeginTransformFeedbackEXTDelegate_0(VkCommandBuffer commandBuffer, uint firstCounterBuffer, uint counterBufferCount, VkBuffer* pCounterBuffers, VkDeviceSize* pCounterBufferOffsets);
	...
	public static void vkCmdEndTransformFeedbackEXT(VkCommandBuffer commandBuffer, uint firstCounterBuffer, uint counterBufferCount, VkBuffer* pCounterBuffers, VkDeviceSize* pCounterBufferOffsets) => vkCmdEndTransformFeedbackEXT_0(commandBuffer, firstCounterBuffer, counterBufferCount, pCounterBuffers, pCounterBufferOffsets);
	private delegate void vkCmdEndTransformFeedbackEXTDelegate_0(VkCommandBuffer commandBuffer, uint firstCounterBuffer, uint counterBufferCount, VkBuffer* pCounterBuffers, VkDeviceSize* pCounterBufferOffsets);
	...
	public static void vkCmdBeginQueryIndexedEXT(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint query, VkQueryControlFlags flags, uint index) => vkCmdBeginQueryIndexedEXT_0(commandBuffer, queryPool, query, flags, index);
	private delegate void vkCmdBeginQueryIndexedEXTDelegate_0(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint query, VkQueryControlFlags flags, uint index);
	...
	public static void vkCmdEndQueryIndexedEXT(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint query, uint index) => vkCmdEndQueryIndexedEXT_0(commandBuffer, queryPool, query, index);
	private delegate void vkCmdEndQueryIndexedEXTDelegate_0(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint query, uint index);
	...
	public static void vkCmdDrawIndirectByteCountEXT(VkCommandBuffer commandBuffer, uint instanceCount, uint firstInstance, VkBuffer counterBuffer, VkDeviceSize counterBufferOffset, uint counterOffset, uint vertexStride) => vkCmdDrawIndirectByteCountEXT_0(commandBuffer, instanceCount, firstInstance, counterBuffer, counterBufferOffset, counterOffset, vertexStride);
	private delegate void vkCmdDrawIndirectByteCountEXTDelegate_0(VkCommandBuffer commandBuffer, uint instanceCount, uint firstInstance, VkBuffer counterBuffer, VkDeviceSize counterBufferOffset, uint counterOffset, uint vertexStride);
	...
	public static uint vkGetImageViewHandleNVX(VkDevice device, VkImageViewHandleInfoNVX* pInfo) => vkGetImageViewHandleNVX_0(device, pInfo);
	private delegate uint vkGetImageViewHandleNVXDelegate_0(VkDevice device, VkImageViewHandleInfoNVX* pInfo);
	...
	[Obsolete("Use vkCmdBeginRendering")]
	public static void vkCmdBeginRenderingKHR(VkCommandBuffer commandBuffer, VkRenderingInfo* pRenderingInfo) => vkCmdBeginRenderingKHR_0(commandBuffer, pRenderingInfo);
	private delegate void vkCmdBeginRenderingKHRDelegate_0(VkCommandBuffer commandBuffer, VkRenderingInfo* pRenderingInfo);
	...
	[Obsolete("Use vkCmdEndRendering")]
	...
	public static void vkGetPhysicalDeviceQueueFamilyProperties2KHR(VkPhysicalDevice physicalDevice, uint* pQueueFamilyPropertyCount, VkQueueFamilyProperties2* pQueueFamilyProperties) => vkGetPhysicalDeviceQueueFamilyProperties2KHR_0(physicalDevice, pQueueFamilyPropertyCount, pQueueFamilyProperties);
	private delegate void vkGetPhysicalDeviceQueueFamilyProperties2KHRDelegate_0(VkPhysicalDevice physicalDevice, uint* pQueueFamilyPropertyCount, VkQueueFamilyProperties2* pQueueFamilyProperties);
	...
	public static void vkGetPhysicalDeviceSparseImageFormatProperties2KHR(VkPhysicalDevice physicalDevice, VkPhysicalDeviceSparseImageFormatInfo2* pFormatInfo, uint* pPropertyCount, VkSparseImageFormatProperties2* pProperties) => vkGetPhysicalDeviceSparseImageFormatProperties2KHR_0(physicalDevice, pFormatInfo, pPropertyCount, pProperties);
	private delegate void vkGetPhysicalDeviceSparseImageFormatProperties2KHRDelegate_0(VkPhysicalDevice physicalDevice, VkPhysicalDeviceSparseImageFormatInfo2* pFormatInfo, uint* pPropertyCount, VkSparseImageFormatProperties2* pProperties);
	...
	public static void vkGetDeviceGroupPeerMemoryFeaturesKHR(VkDevice device, uint heapIndex, uint localDeviceIndex, uint remoteDeviceIndex, VkPeerMemoryFeatureFlags* pPeerMemoryFeatures) => vkGetDeviceGroupPeerMemoryFeaturesKHR_0(device, heapIndex, localDeviceIndex, remoteDeviceIndex, pPeerMemoryFeatures);
	private delegate void vkGetDeviceGroupPeerMemoryFeaturesKHRDelegate_0(VkDevice device, uint heapIndex, uint localDeviceIndex, uint remoteDeviceIndex, VkPeerMemoryFeatureFlags* pPeerMemoryFeatures);
	...
	public static void vkCmdSetDeviceMaskKHR(VkCommandBuffer commandBuffer, uint deviceMask) => vkCmdSetDeviceMaskKHR_0(commandBuffer, deviceMask);
	private delegate void vkCmdSetDeviceMaskKHRDelegate_0(VkCommandBuffer commandBuffer, uint deviceMask);
	...
	public static void vkCmdDispatchBaseKHR(VkCommandBuffer commandBuffer, uint baseGroupX, uint baseGroupY, uint baseGroupZ, uint groupCountX, uint groupCountY, uint groupCountZ) => vkCmdDispatchBaseKHR_0(commandBuffer, baseGroupX, baseGroupY, baseGroupZ, groupCountX, groupCountY, groupCountZ);
	private delegate void vkCmdDispatchBaseKHRDelegate_0(VkCommandBuffer commandBuffer, uint baseGroupX, uint baseGroupY, uint baseGroupZ, uint groupCountX, uint groupCountY, uint groupCountZ);
	...
	public static void vkEnumeratePhysicalDeviceGroupsKHR(VkInstance instance, uint* pPhysicalDeviceGroupCount, VkPhysicalDeviceGroupProperties* pPhysicalDeviceGroupProperties) => vkEnumeratePhysicalDeviceGroupsKHR_0(instance, pPhysicalDeviceGroupCount, pPhysicalDeviceGroupProperties);
	private delegate void vkEnumeratePhysicalDeviceGroupsKHRDelegate_0(VkInstance instance, uint* pPhysicalDeviceGroupCount, VkPhysicalDeviceGroupProperties* pPhysicalDeviceGroupProperties);
	...
	public static VkResult vkGetMemoryWin32HandlePropertiesKHR(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, IntPtr handle, VkMemoryWin32HandlePropertiesKHR* pMemoryWin32HandleProperties) => vkGetMemoryWin32HandlePropertiesKHR_0(device, handleType, handle, pMemoryWin32HandleProperties);
	private delegate VkResult vkGetMemoryWin32HandlePropertiesKHRDelegate_0(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, IntPtr handle, VkMemoryWin32HandlePropertiesKHR* pMemoryWin32HandleProperties);
	...
	public static void vkCmdPushDescriptorSetWithTemplateKHR(VkCommandBuffer commandBuffer, VkDescriptorUpdateTemplate descriptorUpdateTemplate, VkPipelineLayout layout, uint set, void* pData) => vkCmdPushDescriptorSetWithTemplateKHR_0(commandBuffer, descriptorUpdateTemplate, layout, set, pData);
	private delegate void vkCmdPushDescriptorSetWithTemplateKHRDelegate_0(VkCommandBuffer commandBuffer, VkDescriptorUpdateTemplate descriptorUpdateTemplate, VkPipelineLayout layout, uint set, void* pData);
	...
	public static VkResult vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR(VkPhysicalDevice physicalDevice, uint queueFamilyIndex, uint* pCounterCount, VkPerformanceCounterKHR* pCounters, VkPerformanceCounterDescriptionKHR* pCounterDescriptions) => vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR_0(physicalDevice, queueFamilyIndex, pCounterCount, pCounters, pCounterDescriptions);
	private delegate VkResult vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHRDelegate_0(VkPhysicalDevice physicalDevice, uint queueFamilyIndex, uint* pCounterCount, VkPerformanceCounterKHR* pCounters, VkPerformanceCounterDescriptionKHR* pCounterDescriptions);
	...
	public static void vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR(VkPhysicalDevice physicalDevice, VkQueryPoolPerformanceCreateInfoKHR* pPerformanceQueryCreateInfo, uint* pNumPasses) => vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR_0(physicalDevice, pPerformanceQueryCreateInfo, pNumPasses);
	private delegate void vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHRDelegate_0(VkPhysicalDevice physicalDevice, VkQueryPoolPerformanceCreateInfoKHR* pPerformanceQueryCreateInfo, uint* pNumPasses);
	...
	public static VkResult vkGetPhysicalDeviceDisplayProperties2KHR(VkPhysicalDevice physicalDevice, uint* pPropertyCount, VkDisplayProperties2KHR* pProperties) => vkGetPhysicalDeviceDisplayProperties2KHR_0(physicalDevice, pPropertyCount, pProperties);
	private delegate VkResult vkGetPhysicalDeviceDisplayProperties2KHRDelegate_0(VkPhysicalDevice physicalDevice, uint* pPropertyCount, VkDisplayProperties2KHR* pProperties);
	...
	public static VkResult vkGetPhysicalDeviceDisplayPlaneProperties2KHR(VkPhysicalDevice physicalDevice, uint* pPropertyCount, VkDisplayPlaneProperties2KHR* pProperties) => vkGetPhysicalDeviceDisplayPlaneProperties2KHR_0(physicalDevice, pPropertyCount, pProperties);
	private delegate VkResult vkGetPhysicalDeviceDisplayPlaneProperties2KHRDelegate_0(VkPhysicalDevice physicalDevice, uint* pPropertyCount, VkDisplayPlaneProperties2KHR* pProperties);
	...
	public static VkResult vkGetDisplayModeProperties2KHR(VkPhysicalDevice physicalDevice, VkDisplayKHR display, uint* pPropertyCount, VkDisplayModeProperties2KHR* pProperties) => vkGetDisplayModeProperties2KHR_0(physicalDevice, display, pPropertyCount, pProperties);
	private delegate VkResult vkGetDisplayModeProperties2KHRDelegate_0(VkPhysicalDevice physicalDevice, VkDisplayKHR display, uint* pPropertyCount, VkDisplayModeProperties2KHR* pProperties);
	...
	public static VkResult vkGetAndroidHardwareBufferPropertiesANDROID(VkDevice device, void* buffer, VkAndroidHardwareBufferPropertiesANDROID* pProperties) => vkGetAndroidHardwareBufferPropertiesANDROID_0(device, buffer, pProperties);
	private delegate VkResult vkGetAndroidHardwareBufferPropertiesANDROIDDelegate_0(VkDevice device, void* buffer, VkAndroidHardwareBufferPropertiesANDROID* pProperties);
	...
	public static VkResult vkGetMemoryAndroidHardwareBufferANDROID(VkDevice device, VkMemoryGetAndroidHardwareBufferInfoANDROID* pInfo, void** pBuffer) => vkGetMemoryAndroidHardwareBufferANDROID_0(device, pInfo, pBuffer);
	private delegate VkResult vkGetMemoryAndroidHardwareBufferANDROIDDelegate_0(VkDevice device, VkMemoryGetAndroidHardwareBufferInfoANDROID* pInfo, void** pBuffer);
	...
	public static void vkGetImageSparseMemoryRequirements2KHR(VkDevice device, VkImageSparseMemoryRequirementsInfo2* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements) => vkGetImageSparseMemoryRequirements2KHR_0(device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
	private delegate void vkGetImageSparseMemoryRequirements2KHRDelegate_0(VkDevice device, VkImageSparseMemoryRequirementsInfo2* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements);
	...
	public static void vkCmdBuildAccelerationStructuresKHR(VkCommandBuffer commandBuffer, uint infoCount, VkAccelerationStructureBuildGeometryInfoKHR* pInfos, VkAccelerationStructureBuildRangeInfoKHR** ppBuildRangeInfos) => vkCmdBuildAccelerationStructuresKHR_0(commandBuffer, infoCount, pInfos, ppBuildRangeInfos);
	private delegate void vkCmdBuildAccelerationStructuresKHRDelegate_0(VkCommandBuffer commandBuffer, uint infoCount, VkAccelerationStructureBuildGeometryInfoKHR* pInfos, VkAccelerationStructureBuildRangeInfoKHR** ppBuildRangeInfos);
	...
	public static void vkCmdBuildAccelerationStructuresIndirectKHR(VkCommandBuffer commandBuffer, uint infoCount, VkAccelerationStructureBuildGeometryInfoKHR* pInfos, VkDeviceAddress* pIndirectDeviceAddresses, uint* pIndirectStrides, uint** ppMaxPrimitiveCounts) => vkCmdBuildAccelerationStructuresIndirectKHR_0(commandBuffer, infoCount, pInfos, pIndirectDeviceAddresses, pIndirectStrides, ppMaxPrimitiveCounts);
	private delegate void vkCmdBuildAccelerationStructuresIndirectKHRDelegate_0(VkCommandBuffer commandBuffer, uint infoCount, VkAccelerationStructureBuildGeometryInfoKHR* pInfos, VkDeviceAddress* pIndirectDeviceAddresses, uint* pIndirectStrides, uint** ppMaxPrimitiveCounts);
	...
	private delegate VkResult vkBuildAccelerationStructuresKHRDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, uint infoCount, VkAccelerationStructureBuildGeometryInfoKHR* pInfos, VkAccelerationStructureBuildRangeInfoKHR** ppBuildRangeInfos);
	...
	public static VkResult vkWriteAccelerationStructuresPropertiesKHR(VkDevice device, uint accelerationStructureCount, VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, nuint dataSize, void* pData, nuint stride) => vkWriteAccelerationStructuresPropertiesKHR_0(device, accelerationStructureCount, pAccelerationStructures, queryType, dataSize, pData, stride);
	private delegate VkResult vkWriteAccelerationStructuresPropertiesKHRDelegate_0(VkDevice device, uint accelerationStructureCount, VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, nuint dataSize, void* pData, nuint stride);
	...
	public static void vkCmdWriteAccelerationStructuresPropertiesKHR(VkCommandBuffer commandBuffer, uint accelerationStructureCount, VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint firstQuery) => vkCmdWriteAccelerationStructuresPropertiesKHR_0(commandBuffer, accelerationStructureCount, pAccelerationStructures, queryType, queryPool, firstQuery);
	private delegate void vkCmdWriteAccelerationStructuresPropertiesKHRDelegate_0(VkCommandBuffer commandBuffer, uint accelerationStructureCount, VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint firstQuery);
	...
	public static void vkGetAccelerationStructureBuildSizesKHR(VkDevice device, VkAccelerationStructureBuildTypeKHR buildType, VkAccelerationStructureBuildGeometryInfoKHR* pBuildInfo, uint* pMaxPrimitiveCounts, VkAccelerationStructureBuildSizesInfoKHR* pSizeInfo) => vkGetAccelerationStructureBuildSizesKHR_0(device, buildType, pBuildInfo, pMaxPrimitiveCounts, pSizeInfo);
	private delegate void vkGetAccelerationStructureBuildSizesKHRDelegate_0(VkDevice device, VkAccelerationStructureBuildTypeKHR buildType, VkAccelerationStructureBuildGeometryInfoKHR* pBuildInfo, uint* pMaxPrimitiveCounts, VkAccelerationStructureBuildSizesInfoKHR* pSizeInfo);
	...
	public static void vkCmdTraceRaysKHR(VkCommandBuffer commandBuffer, VkStridedDeviceAddressRegionKHR* pRaygenShaderBindingTable, VkStridedDeviceAddressRegionKHR* pMissShaderBindingTable, VkStridedDeviceAddressRegionKHR* pHitShaderBindingTable, VkStridedDeviceAddressRegionKHR* pCallableShaderBindingTable, uint width, uint height, uint depth) => vkCmdTraceRaysKHR_0(commandBuffer, pRaygenShaderBindingTable, pMissShaderBindingTable, pHitShaderBindingTable, pCallableShaderBindingTable, width, height, depth);
	private delegate void vkCmdTraceRaysKHRDelegate_0(VkCommandBuffer commandBuffer, VkStridedDeviceAddressRegionKHR* pRaygenShaderBindingTable, VkStridedDeviceAddressRegionKHR* pMissShaderBindingTable, VkStridedDeviceAddressRegionKHR* pHitShaderBindingTable, VkStridedDeviceAddressRegionKHR* pCallableShaderBindingTable, uint width, uint height, uint depth);
	private static IntPtr vkCmdTraceRaysKHRPointer;
	private static vkCmdTraceRaysKHRDelegate_0 vkCmdTraceRaysKHR_0;
	public static VkResult vkCreateRayTracingPipelinesKHR(VkDevice device, VkDeferredOperationKHR deferredOperation, VkPipelineCache pipelineCache, uint createInfoCount, VkRayTracingPipelineCreateInfoKHR* pCreateInfos, VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines) => vkCreateRayTracingPipelinesKHR_0(device, deferredOperation, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
	private delegate VkResult vkCreateRayTracingPipelinesKHRDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, VkPipelineCache pipelineCache, uint createInfoCount, VkRayTracingPipelineCreateInfoKHR* pCreateInfos, VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines);
	...
	public static VkResult vkGetRayTracingShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData) => vkGetRayTracingShaderGroupHandlesKHR_0(device, pipeline, firstGroup, groupCount, dataSize, pData);
	private delegate VkResult vkGetRayTracingShaderGroupHandlesKHRDelegate_0(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData);
	...
	public static VkResult vkGetRayTracingCaptureReplayShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData) => vkGetRayTracingCaptureReplayShaderGroupHandlesKHR_0(device, pipeline, firstGroup, groupCount, dataSize, pData);
	private delegate VkResult vkGetRayTracingCaptureReplayShaderGroupHandlesKHRDelegate_0(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData);
	...
	public static VkDeviceSize vkGetRayTracingShaderGroupStackSizeKHR(VkDevice device, VkPipeline pipeline, uint group, VkShaderGroupShaderKHR groupShader) => vkGetRayTracingShaderGroupStackSizeKHR_0(device, pipeline, group, groupShader);
	private delegate VkDeviceSize vkGetRayTracingShaderGroupStackSizeKHRDelegate_0(VkDevice device, VkPipeline pipeline, uint group, VkShaderGroupShaderKHR groupShader);
	...
	public static void vkCmdSetRayTracingPipelineStackSizeKHR(VkCommandBuffer commandBuffer, uint pipelineStackSize) => vkCmdSetRayTracingPipelineStackSizeKHR_0(commandBuffer, pipelineStackSize);
	private delegate void vkCmdSetRayTracingPipelineStackSizeKHRDelegate_0(VkCommandBuffer commandBuffer, uint pipelineStackSize);
	...
	public static void vkBindBufferMemory2KHR(VkDevice device, uint bindInfoCount, VkBindBufferMemoryInfo* pBindInfos) => vkBindBufferMemory2KHR_0(device, bindInfoCount, pBindInfos);
	private delegate void vkBindBufferMemory2KHRDelegate_0(VkDevice device, uint bindInfoCount, VkBindBufferMemoryInfo* pBindInfos);
	...
	public static void vkBindImageMemory2KHR(VkDevice device, uint bindInfoCount, VkBindImageMemoryInfo* pBindInfos) => vkBindImageMemory2KHR_0(device, bindInfoCount, pBindInfos);
	private delegate void vkBindImageMemory2KHRDelegate_0(VkDevice device, uint bindInfoCount, VkBindImageMemoryInfo* pBindInfos);
	...
	public static void vkCmdSetViewportShadingRatePaletteNV(VkCommandBuffer commandBuffer, uint firstViewport, uint viewportCount, VkShadingRatePaletteNV* pShadingRatePalettes) => vkCmdSetViewportShadingRatePaletteNV_0(commandBuffer, firstViewport, viewportCount, pShadingRatePalettes);
	private delegate void vkCmdSetViewportShadingRatePaletteNVDelegate_0(VkCommandBuffer commandBuffer, uint firstViewport, uint viewportCount, VkShadingRatePaletteNV* pShadingRatePalettes);
	...
	public static void vkCmdSetCoarseSampleOrderNV(VkCommandBuffer commandBuffer, VkCoarseSampleOrderTypeNV sampleOrderType, uint customSampleOrderCount, VkCoarseSampleOrderCustomNV* pCustomSampleOrders) => vkCmdSetCoarseSampleOrderNV_0(commandBuffer, sampleOrderType, customSampleOrderCount, pCustomSampleOrders);
	private delegate void vkCmdSetCoarseSampleOrderNVDelegate_0(VkCommandBuffer commandBuffer, VkCoarseSampleOrderTypeNV sampleOrderType, uint customSampleOrderCount, VkCoarseSampleOrderCustomNV* pCustomSampleOrders);
	...
	public static VkResult vkBindAccelerationStructureMemoryNV(VkDevice device, uint bindInfoCount, VkBindAccelerationStructureMemoryInfoNV* pBindInfos) => vkBindAccelerationStructureMemoryNV_0(device, bindInfoCount, pBindInfos);
	private delegate VkResult vkBindAccelerationStructureMemoryNVDelegate_0(VkDevice device, uint bindInfoCount, VkBindAccelerationStructureMemoryInfoNV* pBindInfos);
	...
	private delegate VkResult vkCreateRayTracingPipelinesNVDelegate_0(VkDevice device, VkPipelineCache pipelineCache, uint createInfoCount, VkRayTracingPipelineCreateInfoNV* pCreateInfos, VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines);
	...
	public static void vkGetRayTracingShaderGroupHandlesNV(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData) => vkGetRayTracingShaderGroupHandlesNV_0(device, pipeline, firstGroup, groupCount, dataSize, pData);
	private delegate void vkGetRayTracingShaderGroupHandlesNVDelegate_0(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData);
	...
	public static VkResult vkGetAccelerationStructureHandleNV(VkDevice device, VkAccelerationStructureNV accelerationStructure, nuint dataSize, void* pData) => vkGetAccelerationStructureHandleNV_0(device, accelerationStructure, dataSize, pData);
	private delegate VkResult vkGetAccelerationStructureHandleNVDelegate_0(VkDevice device, VkAccelerationStructureNV accelerationStructure, nuint dataSize, void* pData);
	...
	public static void vkCmdWriteAccelerationStructuresPropertiesNV(VkCommandBuffer commandBuffer, uint accelerationStructureCount, VkAccelerationStructureNV* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint firstQuery) => vkCmdWriteAccelerationStructuresPropertiesNV_0(commandBuffer, accelerationStructureCount, pAccelerationStructures, queryType, queryPool, firstQuery);
	private delegate void vkCmdWriteAccelerationStructuresPropertiesNVDelegate_0(VkCommandBuffer commandBuffer, uint accelerationStructureCount, VkAccelerationStructureNV* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint firstQuery);
	...
	public static VkResult vkCompileDeferredNV(VkDevice device, VkPipeline pipeline, uint shader) => vkCompileDeferredNV_0(device, pipeline, shader);
	private delegate VkResult vkCompileDeferredNVDelegate_0(VkDevice device, VkPipeline pipeline, uint shader);
	...
	[Obsolete("Use vkCmdDrawIndirectCount")]
	public static void vkCmdDrawIndirectCountKHR(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride) => vkCmdDrawIndirectCountKHR_0(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	private delegate void vkCmdDrawIndirectCountKHRDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride);
	...
	[Obsolete("Use vkCmdDrawIndexedIndirectCount")]
	public static void vkCmdDrawIndexedIndirectCountKHR(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride) => vkCmdDrawIndexedIndirectCountKHR_0(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	private delegate void vkCmdDrawIndexedIndirectCountKHRDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride);
	...
	public static VkResult vkGetPhysicalDeviceCalibrateableTimeDomainsEXT(VkPhysicalDevice physicalDevice, uint* pTimeDomainCount, VkTimeDomainEXT* pTimeDomains) => vkGetPhysicalDeviceCalibrateableTimeDomainsEXT_0(physicalDevice, pTimeDomainCount, pTimeDomains);
	private delegate VkResult vkGetPhysicalDeviceCalibrateableTimeDomainsEXTDelegate_0(VkPhysicalDevice physicalDevice, uint* pTimeDomainCount, VkTimeDomainEXT* pTimeDomains);
	...
	public static VkResult vkGetCalibratedTimestampsEXT(VkDevice device, uint timestampCount, VkCalibratedTimestampInfoEXT* pTimestampInfos, ulong* pTimestamps, ulong* pMaxDeviation) => vkGetCalibratedTimestampsEXT_0(device, timestampCount, pTimestampInfos, pTimestamps, pMaxDeviation);
	private delegate VkResult vkGetCalibratedTimestampsEXTDelegate_0(VkDevice device, uint timestampCount, VkCalibratedTimestampInfoEXT* pTimestampInfos, ulong* pTimestamps, ulong* pMaxDeviation);
	...
	public static void vkCmdDrawMeshTasksNV(VkCommandBuffer commandBuffer, uint taskCount, uint firstTask) => vkCmdDrawMeshTasksNV_0(commandBuffer, taskCount, firstTask);
	private delegate void vkCmdDrawMeshTasksNVDelegate_0(VkCommandBuffer commandBuffer, uint taskCount, uint firstTask);
	private static IntPtr vkCmdDrawMeshTasksNVPointer;
	private static vkCmdDrawMeshTasksNVDelegate_0 vkCmdDrawMeshTasksNV_0;
	public static void vkCmdDrawMeshTasksIndirectNV(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint drawCount, uint stride) => vkCmdDrawMeshTasksIndirectNV_0(commandBuffer, buffer, offset, drawCount, stride);
	private delegate void vkCmdDrawMeshTasksIndirectNVDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint drawCount, uint stride);
	...
	public static void vkCmdDrawMeshTasksIndirectCountNV(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride) => vkCmdDrawMeshTasksIndirectCountNV_0(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	private delegate void vkCmdDrawMeshTasksIndirectCountNVDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride);
	...
	public static void vkCmdSetExclusiveScissorNV(VkCommandBuffer commandBuffer, uint firstExclusiveScissor, uint exclusiveScissorCount, VkRect2D* pExclusiveScissors) => vkCmdSetExclusiveScissorNV_0(commandBuffer, firstExclusiveScissor, exclusiveScissorCount, pExclusiveScissors);
	private delegate void vkCmdSetExclusiveScissorNVDelegate_0(VkCommandBuffer commandBuffer, uint firstExclusiveScissor, uint exclusiveScissorCount, VkRect2D* pExclusiveScissors);
	...
	public static void vkGetQueueCheckpointDataNV(VkQueue queue, uint* pCheckpointDataCount, VkCheckpointDataNV* pCheckpointData) => vkGetQueueCheckpointDataNV_0(queue, pCheckpointDataCount, pCheckpointData);
	private delegate void vkGetQueueCheckpointDataNVDelegate_0(VkQueue queue, uint* pCheckpointDataCount, VkCheckpointDataNV* pCheckpointData);
	...
	public static void vkGetSemaphoreCounterValueKHR(VkDevice device, VkSemaphore semaphore, ulong* pValue) => vkGetSemaphoreCounterValueKHR_0(device, semaphore, pValue);
	private delegate void vkGetSemaphoreCounterValueKHRDelegate_0(VkDevice device, VkSemaphore semaphore, ulong* pValue);
	...
	public static void vkWaitSemaphoresKHR(VkDevice device, VkSemaphoreWaitInfo* pWaitInfo, ulong timeout) => vkWaitSemaphoresKHR_0(device, pWaitInfo, timeout);
	private delegate void vkWaitSemaphoresKHRDelegate_0(VkDevice device, VkSemaphoreWaitInfo* pWaitInfo, ulong timeout);
	...
	public static VkResult vkGetPhysicalDeviceFragmentShadingRatesKHR(VkPhysicalDevice physicalDevice, uint* pFragmentShadingRateCount, VkPhysicalDeviceFragmentShadingRateKHR* pFragmentShadingRates) => vkGetPhysicalDeviceFragmentShadingRatesKHR_0(physicalDevice, pFragmentShadingRateCount, pFragmentShadingRates);
	private delegate VkResult vkGetPhysicalDeviceFragmentShadingRatesKHRDelegate_0(VkPhysicalDevice physicalDevice, uint* pFragmentShadingRateCount, VkPhysicalDeviceFragmentShadingRateKHR* pFragmentShadingRates);
	...
	[Obsolete("Use vkGetPhysicalDeviceToolProperties")]
	public static void vkGetPhysicalDeviceToolPropertiesEXT(VkPhysicalDevice physicalDevice, uint* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties) => vkGetPhysicalDeviceToolPropertiesEXT_0(physicalDevice, pToolCount, pToolProperties);
	private delegate void vkGetPhysicalDeviceToolPropertiesEXTDelegate_0(VkPhysicalDevice physicalDevice, uint* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties);
	...
	public static VkResult vkWaitForPresentKHR(VkDevice device, VkSwapchainKHR swapchain, ulong presentId, ulong timeout) => vkWaitForPresentKHR_0(device, swapchain, presentId, timeout);
	private delegate VkResult vkWaitForPresentKHRDelegate_0(VkDevice device, VkSwapchainKHR swapchain, ulong presentId, ulong timeout);
	private static IntPtr vkWaitForPresentKHRPointer;
	private static vkWaitForPresentKHRDelegate_0 vkWaitForPresentKHR_0;
	public static VkResult vkGetPhysicalDeviceCooperativeMatrixPropertiesNV(VkPhysicalDevice physicalDevice, uint* pPropertyCount, VkCooperativeMatrixPropertiesNV* pProperties) => vkGetPhysicalDeviceCooperativeMatrixPropertiesNV_0(physicalDevice, pPropertyCount, pProperties);
	private delegate VkResult vkGetPhysicalDeviceCooperativeMatrixPropertiesNVDelegate_0(VkPhysicalDevice physicalDevice, uint* pPropertyCount, VkCooperativeMatrixPropertiesNV* pProperties);
	...
	public static VkResult vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(VkPhysicalDevice physicalDevice, uint* pCombinationCount, VkFramebufferMixedSamplesCombinationNV* pCombinations) => vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV_0(physicalDevice, pCombinationCount, pCombinations);
	private delegate VkResult vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNVDelegate_0(VkPhysicalDevice physicalDevice, uint* pCombinationCount, VkFramebufferMixedSamplesCombinationNV* pCombinations);
	...
	public static VkResult vkGetPhysicalDeviceSurfacePresentModes2EXT(VkPhysicalDevice physicalDevice, VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, uint* pPresentModeCount, VkPresentModeKHR* pPresentModes) => vkGetPhysicalDeviceSurfacePresentModes2EXT_0(physicalDevice, pSurfaceInfo, pPresentModeCount, pPresentModes);
	private delegate VkResult vkGetPhysicalDeviceSurfacePresentModes2EXTDelegate_0(VkPhysicalDevice physicalDevice, VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, uint* pPresentModeCount, VkPresentModeKHR* pPresentModes);
	...
	public static void vkCmdSetLineStippleEXT(VkCommandBuffer commandBuffer, uint lineStippleFactor, ushort lineStipplePattern) => vkCmdSetLineStippleEXT_0(commandBuffer, lineStippleFactor, lineStipplePattern);
	private delegate void vkCmdSetLineStippleEXTDelegate_0(VkCommandBuffer commandBuffer, uint lineStippleFactor, ushort lineStipplePattern);
	...
	public static void vkResetQueryPoolEXT(VkDevice device, VkQueryPool queryPool, uint firstQuery, uint queryCount) => vkResetQueryPoolEXT_0(device, queryPool, firstQuery, queryCount);
	private delegate void vkResetQueryPoolEXTDelegate_0(VkDevice device, VkQueryPool queryPool, uint firstQuery, uint queryCount);
	private static IntPtr vkResetQueryPoolEXTPointer;
	private static vkResetQueryPoolEXTDelegate_0 vkResetQueryPoolEXT_0;
	[Obsolete("Use vkCmdSetCullMode")]
	...
	[Obsolete("Use vkCmdSetFrontFace")]
	...
	[Obsolete("Use vkCmdSetPrimitiveTopology")]
	...
	[Obsolete("Use vkCmdSetViewportWithCount")]
	public static void vkCmdSetViewportWithCountEXT(VkCommandBuffer commandBuffer, uint viewportCount, VkViewport* pViewports) => vkCmdSetViewportWithCountEXT_0(commandBuffer, viewportCount, pViewports);
	private delegate void vkCmdSetViewportWithCountEXTDelegate_0(VkCommandBuffer commandBuffer, uint viewportCount, VkViewport* pViewports);
	...
	[Obsolete("Use vkCmdSetScissorWithCount")]
	public static void vkCmdSetScissorWithCountEXT(VkCommandBuffer commandBuffer, uint scissorCount, VkRect2D* pScissors) => vkCmdSetScissorWithCountEXT_0(commandBuffer, scissorCount, pScissors);
	private delegate void vkCmdSetScissorWithCountEXTDelegate_0(VkCommandBuffer commandBuffer, uint scissorCount, VkRect2D* pScissors);
	...
	[Obsolete("Use vkCmdBindVertexBuffers2")]
	public static void vkCmdBindVertexBuffers2EXT(VkCommandBuffer commandBuffer, uint firstBinding, uint bindingCount, VkBuffer* pBuffers, VkDeviceSize* pOffsets, VkDeviceSize* pSizes, VkDeviceSize* pStrides) => vkCmdBindVertexBuffers2EXT_0(commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, pSizes, pStrides);
	private delegate void vkCmdBindVertexBuffers2EXTDelegate_0(VkCommandBuffer commandBuffer, uint firstBinding, uint bindingCount, VkBuffer* pBuffers, VkDeviceSize* pOffsets, VkDeviceSize* pSizes, VkDeviceSize* pStrides);
	...
	[Obsolete("Use vkCmdSetDepthTestEnable")]
	...
	[Obsolete("Use vkCmdSetDepthWriteEnable")]
	...
	[Obsolete("Use vkCmdSetDepthCompareOp")]
	...
	[Obsolete("Use vkCmdSetDepthBoundsTestEnable")]
	...
	[Obsolete("Use vkCmdSetStencilTestEnable")]
	...
	[Obsolete("Use vkCmdSetStencilOp")]
	...
	public static uint vkGetDeferredOperationMaxConcurrencyKHR(VkDevice device, VkDeferredOperationKHR operation) => vkGetDeferredOperationMaxConcurrencyKHR_0(device, operation);
	private delegate uint vkGetDeferredOperationMaxConcurrencyKHRDelegate_0(VkDevice device, VkDeferredOperationKHR operation);
	...
	public static VkResult vkGetPipelineExecutablePropertiesKHR(VkDevice device, VkPipelineInfoKHR* pPipelineInfo, uint* pExecutableCount, VkPipelineExecutablePropertiesKHR* pProperties) => vkGetPipelineExecutablePropertiesKHR_0(device, pPipelineInfo, pExecutableCount, pProperties);
	private delegate VkResult vkGetPipelineExecutablePropertiesKHRDelegate_0(VkDevice device, VkPipelineInfoKHR* pPipelineInfo, uint* pExecutableCount, VkPipelineExecutablePropertiesKHR* pProperties);
	...
	public static VkResult vkGetPipelineExecutableStatisticsKHR(VkDevice device, VkPipelineExecutableInfoKHR* pExecutableInfo, uint* pStatisticCount, VkPipelineExecutableStatisticKHR* pStatistics) => vkGetPipelineExecutableStatisticsKHR_0(device, pExecutableInfo, pStatisticCount, pStatistics);
	private delegate VkResult vkGetPipelineExecutableStatisticsKHRDelegate_0(VkDevice device, VkPipelineExecutableInfoKHR* pExecutableInfo, uint* pStatisticCount, VkPipelineExecutableStatisticKHR* pStatistics);
	...
	public static VkResult vkGetPipelineExecutableInternalRepresentationsKHR(VkDevice device, VkPipelineExecutableInfoKHR* pExecutableInfo, uint* pInternalRepresentationCount, VkPipelineExecutableInternalRepresentationKHR* pInternalRepresentations) => vkGetPipelineExecutableInternalRepresentationsKHR_0(device, pExecutableInfo, pInternalRepresentationCount, pInternalRepresentations);
	private delegate VkResult vkGetPipelineExecutableInternalRepresentationsKHRDelegate_0(VkDevice device, VkPipelineExecutableInfoKHR* pExecutableInfo, uint* pInternalRepresentationCount, VkPipelineExecutableInternalRepresentationKHR* pInternalRepresentations);
	...
	public static VkResult vkReleaseSwapchainImagesEXT(VkDevice device, VkReleaseSwapchainImagesInfoEXT* pReleaseInfo) => vkReleaseSwapchainImagesEXT_0(device, pReleaseInfo);
	private delegate VkResult vkReleaseSwapchainImagesEXTDelegate_0(VkDevice device, VkReleaseSwapchainImagesInfoEXT* pReleaseInfo);
	private static IntPtr vkReleaseSwapchainImagesEXTPointer;
	private static vkReleaseSwapchainImagesEXTDelegate_0 vkReleaseSwapchainImagesEXT_0;
	...
	public static void vkCmdBindPipelineShaderGroupNV(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipeline pipeline, uint groupIndex) => vkCmdBindPipelineShaderGroupNV_0(commandBuffer, pipelineBindPoint, pipeline, groupIndex);
	private delegate void vkCmdBindPipelineShaderGroupNVDelegate_0(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipeline pipeline, uint groupIndex);
	...
	public static VkResult vkAcquireDrmDisplayEXT(VkPhysicalDevice physicalDevice, int drmFd, VkDisplayKHR display) => vkAcquireDrmDisplayEXT_0(physicalDevice, drmFd, display);
	private delegate VkResult vkAcquireDrmDisplayEXTDelegate_0(VkPhysicalDevice physicalDevice, int drmFd, VkDisplayKHR display);
	...
	public static VkResult vkGetDrmDisplayEXT(VkPhysicalDevice physicalDevice, int drmFd, uint connectorId, VkDisplayKHR* display) => vkGetDrmDisplayEXT_0(physicalDevice, drmFd, connectorId, display);
	private delegate VkResult vkGetDrmDisplayEXTDelegate_0(VkPhysicalDevice physicalDevice, int drmFd, uint connectorId, VkDisplayKHR* display);
	private static IntPtr vkGetDrmDisplayEXTPointer;
	private static vkGetDrmDisplayEXTDelegate_0 vkGetDrmDisplayEXT_0;
	[Obsolete("Use vkCreatePrivateDataSlot")]
	public static void vkCreatePrivateDataSlotEXT(VkDevice device, VkPrivateDataSlotCreateInfo* pCreateInfo, VkAllocationCallbacks* pAllocator, VkPrivateDataSlot* pPrivateDataSlot) => vkCreatePrivateDataSlotEXT_0(device, pCreateInfo, pAllocator, pPrivateDataSlot);
	private delegate void vkCreatePrivateDataSlotEXTDelegate_0(VkDevice device, VkPrivateDataSlotCreateInfo* pCreateInfo, VkAllocationCallbacks* pAllocator, VkPrivateDataSlot* pPrivateDataSlot);
	...
	[Obsolete("Use vkDestroyPrivateDataSlot")]
	public static void vkDestroyPrivateDataSlotEXT(VkDevice device, VkPrivateDataSlot privateDataSlot, VkAllocationCallbacks* pAllocator) => vkDestroyPrivateDataSlotEXT_0(device, privateDataSlot, pAllocator);
	private delegate void vkDestroyPrivateDataSlotEXTDelegate_0(VkDevice device, VkPrivateDataSlot privateDataSlot, VkAllocationCallbacks* pAllocator);
	...
	[Obsolete("Use vkSetPrivateData")]
	public static void vkSetPrivateDataEXT(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong data) => vkSetPrivateDataEXT_0(device, objectType, objectHandle, privateDataSlot, data);
	private delegate void vkSetPrivateDataEXTDelegate_0(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong data);
	private static IntPtr vkSetPrivateDataEXTPointer;
	private static vkSetPrivateDataEXTDelegate_0 vkSetPrivateDataEXT_0;
	[Obsolete("Use vkGetPrivateData")]
	public static void vkGetPrivateDataEXT(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong* pData) => vkGetPrivateDataEXT_0(device, objectType, objectHandle, privateDataSlot, pData);
	private delegate void vkGetPrivateDataEXTDelegate_0(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong* pData);
	private static IntPtr vkGetPrivateDataEXTPointer;
	private static vkGetPrivateDataEXTDelegate_0 vkGetPrivateDataEXT_0;
	[Obsolete("Use vkCmdSetEvent2")]
	public static void vkCmdSetEvent2KHR(VkCommandBuffer commandBuffer, VkEvent event, VkDependencyInfo* pDependencyInfo) => vkCmdSetEvent2KHR_0(commandBuffer, event, pDependencyInfo);
	private delegate void vkCmdSetEvent2KHRDelegate_0(VkCommandBuffer commandBuffer, VkEvent event, VkDependencyInfo* pDependencyInfo);
	private static IntPtr vkCmdSetEvent2KHRPointer;
	private static vkCmdSetEvent2KHRDelegate_0 vkCmdSetEvent2KHR_0;
	[Obsolete("Use vkCmdResetEvent2")]
	public static void vkCmdResetEvent2KHR(VkCommandBuffer commandBuffer, VkEvent event, VkPipelineStageFlags2 stageMask) => vkCmdResetEvent2KHR_0(commandBuffer, event, stageMask);
	private delegate void vkCmdResetEvent2KHRDelegate_0(VkCommandBuffer commandBuffer, VkEvent event, VkPipelineStageFlags2 stageMask);
	private static IntPtr vkCmdResetEvent2KHRPointer;
	private static vkCmdResetEvent2KHRDelegate_0 vkCmdResetEvent2KHR_0;
	[Obsolete("Use vkCmdWaitEvents2")]
	public static void vkCmdWaitEvents2KHR(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, VkDependencyInfo* pDependencyInfos) => vkCmdWaitEvents2KHR_0(commandBuffer, eventCount, pEvents, pDependencyInfos);
	private delegate void vkCmdWaitEvents2KHRDelegate_0(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, VkDependencyInfo* pDependencyInfos);
	private static IntPtr vkCmdWaitEvents2KHRPointer;
	private static vkCmdWaitEvents2KHRDelegate_0 vkCmdWaitEvents2KHR_0;
	[Obsolete("Use vkCmdPipelineBarrier2")]
	public static void vkCmdPipelineBarrier2KHR(VkCommandBuffer commandBuffer, VkDependencyInfo* pDependencyInfo) => vkCmdPipelineBarrier2KHR_0(commandBuffer, pDependencyInfo);
	private delegate void vkCmdPipelineBarrier2KHRDelegate_0(VkCommandBuffer commandBuffer, VkDependencyInfo* pDependencyInfo);
	...
	[Obsolete("Use vkCmdWriteTimestamp2")]
	public static void vkCmdWriteTimestamp2KHR(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint query) => vkCmdWriteTimestamp2KHR_0(commandBuffer, stage, queryPool, query);
	private delegate void vkCmdWriteTimestamp2KHRDelegate_0(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint query);
	...
	[Obsolete("Use vkQueueSubmit2")]
	public static void vkQueueSubmit2KHR(VkQueue queue, uint submitCount, VkSubmitInfo2* pSubmits, VkFence fence) => vkQueueSubmit2KHR_0(queue, submitCount, pSubmits, fence);
	private delegate void vkQueueSubmit2KHRDelegate_0(VkQueue queue, uint submitCount, VkSubmitInfo2* pSubmits, VkFence fence);
	private static IntPtr vkQueueSubmit2KHRPointer;
	private static vkQueueSubmit2KHRDelegate_0 vkQueueSubmit2KHR_0;
	public static void vkCmdWriteBufferMarker2AMD(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkBuffer dstBuffer, VkDeviceSize dstOffset, uint marker) => vkCmdWriteBufferMarker2AMD_0(commandBuffer, stage, dstBuffer, dstOffset, marker);
	private delegate void vkCmdWriteBufferMarker2AMDDelegate_0(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkBuffer dstBuffer, VkDeviceSize dstOffset, uint marker);
	...
	public static void vkGetQueueCheckpointData2NV(VkQueue queue, uint* pCheckpointDataCount, VkCheckpointData2NV* pCheckpointData) => vkGetQueueCheckpointData2NV_0(queue, pCheckpointDataCount, pCheckpointData);
	private delegate void vkGetQueueCheckpointData2NVDelegate_0(VkQueue queue, uint* pCheckpointDataCount, VkCheckpointData2NV* pCheckpointData);
	...
	public static void vkGetDescriptorSetLayoutSizeEXT(VkDevice device, VkDescriptorSetLayout layout, VkDeviceSize* pLayoutSizeInBytes) => vkGetDescriptorSetLayoutSizeEXT_0(device, layout, pLayoutSizeInBytes);
	private delegate void vkGetDescriptorSetLayoutSizeEXTDelegate_0(VkDevice device, VkDescriptorSetLayout layout, VkDeviceSize* pLayoutSizeInBytes);
	private static IntPtr vkGetDescriptorSetLayoutSizeEXTPointer;
	private static vkGetDescriptorSetLayoutSizeEXTDelegate_0 vkGetDescriptorSetLayoutSizeEXT_0;
	public static void vkGetDescriptorSetLayoutBindingOffsetEXT(VkDevice device, VkDescriptorSetLayout layout, uint binding, VkDeviceSize* pOffset) => vkGetDescriptorSetLayoutBindingOffsetEXT_0(device, layout, binding, pOffset);
	private delegate void vkGetDescriptorSetLayoutBindingOffsetEXTDelegate_0(VkDevice device, VkDescriptorSetLayout layout, uint binding, VkDeviceSize* pOffset);
	private static IntPtr vkGetDescriptorSetLayoutBindingOffsetEXTPointer;
	private static vkGetDescriptorSetLayoutBindingOffsetEXTDelegate_0 vkGetDescriptorSetLayoutBindingOffsetEXT_0;
	public static void vkGetDescriptorEXT(VkDevice device, VkDescriptorGetInfoEXT* pDescriptorInfo, nuint dataSize, void* pDescriptor) => vkGetDescriptorEXT_0(device, pDescriptorInfo, dataSize, pDescriptor);
	private delegate void vkGetDescriptorEXTDelegate_0(VkDevice device, VkDescriptorGetInfoEXT* pDescriptorInfo, nuint dataSize, void* pDescriptor);
	private static IntPtr vkGetDescriptorEXTPointer;
	private static vkGetDescriptorEXTDelegate_0 vkGetDescriptorEXT_0;
	public static void vkCmdBindDescriptorBuffersEXT(VkCommandBuffer commandBuffer, uint bufferCount, VkDescriptorBufferBindingInfoEXT* pBindingInfos) => vkCmdBindDescriptorBuffersEXT_0(commandBuffer, bufferCount, pBindingInfos);
	private delegate void vkCmdBindDescriptorBuffersEXTDelegate_0(VkCommandBuffer commandBuffer, uint bufferCount, VkDescriptorBufferBindingInfoEXT* pBindingInfos);
	private static IntPtr vkCmdBindDescriptorBuffersEXTPointer;
	private static vkCmdBindDescriptorBuffersEXTDelegate_0 vkCmdBindDescriptorBuffersEXT_0;
	public static void vkCmdSetDescriptorBufferOffsetsEXT(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint firstSet, uint setCount, uint* pBufferIndices, VkDeviceSize* pOffsets) => vkCmdSetDescriptorBufferOffsetsEXT_0(commandBuffer, pipelineBindPoint, layout, firstSet, setCount, pBufferIndices, pOffsets);
	private delegate void vkCmdSetDescriptorBufferOffsetsEXTDelegate_0(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint firstSet, uint setCount, uint* pBufferIndices, VkDeviceSize* pOffsets);
	private static IntPtr vkCmdSetDescriptorBufferOffsetsEXTPointer;
	private static vkCmdSetDescriptorBufferOffsetsEXTDelegate_0 vkCmdSetDescriptorBufferOffsetsEXT_0;
	public static void vkCmdBindDescriptorBufferEmbeddedSamplersEXT(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint set) => vkCmdBindDescriptorBufferEmbeddedSamplersEXT_0(commandBuffer, pipelineBindPoint, layout, set);
	private delegate void vkCmdBindDescriptorBufferEmbeddedSamplersEXTDelegate_0(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint set);
	private static IntPtr vkCmdBindDescriptorBufferEmbeddedSamplersEXTPointer;
	private static vkCmdBindDescriptorBufferEmbeddedSamplersEXTDelegate_0 vkCmdBindDescriptorBufferEmbeddedSamplersEXT_0;
	public static VkResult vkGetBufferOpaqueCaptureDescriptorDataEXT(VkDevice device, VkBufferCaptureDescriptorDataInfoEXT* pInfo, void* pData) => vkGetBufferOpaqueCaptureDescriptorDataEXT_0(device, pInfo, pData);
	private delegate VkResult vkGetBufferOpaqueCaptureDescriptorDataEXTDelegate_0(VkDevice device, VkBufferCaptureDescriptorDataInfoEXT* pInfo, void* pData);
	private static IntPtr vkGetBufferOpaqueCaptureDescriptorDataEXTPointer;
	private static vkGetBufferOpaqueCaptureDescriptorDataEXTDelegate_0 vkGetBufferOpaqueCaptureDescriptorDataEXT_0;
	public static VkResult vkGetImageOpaqueCaptureDescriptorDataEXT(VkDevice device, VkImageCaptureDescriptorDataInfoEXT* pInfo, void* pData) => vkGetImageOpaqueCaptureDescriptorDataEXT_0(device, pInfo, pData);
	private delegate VkResult vkGetImageOpaqueCaptureDescriptorDataEXTDelegate_0(VkDevice device, VkImageCaptureDescriptorDataInfoEXT* pInfo, void* pData);
	private static IntPtr vkGetImageOpaqueCaptureDescriptorDataEXTPointer;
	private static vkGetImageOpaqueCaptureDescriptorDataEXTDelegate_0 vkGetImageOpaqueCaptureDescriptorDataEXT_0;
	public static VkResult vkGetImageViewOpaqueCaptureDescriptorDataEXT(VkDevice device, VkImageViewCaptureDescriptorDataInfoEXT* pInfo, void* pData) => vkGetImageViewOpaqueCaptureDescriptorDataEXT_0(device, pInfo, pData);
	private delegate VkResult vkGetImageViewOpaqueCaptureDescriptorDataEXTDelegate_0(VkDevice device, VkImageViewCaptureDescriptorDataInfoEXT* pInfo, void* pData);
	private static IntPtr vkGetImageViewOpaqueCaptureDescriptorDataEXTPointer;
	private static vkGetImageViewOpaqueCaptureDescriptorDataEXTDelegate_0 vkGetImageViewOpaqueCaptureDescriptorDataEXT_0;
	public static VkResult vkGetSamplerOpaqueCaptureDescriptorDataEXT(VkDevice device, VkSamplerCaptureDescriptorDataInfoEXT* pInfo, void* pData) => vkGetSamplerOpaqueCaptureDescriptorDataEXT_0(device, pInfo, pData);
	private delegate VkResult vkGetSamplerOpaqueCaptureDescriptorDataEXTDelegate_0(VkDevice device, VkSamplerCaptureDescriptorDataInfoEXT* pInfo, void* pData);
	private static IntPtr vkGetSamplerOpaqueCaptureDescriptorDataEXTPointer;
	private static vkGetSamplerOpaqueCaptureDescriptorDataEXTDelegate_0 vkGetSamplerOpaqueCaptureDescriptorDataEXT_0;
	public static VkResult vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT(VkDevice device, VkAccelerationStructureCaptureDescriptorDataInfoEXT* pInfo, void* pData) => vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT_0(device, pInfo, pData);
	private delegate VkResult vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXTDelegate_0(VkDevice device, VkAccelerationStructureCaptureDescriptorDataInfoEXT* pInfo, void* pData);
	private static IntPtr vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXTPointer;
	private static vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXTDelegate_0 vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT_0;
	...
	public static void vkCmdDrawMeshTasksEXT(VkCommandBuffer commandBuffer, uint groupCountX, uint groupCountY, uint groupCountZ) => vkCmdDrawMeshTasksEXT_0(commandBuffer, groupCountX, groupCountY, groupCountZ);
	private delegate void vkCmdDrawMeshTasksEXTDelegate_0(VkCommandBuffer commandBuffer, uint groupCountX, uint groupCountY, uint groupCountZ);
	private static IntPtr vkCmdDrawMeshTasksEXTPointer;
	private static vkCmdDrawMeshTasksEXTDelegate_0 vkCmdDrawMeshTasksEXT_0;
	public static void vkCmdDrawMeshTasksIndirectEXT(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint drawCount, uint stride) => vkCmdDrawMeshTasksIndirectEXT_0(commandBuffer, buffer, offset, drawCount, stride);
	private delegate void vkCmdDrawMeshTasksIndirectEXTDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint drawCount, uint stride);
	private static IntPtr vkCmdDrawMeshTasksIndirectEXTPointer;
	private static vkCmdDrawMeshTasksIndirectEXTDelegate_0 vkCmdDrawMeshTasksIndirectEXT_0;
	public static void vkCmdDrawMeshTasksIndirectCountEXT(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride) => vkCmdDrawMeshTasksIndirectCountEXT_0(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	private delegate void vkCmdDrawMeshTasksIndirectCountEXTDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint maxDrawCount, uint stride);
	private static IntPtr vkCmdDrawMeshTasksIndirectCountEXTPointer;
	private static vkCmdDrawMeshTasksIndirectCountEXTDelegate_0 vkCmdDrawMeshTasksIndirectCountEXT_0;
	[Obsolete("Use vkCmdCopyBuffer2")]
	public static void vkCmdCopyBuffer2KHR(VkCommandBuffer commandBuffer, VkCopyBufferInfo2* pCopyBufferInfo) => vkCmdCopyBuffer2KHR_0(commandBuffer, pCopyBufferInfo);
	private delegate void vkCmdCopyBuffer2KHRDelegate_0(VkCommandBuffer commandBuffer, VkCopyBufferInfo2* pCopyBufferInfo);
	private static IntPtr vkCmdCopyBuffer2KHRPointer;
	private static vkCmdCopyBuffer2KHRDelegate_0 vkCmdCopyBuffer2KHR_0;
	[Obsolete("Use vkCmdCopyImage2")]
	public static void vkCmdCopyImage2KHR(VkCommandBuffer commandBuffer, VkCopyImageInfo2* pCopyImageInfo) => vkCmdCopyImage2KHR_0(commandBuffer, pCopyImageInfo);
	private delegate void vkCmdCopyImage2KHRDelegate_0(VkCommandBuffer commandBuffer, VkCopyImageInfo2* pCopyImageInfo);
	private static IntPtr vkCmdCopyImage2KHRPointer;
	private static vkCmdCopyImage2KHRDelegate_0 vkCmdCopyImage2KHR_0;
	[Obsolete("Use vkCmdCopyBufferToImage2")]
	public static void vkCmdCopyBufferToImage2KHR(VkCommandBuffer commandBuffer, VkCopyBufferToImageInfo2* pCopyBufferToImageInfo) => vkCmdCopyBufferToImage2KHR_0(commandBuffer, pCopyBufferToImageInfo);
	private delegate void vkCmdCopyBufferToImage2KHRDelegate_0(VkCommandBuffer commandBuffer, VkCopyBufferToImageInfo2* pCopyBufferToImageInfo);
	...
	[Obsolete("Use vkCmdCopyImageToBuffer2")]
	public static void vkCmdCopyImageToBuffer2KHR(VkCommandBuffer commandBuffer, VkCopyImageToBufferInfo2* pCopyImageToBufferInfo) => vkCmdCopyImageToBuffer2KHR_0(commandBuffer, pCopyImageToBufferInfo);
	private delegate void vkCmdCopyImageToBuffer2KHRDelegate_0(VkCommandBuffer commandBuffer, VkCopyImageToBufferInfo2* pCopyImageToBufferInfo);
	...
	[Obsolete("Use vkCmdBlitImage2")]
	public static void vkCmdBlitImage2KHR(VkCommandBuffer commandBuffer, VkBlitImageInfo2* pBlitImageInfo) => vkCmdBlitImage2KHR_0(commandBuffer, pBlitImageInfo);
	private delegate void vkCmdBlitImage2KHRDelegate_0(VkCommandBuffer commandBuffer, VkBlitImageInfo2* pBlitImageInfo);
	private static IntPtr vkCmdBlitImage2KHRPointer;
	private static vkCmdBlitImage2KHRDelegate_0 vkCmdBlitImage2KHR_0;
	[Obsolete("Use vkCmdResolveImage2")]
	public static void vkCmdResolveImage2KHR(VkCommandBuffer commandBuffer, VkResolveImageInfo2* pResolveImageInfo) => vkCmdResolveImage2KHR_0(commandBuffer, pResolveImageInfo);
	private delegate void vkCmdResolveImage2KHRDelegate_0(VkCommandBuffer commandBuffer, VkResolveImageInfo2* pResolveImageInfo);
	private static IntPtr vkCmdResolveImage2KHRPointer;
	private static vkCmdResolveImage2KHRDelegate_0 vkCmdResolveImage2KHR_0;
	public static void vkGetImageSubresourceLayout2EXT(VkDevice device, VkImage image, VkImageSubresource2EXT* pSubresource, VkSubresourceLayout2EXT* pLayout) => vkGetImageSubresourceLayout2EXT_0(device, image, pSubresource, pLayout);
	private delegate void vkGetImageSubresourceLayout2EXTDelegate_0(VkDevice device, VkImage image, VkImageSubresource2EXT* pSubresource, VkSubresourceLayout2EXT* pLayout);
	private static IntPtr vkGetImageSubresourceLayout2EXTPointer;
	private static vkGetImageSubresourceLayout2EXTDelegate_0 vkGetImageSubresourceLayout2EXT_0;
	public static VkResult vkGetDeviceFaultInfoEXT(VkDevice device, VkDeviceFaultCountsEXT* pFaultCounts, VkDeviceFaultInfoEXT* pFaultInfo) => vkGetDeviceFaultInfoEXT_0(device, pFaultCounts, pFaultInfo);
	private delegate VkResult vkGetDeviceFaultInfoEXTDelegate_0(VkDevice device, VkDeviceFaultCountsEXT* pFaultCounts, VkDeviceFaultInfoEXT* pFaultInfo);
	private static IntPtr vkGetDeviceFaultInfoEXTPointer;
	private static vkGetDeviceFaultInfoEXTDelegate_0 vkGetDeviceFaultInfoEXT_0;
	...
	public static VkResult vkGetWinrtDisplayNV(VkPhysicalDevice physicalDevice, uint deviceRelativeId, VkDisplayKHR* pDisplay) => vkGetWinrtDisplayNV_0(physicalDevice, deviceRelativeId, pDisplay);
	private delegate VkResult vkGetWinrtDisplayNVDelegate_0(VkPhysicalDevice physicalDevice, uint deviceRelativeId, VkDisplayKHR* pDisplay);
	private static IntPtr vkGetWinrtDisplayNVPointer;
	private static vkGetWinrtDisplayNVDelegate_0 vkGetWinrtDisplayNV_0;
	public static void vkCmdSetVertexInputEXT(VkCommandBuffer commandBuffer, uint vertexBindingDescriptionCount, VkVertexInputBindingDescription2EXT* pVertexBindingDescriptions, uint vertexAttributeDescriptionCount, VkVertexInputAttributeDescription2EXT* pVertexAttributeDescriptions) => vkCmdSetVertexInputEXT_0(commandBuffer, vertexBindingDescriptionCount, pVertexBindingDescriptions, vertexAttributeDescriptionCount, pVertexAttributeDescriptions);
	private delegate void vkCmdSetVertexInputEXTDelegate_0(VkCommandBuffer commandBuffer, uint vertexBindingDescriptionCount, VkVertexInputBindingDescription2EXT* pVertexBindingDescriptions, uint vertexAttributeDescriptionCount, VkVertexInputAttributeDescription2EXT* pVertexAttributeDescriptions);
	...
	public static VkResult vkGetMemoryRemoteAddressNV(VkDevice device, VkMemoryGetRemoteAddressInfoNV* pMemoryGetRemoteAddressInfo, IntPtr* pAddress) => vkGetMemoryRemoteAddressNV_0(device, pMemoryGetRemoteAddressInfo, pAddress);
	private delegate VkResult vkGetMemoryRemoteAddressNVDelegate_0(VkDevice device, VkMemoryGetRemoteAddressInfoNV* pMemoryGetRemoteAddressInfo, IntPtr* pAddress);
	...
	public static VkResult vkGetPipelinePropertiesEXT(VkDevice device, VkPipelineInfoEXT* pPipelineInfo, VkBaseOutStructure* pPipelineProperties) => vkGetPipelinePropertiesEXT_0(device, pPipelineInfo, pPipelineProperties);
	private delegate VkResult vkGetPipelinePropertiesEXTDelegate_0(VkDevice device, VkPipelineInfoEXT* pPipelineInfo, VkBaseOutStructure* pPipelineProperties);
	private static IntPtr vkGetPipelinePropertiesEXTPointer;
	private static vkGetPipelinePropertiesEXTDelegate_0 vkGetPipelinePropertiesEXT_0;
	public static void vkCmdSetPatchControlPointsEXT(VkCommandBuffer commandBuffer, uint patchControlPoints) => vkCmdSetPatchControlPointsEXT_0(commandBuffer, patchControlPoints);
	private delegate void vkCmdSetPatchControlPointsEXTDelegate_0(VkCommandBuffer commandBuffer, uint patchControlPoints);
	...
	[Obsolete("Use vkCmdSetRasterizerDiscardEnable")]
	...
	[Obsolete("Use vkCmdSetDepthBiasEnable")]
	...
	[Obsolete("Use vkCmdSetPrimitiveRestartEnable")]
	...
	public static void vkCmdSetColorWriteEnableEXT(VkCommandBuffer commandBuffer, uint attachmentCount, VkBool32* pColorWriteEnables) => vkCmdSetColorWriteEnableEXT_0(commandBuffer, attachmentCount, pColorWriteEnables);
	private delegate void vkCmdSetColorWriteEnableEXTDelegate_0(VkCommandBuffer commandBuffer, uint attachmentCount, VkBool32* pColorWriteEnables);
	...
	public static void vkCmdTraceRaysIndirect2KHR(VkCommandBuffer commandBuffer, VkDeviceAddress indirectDeviceAddress) => vkCmdTraceRaysIndirect2KHR_0(commandBuffer, indirectDeviceAddress);
	private delegate void vkCmdTraceRaysIndirect2KHRDelegate_0(VkCommandBuffer commandBuffer, VkDeviceAddress indirectDeviceAddress);
	private static IntPtr vkCmdTraceRaysIndirect2KHRPointer;
	private static vkCmdTraceRaysIndirect2KHRDelegate_0 vkCmdTraceRaysIndirect2KHR_0;
	public static void vkCmdDrawMultiEXT(VkCommandBuffer commandBuffer, uint drawCount, VkMultiDrawInfoEXT* pVertexInfo, uint instanceCount, uint firstInstance, uint stride) => vkCmdDrawMultiEXT_0(commandBuffer, drawCount, pVertexInfo, instanceCount, firstInstance, stride);
	private delegate void vkCmdDrawMultiEXTDelegate_0(VkCommandBuffer commandBuffer, uint drawCount, VkMultiDrawInfoEXT* pVertexInfo, uint instanceCount, uint firstInstance, uint stride);
	private static IntPtr vkCmdDrawMultiEXTPointer;
	private static vkCmdDrawMultiEXTDelegate_0 vkCmdDrawMultiEXT_0;
	public static void vkCmdDrawMultiIndexedEXT(VkCommandBuffer commandBuffer, uint drawCount, VkMultiDrawIndexedInfoEXT* pIndexInfo, uint instanceCount, uint firstInstance, uint stride, int* pVertexOffset) => vkCmdDrawMultiIndexedEXT_0(commandBuffer, drawCount, pIndexInfo, instanceCount, firstInstance, stride, pVertexOffset);
	private delegate void vkCmdDrawMultiIndexedEXTDelegate_0(VkCommandBuffer commandBuffer, uint drawCount, VkMultiDrawIndexedInfoEXT* pIndexInfo, uint instanceCount, uint firstInstance, uint stride, int* pVertexOffset);
	...
	public static VkResult vkCreateMicromapEXT(VkDevice device, VkMicromapCreateInfoEXT* pCreateInfo, VkAllocationCallbacks* pAllocator, VkMicromapEXT* pMicromap) => vkCreateMicromapEXT_0(device, pCreateInfo, pAllocator, pMicromap);
	private delegate VkResult vkCreateMicromapEXTDelegate_0(VkDevice device, VkMicromapCreateInfoEXT* pCreateInfo, VkAllocationCallbacks* pAllocator, VkMicromapEXT* pMicromap);
	private static IntPtr vkCreateMicromapEXTPointer;
	private static vkCreateMicromapEXTDelegate_0 vkCreateMicromapEXT_0;
	public static void vkDestroyMicromapEXT(VkDevice device, VkMicromapEXT micromap, VkAllocationCallbacks* pAllocator) => vkDestroyMicromapEXT_0(device, micromap, pAllocator);
	private delegate void vkDestroyMicromapEXTDelegate_0(VkDevice device, VkMicromapEXT micromap, VkAllocationCallbacks* pAllocator);
	private static IntPtr vkDestroyMicromapEXTPointer;
	private static vkDestroyMicromapEXTDelegate_0 vkDestroyMicromapEXT_0;
	public static void vkCmdBuildMicromapsEXT(VkCommandBuffer commandBuffer, uint infoCount, VkMicromapBuildInfoEXT* pInfos) => vkCmdBuildMicromapsEXT_0(commandBuffer, infoCount, pInfos);
	private delegate void vkCmdBuildMicromapsEXTDelegate_0(VkCommandBuffer commandBuffer, uint infoCount, VkMicromapBuildInfoEXT* pInfos);
	private static IntPtr vkCmdBuildMicromapsEXTPointer;
	private static vkCmdBuildMicromapsEXTDelegate_0 vkCmdBuildMicromapsEXT_0;
	public static VkResult vkBuildMicromapsEXT(VkDevice device, VkDeferredOperationKHR deferredOperation, uint infoCount, VkMicromapBuildInfoEXT* pInfos) => vkBuildMicromapsEXT_0(device, deferredOperation, infoCount, pInfos);
	private delegate VkResult vkBuildMicromapsEXTDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, uint infoCount, VkMicromapBuildInfoEXT* pInfos);
	private static IntPtr vkBuildMicromapsEXTPointer;
	private static vkBuildMicromapsEXTDelegate_0 vkBuildMicromapsEXT_0;
	public static VkResult vkCopyMicromapEXT(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyMicromapInfoEXT* pInfo) => vkCopyMicromapEXT_0(device, deferredOperation, pInfo);
	private delegate VkResult vkCopyMicromapEXTDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyMicromapInfoEXT* pInfo);
	private static IntPtr vkCopyMicromapEXTPointer;
	private static vkCopyMicromapEXTDelegate_0 vkCopyMicromapEXT_0;
	public static VkResult vkCopyMicromapToMemoryEXT(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyMicromapToMemoryInfoEXT* pInfo) => vkCopyMicromapToMemoryEXT_0(device, deferredOperation, pInfo);
	private delegate VkResult vkCopyMicromapToMemoryEXTDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyMicromapToMemoryInfoEXT* pInfo);
	private static IntPtr vkCopyMicromapToMemoryEXTPointer;
	private static vkCopyMicromapToMemoryEXTDelegate_0 vkCopyMicromapToMemoryEXT_0;
	public static VkResult vkCopyMemoryToMicromapEXT(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyMemoryToMicromapInfoEXT* pInfo) => vkCopyMemoryToMicromapEXT_0(device, deferredOperation, pInfo);
	private delegate VkResult vkCopyMemoryToMicromapEXTDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyMemoryToMicromapInfoEXT* pInfo);
	private static IntPtr vkCopyMemoryToMicromapEXTPointer;
	private static vkCopyMemoryToMicromapEXTDelegate_0 vkCopyMemoryToMicromapEXT_0;
	public static VkResult vkWriteMicromapsPropertiesEXT(VkDevice device, uint micromapCount, VkMicromapEXT* pMicromaps, VkQueryType queryType, nuint dataSize, void* pData, nuint stride) => vkWriteMicromapsPropertiesEXT_0(device, micromapCount, pMicromaps, queryType, dataSize, pData, stride);
	private delegate VkResult vkWriteMicromapsPropertiesEXTDelegate_0(VkDevice device, uint micromapCount, VkMicromapEXT* pMicromaps, VkQueryType queryType, nuint dataSize, void* pData, nuint stride);
	private static IntPtr vkWriteMicromapsPropertiesEXTPointer;
	private static vkWriteMicromapsPropertiesEXTDelegate_0 vkWriteMicromapsPropertiesEXT_0;
	public static void vkCmdCopyMicromapEXT(VkCommandBuffer commandBuffer, VkCopyMicromapInfoEXT* pInfo) => vkCmdCopyMicromapEXT_0(commandBuffer, pInfo);
	private delegate void vkCmdCopyMicromapEXTDelegate_0(VkCommandBuffer commandBuffer, VkCopyMicromapInfoEXT* pInfo);
	private static IntPtr vkCmdCopyMicromapEXTPointer;
	private static vkCmdCopyMicromapEXTDelegate_0 vkCmdCopyMicromapEXT_0;
	public static void vkCmdCopyMicromapToMemoryEXT(VkCommandBuffer commandBuffer, VkCopyMicromapToMemoryInfoEXT* pInfo) => vkCmdCopyMicromapToMemoryEXT_0(commandBuffer, pInfo);
	private delegate void vkCmdCopyMicromapToMemoryEXTDelegate_0(VkCommandBuffer commandBuffer, VkCopyMicromapToMemoryInfoEXT* pInfo);
	private static IntPtr vkCmdCopyMicromapToMemoryEXTPointer;
	private static vkCmdCopyMicromapToMemoryEXTDelegate_0 vkCmdCopyMicromapToMemoryEXT_0;
	public static void vkCmdCopyMemoryToMicromapEXT(VkCommandBuffer commandBuffer, VkCopyMemoryToMicromapInfoEXT* pInfo) => vkCmdCopyMemoryToMicromapEXT_0(commandBuffer, pInfo);
	private delegate void vkCmdCopyMemoryToMicromapEXTDelegate_0(VkCommandBuffer commandBuffer, VkCopyMemoryToMicromapInfoEXT* pInfo);
	private static IntPtr vkCmdCopyMemoryToMicromapEXTPointer;
	private static vkCmdCopyMemoryToMicromapEXTDelegate_0 vkCmdCopyMemoryToMicromapEXT_0;
	public static void vkCmdWriteMicromapsPropertiesEXT(VkCommandBuffer commandBuffer, uint micromapCount, VkMicromapEXT* pMicromaps, VkQueryType queryType, VkQueryPool queryPool, uint firstQuery) => vkCmdWriteMicromapsPropertiesEXT_0(commandBuffer, micromapCount, pMicromaps, queryType, queryPool, firstQuery);
	private delegate void vkCmdWriteMicromapsPropertiesEXTDelegate_0(VkCommandBuffer commandBuffer, uint micromapCount, VkMicromapEXT* pMicromaps, VkQueryType queryType, VkQueryPool queryPool, uint firstQuery);
	private static IntPtr vkCmdWriteMicromapsPropertiesEXTPointer;
	private static vkCmdWriteMicromapsPropertiesEXTDelegate_0 vkCmdWriteMicromapsPropertiesEXT_0;
	public static void vkGetDeviceMicromapCompatibilityEXT(VkDevice device, VkMicromapVersionInfoEXT* pVersionInfo, VkAccelerationStructureCompatibilityKHR* pCompatibility) => vkGetDeviceMicromapCompatibilityEXT_0(device, pVersionInfo, pCompatibility);
	private delegate void vkGetDeviceMicromapCompatibilityEXTDelegate_0(VkDevice device, VkMicromapVersionInfoEXT* pVersionInfo, VkAccelerationStructureCompatibilityKHR* pCompatibility);
	private static IntPtr vkGetDeviceMicromapCompatibilityEXTPointer;
	private static vkGetDeviceMicromapCompatibilityEXTDelegate_0 vkGetDeviceMicromapCompatibilityEXT_0;
	public static void vkGetMicromapBuildSizesEXT(VkDevice device, VkAccelerationStructureBuildTypeKHR buildType, VkMicromapBuildInfoEXT* pBuildInfo, VkMicromapBuildSizesInfoEXT* pSizeInfo) => vkGetMicromapBuildSizesEXT_0(device, buildType, pBuildInfo, pSizeInfo);
	private delegate void vkGetMicromapBuildSizesEXTDelegate_0(VkDevice device, VkAccelerationStructureBuildTypeKHR buildType, VkMicromapBuildInfoEXT* pBuildInfo, VkMicromapBuildSizesInfoEXT* pSizeInfo);
	private static IntPtr vkGetMicromapBuildSizesEXTPointer;
	private static vkGetMicromapBuildSizesEXTDelegate_0 vkGetMicromapBuildSizesEXT_0;
	public static void vkCmdDrawClusterHUAWEI(VkCommandBuffer commandBuffer, uint groupCountX, uint groupCountY, uint groupCountZ) => vkCmdDrawClusterHUAWEI_0(commandBuffer, groupCountX, groupCountY, groupCountZ);
	private delegate void vkCmdDrawClusterHUAWEIDelegate_0(VkCommandBuffer commandBuffer, uint groupCountX, uint groupCountY, uint groupCountZ);
	private static IntPtr vkCmdDrawClusterHUAWEIPointer;
	private static vkCmdDrawClusterHUAWEIDelegate_0 vkCmdDrawClusterHUAWEI_0;
	public static void vkCmdDrawClusterIndirectHUAWEI(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset) => vkCmdDrawClusterIndirectHUAWEI_0(commandBuffer, buffer, offset);
	private delegate void vkCmdDrawClusterIndirectHUAWEIDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset);
	private static IntPtr vkCmdDrawClusterIndirectHUAWEIPointer;
	private static vkCmdDrawClusterIndirectHUAWEIDelegate_0 vkCmdDrawClusterIndirectHUAWEI_0;
	...
	[Obsolete("Use vkGetDeviceBufferMemoryRequirements")]
	public static void vkGetDeviceBufferMemoryRequirementsKHR(VkDevice device, VkDeviceBufferMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements) => vkGetDeviceBufferMemoryRequirementsKHR_0(device, pInfo, pMemoryRequirements);
	private delegate void vkGetDeviceBufferMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceBufferMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements);
	...
	[Obsolete("Use vkGetDeviceImageMemoryRequirements")]
	public static void vkGetDeviceImageMemoryRequirementsKHR(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements) => vkGetDeviceImageMemoryRequirementsKHR_0(device, pInfo, pMemoryRequirements);
	private delegate void vkGetDeviceImageMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements);
	...
	[Obsolete("Use vkGetDeviceImageSparseMemoryRequirements")]
	public static void vkGetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements) => vkGetDeviceImageSparseMemoryRequirementsKHR_0(device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
	private delegate void vkGetDeviceImageSparseMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements);
	...
	public static void vkGetDescriptorSetLayoutHostMappingInfoVALVE(VkDevice device, VkDescriptorSetBindingReferenceVALVE* pBindingReference, VkDescriptorSetLayoutHostMappingInfoVALVE* pHostMapping) => vkGetDescriptorSetLayoutHostMappingInfoVALVE_0(device, pBindingReference, pHostMapping);
	private delegate void vkGetDescriptorSetLayoutHostMappingInfoVALVEDelegate_0(VkDevice device, VkDescriptorSetBindingReferenceVALVE* pBindingReference, VkDescriptorSetLayoutHostMappingInfoVALVE* pHostMapping);
	private static IntPtr vkGetDescriptorSetLayoutHostMappingInfoVALVEPointer;
	private static vkGetDescriptorSetLayoutHostMappingInfoVALVEDelegate_0 vkGetDescriptorSetLayoutHostMappingInfoVALVE_0;
	public static void vkGetDescriptorSetHostMappingVALVE(VkDevice device, VkDescriptorSet descriptorSet, void** ppData) => vkGetDescriptorSetHostMappingVALVE_0(device, descriptorSet, ppData);
	private delegate void vkGetDescriptorSetHostMappingVALVEDelegate_0(VkDevice device, VkDescriptorSet descriptorSet, void** ppData);
	private static IntPtr vkGetDescriptorSetHostMappingVALVEPointer;
	private static vkGetDescriptorSetHostMappingVALVEDelegate_0 vkGetDescriptorSetHostMappingVALVE_0;
	public static void vkCmdCopyMemoryIndirectNV(VkCommandBuffer commandBuffer, VkDeviceAddress copyBufferAddress, uint copyCount, uint stride) => vkCmdCopyMemoryIndirectNV_0(commandBuffer, copyBufferAddress, copyCount, stride);
	private delegate void vkCmdCopyMemoryIndirectNVDelegate_0(VkCommandBuffer commandBuffer, VkDeviceAddress copyBufferAddress, uint copyCount, uint stride);
	private static IntPtr vkCmdCopyMemoryIndirectNVPointer;
	private static vkCmdCopyMemoryIndirectNVDelegate_0 vkCmdCopyMemoryIndirectNV_0;
	public static void vkCmdCopyMemoryToImageIndirectNV(VkCommandBuffer commandBuffer, VkDeviceAddress copyBufferAddress, uint copyCount, uint stride, VkImage dstImage, VkImageLayout dstImageLayout, VkImageSubresourceLayers* pImageSubresources) => vkCmdCopyMemoryToImageIndirectNV_0(commandBuffer, copyBufferAddress, copyCount, stride, dstImage, dstImageLayout, pImageSubresources);
	private delegate void vkCmdCopyMemoryToImageIndirectNVDelegate_0(VkCommandBuffer commandBuffer, VkDeviceAddress copyBufferAddress, uint copyCount, uint stride, VkImage dstImage, VkImageLayout dstImageLayout, VkImageSubresourceLayers* pImageSubresources);
	private static IntPtr vkCmdCopyMemoryToImageIndirectNVPointer;
	private static vkCmdCopyMemoryToImageIndirectNVDelegate_0 vkCmdCopyMemoryToImageIndirectNV_0;
	public static void vkCmdDecompressMemoryNV(VkCommandBuffer commandBuffer, uint decompressRegionCount, VkDecompressMemoryRegionNV* pDecompressMemoryRegions) => vkCmdDecompressMemoryNV_0(commandBuffer, decompressRegionCount, pDecompressMemoryRegions);
	private delegate void vkCmdDecompressMemoryNVDelegate_0(VkCommandBuffer commandBuffer, uint decompressRegionCount, VkDecompressMemoryRegionNV* pDecompressMemoryRegions);
	private static IntPtr vkCmdDecompressMemoryNVPointer;
	private static vkCmdDecompressMemoryNVDelegate_0 vkCmdDecompressMemoryNV_0;
	public static void vkCmdDecompressMemoryIndirectCountNV(VkCommandBuffer commandBuffer, VkDeviceAddress indirectCommandsAddress, VkDeviceAddress indirectCommandsCountAddress, uint stride) => vkCmdDecompressMemoryIndirectCountNV_0(commandBuffer, indirectCommandsAddress, indirectCommandsCountAddress, stride);
	private delegate void vkCmdDecompressMemoryIndirectCountNVDelegate_0(VkCommandBuffer commandBuffer, VkDeviceAddress indirectCommandsAddress, VkDeviceAddress indirectCommandsCountAddress, uint stride);
	private static IntPtr vkCmdDecompressMemoryIndirectCountNVPointer;
	private static vkCmdDecompressMemoryIndirectCountNVDelegate_0 vkCmdDecompressMemoryIndirectCountNV_0;
	public static void vkCmdSetTessellationDomainOriginEXT(VkCommandBuffer commandBuffer, VkTessellationDomainOrigin domainOrigin) => vkCmdSetTessellationDomainOriginEXT_0(commandBuffer, domainOrigin);
	private delegate void vkCmdSetTessellationDomainOriginEXTDelegate_0(VkCommandBuffer commandBuffer, VkTessellationDomainOrigin domainOrigin);
	private static IntPtr vkCmdSetTessellationDomainOriginEXTPointer;
	private static vkCmdSetTessellationDomainOriginEXTDelegate_0 vkCmdSetTessellationDomainOriginEXT_0;
	public static void vkCmdSetDepthClampEnableEXT(VkCommandBuffer commandBuffer, VkBool32 depthClampEnable) => vkCmdSetDepthClampEnableEXT_0(commandBuffer, depthClampEnable);
	private delegate void vkCmdSetDepthClampEnableEXTDelegate_0(VkCommandBuffer commandBuffer, VkBool32 depthClampEnable);
	private static IntPtr vkCmdSetDepthClampEnableEXTPointer;
	private static vkCmdSetDepthClampEnableEXTDelegate_0 vkCmdSetDepthClampEnableEXT_0;
	public static void vkCmdSetPolygonModeEXT(VkCommandBuffer commandBuffer, VkPolygonMode polygonMode) => vkCmdSetPolygonModeEXT_0(commandBuffer, polygonMode);
	private delegate void vkCmdSetPolygonModeEXTDelegate_0(VkCommandBuffer commandBuffer, VkPolygonMode polygonMode);
	private static IntPtr vkCmdSetPolygonModeEXTPointer;
	private static vkCmdSetPolygonModeEXTDelegate_0 vkCmdSetPolygonModeEXT_0;
	public static void vkCmdSetRasterizationSamplesEXT(VkCommandBuffer commandBuffer, VkSampleCountFlagBits rasterizationSamples) => vkCmdSetRasterizationSamplesEXT_0(commandBuffer, rasterizationSamples);
	...
	private delegate void vkCmdSetAlphaToCoverageEnableEXTDelegate_0(VkCommandBuffer commandBuffer, VkBool32 alphaToCoverageEnable);
	private static IntPtr vkCmdSetAlphaToCoverageEnableEXTPointer;
	private static vkCmdSetAlphaToCoverageEnableEXTDelegate_0 vkCmdSetAlphaToCoverageEnableEXT_0;
	public static void vkCmdSetAlphaToOneEnableEXT(VkCommandBuffer commandBuffer, VkBool32 alphaToOneEnable) => vkCmdSetAlphaToOneEnableEXT_0(commandBuffer, alphaToOneEnable);
	private delegate void vkCmdSetAlphaToOneEnableEXTDelegate_0(VkCommandBuffer commandBuffer, VkBool32 alphaToOneEnable);
	private static IntPtr vkCmdSetAlphaToOneEnableEXTPointer;
	private static vkCmdSetAlphaToOneEnableEXTDelegate_0 vkCmdSetAlphaToOneEnableEXT_0;
	public static void vkCmdSetLogicOpEnableEXT(VkCommandBuffer commandBuffer, VkBool32 logicOpEnable) => vkCmdSetLogicOpEnableEXT_0(commandBuffer, logicOpEnable);
	private delegate void vkCmdSetLogicOpEnableEXTDelegate_0(VkCommandBuffer commandBuffer, VkBool32 logicOpEnable);
	private static IntPtr vkCmdSetLogicOpEnableEXTPointer;
	private static vkCmdSetLogicOpEnableEXTDelegate_0 vkCmdSetLogicOpEnableEXT_0;
	public static void vkCmdSetColorBlendEnableEXT(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkBool32* pColorBlendEnables) => vkCmdSetColorBlendEnableEXT_0(commandBuffer, firstAttachment, attachmentCount, pColorBlendEnables);
	private delegate void vkCmdSetColorBlendEnableEXTDelegate_0(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkBool32* pColorBlendEnables);
	private static IntPtr vkCmdSetColorBlendEnableEXTPointer;
	private static vkCmdSetColorBlendEnableEXTDelegate_0 vkCmdSetColorBlendEnableEXT_0;
	public static void vkCmdSetColorBlendEquationEXT(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkColorBlendEquationEXT* pColorBlendEquations) => vkCmdSetColorBlendEquationEXT_0(commandBuffer, firstAttachment, attachmentCount, pColorBlendEquations);
	private delegate void vkCmdSetColorBlendEquationEXTDelegate_0(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkColorBlendEquationEXT* pColorBlendEquations);
	private static IntPtr vkCmdSetColorBlendEquationEXTPointer;
	private static vkCmdSetColorBlendEquationEXTDelegate_0 vkCmdSetColorBlendEquationEXT_0;
	public static void vkCmdSetColorWriteMaskEXT(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkColorComponentFlags* pColorWriteMasks) => vkCmdSetColorWriteMaskEXT_0(commandBuffer, firstAttachment, attachmentCount, pColorWriteMasks);
	private delegate void vkCmdSetColorWriteMaskEXTDelegate_0(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkColorComponentFlags* pColorWriteMasks);
	private static IntPtr vkCmdSetColorWriteMaskEXTPointer;
	private static vkCmdSetColorWriteMaskEXTDelegate_0 vkCmdSetColorWriteMaskEXT_0;
	public static void vkCmdSetRasterizationStreamEXT(VkCommandBuffer commandBuffer, uint rasterizationStream) => vkCmdSetRasterizationStreamEXT_0(commandBuffer, rasterizationStream);
	private delegate void vkCmdSetRasterizationStreamEXTDelegate_0(VkCommandBuffer commandBuffer, uint rasterizationStream);
	private static IntPtr vkCmdSetRasterizationStreamEXTPointer;
	private static vkCmdSetRasterizationStreamEXTDelegate_0 vkCmdSetRasterizationStreamEXT_0;
	public static void vkCmdSetConservativeRasterizationModeEXT(VkCommandBuffer commandBuffer, VkConservativeRasterizationModeEXT conservativeRasterizationMode) => vkCmdSetConservativeRasterizationModeEXT_0(commandBuffer, conservativeRasterizationMode);
	private delegate void vkCmdSetConservativeRasterizationModeEXTDelegate_0(VkCommandBuffer commandBuffer, VkConservativeRasterizationModeEXT conservativeRasterizationMode);
	private static IntPtr vkCmdSetConservativeRasterizationModeEXTPointer;
	private static vkCmdSetConservativeRasterizationModeEXTDelegate_0 vkCmdSetConservativeRasterizationModeEXT_0;
	public static void vkCmdSetExtraPrimitiveOverestimationSizeEXT(VkCommandBuffer commandBuffer, float extraPrimitiveOverestimationSize) => vkCmdSetExtraPrimitiveOverestimationSizeEXT_0(commandBuffer, extraPrimitiveOverestimationSize);
	private delegate void vkCmdSetExtraPrimitiveOverestimationSizeEXTDelegate_0(VkCommandBuffer commandBuffer, float extraPrimitiveOverestimationSize);
	private static IntPtr vkCmdSetExtraPrimitiveOverestimationSizeEXTPointer;
	private static vkCmdSetExtraPrimitiveOverestimationSizeEXTDelegate_0 vkCmdSetExtraPrimitiveOverestimationSizeEXT_0;
	public static void vkCmdSetDepthClipEnableEXT(VkCommandBuffer commandBuffer, VkBool32 depthClipEnable) => vkCmdSetDepthClipEnableEXT_0(commandBuffer, depthClipEnable);
	private delegate void vkCmdSetDepthClipEnableEXTDelegate_0(VkCommandBuffer commandBuffer, VkBool32 depthClipEnable);
	private static IntPtr vkCmdSetDepthClipEnableEXTPointer;
	private static vkCmdSetDepthClipEnableEXTDelegate_0 vkCmdSetDepthClipEnableEXT_0;
	public static void vkCmdSetSampleLocationsEnableEXT(VkCommandBuffer commandBuffer, VkBool32 sampleLocationsEnable) => vkCmdSetSampleLocationsEnableEXT_0(commandBuffer, sampleLocationsEnable);
	private delegate void vkCmdSetSampleLocationsEnableEXTDelegate_0(VkCommandBuffer commandBuffer, VkBool32 sampleLocationsEnable);
	private static IntPtr vkCmdSetSampleLocationsEnableEXTPointer;
	private static vkCmdSetSampleLocationsEnableEXTDelegate_0 vkCmdSetSampleLocationsEnableEXT_0;
	public static void vkCmdSetColorBlendAdvancedEXT(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkColorBlendAdvancedEXT* pColorBlendAdvanced) => vkCmdSetColorBlendAdvancedEXT_0(commandBuffer, firstAttachment, attachmentCount, pColorBlendAdvanced);
	private delegate void vkCmdSetColorBlendAdvancedEXTDelegate_0(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkColorBlendAdvancedEXT* pColorBlendAdvanced);
	private static IntPtr vkCmdSetColorBlendAdvancedEXTPointer;
	private static vkCmdSetColorBlendAdvancedEXTDelegate_0 vkCmdSetColorBlendAdvancedEXT_0;
	public static void vkCmdSetProvokingVertexModeEXT(VkCommandBuffer commandBuffer, VkProvokingVertexModeEXT provokingVertexMode) => vkCmdSetProvokingVertexModeEXT_0(commandBuffer, provokingVertexMode);
	private delegate void vkCmdSetProvokingVertexModeEXTDelegate_0(VkCommandBuffer commandBuffer, VkProvokingVertexModeEXT provokingVertexMode);
	private static IntPtr vkCmdSetProvokingVertexModeEXTPointer;
	private static vkCmdSetProvokingVertexModeEXTDelegate_0 vkCmdSetProvokingVertexModeEXT_0;
	public static void vkCmdSetLineRasterizationModeEXT(VkCommandBuffer commandBuffer, VkLineRasterizationModeEXT lineRasterizationMode) => vkCmdSetLineRasterizationModeEXT_0(commandBuffer, lineRasterizationMode);
	private delegate void vkCmdSetLineRasterizationModeEXTDelegate_0(VkCommandBuffer commandBuffer, VkLineRasterizationModeEXT lineRasterizationMode);
	private static IntPtr vkCmdSetLineRasterizationModeEXTPointer;
	private static vkCmdSetLineRasterizationModeEXTDelegate_0 vkCmdSetLineRasterizationModeEXT_0;
	public static void vkCmdSetLineStippleEnableEXT(VkCommandBuffer commandBuffer, VkBool32 stippledLineEnable) => vkCmdSetLineStippleEnableEXT_0(commandBuffer, stippledLineEnable);
	private delegate void vkCmdSetLineStippleEnableEXTDelegate_0(VkCommandBuffer commandBuffer, VkBool32 stippledLineEnable);
	private static IntPtr vkCmdSetLineStippleEnableEXTPointer;
	private static vkCmdSetLineStippleEnableEXTDelegate_0 vkCmdSetLineStippleEnableEXT_0;
	public static void vkCmdSetDepthClipNegativeOneToOneEXT(VkCommandBuffer commandBuffer, VkBool32 negativeOneToOne) => vkCmdSetDepthClipNegativeOneToOneEXT_0(commandBuffer, negativeOneToOne);
	private delegate void vkCmdSetDepthClipNegativeOneToOneEXTDelegate_0(VkCommandBuffer commandBuffer, VkBool32 negativeOneToOne);
	private static IntPtr vkCmdSetDepthClipNegativeOneToOneEXTPointer;
	private static vkCmdSetDepthClipNegativeOneToOneEXTDelegate_0 vkCmdSetDepthClipNegativeOneToOneEXT_0;
	public static void vkCmdSetViewportWScalingEnableNV(VkCommandBuffer commandBuffer, VkBool32 viewportWScalingEnable) => vkCmdSetViewportWScalingEnableNV_0(commandBuffer, viewportWScalingEnable);
	private delegate void vkCmdSetViewportWScalingEnableNVDelegate_0(VkCommandBuffer commandBuffer, VkBool32 viewportWScalingEnable);
	private static IntPtr vkCmdSetViewportWScalingEnableNVPointer;
	private static vkCmdSetViewportWScalingEnableNVDelegate_0 vkCmdSetViewportWScalingEnableNV_0;
	public static void vkCmdSetViewportSwizzleNV(VkCommandBuffer commandBuffer, uint firstViewport, uint viewportCount, VkViewportSwizzleNV* pViewportSwizzles) => vkCmdSetViewportSwizzleNV_0(commandBuffer, firstViewport, viewportCount, pViewportSwizzles);
	private delegate void vkCmdSetViewportSwizzleNVDelegate_0(VkCommandBuffer commandBuffer, uint firstViewport, uint viewportCount, VkViewportSwizzleNV* pViewportSwizzles);
	private static IntPtr vkCmdSetViewportSwizzleNVPointer;
	private static vkCmdSetViewportSwizzleNVDelegate_0 vkCmdSetViewportSwizzleNV_0;
	public static void vkCmdSetCoverageToColorEnableNV(VkCommandBuffer commandBuffer, VkBool32 coverageToColorEnable) => vkCmdSetCoverageToColorEnableNV_0(commandBuffer, coverageToColorEnable);
	private delegate void vkCmdSetCoverageToColorEnableNVDelegate_0(VkCommandBuffer commandBuffer, VkBool32 coverageToColorEnable);
	private static IntPtr vkCmdSetCoverageToColorEnableNVPointer;
	private static vkCmdSetCoverageToColorEnableNVDelegate_0 vkCmdSetCoverageToColorEnableNV_0;
	public static void vkCmdSetCoverageToColorLocationNV(VkCommandBuffer commandBuffer, uint coverageToColorLocation) => vkCmdSetCoverageToColorLocationNV_0(commandBuffer, coverageToColorLocation);
	private delegate void vkCmdSetCoverageToColorLocationNVDelegate_0(VkCommandBuffer commandBuffer, uint coverageToColorLocation);
	private static IntPtr vkCmdSetCoverageToColorLocationNVPointer;
	private static vkCmdSetCoverageToColorLocationNVDelegate_0 vkCmdSetCoverageToColorLocationNV_0;
	public static void vkCmdSetCoverageModulationModeNV(VkCommandBuffer commandBuffer, VkCoverageModulationModeNV coverageModulationMode) => vkCmdSetCoverageModulationModeNV_0(commandBuffer, coverageModulationMode);
	private delegate void vkCmdSetCoverageModulationModeNVDelegate_0(VkCommandBuffer commandBuffer, VkCoverageModulationModeNV coverageModulationMode);
	private static IntPtr vkCmdSetCoverageModulationModeNVPointer;
	private static vkCmdSetCoverageModulationModeNVDelegate_0 vkCmdSetCoverageModulationModeNV_0;
	public static void vkCmdSetCoverageModulationTableEnableNV(VkCommandBuffer commandBuffer, VkBool32 coverageModulationTableEnable) => vkCmdSetCoverageModulationTableEnableNV_0(commandBuffer, coverageModulationTableEnable);
	private delegate void vkCmdSetCoverageModulationTableEnableNVDelegate_0(VkCommandBuffer commandBuffer, VkBool32 coverageModulationTableEnable);
	private static IntPtr vkCmdSetCoverageModulationTableEnableNVPointer;
	private static vkCmdSetCoverageModulationTableEnableNVDelegate_0 vkCmdSetCoverageModulationTableEnableNV_0;
	public static void vkCmdSetCoverageModulationTableNV(VkCommandBuffer commandBuffer, uint coverageModulationTableCount, float* pCoverageModulationTable) => vkCmdSetCoverageModulationTableNV_0(commandBuffer, coverageModulationTableCount, pCoverageModulationTable);
	private delegate void vkCmdSetCoverageModulationTableNVDelegate_0(VkCommandBuffer commandBuffer, uint coverageModulationTableCount, float* pCoverageModulationTable);
	private static IntPtr vkCmdSetCoverageModulationTableNVPointer;
	private static vkCmdSetCoverageModulationTableNVDelegate_0 vkCmdSetCoverageModulationTableNV_0;
	public static void vkCmdSetShadingRateImageEnableNV(VkCommandBuffer commandBuffer, VkBool32 shadingRateImageEnable) => vkCmdSetShadingRateImageEnableNV_0(commandBuffer, shadingRateImageEnable);
	private delegate void vkCmdSetShadingRateImageEnableNVDelegate_0(VkCommandBuffer commandBuffer, VkBool32 shadingRateImageEnable);
	private static IntPtr vkCmdSetShadingRateImageEnableNVPointer;
	private static vkCmdSetShadingRateImageEnableNVDelegate_0 vkCmdSetShadingRateImageEnableNV_0;
	public static void vkCmdSetRepresentativeFragmentTestEnableNV(VkCommandBuffer commandBuffer, VkBool32 representativeFragmentTestEnable) => vkCmdSetRepresentativeFragmentTestEnableNV_0(commandBuffer, representativeFragmentTestEnable);
	private delegate void vkCmdSetRepresentativeFragmentTestEnableNVDelegate_0(VkCommandBuffer commandBuffer, VkBool32 representativeFragmentTestEnable);
	private static IntPtr vkCmdSetRepresentativeFragmentTestEnableNVPointer;
	private static vkCmdSetRepresentativeFragmentTestEnableNVDelegate_0 vkCmdSetRepresentativeFragmentTestEnableNV_0;
	public static void vkCmdSetCoverageReductionModeNV(VkCommandBuffer commandBuffer, VkCoverageReductionModeNV coverageReductionMode) => vkCmdSetCoverageReductionModeNV_0(commandBuffer, coverageReductionMode);
	private delegate void vkCmdSetCoverageReductionModeNVDelegate_0(VkCommandBuffer commandBuffer, VkCoverageReductionModeNV coverageReductionMode);
	private static IntPtr vkCmdSetCoverageReductionModeNVPointer;
	private static vkCmdSetCoverageReductionModeNVDelegate_0 vkCmdSetCoverageReductionModeNV_0;
	public static void vkGetShaderModuleIdentifierEXT(VkDevice device, VkShaderModule shaderModule, VkShaderModuleIdentifierEXT* pIdentifier) => vkGetShaderModuleIdentifierEXT_0(device, shaderModule, pIdentifier);
	private delegate void vkGetShaderModuleIdentifierEXTDelegate_0(VkDevice device, VkShaderModule shaderModule, VkShaderModuleIdentifierEXT* pIdentifier);
	private static IntPtr vkGetShaderModuleIdentifierEXTPointer;
	private static vkGetShaderModuleIdentifierEXTDelegate_0 vkGetShaderModuleIdentifierEXT_0;
	public static void vkGetShaderModuleCreateInfoIdentifierEXT(VkDevice device, VkShaderModuleCreateInfo* pCreateInfo, VkShaderModuleIdentifierEXT* pIdentifier) => vkGetShaderModuleCreateInfoIdentifierEXT_0(device, pCreateInfo, pIdentifier);
	private delegate void vkGetShaderModuleCreateInfoIdentifierEXTDelegate_0(VkDevice device, VkShaderModuleCreateInfo* pCreateInfo, VkShaderModuleIdentifierEXT* pIdentifier);
	private static IntPtr vkGetShaderModuleCreateInfoIdentifierEXTPointer;
	private static vkGetShaderModuleCreateInfoIdentifierEXTDelegate_0 vkGetShaderModuleCreateInfoIdentifierEXT_0;
	public static VkResult vkGetPhysicalDeviceOpticalFlowImageFormatsNV(VkPhysicalDevice physicalDevice, VkOpticalFlowImageFormatInfoNV* pOpticalFlowImageFormatInfo, uint* pFormatCount, VkOpticalFlowImageFormatPropertiesNV* pImageFormatProperties) => vkGetPhysicalDeviceOpticalFlowImageFormatsNV_0(physicalDevice, pOpticalFlowImageFormatInfo, pFormatCount, pImageFormatProperties);
	private delegate VkResult vkGetPhysicalDeviceOpticalFlowImageFormatsNVDelegate_0(VkPhysicalDevice physicalDevice, VkOpticalFlowImageFormatInfoNV* pOpticalFlowImageFormatInfo, uint* pFormatCount, VkOpticalFlowImageFormatPropertiesNV* pImageFormatProperties);
	private static IntPtr vkGetPhysicalDeviceOpticalFlowImageFormatsNVPointer;
	private static vkGetPhysicalDeviceOpticalFlowImageFormatsNVDelegate_0 vkGetPhysicalDeviceOpticalFlowImageFormatsNV_0;
	public static VkResult vkCreateOpticalFlowSessionNV(VkDevice device, VkOpticalFlowSessionCreateInfoNV* pCreateInfo, VkAllocationCallbacks* pAllocator, VkOpticalFlowSessionNV* pSession) => vkCreateOpticalFlowSessionNV_0(device, pCreateInfo, pAllocator, pSession);
	private delegate VkResult vkCreateOpticalFlowSessionNVDelegate_0(VkDevice device, VkOpticalFlowSessionCreateInfoNV* pCreateInfo, VkAllocationCallbacks* pAllocator, VkOpticalFlowSessionNV* pSession);
	private static IntPtr vkCreateOpticalFlowSessionNVPointer;
	private static vkCreateOpticalFlowSessionNVDelegate_0 vkCreateOpticalFlowSessionNV_0;
	public static void vkDestroyOpticalFlowSessionNV(VkDevice device, VkOpticalFlowSessionNV session, VkAllocationCallbacks* pAllocator) => vkDestroyOpticalFlowSessionNV_0(device, session, pAllocator);
	private delegate void vkDestroyOpticalFlowSessionNVDelegate_0(VkDevice device, VkOpticalFlowSessionNV session, VkAllocationCallbacks* pAllocator);
	private static IntPtr vkDestroyOpticalFlowSessionNVPointer;
	private static vkDestroyOpticalFlowSessionNVDelegate_0 vkDestroyOpticalFlowSessionNV_0;
	public static VkResult vkBindOpticalFlowSessionImageNV(VkDevice device, VkOpticalFlowSessionNV session, VkOpticalFlowSessionBindingPointNV bindingPoint, VkImageView view, VkImageLayout layout) => vkBindOpticalFlowSessionImageNV_0(device, session, bindingPoint, view, layout);
	private delegate VkResult vkBindOpticalFlowSessionImageNVDelegate_0(VkDevice device, VkOpticalFlowSessionNV session, VkOpticalFlowSessionBindingPointNV bindingPoint, VkImageView view, VkImageLayout layout);
	private static IntPtr vkBindOpticalFlowSessionImageNVPointer;
	private static vkBindOpticalFlowSessionImageNVDelegate_0 vkBindOpticalFlowSessionImageNV_0;
	public static void vkCmdOpticalFlowExecuteNV(VkCommandBuffer commandBuffer, VkOpticalFlowSessionNV session, VkOpticalFlowExecuteInfoNV* pExecuteInfo) => vkCmdOpticalFlowExecuteNV_0(commandBuffer, session, pExecuteInfo);
	private delegate void vkCmdOpticalFlowExecuteNVDelegate_0(VkCommandBuffer commandBuffer, VkOpticalFlowSessionNV session, VkOpticalFlowExecuteInfoNV* pExecuteInfo);
	private static IntPtr vkCmdOpticalFlowExecuteNVPointer;
	private static vkCmdOpticalFlowExecuteNVDelegate_0 vkCmdOpticalFlowExecuteNV_0;
	public static VkResult vkGetFramebufferTilePropertiesQCOM(VkDevice device, VkFramebuffer framebuffer, uint* pPropertiesCount, VkTilePropertiesQCOM* pProperties) => vkGetFramebufferTilePropertiesQCOM_0(device, framebuffer, pPropertiesCount, pProperties);
	private delegate VkResult vkGetFramebufferTilePropertiesQCOMDelegate_0(VkDevice device, VkFramebuffer framebuffer, uint* pPropertiesCount, VkTilePropertiesQCOM* pProperties);
	private static IntPtr vkGetFramebufferTilePropertiesQCOMPointer;
	private static vkGetFramebufferTilePropertiesQCOMDelegate_0 vkGetFramebufferTilePropertiesQCOM_0;
	public static VkResult vkGetDynamicRenderingTilePropertiesQCOM(VkDevice device, VkRenderingInfo* pRenderingInfo, VkTilePropertiesQCOM* pProperties) => vkGetDynamicRenderingTilePropertiesQCOM_0(device, pRenderingInfo, pProperties);
	private delegate VkResult vkGetDynamicRenderingTilePropertiesQCOMDelegate_0(VkDevice device, VkRenderingInfo* pRenderingInfo, VkTilePropertiesQCOM* pProperties);
	private static IntPtr vkGetDynamicRenderingTilePropertiesQCOMPointer;
	private static vkGetDynamicRenderingTilePropertiesQCOMDelegate_0 vkGetDynamicRenderingTilePropertiesQCOM_0;
	...
	public static void InitialiseInstanceMethods(VkInstance instance)
	{
		...
		vkGetPhysicalDeviceToolPropertiesPointer = vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceToolProperties");
		if (vkGetPhysicalDeviceToolPropertiesPointer != IntPtr.Zero)
		{
			vkGetPhysicalDeviceToolProperties_0 = Marshal.GetDelegateForFunctionPointer<vkGetPhysicalDeviceToolPropertiesDelegate_0>(vkGetPhysicalDeviceToolPropertiesPointer);
		}
		vkCreatePrivateDataSlotPointer = vkGetInstanceProcAddr(instance, "vkCreatePrivateDataSlot");
		if (vkCreatePrivateDataSlotPointer != IntPtr.Zero)
		{
			vkCreatePrivateDataSlot_0 = Marshal.GetDelegateForFunctionPointer<vkCreatePrivateDataSlotDelegate_0>(vkCreatePrivateDataSlotPointer);
		}
		vkDestroyPrivateDataSlotPointer = vkGetInstanceProcAddr(instance, "vkDestroyPrivateDataSlot");
		if (vkDestroyPrivateDataSlotPointer != IntPtr.Zero)
		{
			vkDestroyPrivateDataSlot_0 = Marshal.GetDelegateForFunctionPointer<vkDestroyPrivateDataSlotDelegate_0>(vkDestroyPrivateDataSlotPointer);
		}
		vkSetPrivateDataPointer = vkGetInstanceProcAddr(instance, "vkSetPrivateData");
		if (vkSetPrivateDataPointer != IntPtr.Zero)
		{
			vkSetPrivateData_0 = Marshal.GetDelegateForFunctionPointer<vkSetPrivateDataDelegate_0>(vkSetPrivateDataPointer);
		}
		vkGetPrivateDataPointer = vkGetInstanceProcAddr(instance, "vkGetPrivateData");
		if (vkGetPrivateDataPointer != IntPtr.Zero)
		{
			vkGetPrivateData_0 = Marshal.GetDelegateForFunctionPointer<vkGetPrivateDataDelegate_0>(vkGetPrivateDataPointer);
		}
		vkCmdSetEvent2Pointer = vkGetInstanceProcAddr(instance, "vkCmdSetEvent2");
		if (vkCmdSetEvent2Pointer != IntPtr.Zero)
		{
			vkCmdSetEvent2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetEvent2Delegate_0>(vkCmdSetEvent2Pointer);
		}
		vkCmdResetEvent2Pointer = vkGetInstanceProcAddr(instance, "vkCmdResetEvent2");
		if (vkCmdResetEvent2Pointer != IntPtr.Zero)
		{
			vkCmdResetEvent2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdResetEvent2Delegate_0>(vkCmdResetEvent2Pointer);
		}
		vkCmdWaitEvents2Pointer = vkGetInstanceProcAddr(instance, "vkCmdWaitEvents2");
		if (vkCmdWaitEvents2Pointer != IntPtr.Zero)
		{
			vkCmdWaitEvents2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdWaitEvents2Delegate_0>(vkCmdWaitEvents2Pointer);
		}
		vkCmdPipelineBarrier2Pointer = vkGetInstanceProcAddr(instance, "vkCmdPipelineBarrier2");
		if (vkCmdPipelineBarrier2Pointer != IntPtr.Zero)
		{
			vkCmdPipelineBarrier2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdPipelineBarrier2Delegate_0>(vkCmdPipelineBarrier2Pointer);
		}
		vkCmdWriteTimestamp2Pointer = vkGetInstanceProcAddr(instance, "vkCmdWriteTimestamp2");
		if (vkCmdWriteTimestamp2Pointer != IntPtr.Zero)
		{
			vkCmdWriteTimestamp2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdWriteTimestamp2Delegate_0>(vkCmdWriteTimestamp2Pointer);
		}
		vkQueueSubmit2Pointer = vkGetInstanceProcAddr(instance, "vkQueueSubmit2");
		if (vkQueueSubmit2Pointer != IntPtr.Zero)
		{
			vkQueueSubmit2_0 = Marshal.GetDelegateForFunctionPointer<vkQueueSubmit2Delegate_0>(vkQueueSubmit2Pointer);
		}
		vkCmdCopyBuffer2Pointer = vkGetInstanceProcAddr(instance, "vkCmdCopyBuffer2");
		if (vkCmdCopyBuffer2Pointer != IntPtr.Zero)
		{
			vkCmdCopyBuffer2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdCopyBuffer2Delegate_0>(vkCmdCopyBuffer2Pointer);
		}
		vkCmdCopyImage2Pointer = vkGetInstanceProcAddr(instance, "vkCmdCopyImage2");
		if (vkCmdCopyImage2Pointer != IntPtr.Zero)
		{
			vkCmdCopyImage2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdCopyImage2Delegate_0>(vkCmdCopyImage2Pointer);
		}
		vkCmdCopyBufferToImage2Pointer = vkGetInstanceProcAddr(instance, "vkCmdCopyBufferToImage2");
		if (vkCmdCopyBufferToImage2Pointer != IntPtr.Zero)
		{
			vkCmdCopyBufferToImage2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdCopyBufferToImage2Delegate_0>(vkCmdCopyBufferToImage2Pointer);
		}
		vkCmdCopyImageToBuffer2Pointer = vkGetInstanceProcAddr(instance, "vkCmdCopyImageToBuffer2");
		if (vkCmdCopyImageToBuffer2Pointer != IntPtr.Zero)
		{
			vkCmdCopyImageToBuffer2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdCopyImageToBuffer2Delegate_0>(vkCmdCopyImageToBuffer2Pointer);
		}
		vkCmdBlitImage2Pointer = vkGetInstanceProcAddr(instance, "vkCmdBlitImage2");
		if (vkCmdBlitImage2Pointer != IntPtr.Zero)
		{
			vkCmdBlitImage2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdBlitImage2Delegate_0>(vkCmdBlitImage2Pointer);
		}
		vkCmdResolveImage2Pointer = vkGetInstanceProcAddr(instance, "vkCmdResolveImage2");
		if (vkCmdResolveImage2Pointer != IntPtr.Zero)
		{
			vkCmdResolveImage2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdResolveImage2Delegate_0>(vkCmdResolveImage2Pointer);
		}
		vkCmdBeginRenderingPointer = vkGetInstanceProcAddr(instance, "vkCmdBeginRendering");
		if (vkCmdBeginRenderingPointer != IntPtr.Zero)
		{
			vkCmdBeginRendering_0 = Marshal.GetDelegateForFunctionPointer<vkCmdBeginRenderingDelegate_0>(vkCmdBeginRenderingPointer);
		}
		vkCmdEndRenderingPointer = vkGetInstanceProcAddr(instance, "vkCmdEndRendering");
		if (vkCmdEndRenderingPointer != IntPtr.Zero)
		{
			vkCmdEndRendering_0 = Marshal.GetDelegateForFunctionPointer<vkCmdEndRenderingDelegate_0>(vkCmdEndRenderingPointer);
		}
		vkCmdSetCullModePointer = vkGetInstanceProcAddr(instance, "vkCmdSetCullMode");
		if (vkCmdSetCullModePointer != IntPtr.Zero)
		{
			vkCmdSetCullMode_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetCullModeDelegate_0>(vkCmdSetCullModePointer);
		}
		vkCmdSetFrontFacePointer = vkGetInstanceProcAddr(instance, "vkCmdSetFrontFace");
		if (vkCmdSetFrontFacePointer != IntPtr.Zero)
		{
			vkCmdSetFrontFace_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetFrontFaceDelegate_0>(vkCmdSetFrontFacePointer);
		}
		vkCmdSetPrimitiveTopologyPointer = vkGetInstanceProcAddr(instance, "vkCmdSetPrimitiveTopology");
		if (vkCmdSetPrimitiveTopologyPointer != IntPtr.Zero)
		{
			vkCmdSetPrimitiveTopology_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetPrimitiveTopologyDelegate_0>(vkCmdSetPrimitiveTopologyPointer);
		}
		vkCmdSetViewportWithCountPointer = vkGetInstanceProcAddr(instance, "vkCmdSetViewportWithCount");
		if (vkCmdSetViewportWithCountPointer != IntPtr.Zero)
		{
			vkCmdSetViewportWithCount_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetViewportWithCountDelegate_0>(vkCmdSetViewportWithCountPointer);
		}
		vkCmdSetScissorWithCountPointer = vkGetInstanceProcAddr(instance, "vkCmdSetScissorWithCount");
		if (vkCmdSetScissorWithCountPointer != IntPtr.Zero)
		{
			vkCmdSetScissorWithCount_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetScissorWithCountDelegate_0>(vkCmdSetScissorWithCountPointer);
		}
		vkCmdBindVertexBuffers2Pointer = vkGetInstanceProcAddr(instance, "vkCmdBindVertexBuffers2");
		if (vkCmdBindVertexBuffers2Pointer != IntPtr.Zero)
		{
			vkCmdBindVertexBuffers2_0 = Marshal.GetDelegateForFunctionPointer<vkCmdBindVertexBuffers2Delegate_0>(vkCmdBindVertexBuffers2Pointer);
		}
		vkCmdSetDepthTestEnablePointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthTestEnable");
		if (vkCmdSetDepthTestEnablePointer != IntPtr.Zero)
		{
			vkCmdSetDepthTestEnable_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetDepthTestEnableDelegate_0>(vkCmdSetDepthTestEnablePointer);
		}
		vkCmdSetDepthWriteEnablePointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthWriteEnable");
		if (vkCmdSetDepthWriteEnablePointer != IntPtr.Zero)
		{
			vkCmdSetDepthWriteEnable_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetDepthWriteEnableDelegate_0>(vkCmdSetDepthWriteEnablePointer);
		}
		vkCmdSetDepthCompareOpPointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthCompareOp");
		if (vkCmdSetDepthCompareOpPointer != IntPtr.Zero)
		{
			vkCmdSetDepthCompareOp_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetDepthCompareOpDelegate_0>(vkCmdSetDepthCompareOpPointer);
		}
		vkCmdSetDepthBoundsTestEnablePointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthBoundsTestEnable");
		if (vkCmdSetDepthBoundsTestEnablePointer != IntPtr.Zero)
		{
			vkCmdSetDepthBoundsTestEnable_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetDepthBoundsTestEnableDelegate_0>(vkCmdSetDepthBoundsTestEnablePointer);
		}
		vkCmdSetStencilTestEnablePointer = vkGetInstanceProcAddr(instance, "vkCmdSetStencilTestEnable");
		if (vkCmdSetStencilTestEnablePointer != IntPtr.Zero)
		{
			vkCmdSetStencilTestEnable_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetStencilTestEnableDelegate_0>(vkCmdSetStencilTestEnablePointer);
		}
		vkCmdSetStencilOpPointer = vkGetInstanceProcAddr(instance, "vkCmdSetStencilOp");
		if (vkCmdSetStencilOpPointer != IntPtr.Zero)
		{
			vkCmdSetStencilOp_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetStencilOpDelegate_0>(vkCmdSetStencilOpPointer);
		}
		vkCmdSetRasterizerDiscardEnablePointer = vkGetInstanceProcAddr(instance, "vkCmdSetRasterizerDiscardEnable");
		if (vkCmdSetRasterizerDiscardEnablePointer != IntPtr.Zero)
		{
			vkCmdSetRasterizerDiscardEnable_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetRasterizerDiscardEnableDelegate_0>(vkCmdSetRasterizerDiscardEnablePointer);
		}
		vkCmdSetDepthBiasEnablePointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthBiasEnable");
		if (vkCmdSetDepthBiasEnablePointer != IntPtr.Zero)
		{
			vkCmdSetDepthBiasEnable_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetDepthBiasEnableDelegate_0>(vkCmdSetDepthBiasEnablePointer);
		}
		vkCmdSetPrimitiveRestartEnablePointer = vkGetInstanceProcAddr(instance, "vkCmdSetPrimitiveRestartEnable");
		if (vkCmdSetPrimitiveRestartEnablePointer != IntPtr.Zero)
		{
			vkCmdSetPrimitiveRestartEnable_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetPrimitiveRestartEnableDelegate_0>(vkCmdSetPrimitiveRestartEnablePointer);
		}
		vkGetDeviceBufferMemoryRequirementsPointer = vkGetInstanceProcAddr(instance, "vkGetDeviceBufferMemoryRequirements");
		if (vkGetDeviceBufferMemoryRequirementsPointer != IntPtr.Zero)
		{
			vkGetDeviceBufferMemoryRequirements_0 = Marshal.GetDelegateForFunctionPointer<vkGetDeviceBufferMemoryRequirementsDelegate_0>(vkGetDeviceBufferMemoryRequirementsPointer);
		}
		vkGetDeviceImageMemoryRequirementsPointer = vkGetInstanceProcAddr(instance, "vkGetDeviceImageMemoryRequirements");
		if (vkGetDeviceImageMemoryRequirementsPointer != IntPtr.Zero)
		{
			vkGetDeviceImageMemoryRequirements_0 = Marshal.GetDelegateForFunctionPointer<vkGetDeviceImageMemoryRequirementsDelegate_0>(vkGetDeviceImageMemoryRequirementsPointer);
		}
		vkGetDeviceImageSparseMemoryRequirementsPointer = vkGetInstanceProcAddr(instance, "vkGetDeviceImageSparseMemoryRequirements");
		if (vkGetDeviceImageSparseMemoryRequirementsPointer != IntPtr.Zero)
		{
			vkGetDeviceImageSparseMemoryRequirements_0 = Marshal.GetDelegateForFunctionPointer<vkGetDeviceImageSparseMemoryRequirementsDelegate_0>(vkGetDeviceImageSparseMemoryRequirementsPointer);
		}
		...
		vkGetPhysicalDeviceVideoCapabilitiesKHRPointer = vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceVideoCapabilitiesKHR");
		if (vkGetPhysicalDeviceVideoCapabilitiesKHRPointer != IntPtr.Zero)
		{
			vkGetPhysicalDeviceVideoCapabilitiesKHR_0 = Marshal.GetDelegateForFunctionPointer<vkGetPhysicalDeviceVideoCapabilitiesKHRDelegate_0>(vkGetPhysicalDeviceVideoCapabilitiesKHRPointer);
		}
		vkGetPhysicalDeviceVideoFormatPropertiesKHRPointer = vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceVideoFormatPropertiesKHR");
		if (vkGetPhysicalDeviceVideoFormatPropertiesKHRPointer != IntPtr.Zero)
		{
			vkGetPhysicalDeviceVideoFormatPropertiesKHR_0 = Marshal.GetDelegateForFunctionPointer<vkGetPhysicalDeviceVideoFormatPropertiesKHRDelegate_0>(vkGetPhysicalDeviceVideoFormatPropertiesKHRPointer);
		}
		vkCreateVideoSessionKHRPointer = vkGetInstanceProcAddr(instance, "vkCreateVideoSessionKHR");
		if (vkCreateVideoSessionKHRPointer != IntPtr.Zero)
		{
			vkCreateVideoSessionKHR_0 = Marshal.GetDelegateForFunctionPointer<vkCreateVideoSessionKHRDelegate_0>(vkCreateVideoSessionKHRPointer);
		}
		vkDestroyVideoSessionKHRPointer = vkGetInstanceProcAddr(instance, "vkDestroyVideoSessionKHR");
		if (vkDestroyVideoSessionKHRPointer != IntPtr.Zero)
		{
			vkDestroyVideoSessionKHR_0 = Marshal.GetDelegateForFunctionPointer<vkDestroyVideoSessionKHRDelegate_0>(vkDestroyVideoSessionKHRPointer);
		}
		vkGetVideoSessionMemoryRequirementsKHRPointer = vkGetInstanceProcAddr(instance, "vkGetVideoSessionMemoryRequirementsKHR");
		if (vkGetVideoSessionMemoryRequirementsKHRPointer != IntPtr.Zero)
		{
			vkGetVideoSessionMemoryRequirementsKHR_0 = Marshal.GetDelegateForFunctionPointer<vkGetVideoSessionMemoryRequirementsKHRDelegate_0>(vkGetVideoSessionMemoryRequirementsKHRPointer);
		}
		vkBindVideoSessionMemoryKHRPointer = vkGetInstanceProcAddr(instance, "vkBindVideoSessionMemoryKHR");
		if (vkBindVideoSessionMemoryKHRPointer != IntPtr.Zero)
		{
			vkBindVideoSessionMemoryKHR_0 = Marshal.GetDelegateForFunctionPointer<vkBindVideoSessionMemoryKHRDelegate_0>(vkBindVideoSessionMemoryKHRPointer);
		}
		vkCreateVideoSessionParametersKHRPointer = vkGetInstanceProcAddr(instance, "vkCreateVideoSessionParametersKHR");
		if (vkCreateVideoSessionParametersKHRPointer != IntPtr.Zero)
		{
			vkCreateVideoSessionParametersKHR_0 = Marshal.GetDelegateForFunctionPointer<vkCreateVideoSessionParametersKHRDelegate_0>(vkCreateVideoSessionParametersKHRPointer);
		}
		vkUpdateVideoSessionParametersKHRPointer = vkGetInstanceProcAddr(instance, "vkUpdateVideoSessionParametersKHR");
		if (vkUpdateVideoSessionParametersKHRPointer != IntPtr.Zero)
		{
			vkUpdateVideoSessionParametersKHR_0 = Marshal.GetDelegateForFunctionPointer<vkUpdateVideoSessionParametersKHRDelegate_0>(vkUpdateVideoSessionParametersKHRPointer);
		}
		vkDestroyVideoSessionParametersKHRPointer = vkGetInstanceProcAddr(instance, "vkDestroyVideoSessionParametersKHR");
		if (vkDestroyVideoSessionParametersKHRPointer != IntPtr.Zero)
		{
			vkDestroyVideoSessionParametersKHR_0 = Marshal.GetDelegateForFunctionPointer<vkDestroyVideoSessionParametersKHRDelegate_0>(vkDestroyVideoSessionParametersKHRPointer);
		}
		vkCmdBeginVideoCodingKHRPointer = vkGetInstanceProcAddr(instance, "vkCmdBeginVideoCodingKHR");
		if (vkCmdBeginVideoCodingKHRPointer != IntPtr.Zero)
		{
			vkCmdBeginVideoCodingKHR_0 = Marshal.GetDelegateForFunctionPointer<vkCmdBeginVideoCodingKHRDelegate_0>(vkCmdBeginVideoCodingKHRPointer);
		}
		vkCmdEndVideoCodingKHRPointer = vkGetInstanceProcAddr(instance, "vkCmdEndVideoCodingKHR");
		if (vkCmdEndVideoCodingKHRPointer != IntPtr.Zero)
		{
			vkCmdEndVideoCodingKHR_0 = Marshal.GetDelegateForFunctionPointer<vkCmdEndVideoCodingKHRDelegate_0>(vkCmdEndVideoCodingKHRPointer);
		}
		vkCmdControlVideoCodingKHRPointer = vkGetInstanceProcAddr(instance, "vkCmdControlVideoCodingKHR");
		if (vkCmdControlVideoCodingKHRPointer != IntPtr.Zero)
		{
			vkCmdControlVideoCodingKHR_0 = Marshal.GetDelegateForFunctionPointer<vkCmdControlVideoCodingKHRDelegate_0>(vkCmdControlVideoCodingKHRPointer);
		}
		vkCmdDecodeVideoKHRPointer = vkGetInstanceProcAddr(instance, "vkCmdDecodeVideoKHR");
		if (vkCmdDecodeVideoKHRPointer != IntPtr.Zero)
		{
			vkCmdDecodeVideoKHR_0 = Marshal.GetDelegateForFunctionPointer<vkCmdDecodeVideoKHRDelegate_0>(vkCmdDecodeVideoKHRPointer);
		}
		...
		vkCmdBeginRenderingKHRPointer = vkGetInstanceProcAddr(instance, "vkCmdBeginRendering");
		...
		vkCmdEndRenderingKHRPointer = vkGetInstanceProcAddr(instance, "vkCmdEndRendering");
		...
		vkGetPhysicalDeviceToolPropertiesEXTPointer = vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceToolProperties");
		...
		vkCmdSetCullModeEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetCullMode");
		...
		vkCmdSetFrontFaceEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetFrontFace");
		...
		vkCmdSetPrimitiveTopologyEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetPrimitiveTopology");
		...
		vkCmdSetViewportWithCountEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetViewportWithCount");
		...
		vkCmdSetScissorWithCountEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetScissorWithCount");
		...
		vkCmdBindVertexBuffers2EXTPointer = vkGetInstanceProcAddr(instance, "vkCmdBindVertexBuffers2");
		...
		vkCmdSetDepthTestEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthTestEnable");
		...
		vkCmdSetDepthWriteEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthWriteEnable");
		...
		vkCmdSetDepthCompareOpEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthCompareOp");
		...
		vkCmdSetDepthBoundsTestEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthBoundsTestEnable");
		...
		vkCmdSetStencilTestEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetStencilTestEnable");
		...
		vkCmdSetStencilOpEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetStencilOp");
		...
		vkReleaseSwapchainImagesEXTPointer = vkGetInstanceProcAddr(instance, "vkReleaseSwapchainImagesEXT");
		if (vkReleaseSwapchainImagesEXTPointer != IntPtr.Zero)
		{
			vkReleaseSwapchainImagesEXT_0 = Marshal.GetDelegateForFunctionPointer<vkReleaseSwapchainImagesEXTDelegate_0>(vkReleaseSwapchainImagesEXTPointer);
		}
		...
		vkCreatePrivateDataSlotEXTPointer = vkGetInstanceProcAddr(instance, "vkCreatePrivateDataSlot");
		...
		vkDestroyPrivateDataSlotEXTPointer = vkGetInstanceProcAddr(instance, "vkDestroyPrivateDataSlot");
		...
		vkSetPrivateDataEXTPointer = vkGetInstanceProcAddr(instance, "vkSetPrivateData");
		...
		vkGetPrivateDataEXTPointer = vkGetInstanceProcAddr(instance, "vkGetPrivateData");
		...
		vkCmdSetEvent2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdSetEvent2");
		...
		vkCmdResetEvent2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdResetEvent2");
		...
		vkCmdWaitEvents2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdWaitEvents2");
		...
		vkCmdPipelineBarrier2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdPipelineBarrier2");
		...
		vkCmdWriteTimestamp2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdWriteTimestamp2");
		...
		vkQueueSubmit2KHRPointer = vkGetInstanceProcAddr(instance, "vkQueueSubmit2");
		...
		vkGetDescriptorSetLayoutSizeEXTPointer = vkGetInstanceProcAddr(instance, "vkGetDescriptorSetLayoutSizeEXT");
		if (vkGetDescriptorSetLayoutSizeEXTPointer != IntPtr.Zero)
		{
			vkGetDescriptorSetLayoutSizeEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetDescriptorSetLayoutSizeEXTDelegate_0>(vkGetDescriptorSetLayoutSizeEXTPointer);
		}
		vkGetDescriptorSetLayoutBindingOffsetEXTPointer = vkGetInstanceProcAddr(instance, "vkGetDescriptorSetLayoutBindingOffsetEXT");
		if (vkGetDescriptorSetLayoutBindingOffsetEXTPointer != IntPtr.Zero)
		{
			vkGetDescriptorSetLayoutBindingOffsetEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetDescriptorSetLayoutBindingOffsetEXTDelegate_0>(vkGetDescriptorSetLayoutBindingOffsetEXTPointer);
		}
		vkGetDescriptorEXTPointer = vkGetInstanceProcAddr(instance, "vkGetDescriptorEXT");
		if (vkGetDescriptorEXTPointer != IntPtr.Zero)
		{
			vkGetDescriptorEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetDescriptorEXTDelegate_0>(vkGetDescriptorEXTPointer);
		}
		vkCmdBindDescriptorBuffersEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdBindDescriptorBuffersEXT");
		if (vkCmdBindDescriptorBuffersEXTPointer != IntPtr.Zero)
		{
			vkCmdBindDescriptorBuffersEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdBindDescriptorBuffersEXTDelegate_0>(vkCmdBindDescriptorBuffersEXTPointer);
		}
		vkCmdSetDescriptorBufferOffsetsEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetDescriptorBufferOffsetsEXT");
		if (vkCmdSetDescriptorBufferOffsetsEXTPointer != IntPtr.Zero)
		{
			vkCmdSetDescriptorBufferOffsetsEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetDescriptorBufferOffsetsEXTDelegate_0>(vkCmdSetDescriptorBufferOffsetsEXTPointer);
		}
		vkCmdBindDescriptorBufferEmbeddedSamplersEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdBindDescriptorBufferEmbeddedSamplersEXT");
		if (vkCmdBindDescriptorBufferEmbeddedSamplersEXTPointer != IntPtr.Zero)
		{
			vkCmdBindDescriptorBufferEmbeddedSamplersEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdBindDescriptorBufferEmbeddedSamplersEXTDelegate_0>(vkCmdBindDescriptorBufferEmbeddedSamplersEXTPointer);
		}
		vkGetBufferOpaqueCaptureDescriptorDataEXTPointer = vkGetInstanceProcAddr(instance, "vkGetBufferOpaqueCaptureDescriptorDataEXT");
		if (vkGetBufferOpaqueCaptureDescriptorDataEXTPointer != IntPtr.Zero)
		{
			vkGetBufferOpaqueCaptureDescriptorDataEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetBufferOpaqueCaptureDescriptorDataEXTDelegate_0>(vkGetBufferOpaqueCaptureDescriptorDataEXTPointer);
		}
		vkGetImageOpaqueCaptureDescriptorDataEXTPointer = vkGetInstanceProcAddr(instance, "vkGetImageOpaqueCaptureDescriptorDataEXT");
		if (vkGetImageOpaqueCaptureDescriptorDataEXTPointer != IntPtr.Zero)
		{
			vkGetImageOpaqueCaptureDescriptorDataEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetImageOpaqueCaptureDescriptorDataEXTDelegate_0>(vkGetImageOpaqueCaptureDescriptorDataEXTPointer);
		}
		vkGetImageViewOpaqueCaptureDescriptorDataEXTPointer = vkGetInstanceProcAddr(instance, "vkGetImageViewOpaqueCaptureDescriptorDataEXT");
		if (vkGetImageViewOpaqueCaptureDescriptorDataEXTPointer != IntPtr.Zero)
		{
			vkGetImageViewOpaqueCaptureDescriptorDataEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetImageViewOpaqueCaptureDescriptorDataEXTDelegate_0>(vkGetImageViewOpaqueCaptureDescriptorDataEXTPointer);
		}
		vkGetSamplerOpaqueCaptureDescriptorDataEXTPointer = vkGetInstanceProcAddr(instance, "vkGetSamplerOpaqueCaptureDescriptorDataEXT");
		if (vkGetSamplerOpaqueCaptureDescriptorDataEXTPointer != IntPtr.Zero)
		{
			vkGetSamplerOpaqueCaptureDescriptorDataEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetSamplerOpaqueCaptureDescriptorDataEXTDelegate_0>(vkGetSamplerOpaqueCaptureDescriptorDataEXTPointer);
		}
		vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXTPointer = vkGetInstanceProcAddr(instance, "vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT");
		if (vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXTPointer != IntPtr.Zero)
		{
			vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXTDelegate_0>(vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXTPointer);
		}
		...
		vkCmdDrawMeshTasksEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdDrawMeshTasksEXT");
		if (vkCmdDrawMeshTasksEXTPointer != IntPtr.Zero)
		{
			vkCmdDrawMeshTasksEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdDrawMeshTasksEXTDelegate_0>(vkCmdDrawMeshTasksEXTPointer);
		}
		vkCmdDrawMeshTasksIndirectEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdDrawMeshTasksIndirectEXT");
		if (vkCmdDrawMeshTasksIndirectEXTPointer != IntPtr.Zero)
		{
			vkCmdDrawMeshTasksIndirectEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdDrawMeshTasksIndirectEXTDelegate_0>(vkCmdDrawMeshTasksIndirectEXTPointer);
		}
		vkCmdDrawMeshTasksIndirectCountEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdDrawMeshTasksIndirectCountEXT");
		if (vkCmdDrawMeshTasksIndirectCountEXTPointer != IntPtr.Zero)
		{
			vkCmdDrawMeshTasksIndirectCountEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdDrawMeshTasksIndirectCountEXTDelegate_0>(vkCmdDrawMeshTasksIndirectCountEXTPointer);
		}
		vkCmdCopyBuffer2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdCopyBuffer2");
		...
		vkCmdCopyImage2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdCopyImage2");
		...
		vkCmdCopyBufferToImage2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdCopyBufferToImage2");
		...
		vkCmdCopyImageToBuffer2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdCopyImageToBuffer2");
		...
		vkCmdBlitImage2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdBlitImage2");
		...
		vkCmdResolveImage2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdResolveImage2");
		...
		vkGetImageSubresourceLayout2EXTPointer = vkGetInstanceProcAddr(instance, "vkGetImageSubresourceLayout2EXT");
		if (vkGetImageSubresourceLayout2EXTPointer != IntPtr.Zero)
		{
			vkGetImageSubresourceLayout2EXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetImageSubresourceLayout2EXTDelegate_0>(vkGetImageSubresourceLayout2EXTPointer);
		}
		vkGetDeviceFaultInfoEXTPointer = vkGetInstanceProcAddr(instance, "vkGetDeviceFaultInfoEXT");
		if (vkGetDeviceFaultInfoEXTPointer != IntPtr.Zero)
		{
			vkGetDeviceFaultInfoEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetDeviceFaultInfoEXTDelegate_0>(vkGetDeviceFaultInfoEXTPointer);
		}
		...
		vkGetPipelinePropertiesEXTPointer = vkGetInstanceProcAddr(instance, "vkGetPipelinePropertiesEXT");
		if (vkGetPipelinePropertiesEXTPointer != IntPtr.Zero)
		{
			vkGetPipelinePropertiesEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetPipelinePropertiesEXTDelegate_0>(vkGetPipelinePropertiesEXTPointer);
		}
		...
		vkCmdSetRasterizerDiscardEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetRasterizerDiscardEnable");
		...
		vkCmdSetDepthBiasEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthBiasEnable");
		...
		vkCmdSetPrimitiveRestartEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetPrimitiveRestartEnable");
		...
		vkCmdTraceRaysIndirect2KHRPointer = vkGetInstanceProcAddr(instance, "vkCmdTraceRaysIndirect2KHR");
		if (vkCmdTraceRaysIndirect2KHRPointer != IntPtr.Zero)
		{
			vkCmdTraceRaysIndirect2KHR_0 = Marshal.GetDelegateForFunctionPointer<vkCmdTraceRaysIndirect2KHRDelegate_0>(vkCmdTraceRaysIndirect2KHRPointer);
		}
		...
		vkCreateMicromapEXTPointer = vkGetInstanceProcAddr(instance, "vkCreateMicromapEXT");
		if (vkCreateMicromapEXTPointer != IntPtr.Zero)
		{
			vkCreateMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCreateMicromapEXTDelegate_0>(vkCreateMicromapEXTPointer);
		}
		vkDestroyMicromapEXTPointer = vkGetInstanceProcAddr(instance, "vkDestroyMicromapEXT");
		if (vkDestroyMicromapEXTPointer != IntPtr.Zero)
		{
			vkDestroyMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<vkDestroyMicromapEXTDelegate_0>(vkDestroyMicromapEXTPointer);
		}
		vkCmdBuildMicromapsEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdBuildMicromapsEXT");
		if (vkCmdBuildMicromapsEXTPointer != IntPtr.Zero)
		{
			vkCmdBuildMicromapsEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdBuildMicromapsEXTDelegate_0>(vkCmdBuildMicromapsEXTPointer);
		}
		vkBuildMicromapsEXTPointer = vkGetInstanceProcAddr(instance, "vkBuildMicromapsEXT");
		if (vkBuildMicromapsEXTPointer != IntPtr.Zero)
		{
			vkBuildMicromapsEXT_0 = Marshal.GetDelegateForFunctionPointer<vkBuildMicromapsEXTDelegate_0>(vkBuildMicromapsEXTPointer);
		}
		vkCopyMicromapEXTPointer = vkGetInstanceProcAddr(instance, "vkCopyMicromapEXT");
		if (vkCopyMicromapEXTPointer != IntPtr.Zero)
		{
			vkCopyMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCopyMicromapEXTDelegate_0>(vkCopyMicromapEXTPointer);
		}
		vkCopyMicromapToMemoryEXTPointer = vkGetInstanceProcAddr(instance, "vkCopyMicromapToMemoryEXT");
		if (vkCopyMicromapToMemoryEXTPointer != IntPtr.Zero)
		{
			vkCopyMicromapToMemoryEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCopyMicromapToMemoryEXTDelegate_0>(vkCopyMicromapToMemoryEXTPointer);
		}
		vkCopyMemoryToMicromapEXTPointer = vkGetInstanceProcAddr(instance, "vkCopyMemoryToMicromapEXT");
		if (vkCopyMemoryToMicromapEXTPointer != IntPtr.Zero)
		{
			vkCopyMemoryToMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCopyMemoryToMicromapEXTDelegate_0>(vkCopyMemoryToMicromapEXTPointer);
		}
		vkWriteMicromapsPropertiesEXTPointer = vkGetInstanceProcAddr(instance, "vkWriteMicromapsPropertiesEXT");
		if (vkWriteMicromapsPropertiesEXTPointer != IntPtr.Zero)
		{
			vkWriteMicromapsPropertiesEXT_0 = Marshal.GetDelegateForFunctionPointer<vkWriteMicromapsPropertiesEXTDelegate_0>(vkWriteMicromapsPropertiesEXTPointer);
		}
		vkCmdCopyMicromapEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdCopyMicromapEXT");
		if (vkCmdCopyMicromapEXTPointer != IntPtr.Zero)
		{
			vkCmdCopyMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdCopyMicromapEXTDelegate_0>(vkCmdCopyMicromapEXTPointer);
		}
		vkCmdCopyMicromapToMemoryEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdCopyMicromapToMemoryEXT");
		if (vkCmdCopyMicromapToMemoryEXTPointer != IntPtr.Zero)
		{
			vkCmdCopyMicromapToMemoryEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdCopyMicromapToMemoryEXTDelegate_0>(vkCmdCopyMicromapToMemoryEXTPointer);
		}
		vkCmdCopyMemoryToMicromapEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdCopyMemoryToMicromapEXT");
		if (vkCmdCopyMemoryToMicromapEXTPointer != IntPtr.Zero)
		{
			vkCmdCopyMemoryToMicromapEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdCopyMemoryToMicromapEXTDelegate_0>(vkCmdCopyMemoryToMicromapEXTPointer);
		}
		vkCmdWriteMicromapsPropertiesEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdWriteMicromapsPropertiesEXT");
		if (vkCmdWriteMicromapsPropertiesEXTPointer != IntPtr.Zero)
		{
			vkCmdWriteMicromapsPropertiesEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdWriteMicromapsPropertiesEXTDelegate_0>(vkCmdWriteMicromapsPropertiesEXTPointer);
		}
		vkGetDeviceMicromapCompatibilityEXTPointer = vkGetInstanceProcAddr(instance, "vkGetDeviceMicromapCompatibilityEXT");
		if (vkGetDeviceMicromapCompatibilityEXTPointer != IntPtr.Zero)
		{
			vkGetDeviceMicromapCompatibilityEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetDeviceMicromapCompatibilityEXTDelegate_0>(vkGetDeviceMicromapCompatibilityEXTPointer);
		}
		vkGetMicromapBuildSizesEXTPointer = vkGetInstanceProcAddr(instance, "vkGetMicromapBuildSizesEXT");
		if (vkGetMicromapBuildSizesEXTPointer != IntPtr.Zero)
		{
			vkGetMicromapBuildSizesEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetMicromapBuildSizesEXTDelegate_0>(vkGetMicromapBuildSizesEXTPointer);
		}
		vkCmdDrawClusterHUAWEIPointer = vkGetInstanceProcAddr(instance, "vkCmdDrawClusterHUAWEI");
		if (vkCmdDrawClusterHUAWEIPointer != IntPtr.Zero)
		{
			vkCmdDrawClusterHUAWEI_0 = Marshal.GetDelegateForFunctionPointer<vkCmdDrawClusterHUAWEIDelegate_0>(vkCmdDrawClusterHUAWEIPointer);
		}
		vkCmdDrawClusterIndirectHUAWEIPointer = vkGetInstanceProcAddr(instance, "vkCmdDrawClusterIndirectHUAWEI");
		if (vkCmdDrawClusterIndirectHUAWEIPointer != IntPtr.Zero)
		{
			vkCmdDrawClusterIndirectHUAWEI_0 = Marshal.GetDelegateForFunctionPointer<vkCmdDrawClusterIndirectHUAWEIDelegate_0>(vkCmdDrawClusterIndirectHUAWEIPointer);
		}
		...
		vkGetDeviceBufferMemoryRequirementsKHRPointer = vkGetInstanceProcAddr(instance, "vkGetDeviceBufferMemoryRequirements");
		...
		vkGetDeviceImageMemoryRequirementsKHRPointer = vkGetInstanceProcAddr(instance, "vkGetDeviceImageMemoryRequirements");
		...
		vkGetDeviceImageSparseMemoryRequirementsKHRPointer = vkGetInstanceProcAddr(instance, "vkGetDeviceImageSparseMemoryRequirements");
		...
		vkGetDescriptorSetLayoutHostMappingInfoVALVEPointer = vkGetInstanceProcAddr(instance, "vkGetDescriptorSetLayoutHostMappingInfoVALVE");
		if (vkGetDescriptorSetLayoutHostMappingInfoVALVEPointer != IntPtr.Zero)
		{
			vkGetDescriptorSetLayoutHostMappingInfoVALVE_0 = Marshal.GetDelegateForFunctionPointer<vkGetDescriptorSetLayoutHostMappingInfoVALVEDelegate_0>(vkGetDescriptorSetLayoutHostMappingInfoVALVEPointer);
		}
		vkGetDescriptorSetHostMappingVALVEPointer = vkGetInstanceProcAddr(instance, "vkGetDescriptorSetHostMappingVALVE");
		if (vkGetDescriptorSetHostMappingVALVEPointer != IntPtr.Zero)
		{
			vkGetDescriptorSetHostMappingVALVE_0 = Marshal.GetDelegateForFunctionPointer<vkGetDescriptorSetHostMappingVALVEDelegate_0>(vkGetDescriptorSetHostMappingVALVEPointer);
		}
		vkCmdCopyMemoryIndirectNVPointer = vkGetInstanceProcAddr(instance, "vkCmdCopyMemoryIndirectNV");
		if (vkCmdCopyMemoryIndirectNVPointer != IntPtr.Zero)
		{
			vkCmdCopyMemoryIndirectNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdCopyMemoryIndirectNVDelegate_0>(vkCmdCopyMemoryIndirectNVPointer);
		}
		vkCmdCopyMemoryToImageIndirectNVPointer = vkGetInstanceProcAddr(instance, "vkCmdCopyMemoryToImageIndirectNV");
		if (vkCmdCopyMemoryToImageIndirectNVPointer != IntPtr.Zero)
		{
			vkCmdCopyMemoryToImageIndirectNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdCopyMemoryToImageIndirectNVDelegate_0>(vkCmdCopyMemoryToImageIndirectNVPointer);
		}
		vkCmdDecompressMemoryNVPointer = vkGetInstanceProcAddr(instance, "vkCmdDecompressMemoryNV");
		if (vkCmdDecompressMemoryNVPointer != IntPtr.Zero)
		{
			vkCmdDecompressMemoryNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdDecompressMemoryNVDelegate_0>(vkCmdDecompressMemoryNVPointer);
		}
		vkCmdDecompressMemoryIndirectCountNVPointer = vkGetInstanceProcAddr(instance, "vkCmdDecompressMemoryIndirectCountNV");
		if (vkCmdDecompressMemoryIndirectCountNVPointer != IntPtr.Zero)
		{
			vkCmdDecompressMemoryIndirectCountNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdDecompressMemoryIndirectCountNVDelegate_0>(vkCmdDecompressMemoryIndirectCountNVPointer);
		}
		vkCmdSetTessellationDomainOriginEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetTessellationDomainOriginEXT");
		if (vkCmdSetTessellationDomainOriginEXTPointer != IntPtr.Zero)
		{
			vkCmdSetTessellationDomainOriginEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetTessellationDomainOriginEXTDelegate_0>(vkCmdSetTessellationDomainOriginEXTPointer);
		}
		vkCmdSetDepthClampEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthClampEnableEXT");
		if (vkCmdSetDepthClampEnableEXTPointer != IntPtr.Zero)
		{
			vkCmdSetDepthClampEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetDepthClampEnableEXTDelegate_0>(vkCmdSetDepthClampEnableEXTPointer);
		}
		vkCmdSetPolygonModeEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetPolygonModeEXT");
		if (vkCmdSetPolygonModeEXTPointer != IntPtr.Zero)
		{
			vkCmdSetPolygonModeEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetPolygonModeEXTDelegate_0>(vkCmdSetPolygonModeEXTPointer);
		}
		vkCmdSetRasterizationSamplesEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetRasterizationSamplesEXT");
		if (vkCmdSetRasterizationSamplesEXTPointer != IntPtr.Zero)
		{
			vkCmdSetRasterizationSamplesEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetRasterizationSamplesEXTDelegate_0>(vkCmdSetRasterizationSamplesEXTPointer);
		}
		vkCmdSetSampleMaskEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetSampleMaskEXT");
		if (vkCmdSetSampleMaskEXTPointer != IntPtr.Zero)
		{
			vkCmdSetSampleMaskEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetSampleMaskEXTDelegate_0>(vkCmdSetSampleMaskEXTPointer);
		}
		vkCmdSetAlphaToCoverageEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetAlphaToCoverageEnableEXT");
		if (vkCmdSetAlphaToCoverageEnableEXTPointer != IntPtr.Zero)
		{
			vkCmdSetAlphaToCoverageEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetAlphaToCoverageEnableEXTDelegate_0>(vkCmdSetAlphaToCoverageEnableEXTPointer);
		}
		vkCmdSetAlphaToOneEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetAlphaToOneEnableEXT");
		if (vkCmdSetAlphaToOneEnableEXTPointer != IntPtr.Zero)
		{
			vkCmdSetAlphaToOneEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetAlphaToOneEnableEXTDelegate_0>(vkCmdSetAlphaToOneEnableEXTPointer);
		}
		vkCmdSetLogicOpEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetLogicOpEnableEXT");
		if (vkCmdSetLogicOpEnableEXTPointer != IntPtr.Zero)
		{
			vkCmdSetLogicOpEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetLogicOpEnableEXTDelegate_0>(vkCmdSetLogicOpEnableEXTPointer);
		}
		vkCmdSetColorBlendEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetColorBlendEnableEXT");
		if (vkCmdSetColorBlendEnableEXTPointer != IntPtr.Zero)
		{
			vkCmdSetColorBlendEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetColorBlendEnableEXTDelegate_0>(vkCmdSetColorBlendEnableEXTPointer);
		}
		vkCmdSetColorBlendEquationEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetColorBlendEquationEXT");
		if (vkCmdSetColorBlendEquationEXTPointer != IntPtr.Zero)
		{
			vkCmdSetColorBlendEquationEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetColorBlendEquationEXTDelegate_0>(vkCmdSetColorBlendEquationEXTPointer);
		}
		vkCmdSetColorWriteMaskEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetColorWriteMaskEXT");
		if (vkCmdSetColorWriteMaskEXTPointer != IntPtr.Zero)
		{
			vkCmdSetColorWriteMaskEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetColorWriteMaskEXTDelegate_0>(vkCmdSetColorWriteMaskEXTPointer);
		}
		vkCmdSetRasterizationStreamEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetRasterizationStreamEXT");
		if (vkCmdSetRasterizationStreamEXTPointer != IntPtr.Zero)
		{
			vkCmdSetRasterizationStreamEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetRasterizationStreamEXTDelegate_0>(vkCmdSetRasterizationStreamEXTPointer);
		}
		vkCmdSetConservativeRasterizationModeEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetConservativeRasterizationModeEXT");
		if (vkCmdSetConservativeRasterizationModeEXTPointer != IntPtr.Zero)
		{
			vkCmdSetConservativeRasterizationModeEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetConservativeRasterizationModeEXTDelegate_0>(vkCmdSetConservativeRasterizationModeEXTPointer);
		}
		vkCmdSetExtraPrimitiveOverestimationSizeEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetExtraPrimitiveOverestimationSizeEXT");
		if (vkCmdSetExtraPrimitiveOverestimationSizeEXTPointer != IntPtr.Zero)
		{
			vkCmdSetExtraPrimitiveOverestimationSizeEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetExtraPrimitiveOverestimationSizeEXTDelegate_0>(vkCmdSetExtraPrimitiveOverestimationSizeEXTPointer);
		}
		vkCmdSetDepthClipEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthClipEnableEXT");
		if (vkCmdSetDepthClipEnableEXTPointer != IntPtr.Zero)
		{
			vkCmdSetDepthClipEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetDepthClipEnableEXTDelegate_0>(vkCmdSetDepthClipEnableEXTPointer);
		}
		vkCmdSetSampleLocationsEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetSampleLocationsEnableEXT");
		if (vkCmdSetSampleLocationsEnableEXTPointer != IntPtr.Zero)
		{
			vkCmdSetSampleLocationsEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetSampleLocationsEnableEXTDelegate_0>(vkCmdSetSampleLocationsEnableEXTPointer);
		}
		vkCmdSetColorBlendAdvancedEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetColorBlendAdvancedEXT");
		if (vkCmdSetColorBlendAdvancedEXTPointer != IntPtr.Zero)
		{
			vkCmdSetColorBlendAdvancedEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetColorBlendAdvancedEXTDelegate_0>(vkCmdSetColorBlendAdvancedEXTPointer);
		}
		vkCmdSetProvokingVertexModeEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetProvokingVertexModeEXT");
		if (vkCmdSetProvokingVertexModeEXTPointer != IntPtr.Zero)
		{
			vkCmdSetProvokingVertexModeEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetProvokingVertexModeEXTDelegate_0>(vkCmdSetProvokingVertexModeEXTPointer);
		}
		vkCmdSetLineRasterizationModeEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetLineRasterizationModeEXT");
		if (vkCmdSetLineRasterizationModeEXTPointer != IntPtr.Zero)
		{
			vkCmdSetLineRasterizationModeEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetLineRasterizationModeEXTDelegate_0>(vkCmdSetLineRasterizationModeEXTPointer);
		}
		vkCmdSetLineStippleEnableEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetLineStippleEnableEXT");
		if (vkCmdSetLineStippleEnableEXTPointer != IntPtr.Zero)
		{
			vkCmdSetLineStippleEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetLineStippleEnableEXTDelegate_0>(vkCmdSetLineStippleEnableEXTPointer);
		}
		vkCmdSetDepthClipNegativeOneToOneEXTPointer = vkGetInstanceProcAddr(instance, "vkCmdSetDepthClipNegativeOneToOneEXT");
		if (vkCmdSetDepthClipNegativeOneToOneEXTPointer != IntPtr.Zero)
		{
			vkCmdSetDepthClipNegativeOneToOneEXT_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetDepthClipNegativeOneToOneEXTDelegate_0>(vkCmdSetDepthClipNegativeOneToOneEXTPointer);
		}
		vkCmdSetViewportWScalingEnableNVPointer = vkGetInstanceProcAddr(instance, "vkCmdSetViewportWScalingEnableNV");
		if (vkCmdSetViewportWScalingEnableNVPointer != IntPtr.Zero)
		{
			vkCmdSetViewportWScalingEnableNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetViewportWScalingEnableNVDelegate_0>(vkCmdSetViewportWScalingEnableNVPointer);
		}
		vkCmdSetViewportSwizzleNVPointer = vkGetInstanceProcAddr(instance, "vkCmdSetViewportSwizzleNV");
		if (vkCmdSetViewportSwizzleNVPointer != IntPtr.Zero)
		{
			vkCmdSetViewportSwizzleNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetViewportSwizzleNVDelegate_0>(vkCmdSetViewportSwizzleNVPointer);
		}
		vkCmdSetCoverageToColorEnableNVPointer = vkGetInstanceProcAddr(instance, "vkCmdSetCoverageToColorEnableNV");
		if (vkCmdSetCoverageToColorEnableNVPointer != IntPtr.Zero)
		{
			vkCmdSetCoverageToColorEnableNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetCoverageToColorEnableNVDelegate_0>(vkCmdSetCoverageToColorEnableNVPointer);
		}
		vkCmdSetCoverageToColorLocationNVPointer = vkGetInstanceProcAddr(instance, "vkCmdSetCoverageToColorLocationNV");
		if (vkCmdSetCoverageToColorLocationNVPointer != IntPtr.Zero)
		{
			vkCmdSetCoverageToColorLocationNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetCoverageToColorLocationNVDelegate_0>(vkCmdSetCoverageToColorLocationNVPointer);
		}
		vkCmdSetCoverageModulationModeNVPointer = vkGetInstanceProcAddr(instance, "vkCmdSetCoverageModulationModeNV");
		if (vkCmdSetCoverageModulationModeNVPointer != IntPtr.Zero)
		{
			vkCmdSetCoverageModulationModeNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetCoverageModulationModeNVDelegate_0>(vkCmdSetCoverageModulationModeNVPointer);
		}
		vkCmdSetCoverageModulationTableEnableNVPointer = vkGetInstanceProcAddr(instance, "vkCmdSetCoverageModulationTableEnableNV");
		if (vkCmdSetCoverageModulationTableEnableNVPointer != IntPtr.Zero)
		{
			vkCmdSetCoverageModulationTableEnableNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetCoverageModulationTableEnableNVDelegate_0>(vkCmdSetCoverageModulationTableEnableNVPointer);
		}
		vkCmdSetCoverageModulationTableNVPointer = vkGetInstanceProcAddr(instance, "vkCmdSetCoverageModulationTableNV");
		if (vkCmdSetCoverageModulationTableNVPointer != IntPtr.Zero)
		{
			vkCmdSetCoverageModulationTableNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetCoverageModulationTableNVDelegate_0>(vkCmdSetCoverageModulationTableNVPointer);
		}
		vkCmdSetShadingRateImageEnableNVPointer = vkGetInstanceProcAddr(instance, "vkCmdSetShadingRateImageEnableNV");
		if (vkCmdSetShadingRateImageEnableNVPointer != IntPtr.Zero)
		{
			vkCmdSetShadingRateImageEnableNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetShadingRateImageEnableNVDelegate_0>(vkCmdSetShadingRateImageEnableNVPointer);
		}
		vkCmdSetRepresentativeFragmentTestEnableNVPointer = vkGetInstanceProcAddr(instance, "vkCmdSetRepresentativeFragmentTestEnableNV");
		if (vkCmdSetRepresentativeFragmentTestEnableNVPointer != IntPtr.Zero)
		{
			vkCmdSetRepresentativeFragmentTestEnableNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetRepresentativeFragmentTestEnableNVDelegate_0>(vkCmdSetRepresentativeFragmentTestEnableNVPointer);
		}
		vkCmdSetCoverageReductionModeNVPointer = vkGetInstanceProcAddr(instance, "vkCmdSetCoverageReductionModeNV");
		if (vkCmdSetCoverageReductionModeNVPointer != IntPtr.Zero)
		{
			vkCmdSetCoverageReductionModeNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdSetCoverageReductionModeNVDelegate_0>(vkCmdSetCoverageReductionModeNVPointer);
		}
		vkGetShaderModuleIdentifierEXTPointer = vkGetInstanceProcAddr(instance, "vkGetShaderModuleIdentifierEXT");
		if (vkGetShaderModuleIdentifierEXTPointer != IntPtr.Zero)
		{
			vkGetShaderModuleIdentifierEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetShaderModuleIdentifierEXTDelegate_0>(vkGetShaderModuleIdentifierEXTPointer);
		}
		vkGetShaderModuleCreateInfoIdentifierEXTPointer = vkGetInstanceProcAddr(instance, "vkGetShaderModuleCreateInfoIdentifierEXT");
		if (vkGetShaderModuleCreateInfoIdentifierEXTPointer != IntPtr.Zero)
		{
			vkGetShaderModuleCreateInfoIdentifierEXT_0 = Marshal.GetDelegateForFunctionPointer<vkGetShaderModuleCreateInfoIdentifierEXTDelegate_0>(vkGetShaderModuleCreateInfoIdentifierEXTPointer);
		}
		vkGetPhysicalDeviceOpticalFlowImageFormatsNVPointer = vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceOpticalFlowImageFormatsNV");
		if (vkGetPhysicalDeviceOpticalFlowImageFormatsNVPointer != IntPtr.Zero)
		{
			vkGetPhysicalDeviceOpticalFlowImageFormatsNV_0 = Marshal.GetDelegateForFunctionPointer<vkGetPhysicalDeviceOpticalFlowImageFormatsNVDelegate_0>(vkGetPhysicalDeviceOpticalFlowImageFormatsNVPointer);
		}
		vkCreateOpticalFlowSessionNVPointer = vkGetInstanceProcAddr(instance, "vkCreateOpticalFlowSessionNV");
		if (vkCreateOpticalFlowSessionNVPointer != IntPtr.Zero)
		{
			vkCreateOpticalFlowSessionNV_0 = Marshal.GetDelegateForFunctionPointer<vkCreateOpticalFlowSessionNVDelegate_0>(vkCreateOpticalFlowSessionNVPointer);
		}
		vkDestroyOpticalFlowSessionNVPointer = vkGetInstanceProcAddr(instance, "vkDestroyOpticalFlowSessionNV");
		if (vkDestroyOpticalFlowSessionNVPointer != IntPtr.Zero)
		{
			vkDestroyOpticalFlowSessionNV_0 = Marshal.GetDelegateForFunctionPointer<vkDestroyOpticalFlowSessionNVDelegate_0>(vkDestroyOpticalFlowSessionNVPointer);
		}
		vkBindOpticalFlowSessionImageNVPointer = vkGetInstanceProcAddr(instance, "vkBindOpticalFlowSessionImageNV");
		if (vkBindOpticalFlowSessionImageNVPointer != IntPtr.Zero)
		{
			vkBindOpticalFlowSessionImageNV_0 = Marshal.GetDelegateForFunctionPointer<vkBindOpticalFlowSessionImageNVDelegate_0>(vkBindOpticalFlowSessionImageNVPointer);
		}
		vkCmdOpticalFlowExecuteNVPointer = vkGetInstanceProcAddr(instance, "vkCmdOpticalFlowExecuteNV");
		if (vkCmdOpticalFlowExecuteNVPointer != IntPtr.Zero)
		{
			vkCmdOpticalFlowExecuteNV_0 = Marshal.GetDelegateForFunctionPointer<vkCmdOpticalFlowExecuteNVDelegate_0>(vkCmdOpticalFlowExecuteNVPointer);
		}
		vkGetFramebufferTilePropertiesQCOMPointer = vkGetInstanceProcAddr(instance, "vkGetFramebufferTilePropertiesQCOM");
		if (vkGetFramebufferTilePropertiesQCOMPointer != IntPtr.Zero)
		{
			vkGetFramebufferTilePropertiesQCOM_0 = Marshal.GetDelegateForFunctionPointer<vkGetFramebufferTilePropertiesQCOMDelegate_0>(vkGetFramebufferTilePropertiesQCOMPointer);
		}
		vkGetDynamicRenderingTilePropertiesQCOMPointer = vkGetInstanceProcAddr(instance, "vkGetDynamicRenderingTilePropertiesQCOM");
		if (vkGetDynamicRenderingTilePropertiesQCOMPointer != IntPtr.Zero)
		{
			vkGetDynamicRenderingTilePropertiesQCOM_0 = Marshal.GetDelegateForFunctionPointer<vkGetDynamicRenderingTilePropertiesQCOMDelegate_0>(vkGetDynamicRenderingTilePropertiesQCOMPointer);
		}
	}
}
