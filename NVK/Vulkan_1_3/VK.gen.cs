...
public static unsafe class VK
{
	...
	public static void GetPhysicalDeviceSparseImageFormatProperties(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkSampleCountFlagBits samples, VkImageUsageFlags usage, VkImageTiling tiling, uint* propertyCount, [In, Out] VkSparseImageFormatProperties[] properties) => GetPhysicalDeviceSparseImageFormatProperties_0(physicalDevice, format, type, samples, usage, tiling, propertyCount, properties);
	private delegate void GetPhysicalDeviceSparseImageFormatPropertiesDelegate_0(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkSampleCountFlagBits samples, VkImageUsageFlags usage, VkImageTiling tiling, uint* propertyCount, [In, Out] VkSparseImageFormatProperties[] properties);
	private static GetPhysicalDeviceSparseImageFormatPropertiesDelegate_0 GetPhysicalDeviceSparseImageFormatProperties_0;
	public static void GetPhysicalDeviceSparseImageFormatProperties(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkSampleCountFlagBits samples, VkImageUsageFlags usage, VkImageTiling tiling, ref uint propertyCount, [In, Out] VkSparseImageFormatProperties[] properties) => GetPhysicalDeviceSparseImageFormatProperties_1(physicalDevice, format, type, samples, usage, tiling, ref propertyCount, properties);
	private delegate void GetPhysicalDeviceSparseImageFormatPropertiesDelegate_1(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkSampleCountFlagBits samples, VkImageUsageFlags usage, VkImageTiling tiling, ref uint propertyCount, [In, Out] VkSparseImageFormatProperties[] properties);
	...
	private delegate VkResult GetShaderInfoAMDDelegate_0(VkDevice device, VkPipeline pipeline, VkShaderStageFlagBits shaderStage, VkShaderInfoTypeAMD infoType, nuint* infoSize, void* info);
	private static GetShaderInfoAMDDelegate_0 GetShaderInfoAMD_0;
	public static VkResult GetShaderInfoAMD(VkDevice device, VkPipeline pipeline, VkShaderStageFlagBits shaderStage, VkShaderInfoTypeAMD infoType, ref nuint infoSize, void* info) => GetShaderInfoAMD_1(device, pipeline, shaderStage, infoType, ref infoSize, info);
	private delegate VkResult GetShaderInfoAMDDelegate_1(VkDevice device, VkPipeline pipeline, VkShaderStageFlagBits shaderStage, VkShaderInfoTypeAMD infoType, ref nuint infoSize, void* info);
	...
	public static void CommandBeginRenderingKHR() => CommandBeginRenderingKHR_0();
	private delegate void CommandBeginRenderingKHRDelegate_0();
	private static CommandBeginRenderingKHRDelegate_0 CommandBeginRenderingKHR_0;
	private static IntPtr CommandBeginRenderingKHRPointer;
	[Obsolete("Use CommandEndRendering")]
	public static void CommandEndRenderingKHR() => CommandEndRenderingKHR_0();
	private delegate void CommandEndRenderingKHRDelegate_0();
	private static CommandEndRenderingKHRDelegate_0 CommandEndRenderingKHR_0;
	private static IntPtr CommandEndRenderingKHRPointer;
	...
	public static VkResult GetMemoryWin32HandlePropertiesKHR(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, IntPtr handle, out VkMemoryWin32HandlePropertiesKHR memoryWin32HandleProperties) => GetMemoryWin32HandlePropertiesKHR_0(device, handleType, handle, out memoryWin32HandleProperties);
	private delegate VkResult GetMemoryWin32HandlePropertiesKHRDelegate_0(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, IntPtr handle, out VkMemoryWin32HandlePropertiesKHR memoryWin32HandleProperties);
	...
	private delegate VkResult GetMemoryFileDescriptorPropertiesKHRDelegate_0(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, int fileDescriptor, out VkMemoryFdPropertiesKHR memoryFileDescriptorProperties);
	...
	public static VkResult GetSwapchainCounterEXT(VkDevice device, VkSwapchainKHR swapchain, VkSurfaceCounterFlagBitsEXT counter, out ulong counterValue) => GetSwapchainCounterEXT_0(device, swapchain, counter, out counterValue);
	private delegate VkResult GetSwapchainCounterEXTDelegate_0(VkDevice device, VkSwapchainKHR swapchain, VkSurfaceCounterFlagBitsEXT counter, out ulong counterValue);
	...
	public static void CreateRenderPass2KHR() => CreateRenderPass2KHR_0();
	private delegate void CreateRenderPass2KHRDelegate_0();
	...
	public static void CommandBeginRenderPass2KHR() => CommandBeginRenderPass2KHR_0();
	private delegate void CommandBeginRenderPass2KHRDelegate_0();
	...
	public static void CommandNextSubpass2KHR() => CommandNextSubpass2KHR_0();
	private delegate void CommandNextSubpass2KHRDelegate_0();
	...
	public static void CommandEndRenderPass2KHR() => CommandEndRenderPass2KHR_0();
	private delegate void CommandEndRenderPass2KHRDelegate_0();
	...
	public static void SubmitDebugUtilsMessageEXT(VkInstance instance, VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageTypes, VkDebugUtilsMessengerCallbackDataEXT* callbackData) => SubmitDebugUtilsMessageEXT_0(instance, messageSeverity, messageTypes, callbackData);
	private delegate void SubmitDebugUtilsMessageEXTDelegate_0(VkInstance instance, VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageTypes, VkDebugUtilsMessengerCallbackDataEXT* callbackData);
	private static SubmitDebugUtilsMessageEXTDelegate_0 SubmitDebugUtilsMessageEXT_0;
	public static void SubmitDebugUtilsMessageEXT(VkInstance instance, VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageTypes, ref VkDebugUtilsMessengerCallbackDataEXT callbackData) => SubmitDebugUtilsMessageEXT_1(instance, messageSeverity, messageTypes, ref callbackData);
	private delegate void SubmitDebugUtilsMessageEXTDelegate_1(VkInstance instance, VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageTypes, ref VkDebugUtilsMessengerCallbackDataEXT callbackData);
	...
	public static void GetPhysicalDeviceMultisamplePropertiesEXT(VkPhysicalDevice physicalDevice, VkSampleCountFlagBits samples, out VkMultisamplePropertiesEXT multisampleProperties) => GetPhysicalDeviceMultisamplePropertiesEXT_0(physicalDevice, samples, out multisampleProperties);
	private delegate void GetPhysicalDeviceMultisamplePropertiesEXTDelegate_0(VkPhysicalDevice physicalDevice, VkSampleCountFlagBits samples, out VkMultisamplePropertiesEXT multisampleProperties);
	...
	public static void GetRayTracingShaderGroupHandlesNV() => GetRayTracingShaderGroupHandlesNV_0();
	private delegate void GetRayTracingShaderGroupHandlesNVDelegate_0();
	...
	[Obsolete("Use CommandDrawIndirectCount")]
	public static void CommandDrawIndirectCountKHR() => CommandDrawIndirectCountKHR_0();
	private delegate void CommandDrawIndirectCountKHRDelegate_0();
	...
	[Obsolete("Use CommandDrawIndexedIndirectCount")]
	public static void CommandDrawIndexedIndirectCountKHR() => CommandDrawIndexedIndirectCountKHR_0();
	private delegate void CommandDrawIndexedIndirectCountKHRDelegate_0();
	...
	public static VkResult GetMemoryHostPointerPropertiesEXT(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, void* hostPointer, out VkMemoryHostPointerPropertiesEXT memoryHostPointerProperties) => GetMemoryHostPointerPropertiesEXT_0(device, handleType, hostPointer, out memoryHostPointerProperties);
	private delegate VkResult GetMemoryHostPointerPropertiesEXTDelegate_0(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, void* hostPointer, out VkMemoryHostPointerPropertiesEXT memoryHostPointerProperties);
	...
	public static void CommandWriteBufferMarkerAMD(VkCommandBuffer commandBuffer, VkPipelineStageFlagBits pipelineStage, VkBuffer destinationBuffer, VkDeviceSize destinationOffset, uint marker) => CommandWriteBufferMarkerAMD_0(commandBuffer, pipelineStage, destinationBuffer, destinationOffset, marker);
	private delegate void CommandWriteBufferMarkerAMDDelegate_0(VkCommandBuffer commandBuffer, VkPipelineStageFlagBits pipelineStage, VkBuffer destinationBuffer, VkDeviceSize destinationOffset, uint marker);
	...
	public static void GetSemaphoreCounterValueKHR() => GetSemaphoreCounterValueKHR_0();
	private delegate void GetSemaphoreCounterValueKHRDelegate_0();
	...
	public static void WaitSemaphoresKHR() => WaitSemaphoresKHR_0();
	private delegate void WaitSemaphoresKHRDelegate_0();
	...
	public static void SignalSemaphoreKHR() => SignalSemaphoreKHR_0();
	private delegate void SignalSemaphoreKHRDelegate_0();
	...
	public static void GetPhysicalDeviceToolPropertiesEXT() => GetPhysicalDeviceToolPropertiesEXT_0();
	private delegate void GetPhysicalDeviceToolPropertiesEXTDelegate_0();
	...
	[Obsolete("Use GetBufferDeviceAddress")]
	public static void GetBufferDeviceAddressKHR() => GetBufferDeviceAddressKHR_0();
	private delegate void GetBufferDeviceAddressKHRDelegate_0();
	...
	public static void GetBufferOpaqueCaptureAddressKHR() => GetBufferOpaqueCaptureAddressKHR_0();
	private delegate void GetBufferOpaqueCaptureAddressKHRDelegate_0();
	...
	public static void GetDeviceMemoryOpaqueCaptureAddressKHR() => GetDeviceMemoryOpaqueCaptureAddressKHR_0();
	private delegate void GetDeviceMemoryOpaqueCaptureAddressKHRDelegate_0();
	...
	public static void ResetQueryPoolEXT() => ResetQueryPoolEXT_0();
	private delegate void ResetQueryPoolEXTDelegate_0();
	...
	public static void CommandSetCullModeEXT() => CommandSetCullModeEXT_0();
	private delegate void CommandSetCullModeEXTDelegate_0();
	...
	public static void CommandSetFrontFaceEXT() => CommandSetFrontFaceEXT_0();
	private delegate void CommandSetFrontFaceEXTDelegate_0();
	...
	public static void CommandSetPrimitiveTopologyEXT() => CommandSetPrimitiveTopologyEXT_0();
	private delegate void CommandSetPrimitiveTopologyEXTDelegate_0();
	...
	public static void CommandSetViewportWithCountEXT() => CommandSetViewportWithCountEXT_0();
	private delegate void CommandSetViewportWithCountEXTDelegate_0();
	...
	public static void CommandSetScissorWithCountEXT() => CommandSetScissorWithCountEXT_0();
	private delegate void CommandSetScissorWithCountEXTDelegate_0();
	...
	public static void CommandBindVertexBuffers2EXT() => CommandBindVertexBuffers2EXT_0();
	private delegate void CommandBindVertexBuffers2EXTDelegate_0();
	...
	public static void CommandSetDepthTestEnableEXT() => CommandSetDepthTestEnableEXT_0();
	private delegate void CommandSetDepthTestEnableEXTDelegate_0();
	...
	public static void CommandSetDepthWriteEnableEXT() => CommandSetDepthWriteEnableEXT_0();
	private delegate void CommandSetDepthWriteEnableEXTDelegate_0();
	...
	public static void CommandSetDepthCompareOpEXT() => CommandSetDepthCompareOpEXT_0();
	private delegate void CommandSetDepthCompareOpEXTDelegate_0();
	...
	public static void CommandSetDepthBoundsTestEnableEXT() => CommandSetDepthBoundsTestEnableEXT_0();
	private delegate void CommandSetDepthBoundsTestEnableEXTDelegate_0();
	...
	public static void CommandSetStencilTestEnableEXT() => CommandSetStencilTestEnableEXT_0();
	private delegate void CommandSetStencilTestEnableEXTDelegate_0();
	...
	public static void CommandSetStencilOpEXT() => CommandSetStencilOpEXT_0();
	private delegate void CommandSetStencilOpEXTDelegate_0();
	...
	public static void CreatePrivateDataSlotEXT() => CreatePrivateDataSlotEXT_0();
	private delegate void CreatePrivateDataSlotEXTDelegate_0();
	...
	public static void DestroyPrivateDataSlotEXT() => DestroyPrivateDataSlotEXT_0();
	private delegate void DestroyPrivateDataSlotEXTDelegate_0();
	...
	public static void SetPrivateDataEXT() => SetPrivateDataEXT_0();
	private delegate void SetPrivateDataEXTDelegate_0();
	...
	public static void GetPrivateDataEXT() => GetPrivateDataEXT_0();
	private delegate void GetPrivateDataEXTDelegate_0();
	...
	public static void CommandSetEvent2KHR() => CommandSetEvent2KHR_0();
	private delegate void CommandSetEvent2KHRDelegate_0();
	...
	public static void CommandResetEvent2KHR() => CommandResetEvent2KHR_0();
	private delegate void CommandResetEvent2KHRDelegate_0();
	...
	public static void CommandWaitEvents2KHR() => CommandWaitEvents2KHR_0();
	private delegate void CommandWaitEvents2KHRDelegate_0();
	...
	public static void CommandPipelineBarrier2KHR() => CommandPipelineBarrier2KHR_0();
	private delegate void CommandPipelineBarrier2KHRDelegate_0();
	...
	public static void CommandWriteTimestamp2KHR() => CommandWriteTimestamp2KHR_0();
	private delegate void CommandWriteTimestamp2KHRDelegate_0();
	...
	public static void QueueSubmit2KHR() => QueueSubmit2KHR_0();
	private delegate void QueueSubmit2KHRDelegate_0();
	...
	public static void CommandCopyBuffer2KHR() => CommandCopyBuffer2KHR_0();
	private delegate void CommandCopyBuffer2KHRDelegate_0();
	...
	public static void CommandCopyImage2KHR() => CommandCopyImage2KHR_0();
	private delegate void CommandCopyImage2KHRDelegate_0();
	...
	public static void CommandCopyBufferToImage2KHR() => CommandCopyBufferToImage2KHR_0();
	private delegate void CommandCopyBufferToImage2KHRDelegate_0();
	...
	public static void CommandCopyImageToBuffer2KHR() => CommandCopyImageToBuffer2KHR_0();
	private delegate void CommandCopyImageToBuffer2KHRDelegate_0();
	...
	public static void CommandBlitImage2KHR() => CommandBlitImage2KHR_0();
	private delegate void CommandBlitImage2KHRDelegate_0();
	...
	public static void CommandResolveImage2KHR() => CommandResolveImage2KHR_0();
	private delegate void CommandResolveImage2KHRDelegate_0();
	...
	private delegate VkResult GetPipelinePropertiesEXTDelegate_0(VkDevice device, VkPipelineInfoEXT* pipelineInfo, out VkBaseOutStructure pipelineProperties);
	...
	private delegate VkResult GetPipelinePropertiesEXTDelegate_1(VkDevice device, ref VkPipelineInfoEXT pipelineInfo, out VkBaseOutStructure pipelineProperties);
	...
	public static void CommandSetRasterizerDiscardEnableEXT() => CommandSetRasterizerDiscardEnableEXT_0();
	private delegate void CommandSetRasterizerDiscardEnableEXTDelegate_0();
	private static CommandSetRasterizerDiscardEnableEXTDelegate_0 CommandSetRasterizerDiscardEnableEXT_0;
	private static IntPtr CommandSetRasterizerDiscardEnableEXTPointer;
	[Obsolete("Use CommandSetDepthBiasEnable")]
	public static void CommandSetDepthBiasEnableEXT() => CommandSetDepthBiasEnableEXT_0();
	private delegate void CommandSetDepthBiasEnableEXTDelegate_0();
	private static CommandSetDepthBiasEnableEXTDelegate_0 CommandSetDepthBiasEnableEXT_0;
	private static IntPtr CommandSetDepthBiasEnableEXTPointer;
	...
	public static void CommandSetPrimitiveRestartEnableEXT() => CommandSetPrimitiveRestartEnableEXT_0();
	private delegate void CommandSetPrimitiveRestartEnableEXTDelegate_0();
	private static CommandSetPrimitiveRestartEnableEXTDelegate_0 CommandSetPrimitiveRestartEnableEXT_0;
	private static IntPtr CommandSetPrimitiveRestartEnableEXTPointer;
	...
	private delegate void CommandDrawClusterHUAWEIDelegate_0(VkCommandBuffer commandBuffer, uint groupCountX, uint groupCountY, uint groupCountZ);
	private static CommandDrawClusterHUAWEIDelegate_0 CommandDrawClusterHUAWEI_0;
	private static IntPtr CommandDrawClusterHUAWEIPointer;
	...
	private delegate void CommandDrawClusterIndirectHUAWEIDelegate_0(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset);
	private static CommandDrawClusterIndirectHUAWEIDelegate_0 CommandDrawClusterIndirectHUAWEI_0;
	private static IntPtr CommandDrawClusterIndirectHUAWEIPointer;
	...
	public static void GetDeviceBufferMemoryRequirementsKHR() => GetDeviceBufferMemoryRequirementsKHR_0();
	private delegate void GetDeviceBufferMemoryRequirementsKHRDelegate_0();
	private static GetDeviceBufferMemoryRequirementsKHRDelegate_0 GetDeviceBufferMemoryRequirementsKHR_0;
	private static IntPtr GetDeviceBufferMemoryRequirementsKHRPointer;
	[Obsolete("Use GetDeviceImageMemoryRequirements")]
	public static void GetDeviceImageMemoryRequirementsKHR() => GetDeviceImageMemoryRequirementsKHR_0();
	private delegate void GetDeviceImageMemoryRequirementsKHRDelegate_0();
	private static GetDeviceImageMemoryRequirementsKHRDelegate_0 GetDeviceImageMemoryRequirementsKHR_0;
	private static IntPtr GetDeviceImageMemoryRequirementsKHRPointer;
	[Obsolete("Use GetDeviceImageSparseMemoryRequirements")]
	public static void GetDeviceImageSparseMemoryRequirementsKHR() => GetDeviceImageSparseMemoryRequirementsKHR_0();
	private delegate void GetDeviceImageSparseMemoryRequirementsKHRDelegate_0();
	private static GetDeviceImageSparseMemoryRequirementsKHRDelegate_0 GetDeviceImageSparseMemoryRequirementsKHR_0;
	private static IntPtr GetDeviceImageSparseMemoryRequirementsKHRPointer;
	...
	public static void CommandSetRasterizationSamplesEXT(VkCommandBuffer commandBuffer, VkSampleCountFlagBits rasterizationSamples) => CommandSetRasterizationSamplesEXT_0(commandBuffer, rasterizationSamples);
	private delegate void CommandSetRasterizationSamplesEXTDelegate_0(VkCommandBuffer commandBuffer, VkSampleCountFlagBits rasterizationSamples);
	...
	public static void CommandSetSampleMaskEXT(VkCommandBuffer commandBuffer, VkSampleCountFlagBits samples, uint* sampleMask) => CommandSetSampleMaskEXT_0(commandBuffer, samples, sampleMask);
	private delegate void CommandSetSampleMaskEXTDelegate_0(VkCommandBuffer commandBuffer, VkSampleCountFlagBits samples, uint* sampleMask);
	private static CommandSetSampleMaskEXTDelegate_0 CommandSetSampleMaskEXT_0;
	public static void CommandSetSampleMaskEXT(VkCommandBuffer commandBuffer, VkSampleCountFlagBits samples, ref uint sampleMask) => CommandSetSampleMaskEXT_1(commandBuffer, samples, ref sampleMask);
	private delegate void CommandSetSampleMaskEXTDelegate_1(VkCommandBuffer commandBuffer, VkSampleCountFlagBits samples, ref uint sampleMask);
	...
	public static void InitialiseInstanceMethods(VkInstance instance)
	{
		...
		CommandDrawIndirectCountPointer = GetInstanceProcedureAddress(instance, "CommandDrawIndirectCount");
		...
		CommandDrawIndexedIndirectCountPointer = GetInstanceProcedureAddress(instance, "CommandDrawIndexedIndirectCount");
		...
		CreateRenderPass2Pointer = GetInstanceProcedureAddress(instance, "CreateRenderPass2");
		...
		CommandBeginRenderPass2Pointer = GetInstanceProcedureAddress(instance, "CommandBeginRenderPass2");
		...
		CommandNextSubpass2Pointer = GetInstanceProcedureAddress(instance, "CommandNextSubpass2");
		...
		CommandEndRenderPass2Pointer = GetInstanceProcedureAddress(instance, "CommandEndRenderPass2");
		...
		ResetQueryPoolPointer = GetInstanceProcedureAddress(instance, "ResetQueryPool");
		...
		GetSemaphoreCounterValuePointer = GetInstanceProcedureAddress(instance, "GetSemaphoreCounterValue");
		...
		WaitSemaphoresPointer = GetInstanceProcedureAddress(instance, "WaitSemaphores");
		...
		SignalSemaphorePointer = GetInstanceProcedureAddress(instance, "SignalSemaphore");
		...
		GetBufferDeviceAddressPointer = GetInstanceProcedureAddress(instance, "GetBufferDeviceAddress");
		...
		GetBufferOpaqueCaptureAddressPointer = GetInstanceProcedureAddress(instance, "GetBufferOpaqueCaptureAddress");
		...
		GetDeviceMemoryOpaqueCaptureAddressPointer = GetInstanceProcedureAddress(instance, "GetDeviceMemoryOpaqueCaptureAddress");
		...
		GetPhysicalDeviceToolPropertiesPointer = GetInstanceProcedureAddress(instance, "GetPhysicalDeviceToolProperties");
		...
		CreatePrivateDataSlotPointer = GetInstanceProcedureAddress(instance, "CreatePrivateDataSlot");
		...
		DestroyPrivateDataSlotPointer = GetInstanceProcedureAddress(instance, "DestroyPrivateDataSlot");
		...
		SetPrivateDataPointer = GetInstanceProcedureAddress(instance, "SetPrivateData");
		...
		GetPrivateDataPointer = GetInstanceProcedureAddress(instance, "GetPrivateData");
		...
		CommandSetEvent2Pointer = GetInstanceProcedureAddress(instance, "CommandSetEvent2");
		...
		CommandResetEvent2Pointer = GetInstanceProcedureAddress(instance, "CommandResetEvent2");
		...
		CommandWaitEvents2Pointer = GetInstanceProcedureAddress(instance, "CommandWaitEvents2");
		...
		CommandPipelineBarrier2Pointer = GetInstanceProcedureAddress(instance, "CommandPipelineBarrier2");
		...
		CommandWriteTimestamp2Pointer = GetInstanceProcedureAddress(instance, "CommandWriteTimestamp2");
		...
		QueueSubmit2Pointer = GetInstanceProcedureAddress(instance, "QueueSubmit2");
		...
		CommandCopyBuffer2Pointer = GetInstanceProcedureAddress(instance, "CommandCopyBuffer2");
		...
		CommandCopyImage2Pointer = GetInstanceProcedureAddress(instance, "CommandCopyImage2");
		...
		CommandCopyBufferToImage2Pointer = GetInstanceProcedureAddress(instance, "CommandCopyBufferToImage2");
		...
		CommandCopyImageToBuffer2Pointer = GetInstanceProcedureAddress(instance, "CommandCopyImageToBuffer2");
		...
		CommandBlitImage2Pointer = GetInstanceProcedureAddress(instance, "CommandBlitImage2");
		...
		CommandResolveImage2Pointer = GetInstanceProcedureAddress(instance, "CommandResolveImage2");
		...
		CommandBeginRenderingPointer = GetInstanceProcedureAddress(instance, "CommandBeginRendering");
		...
		CommandEndRenderingPointer = GetInstanceProcedureAddress(instance, "CommandEndRendering");
		...
		CommandSetCullModePointer = GetInstanceProcedureAddress(instance, "CommandSetCullMode");
		...
		CommandSetFrontFacePointer = GetInstanceProcedureAddress(instance, "CommandSetFrontFace");
		...
		CommandSetPrimitiveTopologyPointer = GetInstanceProcedureAddress(instance, "CommandSetPrimitiveTopology");
		...
		CommandSetViewportWithCountPointer = GetInstanceProcedureAddress(instance, "CommandSetViewportWithCount");
		...
		CommandSetScissorWithCountPointer = GetInstanceProcedureAddress(instance, "CommandSetScissorWithCount");
		...
		CommandBindVertexBuffers2Pointer = GetInstanceProcedureAddress(instance, "CommandBindVertexBuffers2");
		...
		CommandSetDepthTestEnablePointer = GetInstanceProcedureAddress(instance, "CommandSetDepthTestEnable");
		...
		CommandSetDepthWriteEnablePointer = GetInstanceProcedureAddress(instance, "CommandSetDepthWriteEnable");
		...
		CommandSetDepthCompareOpPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthCompareOp");
		...
		CommandSetDepthBoundsTestEnablePointer = GetInstanceProcedureAddress(instance, "CommandSetDepthBoundsTestEnable");
		...
		CommandSetStencilTestEnablePointer = GetInstanceProcedureAddress(instance, "CommandSetStencilTestEnable");
		...
		CommandSetStencilOpPointer = GetInstanceProcedureAddress(instance, "CommandSetStencilOp");
		...
		CommandSetRasterizerDiscardEnablePointer = GetInstanceProcedureAddress(instance, "CommandSetRasterizerDiscardEnable");
		...
		CommandSetDepthBiasEnablePointer = GetInstanceProcedureAddress(instance, "CommandSetDepthBiasEnable");
		...
		CommandSetPrimitiveRestartEnablePointer = GetInstanceProcedureAddress(instance, "CommandSetPrimitiveRestartEnable");
		...
		GetDeviceBufferMemoryRequirementsPointer = GetInstanceProcedureAddress(instance, "GetDeviceBufferMemoryRequirements");
		...
		GetDeviceImageMemoryRequirementsPointer = GetInstanceProcedureAddress(instance, "GetDeviceImageMemoryRequirements");
		...
		GetDeviceImageSparseMemoryRequirementsPointer = GetInstanceProcedureAddress(instance, "GetDeviceImageSparseMemoryRequirements");
		...
		GetPhysicalDeviceVideoCapabilitiesKHRPointer = GetInstanceProcedureAddress(instance, "GetPhysicalDeviceVideoCapabilitiesKHR");
		...
		GetPhysicalDeviceVideoFormatPropertiesKHRPointer = GetInstanceProcedureAddress(instance, "GetPhysicalDeviceVideoFormatPropertiesKHR");
		...
		CreateVideoSessionKHRPointer = GetInstanceProcedureAddress(instance, "CreateVideoSessionKHR");
		...
		DestroyVideoSessionKHRPointer = GetInstanceProcedureAddress(instance, "DestroyVideoSessionKHR");
		...
		GetVideoSessionMemoryRequirementsKHRPointer = GetInstanceProcedureAddress(instance, "GetVideoSessionMemoryRequirementsKHR");
		...
		BindVideoSessionMemoryKHRPointer = GetInstanceProcedureAddress(instance, "BindVideoSessionMemoryKHR");
		...
		CreateVideoSessionParametersKHRPointer = GetInstanceProcedureAddress(instance, "CreateVideoSessionParametersKHR");
		...
		UpdateVideoSessionParametersKHRPointer = GetInstanceProcedureAddress(instance, "UpdateVideoSessionParametersKHR");
		...
		DestroyVideoSessionParametersKHRPointer = GetInstanceProcedureAddress(instance, "DestroyVideoSessionParametersKHR");
		...
		CommandBeginVideoCodingKHRPointer = GetInstanceProcedureAddress(instance, "CommandBeginVideoCodingKHR");
		...
		CommandEndVideoCodingKHRPointer = GetInstanceProcedureAddress(instance, "CommandEndVideoCodingKHR");
		...
		CommandControlVideoCodingKHRPointer = GetInstanceProcedureAddress(instance, "CommandControlVideoCodingKHR");
		...
		CommandDecodeVideoKHRPointer = GetInstanceProcedureAddress(instance, "CommandDecodeVideoKHR");
		...
		CreateCuModuleNVXPointer = GetInstanceProcedureAddress(instance, "CreateCuModuleNVX");
		...
		CreateCuFunctionNVXPointer = GetInstanceProcedureAddress(instance, "CreateCuFunctionNVX");
		...
		DestroyCuModuleNVXPointer = GetInstanceProcedureAddress(instance, "DestroyCuModuleNVX");
		...
		DestroyCuFunctionNVXPointer = GetInstanceProcedureAddress(instance, "DestroyCuFunctionNVX");
		...
		CommandCuLaunchKernelNVXPointer = GetInstanceProcedureAddress(instance, "CommandCuLaunchKernelNVX");
		...
		GetImageViewAddressNVXPointer = GetInstanceProcedureAddress(instance, "GetImageViewAddressNVX");
		...
		CommandDrawIndirectCountAMDPointer = GetInstanceProcedureAddress(instance, "CommandDrawIndirectCount");
		...
		CommandDrawIndexedIndirectCountAMDPointer = GetInstanceProcedureAddress(instance, "CommandDrawIndexedIndirectCount");
		...
		CommandBeginRenderingKHRPointer = GetInstanceProcedureAddress(instance, "CommandBeginRendering");
		if (CommandBeginRenderingKHRPointer != IntPtr.Zero)
		{
			CommandBeginRenderingKHR_0 = Marshal.GetDelegateForFunctionPointer<CommandBeginRenderingKHRDelegate_0>(CommandBeginRenderingKHRPointer);
		}
		CommandEndRenderingKHRPointer = GetInstanceProcedureAddress(instance, "CommandEndRendering");
		if (CommandEndRenderingKHRPointer != IntPtr.Zero)
		{
			CommandEndRenderingKHR_0 = Marshal.GetDelegateForFunctionPointer<CommandEndRenderingKHRDelegate_0>(CommandEndRenderingKHRPointer);
		}
		...
		CreateRenderPass2KHRPointer = GetInstanceProcedureAddress(instance, "CreateRenderPass2");
		...
		CommandBeginRenderPass2KHRPointer = GetInstanceProcedureAddress(instance, "CommandBeginRenderPass2");
		...
		CommandNextSubpass2KHRPointer = GetInstanceProcedureAddress(instance, "CommandNextSubpass2");
		...
		CommandEndRenderPass2KHRPointer = GetInstanceProcedureAddress(instance, "CommandEndRenderPass2");
		...
		CreateAccelerationStructureKHRPointer = GetInstanceProcedureAddress(instance, "CreateAccelerationStructureKHR");
		...
		DestroyAccelerationStructureKHRPointer = GetInstanceProcedureAddress(instance, "DestroyAccelerationStructureKHR");
		...
		CommandBuildAccelerationStructuresKHRPointer = GetInstanceProcedureAddress(instance, "CommandBuildAccelerationStructuresKHR");
		...
		CommandBuildAccelerationStructuresIndirectKHRPointer = GetInstanceProcedureAddress(instance, "CommandBuildAccelerationStructuresIndirectKHR");
		...
		BuildAccelerationStructuresKHRPointer = GetInstanceProcedureAddress(instance, "BuildAccelerationStructuresKHR");
		...
		CopyAccelerationStructureKHRPointer = GetInstanceProcedureAddress(instance, "CopyAccelerationStructureKHR");
		...
		CopyAccelerationStructureToMemoryKHRPointer = GetInstanceProcedureAddress(instance, "CopyAccelerationStructureToMemoryKHR");
		...
		CopyMemoryToAccelerationStructureKHRPointer = GetInstanceProcedureAddress(instance, "CopyMemoryToAccelerationStructureKHR");
		...
		WriteAccelerationStructuresPropertiesKHRPointer = GetInstanceProcedureAddress(instance, "WriteAccelerationStructuresPropertiesKHR");
		...
		CommandCopyAccelerationStructureKHRPointer = GetInstanceProcedureAddress(instance, "CommandCopyAccelerationStructureKHR");
		...
		CommandCopyAccelerationStructureToMemoryKHRPointer = GetInstanceProcedureAddress(instance, "CommandCopyAccelerationStructureToMemoryKHR");
		...
		CommandCopyMemoryToAccelerationStructureKHRPointer = GetInstanceProcedureAddress(instance, "CommandCopyMemoryToAccelerationStructureKHR");
		...
		GetAccelerationStructureDeviceAddressKHRPointer = GetInstanceProcedureAddress(instance, "GetAccelerationStructureDeviceAddressKHR");
		...
		CommandWriteAccelerationStructuresPropertiesKHRPointer = GetInstanceProcedureAddress(instance, "CommandWriteAccelerationStructuresPropertiesKHR");
		...
		GetDeviceAccelerationStructureCompatibilityKHRPointer = GetInstanceProcedureAddress(instance, "GetDeviceAccelerationStructureCompatibilityKHR");
		...
		GetAccelerationStructureBuildSizesKHRPointer = GetInstanceProcedureAddress(instance, "GetAccelerationStructureBuildSizesKHR");
		...
		CommandTraceRaysKHRPointer = GetInstanceProcedureAddress(instance, "CommandTraceRaysKHR");
		...
		CreateRayTracingPipelinesKHRPointer = GetInstanceProcedureAddress(instance, "CreateRayTracingPipelinesKHR");
		...
		GetRayTracingShaderGroupHandlesKHRPointer = GetInstanceProcedureAddress(instance, "GetRayTracingShaderGroupHandlesKHR");
		...
		GetRayTracingCaptureReplayShaderGroupHandlesKHRPointer = GetInstanceProcedureAddress(instance, "GetRayTracingCaptureReplayShaderGroupHandlesKHR");
		...
		CommandTraceRaysIndirectKHRPointer = GetInstanceProcedureAddress(instance, "CommandTraceRaysIndirectKHR");
		...
		GetRayTracingShaderGroupStackSizeKHRPointer = GetInstanceProcedureAddress(instance, "GetRayTracingShaderGroupStackSizeKHR");
		...
		CommandSetRayTracingPipelineStackSizeKHRPointer = GetInstanceProcedureAddress(instance, "CommandSetRayTracingPipelineStackSizeKHR");
		...
		GetRayTracingShaderGroupHandlesNVPointer = GetInstanceProcedureAddress(instance, "GetRayTracingShaderGroupHandlesKHR");
		...
		CommandDrawIndirectCountKHRPointer = GetInstanceProcedureAddress(instance, "CommandDrawIndirectCount");
		...
		CommandDrawIndexedIndirectCountKHRPointer = GetInstanceProcedureAddress(instance, "CommandDrawIndexedIndirectCount");
		...
		GetSemaphoreCounterValueKHRPointer = GetInstanceProcedureAddress(instance, "GetSemaphoreCounterValue");
		...
		WaitSemaphoresKHRPointer = GetInstanceProcedureAddress(instance, "WaitSemaphores");
		...
		SignalSemaphoreKHRPointer = GetInstanceProcedureAddress(instance, "SignalSemaphore");
		...
		GetPhysicalDeviceFragmentShadingRatesKHRPointer = GetInstanceProcedureAddress(instance, "GetPhysicalDeviceFragmentShadingRatesKHR");
		...
		CommandSetFragmentShadingRateKHRPointer = GetInstanceProcedureAddress(instance, "CommandSetFragmentShadingRateKHR");
		...
		GetBufferDeviceAddressEXTPointer = GetInstanceProcedureAddress(instance, "GetBufferDeviceAddress");
		...
		GetPhysicalDeviceToolPropertiesEXTPointer = GetInstanceProcedureAddress(instance, "GetPhysicalDeviceToolProperties");
		...
		WaitForPresentKHRPointer = GetInstanceProcedureAddress(instance, "WaitForPresentKHR");
		...
		GetBufferDeviceAddressKHRPointer = GetInstanceProcedureAddress(instance, "GetBufferDeviceAddress");
		...
		GetBufferOpaqueCaptureAddressKHRPointer = GetInstanceProcedureAddress(instance, "GetBufferOpaqueCaptureAddress");
		...
		GetDeviceMemoryOpaqueCaptureAddressKHRPointer = GetInstanceProcedureAddress(instance, "GetDeviceMemoryOpaqueCaptureAddress");
		...
		ResetQueryPoolEXTPointer = GetInstanceProcedureAddress(instance, "ResetQueryPool");
		...
		CommandSetCullModeEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetCullMode");
		...
		CommandSetFrontFaceEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetFrontFace");
		...
		CommandSetPrimitiveTopologyEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetPrimitiveTopology");
		...
		CommandSetViewportWithCountEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetViewportWithCount");
		...
		CommandSetScissorWithCountEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetScissorWithCount");
		...
		CommandBindVertexBuffers2EXTPointer = GetInstanceProcedureAddress(instance, "CommandBindVertexBuffers2");
		...
		CommandSetDepthTestEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthTestEnable");
		...
		CommandSetDepthWriteEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthWriteEnable");
		...
		CommandSetDepthCompareOpEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthCompareOp");
		...
		CommandSetDepthBoundsTestEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthBoundsTestEnable");
		...
		CommandSetStencilTestEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetStencilTestEnable");
		...
		CommandSetStencilOpEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetStencilOp");
		...
		CreateDeferredOperationKHRPointer = GetInstanceProcedureAddress(instance, "CreateDeferredOperationKHR");
		...
		DestroyDeferredOperationKHRPointer = GetInstanceProcedureAddress(instance, "DestroyDeferredOperationKHR");
		...
		GetDeferredOperationMaxConcurrencyKHRPointer = GetInstanceProcedureAddress(instance, "GetDeferredOperationMaxConcurrencyKHR");
		...
		GetDeferredOperationResultKHRPointer = GetInstanceProcedureAddress(instance, "GetDeferredOperationResultKHR");
		...
		DeferredOperationJoinKHRPointer = GetInstanceProcedureAddress(instance, "DeferredOperationJoinKHR");
		...
		ReleaseSwapchainImagesEXTPointer = GetInstanceProcedureAddress(instance, "ReleaseSwapchainImagesEXT");
		...
		GetGeneratedCommandsMemoryRequirementsNVPointer = GetInstanceProcedureAddress(instance, "GetGeneratedCommandsMemoryRequirementsNV");
		...
		CommandPreprocessGeneratedCommandsNVPointer = GetInstanceProcedureAddress(instance, "CommandPreprocessGeneratedCommandsNV");
		...
		CommandExecuteGeneratedCommandsNVPointer = GetInstanceProcedureAddress(instance, "CommandExecuteGeneratedCommandsNV");
		...
		CommandBindPipelineShaderGroupNVPointer = GetInstanceProcedureAddress(instance, "CommandBindPipelineShaderGroupNV");
		...
		CreateIndirectCommandsLayoutNVPointer = GetInstanceProcedureAddress(instance, "CreateIndirectCommandsLayoutNV");
		...
		DestroyIndirectCommandsLayoutNVPointer = GetInstanceProcedureAddress(instance, "DestroyIndirectCommandsLayoutNV");
		...
		AcquireDrmDisplayEXTPointer = GetInstanceProcedureAddress(instance, "AcquireDrmDisplayEXT");
		...
		GetDrmDisplayEXTPointer = GetInstanceProcedureAddress(instance, "GetDrmDisplayEXT");
		...
		CreatePrivateDataSlotEXTPointer = GetInstanceProcedureAddress(instance, "CreatePrivateDataSlot");
		...
		DestroyPrivateDataSlotEXTPointer = GetInstanceProcedureAddress(instance, "DestroyPrivateDataSlot");
		...
		SetPrivateDataEXTPointer = GetInstanceProcedureAddress(instance, "SetPrivateData");
		...
		GetPrivateDataEXTPointer = GetInstanceProcedureAddress(instance, "GetPrivateData");
		...
		CommandSetEvent2KHRPointer = GetInstanceProcedureAddress(instance, "CommandSetEvent2");
		...
		CommandResetEvent2KHRPointer = GetInstanceProcedureAddress(instance, "CommandResetEvent2");
		...
		CommandWaitEvents2KHRPointer = GetInstanceProcedureAddress(instance, "CommandWaitEvents2");
		...
		CommandPipelineBarrier2KHRPointer = GetInstanceProcedureAddress(instance, "CommandPipelineBarrier2");
		...
		CommandWriteTimestamp2KHRPointer = GetInstanceProcedureAddress(instance, "CommandWriteTimestamp2");
		...
		QueueSubmit2KHRPointer = GetInstanceProcedureAddress(instance, "QueueSubmit2");
		...
		CommandWriteBufferMarker2AMDPointer = GetInstanceProcedureAddress(instance, "CommandWriteBufferMarker2AMD");
		...
		GetQueueCheckpointData2NVPointer = GetInstanceProcedureAddress(instance, "GetQueueCheckpointData2NV");
		...
		GetDescriptorSetLayoutSizeEXTPointer = GetInstanceProcedureAddress(instance, "GetDescriptorSetLayoutSizeEXT");
		...
		GetDescriptorSetLayoutBindingOffsetEXTPointer = GetInstanceProcedureAddress(instance, "GetDescriptorSetLayoutBindingOffsetEXT");
		...
		GetDescriptorEXTPointer = GetInstanceProcedureAddress(instance, "GetDescriptorEXT");
		...
		CommandBindDescriptorBuffersEXTPointer = GetInstanceProcedureAddress(instance, "CommandBindDescriptorBuffersEXT");
		...
		CommandSetDescriptorBufferOffsetsEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDescriptorBufferOffsetsEXT");
		...
		CommandBindDescriptorBufferEmbeddedSamplersEXTPointer = GetInstanceProcedureAddress(instance, "CommandBindDescriptorBufferEmbeddedSamplersEXT");
		...
		GetBufferOpaqueCaptureDescriptorDataEXTPointer = GetInstanceProcedureAddress(instance, "GetBufferOpaqueCaptureDescriptorDataEXT");
		...
		GetImageOpaqueCaptureDescriptorDataEXTPointer = GetInstanceProcedureAddress(instance, "GetImageOpaqueCaptureDescriptorDataEXT");
		...
		GetImageViewOpaqueCaptureDescriptorDataEXTPointer = GetInstanceProcedureAddress(instance, "GetImageViewOpaqueCaptureDescriptorDataEXT");
		...
		GetSamplerOpaqueCaptureDescriptorDataEXTPointer = GetInstanceProcedureAddress(instance, "GetSamplerOpaqueCaptureDescriptorDataEXT");
		...
		GetAccelerationStructureOpaqueCaptureDescriptorDataEXTPointer = GetInstanceProcedureAddress(instance, "GetAccelerationStructureOpaqueCaptureDescriptorDataEXT");
		...
		CommandSetFragmentShadingRateEnumNVPointer = GetInstanceProcedureAddress(instance, "CommandSetFragmentShadingRateEnumNV");
		...
		CommandDrawMeshTasksEXTPointer = GetInstanceProcedureAddress(instance, "CommandDrawMeshTasksEXT");
		...
		CommandDrawMeshTasksIndirectEXTPointer = GetInstanceProcedureAddress(instance, "CommandDrawMeshTasksIndirectEXT");
		...
		CommandDrawMeshTasksIndirectCountEXTPointer = GetInstanceProcedureAddress(instance, "CommandDrawMeshTasksIndirectCountEXT");
		...
		CommandCopyBuffer2KHRPointer = GetInstanceProcedureAddress(instance, "CommandCopyBuffer2");
		...
		CommandCopyImage2KHRPointer = GetInstanceProcedureAddress(instance, "CommandCopyImage2");
		...
		CommandCopyBufferToImage2KHRPointer = GetInstanceProcedureAddress(instance, "CommandCopyBufferToImage2");
		...
		CommandCopyImageToBuffer2KHRPointer = GetInstanceProcedureAddress(instance, "CommandCopyImageToBuffer2");
		...
		CommandBlitImage2KHRPointer = GetInstanceProcedureAddress(instance, "CommandBlitImage2");
		...
		CommandResolveImage2KHRPointer = GetInstanceProcedureAddress(instance, "CommandResolveImage2");
		...
		GetImageSubresourceLayout2EXTPointer = GetInstanceProcedureAddress(instance, "GetImageSubresourceLayout2EXT");
		...
		GetDeviceFaultInfoEXTPointer = GetInstanceProcedureAddress(instance, "GetDeviceFaultInfoEXT");
		...
		AcquireWinrtDisplayNVPointer = GetInstanceProcedureAddress(instance, "AcquireWinrtDisplayNV");
		...
		GetWinrtDisplayNVPointer = GetInstanceProcedureAddress(instance, "GetWinrtDisplayNV");
		...
		CommandSetVertexInputEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetVertexInputEXT");
		...
		GetDeviceSubpassShadingMaxWorkgroupSizeHUAWEIPointer = GetInstanceProcedureAddress(instance, "GetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI");
		...
		CommandSubpassShadingHUAWEIPointer = GetInstanceProcedureAddress(instance, "CommandSubpassShadingHUAWEI");
		...
		CommandBindInvocationMaskHUAWEIPointer = GetInstanceProcedureAddress(instance, "CommandBindInvocationMaskHUAWEI");
		...
		GetMemoryRemoteAddressNVPointer = GetInstanceProcedureAddress(instance, "GetMemoryRemoteAddressNV");
		...
		GetPipelinePropertiesEXTPointer = GetInstanceProcedureAddress(instance, "GetPipelinePropertiesEXT");
		...
		CommandSetPatchControlPointsEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetPatchControlPointsEXT");
		...
		CommandSetRasterizerDiscardEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetRasterizerDiscardEnable");
		if (CommandSetRasterizerDiscardEnableEXTPointer != IntPtr.Zero)
		{
			CommandSetRasterizerDiscardEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetRasterizerDiscardEnableEXTDelegate_0>(CommandSetRasterizerDiscardEnableEXTPointer);
		}
		CommandSetDepthBiasEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthBiasEnable");
		if (CommandSetDepthBiasEnableEXTPointer != IntPtr.Zero)
		{
			CommandSetDepthBiasEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetDepthBiasEnableEXTDelegate_0>(CommandSetDepthBiasEnableEXTPointer);
		}
		CommandSetLogicOpEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetLogicOpEXT");
		...
		CommandSetPrimitiveRestartEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetPrimitiveRestartEnable");
		if (CommandSetPrimitiveRestartEnableEXTPointer != IntPtr.Zero)
		{
			CommandSetPrimitiveRestartEnableEXT_0 = Marshal.GetDelegateForFunctionPointer<CommandSetPrimitiveRestartEnableEXTDelegate_0>(CommandSetPrimitiveRestartEnableEXTPointer);
		}
		CommandSetColorWriteEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetColorWriteEnableEXT");
		...
		CommandTraceRaysIndirect2KHRPointer = GetInstanceProcedureAddress(instance, "CommandTraceRaysIndirect2KHR");
		...
		CommandDrawMultiEXTPointer = GetInstanceProcedureAddress(instance, "CommandDrawMultiEXT");
		...
		CommandDrawMultiIndexedEXTPointer = GetInstanceProcedureAddress(instance, "CommandDrawMultiIndexedEXT");
		...
		CreateMicromapEXTPointer = GetInstanceProcedureAddress(instance, "CreateMicromapEXT");
		...
		DestroyMicromapEXTPointer = GetInstanceProcedureAddress(instance, "DestroyMicromapEXT");
		...
		CommandBuildMicromapsEXTPointer = GetInstanceProcedureAddress(instance, "CommandBuildMicromapsEXT");
		...
		BuildMicromapsEXTPointer = GetInstanceProcedureAddress(instance, "BuildMicromapsEXT");
		...
		CopyMicromapEXTPointer = GetInstanceProcedureAddress(instance, "CopyMicromapEXT");
		...
		CopyMicromapToMemoryEXTPointer = GetInstanceProcedureAddress(instance, "CopyMicromapToMemoryEXT");
		...
		CopyMemoryToMicromapEXTPointer = GetInstanceProcedureAddress(instance, "CopyMemoryToMicromapEXT");
		...
		WriteMicromapsPropertiesEXTPointer = GetInstanceProcedureAddress(instance, "WriteMicromapsPropertiesEXT");
		...
		CommandCopyMicromapEXTPointer = GetInstanceProcedureAddress(instance, "CommandCopyMicromapEXT");
		...
		CommandCopyMicromapToMemoryEXTPointer = GetInstanceProcedureAddress(instance, "CommandCopyMicromapToMemoryEXT");
		...
		CommandCopyMemoryToMicromapEXTPointer = GetInstanceProcedureAddress(instance, "CommandCopyMemoryToMicromapEXT");
		...
		CommandWriteMicromapsPropertiesEXTPointer = GetInstanceProcedureAddress(instance, "CommandWriteMicromapsPropertiesEXT");
		...
		GetDeviceMicromapCompatibilityEXTPointer = GetInstanceProcedureAddress(instance, "GetDeviceMicromapCompatibilityEXT");
		...
		GetMicromapBuildSizesEXTPointer = GetInstanceProcedureAddress(instance, "GetMicromapBuildSizesEXT");
		...
		CommandDrawClusterHUAWEIPointer = GetInstanceProcedureAddress(instance, "CommandDrawClusterHUAWEI");
		if (CommandDrawClusterHUAWEIPointer != IntPtr.Zero)
		{
			CommandDrawClusterHUAWEI_0 = Marshal.GetDelegateForFunctionPointer<CommandDrawClusterHUAWEIDelegate_0>(CommandDrawClusterHUAWEIPointer);
		}
		CommandDrawClusterIndirectHUAWEIPointer = GetInstanceProcedureAddress(instance, "CommandDrawClusterIndirectHUAWEI");
		if (CommandDrawClusterIndirectHUAWEIPointer != IntPtr.Zero)
		{
			CommandDrawClusterIndirectHUAWEI_0 = Marshal.GetDelegateForFunctionPointer<CommandDrawClusterIndirectHUAWEIDelegate_0>(CommandDrawClusterIndirectHUAWEIPointer);
		}
		SetDeviceMemoryPriorityEXTPointer = GetInstanceProcedureAddress(instance, "SetDeviceMemoryPriorityEXT");
		...
		GetDeviceBufferMemoryRequirementsKHRPointer = GetInstanceProcedureAddress(instance, "GetDeviceBufferMemoryRequirements");
		if (GetDeviceBufferMemoryRequirementsKHRPointer != IntPtr.Zero)
		{
			GetDeviceBufferMemoryRequirementsKHR_0 = Marshal.GetDelegateForFunctionPointer<GetDeviceBufferMemoryRequirementsKHRDelegate_0>(GetDeviceBufferMemoryRequirementsKHRPointer);
		}
		GetDeviceImageMemoryRequirementsKHRPointer = GetInstanceProcedureAddress(instance, "GetDeviceImageMemoryRequirements");
		if (GetDeviceImageMemoryRequirementsKHRPointer != IntPtr.Zero)
		{
			GetDeviceImageMemoryRequirementsKHR_0 = Marshal.GetDelegateForFunctionPointer<GetDeviceImageMemoryRequirementsKHRDelegate_0>(GetDeviceImageMemoryRequirementsKHRPointer);
		}
		GetDeviceImageSparseMemoryRequirementsKHRPointer = GetInstanceProcedureAddress(instance, "GetDeviceImageSparseMemoryRequirements");
		if (GetDeviceImageSparseMemoryRequirementsKHRPointer != IntPtr.Zero)
		{
			GetDeviceImageSparseMemoryRequirementsKHR_0 = Marshal.GetDelegateForFunctionPointer<GetDeviceImageSparseMemoryRequirementsKHRDelegate_0>(GetDeviceImageSparseMemoryRequirementsKHRPointer);
		}
		GetDescriptorSetLayoutHostMappingInfoVALVEPointer = GetInstanceProcedureAddress(instance, "GetDescriptorSetLayoutHostMappingInfoVALVE");
		...
		GetDescriptorSetHostMappingVALVEPointer = GetInstanceProcedureAddress(instance, "GetDescriptorSetHostMappingVALVE");
		...
		CommandCopyMemoryIndirectNVPointer = GetInstanceProcedureAddress(instance, "CommandCopyMemoryIndirectNV");
		...
		CommandCopyMemoryToImageIndirectNVPointer = GetInstanceProcedureAddress(instance, "CommandCopyMemoryToImageIndirectNV");
		...
		CommandDecompressMemoryNVPointer = GetInstanceProcedureAddress(instance, "CommandDecompressMemoryNV");
		...
		CommandDecompressMemoryIndirectCountNVPointer = GetInstanceProcedureAddress(instance, "CommandDecompressMemoryIndirectCountNV");
		...
		CommandSetTessellationDomainOriginEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetTessellationDomainOriginEXT");
		...
		CommandSetDepthClampEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthClampEnableEXT");
		...
		CommandSetPolygonModeEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetPolygonModeEXT");
		...
		CommandSetRasterizationSamplesEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetRasterizationSamplesEXT");
		...
		CommandSetSampleMaskEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetSampleMaskEXT");
		...
		CommandSetAlphaToCoverageEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetAlphaToCoverageEnableEXT");
		...
		CommandSetAlphaToOneEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetAlphaToOneEnableEXT");
		...
		CommandSetLogicOpEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetLogicOpEnableEXT");
		...
		CommandSetColorBlendEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetColorBlendEnableEXT");
		...
		CommandSetColorBlendEquationEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetColorBlendEquationEXT");
		...
		CommandSetColorWriteMaskEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetColorWriteMaskEXT");
		...
		CommandSetRasterizationStreamEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetRasterizationStreamEXT");
		...
		CommandSetConservativeRasterizationModeEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetConservativeRasterizationModeEXT");
		...
		CommandSetExtraPrimitiveOverestimationSizeEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetExtraPrimitiveOverestimationSizeEXT");
		...
		CommandSetDepthClipEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthClipEnableEXT");
		...
		CommandSetSampleLocationsEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetSampleLocationsEnableEXT");
		...
		CommandSetColorBlendAdvancedEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetColorBlendAdvancedEXT");
		...
		CommandSetProvokingVertexModeEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetProvokingVertexModeEXT");
		...
		CommandSetLineRasterizationModeEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetLineRasterizationModeEXT");
		...
		CommandSetLineStippleEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetLineStippleEnableEXT");
		...
		CommandSetDepthClipNegativeOneToOneEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthClipNegativeOneToOneEXT");
		...
		CommandSetViewportWScalingEnableNVPointer = GetInstanceProcedureAddress(instance, "CommandSetViewportWScalingEnableNV");
		...
		CommandSetViewportSwizzleNVPointer = GetInstanceProcedureAddress(instance, "CommandSetViewportSwizzleNV");
		...
		CommandSetCoverageToColorEnableNVPointer = GetInstanceProcedureAddress(instance, "CommandSetCoverageToColorEnableNV");
		...
		CommandSetCoverageToColorLocationNVPointer = GetInstanceProcedureAddress(instance, "CommandSetCoverageToColorLocationNV");
		...
		CommandSetCoverageModulationModeNVPointer = GetInstanceProcedureAddress(instance, "CommandSetCoverageModulationModeNV");
		...
		CommandSetCoverageModulationTableEnableNVPointer = GetInstanceProcedureAddress(instance, "CommandSetCoverageModulationTableEnableNV");
		...
		CommandSetCoverageModulationTableNVPointer = GetInstanceProcedureAddress(instance, "CommandSetCoverageModulationTableNV");
		...
		CommandSetShadingRateImageEnableNVPointer = GetInstanceProcedureAddress(instance, "CommandSetShadingRateImageEnableNV");
		...
		CommandSetRepresentativeFragmentTestEnableNVPointer = GetInstanceProcedureAddress(instance, "CommandSetRepresentativeFragmentTestEnableNV");
		...
		CommandSetCoverageReductionModeNVPointer = GetInstanceProcedureAddress(instance, "CommandSetCoverageReductionModeNV");
		...
		GetShaderModuleIdentifierEXTPointer = GetInstanceProcedureAddress(instance, "GetShaderModuleIdentifierEXT");
		...
		GetShaderModuleCreateInfoIdentifierEXTPointer = GetInstanceProcedureAddress(instance, "GetShaderModuleCreateInfoIdentifierEXT");
		...
		GetPhysicalDeviceOpticalFlowImageFormatsNVPointer = GetInstanceProcedureAddress(instance, "GetPhysicalDeviceOpticalFlowImageFormatsNV");
		...
		CreateOpticalFlowSessionNVPointer = GetInstanceProcedureAddress(instance, "CreateOpticalFlowSessionNV");
		...
		DestroyOpticalFlowSessionNVPointer = GetInstanceProcedureAddress(instance, "DestroyOpticalFlowSessionNV");
		...
		BindOpticalFlowSessionImageNVPointer = GetInstanceProcedureAddress(instance, "BindOpticalFlowSessionImageNV");
		...
		CommandOpticalFlowExecuteNVPointer = GetInstanceProcedureAddress(instance, "CommandOpticalFlowExecuteNV");
		...
		GetFramebufferTilePropertiesQCOMPointer = GetInstanceProcedureAddress(instance, "GetFramebufferTilePropertiesQCOM");
		...
		GetDynamicRenderingTilePropertiesQCOMPointer = GetInstanceProcedureAddress(instance, "GetDynamicRenderingTilePropertiesQCOM");
