...
public enum VkImageCreateFlags
{
	...
	VK_IMAGE_CREATE_BIND_SFR_BIT_KHX = 1 << 6,
...
public enum VkMemoryHeapFlags
{
	...
	VK_MEMORY_HEAP_MULTI_INSTANCE_BIT_KHX = 1 << 1,
}
[Flags]
...
public enum VkPipelineCreateFlags
{
	...
	VK_PIPELINE_CREATE_VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHX = 1 << 3,
	VK_PIPELINE_CREATE_DISPATCH_BASE_KHX = 1 << 4,
}
[Flags]
...
public enum VkDependencyFlags
{
	...
	VK_DEPENDENCY_VIEW_LOCAL_BIT_KHX = 1 << 1,
	VK_DEPENDENCY_DEVICE_GROUP_BIT_KHX = 1 << 2,
}
[Flags]
...
{
	VK_SWAPCHAIN_CREATE_BIND_SFR_BIT_KHX = 1 << 0,
}
[Flags]
...
{
	VK_PEER_MEMORY_FEATURE_COPY_SRC_BIT_KHX = 1 << 0,
	VK_PEER_MEMORY_FEATURE_COPY_DST_BIT_KHX = 1 << 1,
	VK_PEER_MEMORY_FEATURE_GENERIC_SRC_BIT_KHX = 1 << 2,
	VK_PEER_MEMORY_FEATURE_GENERIC_DST_BIT_KHX = 1 << 3,
}
[Flags]
public enum VkMemoryAllocateFlagsKHX
{
	VK_MEMORY_ALLOCATE_DEVICE_MASK_BIT_KHX = 1 << 0,
}
[Flags]
public enum VkDeviceGroupPresentModeFlagsKHX
{
	VK_DEVICE_GROUP_PRESENT_MODE_LOCAL_BIT_KHX = 1 << 0,
	VK_DEVICE_GROUP_PRESENT_MODE_REMOTE_BIT_KHX = 1 << 1,
	VK_DEVICE_GROUP_PRESENT_MODE_SUM_BIT_KHX = 1 << 2,
	VK_DEVICE_GROUP_PRESENT_MODE_LOCAL_MULTI_DEVICE_BIT_KHX = 1 << 3,
}
