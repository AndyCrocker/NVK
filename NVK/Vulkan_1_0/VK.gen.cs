...
public static unsafe class VK
{
	...
	public static void InitialiseInstanceMethods(VkInstance instance)
	{
		...
		var commandDrawIndirectCountAMD = GetInstanceProcedureAddress(instance, "vkCmdDrawIndirectCountAMD");
		...
		var commandDrawIndexedIndirectCountAMD = GetInstanceProcedureAddress(instance, "vkCmdDrawIndexedIndirectCountAMD");
		...
		var getPhysicalDeviceFeatures2KHR = GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceFeatures2KHR");
		...
		var getPhysicalDeviceProperties2KHR = GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceProperties2KHR");
		...
		var getPhysicalDeviceFormatProperties2KHR = GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceFormatProperties2KHR");
		...
		var getPhysicalDeviceImageFormatProperties2KHR = GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceImageFormatProperties2KHR");
		...
		var getPhysicalDeviceQueueFamilyProperties2KHR = GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceQueueFamilyProperties2KHR");
		...
		var getPhysicalDeviceMemoryProperties2KHR = GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceMemoryProperties2KHR");
		...
		var getPhysicalDeviceSparseImageFormatProperties2KHR = GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceSparseImageFormatProperties2KHR");
		...
		var getDeviceGroupPeerMemoryFeaturesKHX = GetInstanceProcedureAddress(instance, "vkGetDeviceGroupPeerMemoryFeaturesKHX");
		...
		var commandSetDeviceMaskKHX = GetInstanceProcedureAddress(instance, "vkCmdSetDeviceMaskKHX");
		CommandSetDeviceMaskKHX_0 = (delegate* unmanaged[Cdecl]<VkCommandBuffer, uint, void>)commandSetDeviceMaskKHX;
		var commandDispatchBaseKHX = GetInstanceProcedureAddress(instance, "vkCmdDispatchBaseKHX");
		...
		var getDeviceGroupPresentCapabilitiesKHX = GetInstanceProcedureAddress(instance, "vkGetDeviceGroupPresentCapabilitiesKHX");
		...
		var getDeviceGroupSurfacePresentModesKHX = GetInstanceProcedureAddress(instance, "vkGetDeviceGroupSurfacePresentModesKHX");
		...
		var getPhysicalDevicePresentRectanglesKHX = GetInstanceProcedureAddress(instance, "vkGetPhysicalDevicePresentRectanglesKHX");
		...
		var acquireNextImage2KHX = GetInstanceProcedureAddress(instance, "vkAcquireNextImage2KHX");
		...
		var createViSurfaceNN = GetInstanceProcedureAddress(instance, "vkCreateViSurfaceNN");
		...
		var trimCommandPoolKHR = GetInstanceProcedureAddress(instance, "vkTrimCommandPoolKHR");
		TrimCommandPoolKHR_0 = (delegate* unmanaged[Cdecl]<VkDevice, VkCommandPool, VkCommandPoolTrimFlagsKHR, void>)trimCommandPoolKHR;
		var enumeratePhysicalDeviceGroupsKHX = GetInstanceProcedureAddress(instance, "vkEnumeratePhysicalDeviceGroupsKHX");
		...
		var getPhysicalDeviceExternalBufferPropertiesKHR = GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceExternalBufferPropertiesKHR");
		...
		var getPhysicalDeviceExternalSemaphorePropertiesKHR = GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceExternalSemaphorePropertiesKHR");
		...
		var createDescriptorUpdateTemplateKHR = GetInstanceProcedureAddress(instance, "vkCreateDescriptorUpdateTemplateKHR");
		...
		var destroyDescriptorUpdateTemplateKHR = GetInstanceProcedureAddress(instance, "vkDestroyDescriptorUpdateTemplateKHR");
		...
		var updateDescriptorSetWithTemplateKHR = GetInstanceProcedureAddress(instance, "vkUpdateDescriptorSetWithTemplateKHR");
		...
		var acquireXlibDisplayEXT = GetInstanceProcedureAddress(instance, "vkAcquireXlibDisplayEXT");
		AcquireXlibDisplayEXT_0 = (delegate* unmanaged[Cdecl]<VkPhysicalDevice, void*, VkDisplayKHR, VkResult>)acquireXlibDisplayEXT;
		var getRandROutputDisplayEXT = GetInstanceProcedureAddress(instance, "vkGetRandROutputDisplayEXT");
		...
		var getPhysicalDeviceExternalFencePropertiesKHR = GetInstanceProcedureAddress(instance, "vkGetPhysicalDeviceExternalFencePropertiesKHR");
		...
		var createIOSSurfaceMVK = GetInstanceProcedureAddress(instance, "vkCreateIOSSurfaceMVK");
		...
		var getImageMemoryRequirements2KHR = GetInstanceProcedureAddress(instance, "vkGetImageMemoryRequirements2KHR");
		...
		var getBufferMemoryRequirements2KHR = GetInstanceProcedureAddress(instance, "vkGetBufferMemoryRequirements2KHR");
		...
		var getImageSparseMemoryRequirements2KHR = GetInstanceProcedureAddress(instance, "vkGetImageSparseMemoryRequirements2KHR");
		...
		var createSamplerYcbcrConversionKHR = GetInstanceProcedureAddress(instance, "vkCreateSamplerYcbcrConversionKHR");
		...
		var destroySamplerYcbcrConversionKHR = GetInstanceProcedureAddress(instance, "vkDestroySamplerYcbcrConversionKHR");
		...
		var bindBufferMemory2KHR = GetInstanceProcedureAddress(instance, "vkBindBufferMemory2KHR");
		BindBufferMemory2KHR_0 = (delegate* unmanaged[Cdecl]<VkDevice, uint, VkBindBufferMemoryInfoKHR[], VkResult>)bindBufferMemory2KHR;
		var bindImageMemory2KHR = GetInstanceProcedureAddress(instance, "vkBindImageMemory2KHR");
