...
public static unsafe class VK
{
	...
	public static VkResult vkGetPhysicalDeviceToolPropertiesEXT(VkPhysicalDevice physicalDevice, uint* pToolCount, VkPhysicalDeviceToolPropertiesEXT* pToolProperties) => vkGetPhysicalDeviceToolPropertiesEXT_0(physicalDevice, pToolCount, pToolProperties);
	private delegate VkResult vkGetPhysicalDeviceToolPropertiesEXTDelegate_0(VkPhysicalDevice physicalDevice, uint* pToolCount, VkPhysicalDeviceToolPropertiesEXT* pToolProperties);
	...
	public static VkResult vkSetPrivateDataEXT(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlotEXT privateDataSlot, ulong data) => vkSetPrivateDataEXT_0(device, objectType, objectHandle, privateDataSlot, data);
	private delegate VkResult vkSetPrivateDataEXTDelegate_0(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlotEXT privateDataSlot, ulong data);
	private static IntPtr vkSetPrivateDataEXTPointer;
	private static vkSetPrivateDataEXTDelegate_0 vkSetPrivateDataEXT_0;
	public static void vkGetPrivateDataEXT(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlotEXT privateDataSlot, ulong* pData) => vkGetPrivateDataEXT_0(device, objectType, objectHandle, privateDataSlot, pData);
	private delegate void vkGetPrivateDataEXTDelegate_0(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlotEXT privateDataSlot, ulong* pData);
	...
	public static void vkCmdWaitEvents2KHR(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, VkDependencyInfoKHR* pDependencyInfos) => vkCmdWaitEvents2KHR_0(commandBuffer, eventCount, pEvents, pDependencyInfos);
	private delegate void vkCmdWaitEvents2KHRDelegate_0(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, VkDependencyInfoKHR* pDependencyInfos);
	...
	public static void vkCmdWriteTimestamp2KHR(VkCommandBuffer commandBuffer, VkPipelineStageFlags2KHR stage, VkQueryPool queryPool, uint query) => vkCmdWriteTimestamp2KHR_0(commandBuffer, stage, queryPool, query);
	private delegate void vkCmdWriteTimestamp2KHRDelegate_0(VkCommandBuffer commandBuffer, VkPipelineStageFlags2KHR stage, VkQueryPool queryPool, uint query);
	...
	public static VkResult vkQueueSubmit2KHR(VkQueue queue, uint submitCount, VkSubmitInfo2KHR* pSubmits, VkFence fence) => vkQueueSubmit2KHR_0(queue, submitCount, pSubmits, fence);
	private delegate VkResult vkQueueSubmit2KHRDelegate_0(VkQueue queue, uint submitCount, VkSubmitInfo2KHR* pSubmits, VkFence fence);
	private static IntPtr vkQueueSubmit2KHRPointer;
	private static vkQueueSubmit2KHRDelegate_0 vkQueueSubmit2KHR_0;
	public static void vkCmdWriteBufferMarker2AMD(VkCommandBuffer commandBuffer, VkPipelineStageFlags2KHR stage, VkBuffer dstBuffer, VkDeviceSize dstOffset, uint marker) => vkCmdWriteBufferMarker2AMD_0(commandBuffer, stage, dstBuffer, dstOffset, marker);
	private delegate void vkCmdWriteBufferMarker2AMDDelegate_0(VkCommandBuffer commandBuffer, VkPipelineStageFlags2KHR stage, VkBuffer dstBuffer, VkDeviceSize dstOffset, uint marker);
	...
	public static void vkGetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, VkDeviceImageMemoryRequirementsKHR* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements) => vkGetDeviceImageSparseMemoryRequirementsKHR_0(device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
	private delegate void vkGetDeviceImageSparseMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceImageMemoryRequirementsKHR* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements);
