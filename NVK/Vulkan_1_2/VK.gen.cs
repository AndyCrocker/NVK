...
public static unsafe class VK
{
	...
	public static VkResult CreateRenderPass2(VkDevice device, VkRenderPassCreateInfo2* pCreateInfo, VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass) => CreateRenderPass2_0(device, pCreateInfo, pAllocator, pRenderPass);
	private delegate VkResult CreateRenderPass2Delegate_0(VkDevice device, VkRenderPassCreateInfo2* pCreateInfo, VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass);
	private static IntPtr CreateRenderPass2Pointer;
	private static CreateRenderPass2Delegate_0 CreateRenderPass2_0;
	public static void CommandBeginRenderPass2(VkCommandBuffer commandBuffer, VkRenderPassBeginInfo* pRenderPassBegin, VkSubpassBeginInfo* pSubpassBeginInfo) => CommandBeginRenderPass2_0(commandBuffer, pRenderPassBegin, pSubpassBeginInfo);
	private delegate void CommandBeginRenderPass2Delegate_0(VkCommandBuffer commandBuffer, VkRenderPassBeginInfo* pRenderPassBegin, VkSubpassBeginInfo* pSubpassBeginInfo);
	...
	public static void CommandNextSubpass2(VkCommandBuffer commandBuffer, VkSubpassBeginInfo* pSubpassBeginInfo, VkSubpassEndInfo* pSubpassEndInfo) => CommandNextSubpass2_0(commandBuffer, pSubpassBeginInfo, pSubpassEndInfo);
	private delegate void CommandNextSubpass2Delegate_0(VkCommandBuffer commandBuffer, VkSubpassBeginInfo* pSubpassBeginInfo, VkSubpassEndInfo* pSubpassEndInfo);
	private static IntPtr CommandNextSubpass2Pointer;
	private static CommandNextSubpass2Delegate_0 CommandNextSubpass2_0;
	public static void CommandEndRenderPass2(VkCommandBuffer commandBuffer, VkSubpassEndInfo* pSubpassEndInfo) => CommandEndRenderPass2_0(commandBuffer, pSubpassEndInfo);
	private delegate void CommandEndRenderPass2Delegate_0(VkCommandBuffer commandBuffer, VkSubpassEndInfo* pSubpassEndInfo);
	...
	public static VkResult GetSemaphoreCounterValue(VkDevice device, VkSemaphore semaphore, ulong* pValue) => GetSemaphoreCounterValue_0(device, semaphore, pValue);
	private delegate VkResult GetSemaphoreCounterValueDelegate_0(VkDevice device, VkSemaphore semaphore, ulong* pValue);
	...
	public static VkResult WaitSemaphores(VkDevice device, VkSemaphoreWaitInfo* pWaitInfo, ulong timeout) => WaitSemaphores_0(device, pWaitInfo, timeout);
	private delegate VkResult WaitSemaphoresDelegate_0(VkDevice device, VkSemaphoreWaitInfo* pWaitInfo, ulong timeout);
	private static IntPtr WaitSemaphoresPointer;
	private static WaitSemaphoresDelegate_0 WaitSemaphores_0;
	public static VkResult SignalSemaphore(VkDevice device, VkSemaphoreSignalInfo* pSignalInfo) => SignalSemaphore_0(device, pSignalInfo);
	private delegate VkResult SignalSemaphoreDelegate_0(VkDevice device, VkSemaphoreSignalInfo* pSignalInfo);
	private static IntPtr SignalSemaphorePointer;
	private static SignalSemaphoreDelegate_0 SignalSemaphore_0;
	public static VkDeviceAddress GetBufferDeviceAddress(VkDevice device, VkBufferDeviceAddressInfo* pInfo) => GetBufferDeviceAddress_0(device, pInfo);
	private delegate VkDeviceAddress GetBufferDeviceAddressDelegate_0(VkDevice device, VkBufferDeviceAddressInfo* pInfo);
	...
	public static ulong GetBufferOpaqueCaptureAddress(VkDevice device, VkBufferDeviceAddressInfo* pInfo) => GetBufferOpaqueCaptureAddress_0(device, pInfo);
	private delegate ulong GetBufferOpaqueCaptureAddressDelegate_0(VkDevice device, VkBufferDeviceAddressInfo* pInfo);
	...
	public static ulong GetDeviceMemoryOpaqueCaptureAddress(VkDevice device, VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo) => GetDeviceMemoryOpaqueCaptureAddress_0(device, pInfo);
	private delegate ulong GetDeviceMemoryOpaqueCaptureAddressDelegate_0(VkDevice device, VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo);
	...
	public static VkResult CreateCuModuleNVX(VkDevice device, VkCuModuleCreateInfoNVX* pCreateInfo, VkAllocationCallbacks* pAllocator, VkCuModuleNVX* pModule) => CreateCuModuleNVX_0(device, pCreateInfo, pAllocator, pModule);
	private delegate VkResult CreateCuModuleNVXDelegate_0(VkDevice device, VkCuModuleCreateInfoNVX* pCreateInfo, VkAllocationCallbacks* pAllocator, VkCuModuleNVX* pModule);
	private static IntPtr CreateCuModuleNVXPointer;
	private static CreateCuModuleNVXDelegate_0 CreateCuModuleNVX_0;
	public static VkResult CreateCuFunctionNVX(VkDevice device, VkCuFunctionCreateInfoNVX* pCreateInfo, VkAllocationCallbacks* pAllocator, VkCuFunctionNVX* pFunction) => CreateCuFunctionNVX_0(device, pCreateInfo, pAllocator, pFunction);
	private delegate VkResult CreateCuFunctionNVXDelegate_0(VkDevice device, VkCuFunctionCreateInfoNVX* pCreateInfo, VkAllocationCallbacks* pAllocator, VkCuFunctionNVX* pFunction);
	private static IntPtr CreateCuFunctionNVXPointer;
	private static CreateCuFunctionNVXDelegate_0 CreateCuFunctionNVX_0;
	public static void DestroyCuModuleNVX(VkDevice device, VkCuModuleNVX module, VkAllocationCallbacks* pAllocator) => DestroyCuModuleNVX_0(device, module, pAllocator);
	private delegate void DestroyCuModuleNVXDelegate_0(VkDevice device, VkCuModuleNVX module, VkAllocationCallbacks* pAllocator);
	private static IntPtr DestroyCuModuleNVXPointer;
	private static DestroyCuModuleNVXDelegate_0 DestroyCuModuleNVX_0;
	public static void DestroyCuFunctionNVX(VkDevice device, VkCuFunctionNVX function, VkAllocationCallbacks* pAllocator) => DestroyCuFunctionNVX_0(device, function, pAllocator);
	private delegate void DestroyCuFunctionNVXDelegate_0(VkDevice device, VkCuFunctionNVX function, VkAllocationCallbacks* pAllocator);
	private static IntPtr DestroyCuFunctionNVXPointer;
	private static DestroyCuFunctionNVXDelegate_0 DestroyCuFunctionNVX_0;
	public static void CommandCuLaunchKernelNVX(VkCommandBuffer commandBuffer, VkCuLaunchInfoNVX* pLaunchInfo) => CommandCuLaunchKernelNVX_0(commandBuffer, pLaunchInfo);
	private delegate void CommandCuLaunchKernelNVXDelegate_0(VkCommandBuffer commandBuffer, VkCuLaunchInfoNVX* pLaunchInfo);
	...
	public static VkResult GetImageViewAddressNVX(VkDevice device, VkImageView imageView, VkImageViewAddressPropertiesNVX* pProperties) => GetImageViewAddressNVX_0(device, imageView, pProperties);
	private delegate VkResult GetImageViewAddressNVXDelegate_0(VkDevice device, VkImageView imageView, VkImageViewAddressPropertiesNVX* pProperties);
	...
	public static void CommandBeginRenderingKHR(VkCommandBuffer commandBuffer, VkRenderingInfoKHR* pRenderingInfo) => CommandBeginRenderingKHR_0(commandBuffer, pRenderingInfo);
	private delegate void CommandBeginRenderingKHRDelegate_0(VkCommandBuffer commandBuffer, VkRenderingInfoKHR* pRenderingInfo);
	...
	public static void CreateRenderPass2KHR(VkDevice device, VkRenderPassCreateInfo2* pCreateInfo, VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass) => CreateRenderPass2KHR_0(device, pCreateInfo, pAllocator, pRenderPass);
	private delegate void CreateRenderPass2KHRDelegate_0(VkDevice device, VkRenderPassCreateInfo2* pCreateInfo, VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass);
	...
	public static void CommandBeginRenderPass2KHR(VkCommandBuffer commandBuffer, VkRenderPassBeginInfo* pRenderPassBegin, VkSubpassBeginInfo* pSubpassBeginInfo) => CommandBeginRenderPass2KHR_0(commandBuffer, pRenderPassBegin, pSubpassBeginInfo);
	private delegate void CommandBeginRenderPass2KHRDelegate_0(VkCommandBuffer commandBuffer, VkRenderPassBeginInfo* pRenderPassBegin, VkSubpassBeginInfo* pSubpassBeginInfo);
	...
	public static void CommandNextSubpass2KHR(VkCommandBuffer commandBuffer, VkSubpassBeginInfo* pSubpassBeginInfo, VkSubpassEndInfo* pSubpassEndInfo) => CommandNextSubpass2KHR_0(commandBuffer, pSubpassBeginInfo, pSubpassEndInfo);
	private delegate void CommandNextSubpass2KHRDelegate_0(VkCommandBuffer commandBuffer, VkSubpassBeginInfo* pSubpassBeginInfo, VkSubpassEndInfo* pSubpassEndInfo);
	...
	public static void CommandEndRenderPass2KHR(VkCommandBuffer commandBuffer, VkSubpassEndInfo* pSubpassEndInfo) => CommandEndRenderPass2KHR_0(commandBuffer, pSubpassEndInfo);
	private delegate void CommandEndRenderPass2KHRDelegate_0(VkCommandBuffer commandBuffer, VkSubpassEndInfo* pSubpassEndInfo);
	...
	public static VkResult CreateAccelerationStructureKHR(VkDevice device, VkAccelerationStructureCreateInfoKHR* pCreateInfo, VkAllocationCallbacks* pAllocator, VkAccelerationStructureKHR* pAccelerationStructure) => CreateAccelerationStructureKHR_0(device, pCreateInfo, pAllocator, pAccelerationStructure);
	private delegate VkResult CreateAccelerationStructureKHRDelegate_0(VkDevice device, VkAccelerationStructureCreateInfoKHR* pCreateInfo, VkAllocationCallbacks* pAllocator, VkAccelerationStructureKHR* pAccelerationStructure);
	...
	public static void DestroyAccelerationStructureKHR(VkDevice device, VkAccelerationStructureKHR accelerationStructure, VkAllocationCallbacks* pAllocator) => DestroyAccelerationStructureKHR_0(device, accelerationStructure, pAllocator);
	private delegate void DestroyAccelerationStructureKHRDelegate_0(VkDevice device, VkAccelerationStructureKHR accelerationStructure, VkAllocationCallbacks* pAllocator);
	...
	public static void CommandBuildAccelerationStructuresKHR(VkCommandBuffer commandBuffer, uint infoCount, VkAccelerationStructureBuildGeometryInfoKHR* pInfos, VkAccelerationStructureBuildRangeInfoKHR** ppBuildRangeInfos) => CommandBuildAccelerationStructuresKHR_0(commandBuffer, infoCount, pInfos, ppBuildRangeInfos);
	private delegate void CommandBuildAccelerationStructuresKHRDelegate_0(VkCommandBuffer commandBuffer, uint infoCount, VkAccelerationStructureBuildGeometryInfoKHR* pInfos, VkAccelerationStructureBuildRangeInfoKHR** ppBuildRangeInfos);
	...
	public static void CommandBuildAccelerationStructuresIndirectKHR(VkCommandBuffer commandBuffer, uint infoCount, VkAccelerationStructureBuildGeometryInfoKHR* pInfos, VkDeviceAddress* pIndirectDeviceAddresses, uint* pIndirectStrides, uint** ppMaxPrimitiveCounts) => CommandBuildAccelerationStructuresIndirectKHR_0(commandBuffer, infoCount, pInfos, pIndirectDeviceAddresses, pIndirectStrides, ppMaxPrimitiveCounts);
	private delegate void CommandBuildAccelerationStructuresIndirectKHRDelegate_0(VkCommandBuffer commandBuffer, uint infoCount, VkAccelerationStructureBuildGeometryInfoKHR* pInfos, VkDeviceAddress* pIndirectDeviceAddresses, uint* pIndirectStrides, uint** ppMaxPrimitiveCounts);
	...
	public static VkResult BuildAccelerationStructuresKHR(VkDevice device, VkDeferredOperationKHR deferredOperation, uint infoCount, VkAccelerationStructureBuildGeometryInfoKHR* pInfos, VkAccelerationStructureBuildRangeInfoKHR** ppBuildRangeInfos) => BuildAccelerationStructuresKHR_0(device, deferredOperation, infoCount, pInfos, ppBuildRangeInfos);
	private delegate VkResult BuildAccelerationStructuresKHRDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, uint infoCount, VkAccelerationStructureBuildGeometryInfoKHR* pInfos, VkAccelerationStructureBuildRangeInfoKHR** ppBuildRangeInfos);
	...
	public static VkResult CopyAccelerationStructureKHR(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyAccelerationStructureInfoKHR* pInfo) => CopyAccelerationStructureKHR_0(device, deferredOperation, pInfo);
	private delegate VkResult CopyAccelerationStructureKHRDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyAccelerationStructureInfoKHR* pInfo);
	...
	public static VkResult CopyAccelerationStructureToMemoryKHR(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyAccelerationStructureToMemoryInfoKHR* pInfo) => CopyAccelerationStructureToMemoryKHR_0(device, deferredOperation, pInfo);
	private delegate VkResult CopyAccelerationStructureToMemoryKHRDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyAccelerationStructureToMemoryInfoKHR* pInfo);
	...
	public static VkResult CopyMemoryToAccelerationStructureKHR(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyMemoryToAccelerationStructureInfoKHR* pInfo) => CopyMemoryToAccelerationStructureKHR_0(device, deferredOperation, pInfo);
	private delegate VkResult CopyMemoryToAccelerationStructureKHRDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, VkCopyMemoryToAccelerationStructureInfoKHR* pInfo);
	...
	public static VkResult WriteAccelerationStructuresPropertiesKHR(VkDevice device, uint accelerationStructureCount, VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, nuint dataSize, void* pData, nuint stride) => WriteAccelerationStructuresPropertiesKHR_0(device, accelerationStructureCount, pAccelerationStructures, queryType, dataSize, pData, stride);
	private delegate VkResult WriteAccelerationStructuresPropertiesKHRDelegate_0(VkDevice device, uint accelerationStructureCount, VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, nuint dataSize, void* pData, nuint stride);
	...
	public static void CommandCopyAccelerationStructureKHR(VkCommandBuffer commandBuffer, VkCopyAccelerationStructureInfoKHR* pInfo) => CommandCopyAccelerationStructureKHR_0(commandBuffer, pInfo);
	private delegate void CommandCopyAccelerationStructureKHRDelegate_0(VkCommandBuffer commandBuffer, VkCopyAccelerationStructureInfoKHR* pInfo);
	...
	public static void CommandCopyAccelerationStructureToMemoryKHR(VkCommandBuffer commandBuffer, VkCopyAccelerationStructureToMemoryInfoKHR* pInfo) => CommandCopyAccelerationStructureToMemoryKHR_0(commandBuffer, pInfo);
	private delegate void CommandCopyAccelerationStructureToMemoryKHRDelegate_0(VkCommandBuffer commandBuffer, VkCopyAccelerationStructureToMemoryInfoKHR* pInfo);
	...
	public static void CommandCopyMemoryToAccelerationStructureKHR(VkCommandBuffer commandBuffer, VkCopyMemoryToAccelerationStructureInfoKHR* pInfo) => CommandCopyMemoryToAccelerationStructureKHR_0(commandBuffer, pInfo);
	private delegate void CommandCopyMemoryToAccelerationStructureKHRDelegate_0(VkCommandBuffer commandBuffer, VkCopyMemoryToAccelerationStructureInfoKHR* pInfo);
	...
	public static VkDeviceAddress GetAccelerationStructureDeviceAddressKHR(VkDevice device, VkAccelerationStructureDeviceAddressInfoKHR* pInfo) => GetAccelerationStructureDeviceAddressKHR_0(device, pInfo);
	private delegate VkDeviceAddress GetAccelerationStructureDeviceAddressKHRDelegate_0(VkDevice device, VkAccelerationStructureDeviceAddressInfoKHR* pInfo);
	...
	public static void CommandWriteAccelerationStructuresPropertiesKHR(VkCommandBuffer commandBuffer, uint accelerationStructureCount, VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint firstQuery) => CommandWriteAccelerationStructuresPropertiesKHR_0(commandBuffer, accelerationStructureCount, pAccelerationStructures, queryType, queryPool, firstQuery);
	private delegate void CommandWriteAccelerationStructuresPropertiesKHRDelegate_0(VkCommandBuffer commandBuffer, uint accelerationStructureCount, VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint firstQuery);
	...
	public static void GetDeviceAccelerationStructureCompatibilityKHR(VkDevice device, VkAccelerationStructureVersionInfoKHR* pVersionInfo, VkAccelerationStructureCompatibilityKHR* pCompatibility) => GetDeviceAccelerationStructureCompatibilityKHR_0(device, pVersionInfo, pCompatibility);
	private delegate void GetDeviceAccelerationStructureCompatibilityKHRDelegate_0(VkDevice device, VkAccelerationStructureVersionInfoKHR* pVersionInfo, VkAccelerationStructureCompatibilityKHR* pCompatibility);
	...
	public static void GetAccelerationStructureBuildSizesKHR(VkDevice device, VkAccelerationStructureBuildTypeKHR buildType, VkAccelerationStructureBuildGeometryInfoKHR* pBuildInfo, uint* pMaxPrimitiveCounts, VkAccelerationStructureBuildSizesInfoKHR* pSizeInfo) => GetAccelerationStructureBuildSizesKHR_0(device, buildType, pBuildInfo, pMaxPrimitiveCounts, pSizeInfo);
	private delegate void GetAccelerationStructureBuildSizesKHRDelegate_0(VkDevice device, VkAccelerationStructureBuildTypeKHR buildType, VkAccelerationStructureBuildGeometryInfoKHR* pBuildInfo, uint* pMaxPrimitiveCounts, VkAccelerationStructureBuildSizesInfoKHR* pSizeInfo);
	...
	public static void CommandTraceRaysKHR(VkCommandBuffer commandBuffer, VkStridedDeviceAddressRegionKHR* pRaygenShaderBindingTable, VkStridedDeviceAddressRegionKHR* pMissShaderBindingTable, VkStridedDeviceAddressRegionKHR* pHitShaderBindingTable, VkStridedDeviceAddressRegionKHR* pCallableShaderBindingTable, uint width, uint height, uint depth) => CommandTraceRaysKHR_0(commandBuffer, pRaygenShaderBindingTable, pMissShaderBindingTable, pHitShaderBindingTable, pCallableShaderBindingTable, width, height, depth);
	private delegate void CommandTraceRaysKHRDelegate_0(VkCommandBuffer commandBuffer, VkStridedDeviceAddressRegionKHR* pRaygenShaderBindingTable, VkStridedDeviceAddressRegionKHR* pMissShaderBindingTable, VkStridedDeviceAddressRegionKHR* pHitShaderBindingTable, VkStridedDeviceAddressRegionKHR* pCallableShaderBindingTable, uint width, uint height, uint depth);
	private static IntPtr CommandTraceRaysKHRPointer;
	private static CommandTraceRaysKHRDelegate_0 CommandTraceRaysKHR_0;
	public static VkResult CreateRayTracingPipelinesKHR(VkDevice device, VkDeferredOperationKHR deferredOperation, VkPipelineCache pipelineCache, uint createInfoCount, VkRayTracingPipelineCreateInfoKHR* pCreateInfos, VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines) => CreateRayTracingPipelinesKHR_0(device, deferredOperation, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
	private delegate VkResult CreateRayTracingPipelinesKHRDelegate_0(VkDevice device, VkDeferredOperationKHR deferredOperation, VkPipelineCache pipelineCache, uint createInfoCount, VkRayTracingPipelineCreateInfoKHR* pCreateInfos, VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines);
	...
	public static VkResult GetRayTracingShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData) => GetRayTracingShaderGroupHandlesKHR_0(device, pipeline, firstGroup, groupCount, dataSize, pData);
	private delegate VkResult GetRayTracingShaderGroupHandlesKHRDelegate_0(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData);
	...
	public static VkResult GetRayTracingCaptureReplayShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData) => GetRayTracingCaptureReplayShaderGroupHandlesKHR_0(device, pipeline, firstGroup, groupCount, dataSize, pData);
	private delegate VkResult GetRayTracingCaptureReplayShaderGroupHandlesKHRDelegate_0(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData);
	...
	public static void CommandTraceRaysIndirectKHR(VkCommandBuffer commandBuffer, VkStridedDeviceAddressRegionKHR* pRaygenShaderBindingTable, VkStridedDeviceAddressRegionKHR* pMissShaderBindingTable, VkStridedDeviceAddressRegionKHR* pHitShaderBindingTable, VkStridedDeviceAddressRegionKHR* pCallableShaderBindingTable, VkDeviceAddress indirectDeviceAddress) => CommandTraceRaysIndirectKHR_0(commandBuffer, pRaygenShaderBindingTable, pMissShaderBindingTable, pHitShaderBindingTable, pCallableShaderBindingTable, indirectDeviceAddress);
	...
	public static void CommandCopyAccelerationStructureNV(VkCommandBuffer commandBuffer, VkAccelerationStructureNV dst, VkAccelerationStructureNV src, VkCopyAccelerationStructureModeKHR mode) => CommandCopyAccelerationStructureNV_0(commandBuffer, dst, src, mode);
	private delegate void CommandCopyAccelerationStructureNVDelegate_0(VkCommandBuffer commandBuffer, VkAccelerationStructureNV dst, VkAccelerationStructureNV src, VkCopyAccelerationStructureModeKHR mode);
	...
	public static void GetRayTracingShaderGroupHandlesNV(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData) => GetRayTracingShaderGroupHandlesNV_0(device, pipeline, firstGroup, groupCount, dataSize, pData);
	private delegate void GetRayTracingShaderGroupHandlesNVDelegate_0(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData);
	...
	public static void GetSemaphoreCounterValueKHR(VkDevice device, VkSemaphore semaphore, ulong* pValue) => GetSemaphoreCounterValueKHR_0(device, semaphore, pValue);
	private delegate void GetSemaphoreCounterValueKHRDelegate_0(VkDevice device, VkSemaphore semaphore, ulong* pValue);
	...
	public static void WaitSemaphoresKHR(VkDevice device, VkSemaphoreWaitInfo* pWaitInfo, ulong timeout) => WaitSemaphoresKHR_0(device, pWaitInfo, timeout);
	private delegate void WaitSemaphoresKHRDelegate_0(VkDevice device, VkSemaphoreWaitInfo* pWaitInfo, ulong timeout);
	...
	public static void SignalSemaphoreKHR(VkDevice device, VkSemaphoreSignalInfo* pSignalInfo) => SignalSemaphoreKHR_0(device, pSignalInfo);
	private delegate void SignalSemaphoreKHRDelegate_0(VkDevice device, VkSemaphoreSignalInfo* pSignalInfo);
	...
	public static VkResult GetPhysicalDeviceFragmentShadingRatesKHR(VkPhysicalDevice physicalDevice, uint* pFragmentShadingRateCount, VkPhysicalDeviceFragmentShadingRateKHR* pFragmentShadingRates) => GetPhysicalDeviceFragmentShadingRatesKHR_0(physicalDevice, pFragmentShadingRateCount, pFragmentShadingRates);
	private delegate VkResult GetPhysicalDeviceFragmentShadingRatesKHRDelegate_0(VkPhysicalDevice physicalDevice, uint* pFragmentShadingRateCount, VkPhysicalDeviceFragmentShadingRateKHR* pFragmentShadingRates);
	...
	public static void CommandSetFragmentShadingRateKHR(VkCommandBuffer commandBuffer, VkExtent2D* pFragmentSize, VkFragmentShadingRateCombinerOpKHR combinerOps) => CommandSetFragmentShadingRateKHR_0(commandBuffer, pFragmentSize, combinerOps);
	private delegate void CommandSetFragmentShadingRateKHRDelegate_0(VkCommandBuffer commandBuffer, VkExtent2D* pFragmentSize, VkFragmentShadingRateCombinerOpKHR combinerOps);
	...
	public static void GetBufferDeviceAddressEXT(VkDevice device, VkBufferDeviceAddressInfo* pInfo) => GetBufferDeviceAddressEXT_0(device, pInfo);
	private delegate void GetBufferDeviceAddressEXTDelegate_0(VkDevice device, VkBufferDeviceAddressInfo* pInfo);
	...
	[Obsolete("Use GetBufferDeviceAddress")]
	public static void GetBufferDeviceAddressKHR(VkDevice device, VkBufferDeviceAddressInfo* pInfo) => GetBufferDeviceAddressKHR_0(device, pInfo);
	private delegate void GetBufferDeviceAddressKHRDelegate_0(VkDevice device, VkBufferDeviceAddressInfo* pInfo);
	...
	public static void GetBufferOpaqueCaptureAddressKHR(VkDevice device, VkBufferDeviceAddressInfo* pInfo) => GetBufferOpaqueCaptureAddressKHR_0(device, pInfo);
	private delegate void GetBufferOpaqueCaptureAddressKHRDelegate_0(VkDevice device, VkBufferDeviceAddressInfo* pInfo);
	...
	public static void GetDeviceMemoryOpaqueCaptureAddressKHR(VkDevice device, VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo) => GetDeviceMemoryOpaqueCaptureAddressKHR_0(device, pInfo);
	private delegate void GetDeviceMemoryOpaqueCaptureAddressKHRDelegate_0(VkDevice device, VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo);
	...
	public static void CommandSetViewportWithCountEXT(VkCommandBuffer commandBuffer, uint viewportCount, VkViewport* pViewports) => CommandSetViewportWithCountEXT_0(commandBuffer, viewportCount, pViewports);
	private delegate void CommandSetViewportWithCountEXTDelegate_0(VkCommandBuffer commandBuffer, uint viewportCount, VkViewport* pViewports);
	...
	public static void CommandSetScissorWithCountEXT(VkCommandBuffer commandBuffer, uint scissorCount, VkRect2D* pScissors) => CommandSetScissorWithCountEXT_0(commandBuffer, scissorCount, pScissors);
	private delegate void CommandSetScissorWithCountEXTDelegate_0(VkCommandBuffer commandBuffer, uint scissorCount, VkRect2D* pScissors);
	...
	public static void CommandBindVertexBuffers2EXT(VkCommandBuffer commandBuffer, uint firstBinding, uint bindingCount, VkBuffer* pBuffers, VkDeviceSize* pOffsets, VkDeviceSize* pSizes, VkDeviceSize* pStrides) => CommandBindVertexBuffers2EXT_0(commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, pSizes, pStrides);
	private delegate void CommandBindVertexBuffers2EXTDelegate_0(VkCommandBuffer commandBuffer, uint firstBinding, uint bindingCount, VkBuffer* pBuffers, VkDeviceSize* pOffsets, VkDeviceSize* pSizes, VkDeviceSize* pStrides);
	...
	public static VkResult CreateDeferredOperationKHR(VkDevice device, VkAllocationCallbacks* pAllocator, VkDeferredOperationKHR* pDeferredOperation) => CreateDeferredOperationKHR_0(device, pAllocator, pDeferredOperation);
	private delegate VkResult CreateDeferredOperationKHRDelegate_0(VkDevice device, VkAllocationCallbacks* pAllocator, VkDeferredOperationKHR* pDeferredOperation);
	...
	public static void DestroyDeferredOperationKHR(VkDevice device, VkDeferredOperationKHR operation, VkAllocationCallbacks* pAllocator) => DestroyDeferredOperationKHR_0(device, operation, pAllocator);
	private delegate void DestroyDeferredOperationKHRDelegate_0(VkDevice device, VkDeferredOperationKHR operation, VkAllocationCallbacks* pAllocator);
	...
	public static void GetGeneratedCommandsMemoryRequirementsNV(VkDevice device, VkGeneratedCommandsMemoryRequirementsInfoNV* pInfo, VkMemoryRequirements2* pMemoryRequirements) => GetGeneratedCommandsMemoryRequirementsNV_0(device, pInfo, pMemoryRequirements);
	private delegate void GetGeneratedCommandsMemoryRequirementsNVDelegate_0(VkDevice device, VkGeneratedCommandsMemoryRequirementsInfoNV* pInfo, VkMemoryRequirements2* pMemoryRequirements);
	...
	public static void CommandPreprocessGeneratedCommandsNV(VkCommandBuffer commandBuffer, VkGeneratedCommandsInfoNV* pGeneratedCommandsInfo) => CommandPreprocessGeneratedCommandsNV_0(commandBuffer, pGeneratedCommandsInfo);
	private delegate void CommandPreprocessGeneratedCommandsNVDelegate_0(VkCommandBuffer commandBuffer, VkGeneratedCommandsInfoNV* pGeneratedCommandsInfo);
	...
	public static void CommandExecuteGeneratedCommandsNV(VkCommandBuffer commandBuffer, VkBool32 isPreprocessed, VkGeneratedCommandsInfoNV* pGeneratedCommandsInfo) => CommandExecuteGeneratedCommandsNV_0(commandBuffer, isPreprocessed, pGeneratedCommandsInfo);
	private delegate void CommandExecuteGeneratedCommandsNVDelegate_0(VkCommandBuffer commandBuffer, VkBool32 isPreprocessed, VkGeneratedCommandsInfoNV* pGeneratedCommandsInfo);
	...
	public static VkResult CreateIndirectCommandsLayoutNV(VkDevice device, VkIndirectCommandsLayoutCreateInfoNV* pCreateInfo, VkAllocationCallbacks* pAllocator, VkIndirectCommandsLayoutNV* pIndirectCommandsLayout) => CreateIndirectCommandsLayoutNV_0(device, pCreateInfo, pAllocator, pIndirectCommandsLayout);
	private delegate VkResult CreateIndirectCommandsLayoutNVDelegate_0(VkDevice device, VkIndirectCommandsLayoutCreateInfoNV* pCreateInfo, VkAllocationCallbacks* pAllocator, VkIndirectCommandsLayoutNV* pIndirectCommandsLayout);
	...
	public static void DestroyIndirectCommandsLayoutNV(VkDevice device, VkIndirectCommandsLayoutNV indirectCommandsLayout, VkAllocationCallbacks* pAllocator) => DestroyIndirectCommandsLayoutNV_0(device, indirectCommandsLayout, pAllocator);
	private delegate void DestroyIndirectCommandsLayoutNVDelegate_0(VkDevice device, VkIndirectCommandsLayoutNV indirectCommandsLayout, VkAllocationCallbacks* pAllocator);
	...
	public static VkResult AcquireDrmDisplayEXT(VkPhysicalDevice physicalDevice, int drmFd, VkDisplayKHR display) => AcquireDrmDisplayEXT_0(physicalDevice, drmFd, display);
	private delegate VkResult AcquireDrmDisplayEXTDelegate_0(VkPhysicalDevice physicalDevice, int drmFd, VkDisplayKHR display);
	private static IntPtr AcquireDrmDisplayEXTPointer;
	private static AcquireDrmDisplayEXTDelegate_0 AcquireDrmDisplayEXT_0;
	public static VkResult GetDrmDisplayEXT(VkPhysicalDevice physicalDevice, int drmFd, uint connectorId, VkDisplayKHR* display) => GetDrmDisplayEXT_0(physicalDevice, drmFd, connectorId, display);
	private delegate VkResult GetDrmDisplayEXTDelegate_0(VkPhysicalDevice physicalDevice, int drmFd, uint connectorId, VkDisplayKHR* display);
	private static IntPtr GetDrmDisplayEXTPointer;
	private static GetDrmDisplayEXTDelegate_0 GetDrmDisplayEXT_0;
	public static VkResult CreatePrivateDataSlotEXT(VkDevice device, VkPrivateDataSlotCreateInfoEXT* pCreateInfo, VkAllocationCallbacks* pAllocator, VkPrivateDataSlotEXT* pPrivateDataSlot) => CreatePrivateDataSlotEXT_0(device, pCreateInfo, pAllocator, pPrivateDataSlot);
	private delegate VkResult CreatePrivateDataSlotEXTDelegate_0(VkDevice device, VkPrivateDataSlotCreateInfoEXT* pCreateInfo, VkAllocationCallbacks* pAllocator, VkPrivateDataSlotEXT* pPrivateDataSlot);
	...
	public static void DestroyPrivateDataSlotEXT(VkDevice device, VkPrivateDataSlotEXT privateDataSlot, VkAllocationCallbacks* pAllocator) => DestroyPrivateDataSlotEXT_0(device, privateDataSlot, pAllocator);
	private delegate void DestroyPrivateDataSlotEXTDelegate_0(VkDevice device, VkPrivateDataSlotEXT privateDataSlot, VkAllocationCallbacks* pAllocator);
	...
	public static void GetPrivateDataEXT(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlotEXT privateDataSlot, ulong* pData) => GetPrivateDataEXT_0(device, objectType, objectHandle, privateDataSlot, pData);
	private delegate void GetPrivateDataEXTDelegate_0(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlotEXT privateDataSlot, ulong* pData);
	private static IntPtr GetPrivateDataEXTPointer;
	private static GetPrivateDataEXTDelegate_0 GetPrivateDataEXT_0;
	public static void CommandSetEvent2KHR(VkCommandBuffer commandBuffer, VkEvent event, VkDependencyInfoKHR* pDependencyInfo) => CommandSetEvent2KHR_0(commandBuffer, event, pDependencyInfo);
	private delegate void CommandSetEvent2KHRDelegate_0(VkCommandBuffer commandBuffer, VkEvent event, VkDependencyInfoKHR* pDependencyInfo);
	...
	public static void CommandWaitEvents2KHR(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, VkDependencyInfoKHR* pDependencyInfos) => CommandWaitEvents2KHR_0(commandBuffer, eventCount, pEvents, pDependencyInfos);
	private delegate void CommandWaitEvents2KHRDelegate_0(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, VkDependencyInfoKHR* pDependencyInfos);
	private static IntPtr CommandWaitEvents2KHRPointer;
	private static CommandWaitEvents2KHRDelegate_0 CommandWaitEvents2KHR_0;
	public static void CommandPipelineBarrier2KHR(VkCommandBuffer commandBuffer, VkDependencyInfoKHR* pDependencyInfo) => CommandPipelineBarrier2KHR_0(commandBuffer, pDependencyInfo);
	private delegate void CommandPipelineBarrier2KHRDelegate_0(VkCommandBuffer commandBuffer, VkDependencyInfoKHR* pDependencyInfo);
	...
	public static VkResult QueueSubmit2KHR(VkQueue queue, uint submitCount, VkSubmitInfo2KHR* pSubmits, VkFence fence) => QueueSubmit2KHR_0(queue, submitCount, pSubmits, fence);
	private delegate VkResult QueueSubmit2KHRDelegate_0(VkQueue queue, uint submitCount, VkSubmitInfo2KHR* pSubmits, VkFence fence);
	private static IntPtr QueueSubmit2KHRPointer;
	private static QueueSubmit2KHRDelegate_0 QueueSubmit2KHR_0;
	public static void CommandWriteBufferMarker2AMD(VkCommandBuffer commandBuffer, VkPipelineStageFlags2KHR stage, VkBuffer dstBuffer, VkDeviceSize dstOffset, uint marker) => CommandWriteBufferMarker2AMD_0(commandBuffer, stage, dstBuffer, dstOffset, marker);
	private delegate void CommandWriteBufferMarker2AMDDelegate_0(VkCommandBuffer commandBuffer, VkPipelineStageFlags2KHR stage, VkBuffer dstBuffer, VkDeviceSize dstOffset, uint marker);
	...
	public static void GetQueueCheckpointData2NV(VkQueue queue, uint* pCheckpointDataCount, VkCheckpointData2NV* pCheckpointData) => GetQueueCheckpointData2NV_0(queue, pCheckpointDataCount, pCheckpointData);
	private delegate void GetQueueCheckpointData2NVDelegate_0(VkQueue queue, uint* pCheckpointDataCount, VkCheckpointData2NV* pCheckpointData);
	...
	public static void CommandCopyBuffer2KHR(VkCommandBuffer commandBuffer, VkCopyBufferInfo2KHR* pCopyBufferInfo) => CommandCopyBuffer2KHR_0(commandBuffer, pCopyBufferInfo);
	private delegate void CommandCopyBuffer2KHRDelegate_0(VkCommandBuffer commandBuffer, VkCopyBufferInfo2KHR* pCopyBufferInfo);
	private static IntPtr CommandCopyBuffer2KHRPointer;
	private static CommandCopyBuffer2KHRDelegate_0 CommandCopyBuffer2KHR_0;
	public static void CommandCopyImage2KHR(VkCommandBuffer commandBuffer, VkCopyImageInfo2KHR* pCopyImageInfo) => CommandCopyImage2KHR_0(commandBuffer, pCopyImageInfo);
	private delegate void CommandCopyImage2KHRDelegate_0(VkCommandBuffer commandBuffer, VkCopyImageInfo2KHR* pCopyImageInfo);
	private static IntPtr CommandCopyImage2KHRPointer;
	private static CommandCopyImage2KHRDelegate_0 CommandCopyImage2KHR_0;
	public static void CommandCopyBufferToImage2KHR(VkCommandBuffer commandBuffer, VkCopyBufferToImageInfo2KHR* pCopyBufferToImageInfo) => CommandCopyBufferToImage2KHR_0(commandBuffer, pCopyBufferToImageInfo);
	private delegate void CommandCopyBufferToImage2KHRDelegate_0(VkCommandBuffer commandBuffer, VkCopyBufferToImageInfo2KHR* pCopyBufferToImageInfo);
	...
	public static void CommandCopyImageToBuffer2KHR(VkCommandBuffer commandBuffer, VkCopyImageToBufferInfo2KHR* pCopyImageToBufferInfo) => CommandCopyImageToBuffer2KHR_0(commandBuffer, pCopyImageToBufferInfo);
	private delegate void CommandCopyImageToBuffer2KHRDelegate_0(VkCommandBuffer commandBuffer, VkCopyImageToBufferInfo2KHR* pCopyImageToBufferInfo);
	...
	public static void CommandBlitImage2KHR(VkCommandBuffer commandBuffer, VkBlitImageInfo2KHR* pBlitImageInfo) => CommandBlitImage2KHR_0(commandBuffer, pBlitImageInfo);
	private delegate void CommandBlitImage2KHRDelegate_0(VkCommandBuffer commandBuffer, VkBlitImageInfo2KHR* pBlitImageInfo);
	private static IntPtr CommandBlitImage2KHRPointer;
	private static CommandBlitImage2KHRDelegate_0 CommandBlitImage2KHR_0;
	public static void CommandResolveImage2KHR(VkCommandBuffer commandBuffer, VkResolveImageInfo2KHR* pResolveImageInfo) => CommandResolveImage2KHR_0(commandBuffer, pResolveImageInfo);
	private delegate void CommandResolveImage2KHRDelegate_0(VkCommandBuffer commandBuffer, VkResolveImageInfo2KHR* pResolveImageInfo);
	...
	public static VkResult GetWinrtDisplayNV(VkPhysicalDevice physicalDevice, uint deviceRelativeId, VkDisplayKHR* pDisplay) => GetWinrtDisplayNV_0(physicalDevice, deviceRelativeId, pDisplay);
	private delegate VkResult GetWinrtDisplayNVDelegate_0(VkPhysicalDevice physicalDevice, uint deviceRelativeId, VkDisplayKHR* pDisplay);
	private static IntPtr GetWinrtDisplayNVPointer;
	private static GetWinrtDisplayNVDelegate_0 GetWinrtDisplayNV_0;
	public static void CommandSetVertexInputEXT(VkCommandBuffer commandBuffer, uint vertexBindingDescriptionCount, VkVertexInputBindingDescription2EXT* pVertexBindingDescriptions, uint vertexAttributeDescriptionCount, VkVertexInputAttributeDescription2EXT* pVertexAttributeDescriptions) => CommandSetVertexInputEXT_0(commandBuffer, vertexBindingDescriptionCount, pVertexBindingDescriptions, vertexAttributeDescriptionCount, pVertexAttributeDescriptions);
	private delegate void CommandSetVertexInputEXTDelegate_0(VkCommandBuffer commandBuffer, uint vertexBindingDescriptionCount, VkVertexInputBindingDescription2EXT* pVertexBindingDescriptions, uint vertexAttributeDescriptionCount, VkVertexInputAttributeDescription2EXT* pVertexAttributeDescriptions);
	...
	public static VkResult GetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI(VkDevice device, VkRenderPass renderpass, VkExtent2D* pMaxWorkgroupSize) => GetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI_0(device, renderpass, pMaxWorkgroupSize);
	private delegate VkResult GetDeviceSubpassShadingMaxWorkgroupSizeHUAWEIDelegate_0(VkDevice device, VkRenderPass renderpass, VkExtent2D* pMaxWorkgroupSize);
	...
	public static VkResult GetMemoryRemoteAddressNV(VkDevice device, VkMemoryGetRemoteAddressInfoNV* pMemoryGetRemoteAddressInfo, IntPtr* pAddress) => GetMemoryRemoteAddressNV_0(device, pMemoryGetRemoteAddressInfo, pAddress);
	private delegate VkResult GetMemoryRemoteAddressNVDelegate_0(VkDevice device, VkMemoryGetRemoteAddressInfoNV* pMemoryGetRemoteAddressInfo, IntPtr* pAddress);
	...
	public static void CommandSetColorWriteEnableEXT(VkCommandBuffer commandBuffer, uint attachmentCount, VkBool32* pColorWriteEnables) => CommandSetColorWriteEnableEXT_0(commandBuffer, attachmentCount, pColorWriteEnables);
	private delegate void CommandSetColorWriteEnableEXTDelegate_0(VkCommandBuffer commandBuffer, uint attachmentCount, VkBool32* pColorWriteEnables);
	...
	public static void CommandDrawMultiEXT(VkCommandBuffer commandBuffer, uint drawCount, VkMultiDrawInfoEXT* pVertexInfo, uint instanceCount, uint firstInstance, uint stride) => CommandDrawMultiEXT_0(commandBuffer, drawCount, pVertexInfo, instanceCount, firstInstance, stride);
	private delegate void CommandDrawMultiEXTDelegate_0(VkCommandBuffer commandBuffer, uint drawCount, VkMultiDrawInfoEXT* pVertexInfo, uint instanceCount, uint firstInstance, uint stride);
	private static IntPtr CommandDrawMultiEXTPointer;
	private static CommandDrawMultiEXTDelegate_0 CommandDrawMultiEXT_0;
	public static void CommandDrawMultiIndexedEXT(VkCommandBuffer commandBuffer, uint drawCount, VkMultiDrawIndexedInfoEXT* pIndexInfo, uint instanceCount, uint firstInstance, uint stride, int* pVertexOffset) => CommandDrawMultiIndexedEXT_0(commandBuffer, drawCount, pIndexInfo, instanceCount, firstInstance, stride, pVertexOffset);
	private delegate void CommandDrawMultiIndexedEXTDelegate_0(VkCommandBuffer commandBuffer, uint drawCount, VkMultiDrawIndexedInfoEXT* pIndexInfo, uint instanceCount, uint firstInstance, uint stride, int* pVertexOffset);
	...
	public static void GetDeviceBufferMemoryRequirementsKHR(VkDevice device, VkDeviceBufferMemoryRequirementsKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements) => GetDeviceBufferMemoryRequirementsKHR_0(device, pInfo, pMemoryRequirements);
	private delegate void GetDeviceBufferMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceBufferMemoryRequirementsKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements);
	...
	public static void GetDeviceImageMemoryRequirementsKHR(VkDevice device, VkDeviceImageMemoryRequirementsKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements) => GetDeviceImageMemoryRequirementsKHR_0(device, pInfo, pMemoryRequirements);
	private delegate void GetDeviceImageMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceImageMemoryRequirementsKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements);
	...
	public static void GetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, VkDeviceImageMemoryRequirementsKHR* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements) => GetDeviceImageSparseMemoryRequirementsKHR_0(device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
	private delegate void GetDeviceImageSparseMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceImageMemoryRequirementsKHR* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements);
	...
	public static void InitialiseInstanceMethods(VkInstance instance)
	{
		...
		CommandBeginRenderingKHRPointer = GetInstanceProcedureAddress(instance, "CommandBeginRenderingKHR");
		...
		CommandEndRenderingKHRPointer = GetInstanceProcedureAddress(instance, "CommandEndRenderingKHR");
		...
		CommandSetCullModeEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetCullModeEXT");
		...
		CommandSetFrontFaceEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetFrontFaceEXT");
		...
		CommandSetPrimitiveTopologyEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetPrimitiveTopologyEXT");
		...
		CommandSetViewportWithCountEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetViewportWithCountEXT");
		...
		CommandSetScissorWithCountEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetScissorWithCountEXT");
		...
		CommandBindVertexBuffers2EXTPointer = GetInstanceProcedureAddress(instance, "CommandBindVertexBuffers2EXT");
		...
		CommandSetDepthTestEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthTestEnableEXT");
		...
		CommandSetDepthWriteEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthWriteEnableEXT");
		...
		CommandSetDepthCompareOpEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthCompareOpEXT");
		...
		CommandSetDepthBoundsTestEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthBoundsTestEnableEXT");
		...
		CommandSetStencilTestEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetStencilTestEnableEXT");
		...
		CommandSetStencilOpEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetStencilOpEXT");
		...
		CreatePrivateDataSlotEXTPointer = GetInstanceProcedureAddress(instance, "CreatePrivateDataSlotEXT");
		...
		DestroyPrivateDataSlotEXTPointer = GetInstanceProcedureAddress(instance, "DestroyPrivateDataSlotEXT");
		...
		SetPrivateDataEXTPointer = GetInstanceProcedureAddress(instance, "SetPrivateDataEXT");
		...
		GetPrivateDataEXTPointer = GetInstanceProcedureAddress(instance, "GetPrivateDataEXT");
		...
		CommandSetEvent2KHRPointer = GetInstanceProcedureAddress(instance, "CommandSetEvent2KHR");
		...
		CommandResetEvent2KHRPointer = GetInstanceProcedureAddress(instance, "CommandResetEvent2KHR");
		...
		CommandWaitEvents2KHRPointer = GetInstanceProcedureAddress(instance, "CommandWaitEvents2KHR");
		...
		CommandPipelineBarrier2KHRPointer = GetInstanceProcedureAddress(instance, "CommandPipelineBarrier2KHR");
		...
		CommandWriteTimestamp2KHRPointer = GetInstanceProcedureAddress(instance, "CommandWriteTimestamp2KHR");
		...
		QueueSubmit2KHRPointer = GetInstanceProcedureAddress(instance, "QueueSubmit2KHR");
		...
		CommandCopyBuffer2KHRPointer = GetInstanceProcedureAddress(instance, "CommandCopyBuffer2KHR");
		...
		CommandCopyImage2KHRPointer = GetInstanceProcedureAddress(instance, "CommandCopyImage2KHR");
		...
		CommandCopyBufferToImage2KHRPointer = GetInstanceProcedureAddress(instance, "CommandCopyBufferToImage2KHR");
		...
		CommandCopyImageToBuffer2KHRPointer = GetInstanceProcedureAddress(instance, "CommandCopyImageToBuffer2KHR");
		...
		CommandBlitImage2KHRPointer = GetInstanceProcedureAddress(instance, "CommandBlitImage2KHR");
		...
		CommandResolveImage2KHRPointer = GetInstanceProcedureAddress(instance, "CommandResolveImage2KHR");
		...
		CommandSetRasterizerDiscardEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetRasterizerDiscardEnableEXT");
		...
		CommandSetDepthBiasEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetDepthBiasEnableEXT");
		...
		CommandSetPrimitiveRestartEnableEXTPointer = GetInstanceProcedureAddress(instance, "CommandSetPrimitiveRestartEnableEXT");
		...
		GetDeviceBufferMemoryRequirementsKHRPointer = GetInstanceProcedureAddress(instance, "GetDeviceBufferMemoryRequirementsKHR");
		...
		GetDeviceImageMemoryRequirementsKHRPointer = GetInstanceProcedureAddress(instance, "GetDeviceImageMemoryRequirementsKHR");
		...
		GetDeviceImageSparseMemoryRequirementsKHRPointer = GetInstanceProcedureAddress(instance, "GetDeviceImageSparseMemoryRequirementsKHR");
