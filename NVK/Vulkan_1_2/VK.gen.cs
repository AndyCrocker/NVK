...
public static unsafe class VK
{
	...
	public static void GetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, VkDeviceImageMemoryRequirementsKHR* info, uint* sparseMemoryRequirementCount, VkSparseImageMemoryRequirements2[] sparseMemoryRequirements) => GetDeviceImageSparseMemoryRequirementsKHR_0(device, info, sparseMemoryRequirementCount, sparseMemoryRequirements);
	private delegate void GetDeviceImageSparseMemoryRequirementsKHRDelegate_0(VkDevice device, VkDeviceImageMemoryRequirementsKHR* info, uint* sparseMemoryRequirementCount, VkSparseImageMemoryRequirements2[] sparseMemoryRequirements);
	private static GetDeviceImageSparseMemoryRequirementsKHRDelegate_0 GetDeviceImageSparseMemoryRequirementsKHR_0;
	public static void GetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, VkDeviceImageMemoryRequirementsKHR* info, ref uint sparseMemoryRequirementCount, VkSparseImageMemoryRequirements2[] sparseMemoryRequirements) => GetDeviceImageSparseMemoryRequirementsKHR_1(device, info, ref sparseMemoryRequirementCount, sparseMemoryRequirements);
	private delegate void GetDeviceImageSparseMemoryRequirementsKHRDelegate_1(VkDevice device, VkDeviceImageMemoryRequirementsKHR* info, ref uint sparseMemoryRequirementCount, VkSparseImageMemoryRequirements2[] sparseMemoryRequirements);
	private static GetDeviceImageSparseMemoryRequirementsKHRDelegate_1 GetDeviceImageSparseMemoryRequirementsKHR_1;
	public static void GetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, ref VkDeviceImageMemoryRequirementsKHR info, uint* sparseMemoryRequirementCount, VkSparseImageMemoryRequirements2[] sparseMemoryRequirements) => GetDeviceImageSparseMemoryRequirementsKHR_2(device, ref info, sparseMemoryRequirementCount, sparseMemoryRequirements);
	private delegate void GetDeviceImageSparseMemoryRequirementsKHRDelegate_2(VkDevice device, ref VkDeviceImageMemoryRequirementsKHR info, uint* sparseMemoryRequirementCount, VkSparseImageMemoryRequirements2[] sparseMemoryRequirements);
	private static GetDeviceImageSparseMemoryRequirementsKHRDelegate_2 GetDeviceImageSparseMemoryRequirementsKHR_2;
	public static void GetDeviceImageSparseMemoryRequirementsKHR(VkDevice device, ref VkDeviceImageMemoryRequirementsKHR info, ref uint sparseMemoryRequirementCount, VkSparseImageMemoryRequirements2[] sparseMemoryRequirements) => GetDeviceImageSparseMemoryRequirementsKHR_3(device, ref info, ref sparseMemoryRequirementCount, sparseMemoryRequirements);
	private delegate void GetDeviceImageSparseMemoryRequirementsKHRDelegate_3(VkDevice device, ref VkDeviceImageMemoryRequirementsKHR info, ref uint sparseMemoryRequirementCount, VkSparseImageMemoryRequirements2[] sparseMemoryRequirements);
