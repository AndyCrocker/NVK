...
internal class ParameterModifierAttribute : Attribute
{
    ...
    *********/
    ...
    /// <summary>Whether the value is required for calling the delegate as well as the parameter definition.</summary>
    ...
    *********/
    ...
    /// <param name="isRequiredForCalling">Whether the value is required for calling the delegate as well as the parameter definition.</param>
